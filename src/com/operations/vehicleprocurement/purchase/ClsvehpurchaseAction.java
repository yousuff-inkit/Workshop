...
public class ClsvehpurchaseAction extends HttpServlet {

	ClsCommon ClsCommon=new ClsCommon();

ClsvehpurchaseDAO vehpurchaseDAO= new ClsvehpurchaseDAO(); 
ClsvehpurchaseBean pintbean= new ClsvehpurchaseBean(); 
ClsvehpurchaseBean bean;
...
if(mode.equalsIgnoreCase("A")){
	...
	int val=vehpurchaseDAO.insert(sqlStartDate,sqlpurdeldate,invDate,getHeadacccode(),getVehtype(),getMasterrefno(),getNettotal(),
			getVehdesc(),session,getMode(),getFormdetailcode(),descarray,getInvno(),request);
...
return "fail";	
	...
	public String printAction() throws ParseException, SQLException{
		...
		// ArrayList<String> arraylist = ClsvehpurchaseDAO.getPrintdetails(doc);
		 ...
		 setLblprintname("Vehicle Purchase");
