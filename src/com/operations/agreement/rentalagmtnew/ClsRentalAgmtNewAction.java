...
public class ClsRentalAgmtNewAction {
ClsRentalAgmtNewDAO rentalAgmtDAO= new ClsRentalAgmtNewDAO();
	
	ClsCommon commonDAO=new ClsCommon();
	
	ClsRentalAgmtNewBean RentalAgreementBean;
	ClsRentalAgmtNewBean bean;
	//  main 
		 ...
		 Map<String, String[]> requestParams = request.getParameterMap();
           ...
           if(mode.equalsIgnoreCase("A")){
			...
			int val=rentalAgmtDAO.insert(sqlrentalDate,getTxtfleetno(),getTxtcusid(),getRe_salmanid(),getRe_clcodeno(),
					...
					getAdvance_chk(),getMode(),session,getFormdetailcode(),request,getClient_Name(),getDelcharges(),getRentaldesc(),getWeekend(),getCmbtarifnew());
String vdocno=request.getAttribute("vocno").toString();
			if(val>0){
				...
				setCmbtarifnew(getCmbtarifnew());
				setHidcmbtarifnew(getCmbtarifnew());
				//client
			...
			setVehdetails(RentalAgreementBean.getVehdetails());
			  ...
			  setHidcmbtarifnew(RentalAgreementBean.getHidcmbtarifnew());
			  setCmbtarifnew(RentalAgreementBean.getCmbtarifnew());
			//client
		 ...
		 public String printAction() throws ParseException, SQLException,Exception{
			//System.out.println("========"+getFormdetailcode());
			 ...
			 setDocnoval(request.getParameter("docno"));
			  ...
			  setHidcmbtarifnew(bean.getHidcmbtarifnew());
			  setCmbtarifnew(bean.getCmbtarifnew());
...
/*			  setDeldates setDeltimes setDelkmins setDelfuels*/
	    	...
	    	//   System.out.println("=========="+getUrl()+"============"+getFormdetailcode());
	           ...
	           /*System.out.println(bean.getRasupercdw()+"::"+bean.getRacdwscdw()+"::"+bean.getLblpai()+"::"+bean.getLblcosmobabyseater()+"::"+bean.getLblcosmogps()+"::"+bean.getLaldelcharge()+"::"+bean.getLblcosmocollectchg());
	           double cosmototaltemp=Double.parseDouble(bean.getRasupercdw()+bean.getRacdwscdw()+bean.getLblpai()+bean.getLblcosmobabyseater()+bean.getLblcosmogps()+bean.getLaldelcharge()+bean.getLblcosmocollectchg());
	           setLblcosmototal(cosmototaltemp+"");*/
			 }
			 catch(Exception e){
				 e.printStackTrace();
			 }
