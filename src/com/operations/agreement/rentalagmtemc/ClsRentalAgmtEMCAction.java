...
public class ClsRentalAgmtEMCAction {

	ClsRentalAgmtEMCDAO agmtdao=new ClsRentalAgmtEMCDAO();
...
//tariff search foe daily monthly00000
	...
	//Extra added m	
		private String lbltel1,lbltel2, salagent ,raagent,  salname ;
...
private String selcartarif,selcarcdw,selcarcdw1,selcarpai,selcaracc,selcarvmd;
	...
	private String date,vocno,docno,cldocno,clientdetails,clientname,salesman,hidsalesman,description,fleetno,fleetdetails,outdate,outtime,outkm,cmboutfuel,
	hidouttime,hidcmboutfuel,platecode,regno,chassisno,jobcardno,clientvehremarks,hidplatecode,courtesydays,rate,duedate,duetime,hidduetime,msg,mode,clientacno,
	formdetailcode,brchName;
	private int paymentgridlength,drivergridlength;
	...
	public String getClientvehremarks() {
		return clientvehremarks;
	}

	public void setClientvehremarks(String clientvehremarks) {
		this.clientvehremarks = clientvehremarks;
	}

	public String getHidplatecode() {
		return hidplatecode;
	}

	public void setHidplatecode(String hidplatecode) {
		this.hidplatecode = hidplatecode;
	}

	public String getCourtesydays() {
		return courtesydays;
	}

	public void setCourtesydays(String courtesydays) {
		this.courtesydays = courtesydays;
	}
	...
	public String getHidduetime() {
		return hidduetime;
	}

	public void setHidduetime(String hidduetime) {
		this.hidduetime = hidduetime;
	}
	...
	private String job_cardno,reg_no,emiratesid;



	public String getJob_cardno() {
		return job_cardno;
	}

	public void setJob_cardno(String job_cardno) {
		this.job_cardno = job_cardno;
	}
	...
	private String infueldet;
	private String  outfueldet;
	private String customername;
	private String billingaddress;
	private String customerphno;
	private String customeremail;
	private String outmileageprint,inmileageprint,outdateprint,indateprint,accountnoprint,expirydate;
	...
	public String getAccountnoprint() {
		return accountnoprint;
	}

	public void setAccountnoprint(String accountnoprint) {
		this.accountnoprint = accountnoprint;
	}

	public String getOutmileageprint() {
		return outmileageprint;
	}

	public void setOutmileageprint(String outmileageprint) {
		this.outmileageprint = outmileageprint;
	}

	public String getInmileageprint() {
		return inmileageprint;
	}

	public void setInmileageprint(String inmileageprint) {
		this.inmileageprint = inmileageprint;
	}

	public String getOutdateprint() {
		return outdateprint;
	}

	public void setOutdateprint(String outdateprint) {
		this.outdateprint = outdateprint;
	}

	public String getIndateprint() {
		return indateprint;
	}

	public void setIndateprint(String indateprint) {
		this.indateprint = indateprint;
	}

	public String getInfueldet() {
		return infueldet;
	}

	public void setInfueldet(String infueldet) {
		this.infueldet = infueldet;
	}

	public String getOutfueldet() {
		return outfueldet;
	}

	public void setOutfueldet(String outfueldet) {
		this.outfueldet = outfueldet;
	}
	...
	private String vehdet_chasisno;
	
	
	public String getVehdet_chasisno() {
		return vehdet_chasisno;
	}

	public void setVehdet_chasisno(String vehdet_chasisno) {
		this.vehdet_chasisno = vehdet_chasisno;
	}

	public void setData(int docno,java.sql.Date sqldate,java.sql.Date sqloutdate,java.sql.Date sqlduedate,HttpServletRequest request){
		setDocno(docno+"");
		setVocno(request.getAttribute("vocno").toString());
		...
		setOutdate(sqloutdate.toString());
		setHidouttime(getOuttime());
		setOutkm(getOutkm());
		setHidcmboutfuel(getCmboutfuel());
		setPlatecode(getPlatecode());
		setRegno(getRegno());
		setChassisno(getChassisno());
		setJobcardno(getJobcardno());
		setClientvehremarks(getClientvehremarks());
		setCourtesydays(getCourtesydays());
		setRate(getRate());
		setDuedate(sqlduedate.toString());
		setHidduetime(getDuetime());
	}
	public String saveAction() throws ParseException, SQLException{
		...
		String mode=getMode();
		java.sql.Date sqldate=null,sqloutdate=null,sqlduedate=null;
		Map<String, String[]> requestParams = request.getParameterMap();
		if(mode.equalsIgnoreCase("A")){
			if(!getDate().equalsIgnoreCase("") && getDate()!=null){
				sqldate=objcommon.changeStringtoSqlDate(getDate());
			}
			if(!getOutdate().equalsIgnoreCase("") && getOutdate()!=null){
				sqloutdate=objcommon.changeStringtoSqlDate(getOutdate());
			}
			if(!getDuedate().equalsIgnoreCase("") && getDuedate()!=null){
				sqlduedate=objcommon.changeStringtoSqlDate(getDuedate());
			}
			...
			System.out.println();
			int val=agmtdao.insert(sqldate,sqloutdate,sqlduedate,getOuttime(),getDuetime(),getCldocno(),getDescription(),getHidsalesman(),getFleetno(),getOutkm(),
					getCmboutfuel(),getPlatecode(),getRegno(),getChassisno(),getJobcardno(),getClientvehremarks(),getCourtesydays(),getRate(),
					getFormdetailcode(),mode,session,request,paymentarray,driverarray,getClientacno(),getBrchName(),getClientname());
			if(val>0){
				setData(val, sqldate, sqloutdate, sqlduedate,request);
			...
			setFleetdetails(bean.getFleetdetails());
			setOutdate(bean.getOutdate());
			setHidouttime(bean.getHidouttime());
			System.out.println("Bean Client: "+bean.getHidouttime());
			System.out.println("Action Client: "+getHidouttime());
			setOutkm(bean.getOutkm());
			setHidcmboutfuel(bean.getHidcmboutfuel());
			setPlatecode(bean.getPlatecode());
			setRegno(bean.getRegno());
			setChassisno(bean.getChassisno());
			setJobcardno(bean.getJobcardno());
			setClientvehremarks(bean.getClientvehremarks());
			setCourtesydays(bean.getCourtesydays());
			setRate(bean.getRate());
			setDuedate(bean.getDuedate());
			setHidduetime(bean.getDuetime());
			return "success";
		}
	 ...
	 public String printAction() throws ParseException, SQLException,Exception{
		//System.out.println("========"+getFormdetailcode());
		 ...
		 //setDocnoval(request.getParameter("docno"));
		  ...
		  setVehdet_chasisno(bean.getVehdet_chasisno());
		  setOuttime(bean.getOuttime());
		  //del details
...
/*			  setDeldates setDeltimes setDelkmins setDelfuels*/
   	...
   	//   System.out.println("=========="+getUrl()+"============"+getFormdetailcode());
		...
		//For Selcar
		 ...
		 //for emc print
                 setJob_cardno(bean.getJob_cardno());
          setReg_no(bean.getReg_no());
          setEmiratesid(bean.getEmiratesid());
          setIndateprint(bean.getIndateprint());
          setOutdateprint(bean.getOutdateprint());
          setOutfueldet(bean.getOutfueldet());
          setInfueldet(bean.getInfueldet());
          setInmileageprint(bean.getInmileageprint());
          setCusaddress(bean.getCusaddress());
          setCustomeremail(bean.getCustomeremail());
          setCustomerphno(bean.getCustomerphno());
          setCustomername(bean.getCustomername());
          setExpirydate(bean.getExpirydate());
          setAccountnoprint(bean.getAccountnoprint());
