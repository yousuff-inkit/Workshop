...
public class ClsBankReceiptBean {
	...
	private String applyqry,acountgqry,bank;
	...
	public String getApplyqry() {
		return applyqry;
	}

	public void setApplyqry(String applyqry) {
		this.applyqry = applyqry;
	}

	public String getAcountgqry() {
		return acountgqry;
	}

	public void setAcountgqry(String acountgqry) {
		this.acountgqry = acountgqry;
	}
