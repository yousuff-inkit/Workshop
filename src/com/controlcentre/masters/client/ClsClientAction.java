...
public class ClsClientAction  extends ActionSupport {
	...
	private String clientDate,chkstatus;
	private int insurtypegridlength;
	private String insurtypedeleterow;
	
	
	
	public String getInsurtypedeleterow() {
		return insurtypedeleterow;
	}

	public void setInsurtypedeleterow(String insurtypedeleterow) {
		this.insurtypedeleterow = insurtypedeleterow;
	}

	public int getInsurtypegridlength() {
		return insurtypegridlength;
	}

	public void setInsurtypegridlength(int insurtypegridlength) {
		this.insurtypegridlength = insurtypegridlength;
	}
	...
	private int cmbprivillege;
	private int hidcmbprivillege;
...
private int chknontax;
	...
	public int getCmbprivillege() {
		return cmbprivillege;
	}

	public void setCmbprivillege(int cmbprivillege) {
		this.cmbprivillege = cmbprivillege;
	}

	public int getHidcmbprivillege() {
		return hidcmbprivillege;
	}

	public void setHidcmbprivillege(int hidcmbprivillege) {
	...
	public String saveClientMaster() throws ParseException, SQLException
	{
		...
		try{
			...
			if(mode.equalsIgnoreCase("A")){
				...
				for(int i=0;i<getInsurtypegridlength();i++){
					String temp=requestParams.get("testinsur"+i)[0];
					insurtypearray.add(temp);
				}
				//System.out.println(getTxtclient_name()+","+getCurrencyid()+","+getCmbacgroup()+","+getCmbsalesmanid()+","+getCmbsalesman()+","+getTxtcstno()+","+getTxttinno()+","+getTxtcredit_period_min()+","+getTxtcredit_period_max()+","+getTxtcredit_limit()+","+getTxtaddress()+","+getTxtextnno()+","+getTxtmobile()+","+getTxttelephone()+","+getTxtfax()+","+getTxtweb()+","+getTxtemail()+","+getTxtcontact()+","+getTxtarea()+","+getTxtareadet()+","+getTxtareaid()+","+getTxtaccountno()+","+getTxtbankname()+","+getTxtbranchname()+","+getTxtbranchaddress()+","+getTxtswiftno()+","+getTxtibanno()+","+getTxtcity()+","+getCountryid()+",'"+getFormdetailcode()+"'");
				
				val=clientDAO.insert(sqlDate,getTxtclient_name(),getCurrencyid(),getCmbacgroup(),getCmbprivillege() ,getSalid(),getCmbcategory(),getTxtcstno(),getTxttinno(),
						...
						getFormdetailcode(),getTxtfinname(),getTxtfinaddress(),request,getChknontax());
				...
				System.out.println("val==="+val);
				 if(val==-2){
					...
					int insurvalue=clientDAO.insurInsert(val,insurtypearray,getInsurtypedeleterow());
					if(insurvalue==1){
						//Error Occured in Insurance Type Insert
						setClientDate(sqlDate+"");
						reloadData(val);
						setMsg("Insurance Type Error");
						setChkstatus("1");
						return "fail";
					}
					setTxtcode(val+"");
				...
				val=clientDAO.update(sqlDate,getTxtclient_name(),getCurrencyid(),getCmbacgroup(),getCmbprivillege(),getSalid(),getCmbcategory(),getTxtcstno(),getTxttinno(),
						getTxtcredit_period_min(),getTxtcredit_period_max(),getTxtcredit_limit(),getTxtaddress(),getTxtextnno(),getTxtmobile(),getTxttelephone(),
						getTxtfax(),getTxtweb(),getTxtemail(),getTxtcontact(),getTxtareaid(),getTxtaccountno(),getTxtbankname(),
						getTxtbranchname(),getTxtbranchaddress(),getTxtswiftno(),getTxtibanno(),getTxtcity(),getCountryid(),getTxtcontact(),
						cparray,session,getMode(),getTxtcode(),getTxtaccount(),getFormdetailcode(),getTxtfinname(),getTxtfinaddress(),request,getChknontax());
				...
				setHidcmbprivillege(clbean.getCmbprivillege());
				...
				setChknontax(clbean.getChknontax());
