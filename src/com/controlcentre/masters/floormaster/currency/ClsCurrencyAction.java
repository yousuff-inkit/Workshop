package com.controlcentre.masters.floormaster.currency;
...
public class ClsCurrencyAction  {
	...
	public String saveAction() throws ParseException, IOException, SQLException{
		...
		return "fail";
		  ...
		  try {
			  ClsCurrencyDAO ClsCurrencyDAO=new ClsCurrencyDAO();
			  List <ClsCurrencyBean> list= ClsCurrencyDAO.list();
