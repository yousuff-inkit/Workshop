...
public int insert_slab(ArrayList<String> slabarray,String group,int docno,HttpSession session,String tempstatus,String hidgroupdoc) throws SQLException {
	System.out.println("Insert slab Detail"+docno);
	String group2=group.trim();
//	System.out.println(hidgroupdoc+"GID IN DAO");
	...
	try {
		...
		conn.setAutoCommit(false);
		Statement stmtSlab = conn.createStatement ();
	//System.out.println("Here");
...
if(tempstatus.equalsIgnoreCase("0")){
	String deletesql="delete from gl_tarifd where doc_no='"+docno+"' and gid='"+hidgroupdoc+"'";
	int deleteval=stmtSlab.executeUpdate(deletesql);
	/*if(deleteval<=0){
		return 0;
	}*/
}
...
//System.out.println(tarifarray.size());
	for(int i=0;i< slabarray.size();i++){
		
		String[] tarif=slabarray.get(i).split("::");
		System.out.println(slabarray.get(i));
		///System.out.println(tarif[17]);
			/* sql="insert into gl_tarifd(doc_no,branch,cdw,pai,kmrest,exkmrte,rate,gid,renttype,cdw1,pai1,oinschg,chaufchg,chaufexchg,exhrchg,"+
					"disclevel1,disclevel2,disclevel3,gps,babyseater,cooler) values ('"+docno+"','"+session.getAttribute("BRANCHID").toString()+"',"
						*/
		 sql="insert into gl_tarifd(doc_no,branch,cdw,pai,kmrest,exkmrte,gid,renttype,cdw1,pai1,oinschg,chaufexchg,exhrchg,"+
					"gps,babyseater,cooler,slabfromday,slabtoday,slabrateperday) values ('"+docno+"','"+session.getAttribute("BRANCHID").toString()+"',"
						
					+ "'"+(tarif[4].equalsIgnoreCase("undefined") || tarif[4].isEmpty()?0:tarif[4])+"',"
							+ "'"+(tarif[5].equalsIgnoreCase("undefined") || tarif[5].equalsIgnoreCase("")?0:tarif[5])+"',"
							+ "'"+(tarif[13].equalsIgnoreCase("undefined") || tarif[13].equalsIgnoreCase("")?0:tarif[13])+"',"
							+ "'"+(tarif[14].equalsIgnoreCase("undefined") || tarif[14].equalsIgnoreCase("")?0:tarif[14])+"',"
							+ "'"+hidgroupdoc+"','"+tarif[0]+"','"+(tarif[6].equalsIgnoreCase("undefined") || tarif[6].equalsIgnoreCase("")?0:tarif[6])+"',"
							+ "'"+(tarif[7].equalsIgnoreCase("undefined") || tarif[7].equalsIgnoreCase("")?0:tarif[7])+"',"
							+ "'"+(tarif[15].equalsIgnoreCase("undefined") || tarif[15].equalsIgnoreCase("")?0:tarif[15])+"',"
							+ "'"+(tarif[12].equalsIgnoreCase("undefined") || tarif[12].equalsIgnoreCase("")?0:tarif[12])+"',"
							+ "'"+(tarif[11].equalsIgnoreCase("undefined") || tarif[11].equalsIgnoreCase("")?0:tarif[11])+"',"
								+ "'"+(tarif[8].equalsIgnoreCase("undefined") || tarif[8].equalsIgnoreCase("")?0:tarif[8])+"',"
									...
									+ "'"+(tarif[10].equalsIgnoreCase("undefined") || tarif[10].equalsIgnoreCase("")?0:tarif[10])+"',"
									+ "'"+(tarif[1].equalsIgnoreCase("undefined") || tarif[1].equalsIgnoreCase("")?0:tarif[1])+"',"
									+ "'"+(tarif[2].equalsIgnoreCase("undefined") || tarif[2].equalsIgnoreCase("")?0:tarif[2])+"',"
							
									+ "'"+(tarif[3].equalsIgnoreCase("undefined") || tarif[3].equalsIgnoreCase("")?0:tarif[3])+"')";
			 aaa = stmtSlab.executeUpdate (sql);
...
public int insert_package(ArrayList<String> packagearray,String group,int docno,HttpSession session,String tempstatus,String hidgroupdoc) throws SQLException {
	System.out.println("Insert Detail"+docno);
	String group2=group.trim();
//	System.out.println(hidgroupdoc+"GID IN DAO");
...
if(tempstatus.equalsIgnoreCase("0")){
	String deletesql="delete from gl_tarifd where doc_no='"+docno+"' and gid='"+hidgroupdoc+"'";
	int deleteval=stmtPackage.executeUpdate(deletesql);
	/*if(deleteval<=0){
		return 0;
	}*/
}
...
//System.out.println(tarifarray.size());
	for(int i=0;i< packagearray.size();i++){
		...
		String[] tarif=packagearray.get(i).split("::");
		...
		///System.out.println(tarif[17]);
			/* sql="insert into gl_tarifd(doc_no,branch,cdw,pai,kmrest,exkmrte,rate,gid,renttype,cdw1,pai1,oinschg,chaufchg,chaufexchg,exhrchg,"+
					"disclevel1,disclevel2,disclevel3,gps,babyseater,cooler) values ('"+docno+"','"+session.getAttribute("BRANCHID").toString()+"',"
						*/
		 sql="insert into gl_tarifd(doc_no,branch,cdw,pai,kmrest,exkmrte,gid,renttype,cdw1,pai1,oinschg,chaufexchg,exhrchg,"+
					"gps,babyseater,cooler,packageblockday,packageblocktarif,packageextradaytarif) values ('"+docno+"','"+session.getAttribute("BRANCHID").toString()+"',"
			...
			System.out.println("Sql------------------------"+sql);
			 aaa = stmtPackage.executeUpdate (sql);
...
public  JSONArray getSlabTarif(String gid,String docno,HttpSession session) throws SQLException {
   // List<ClsTarifBean> tarifbean = new ArrayList<ClsTarifBean>();
    JSONArray RESULTDATA=new JSONArray();
    Connection conn = ClsConnection.getMyConnection();
	try {
			...
			Statement stmtTarif = conn.createStatement ();
        	String strSql="select m1.renttype rentaltype,m1.cdw,m1.pai,m1.kmrest,m1.exkmrte,m1.gps,m1.babyseater,m1.cooler,m1.disclevel1,m1.disclevel2,m1.disclevel3,m1.cdw1,m1.pai1,m1.oinschg,"+
        			"m1.chaufchg,m1.chaufexchg,m1.exhrchg,m1.slabfromday,m1.slabtoday,m1.slabrateperday from gl_tarifm m2 left join gl_tarifd m1 on m2.doc_no=m1.doc_no "+
					"  where m1.gid = '"+gid+"' and m2.doc_no='"+docno+"'";
			ResultSet resultSet = stmtTarif.executeQuery (strSql);
			RESULTDATA=ClsCommon.convertToJSON(resultSet);
			stmtTarif.close();
			conn.close();
...
public  JSONArray getPackageTarif(String gid,String docno,HttpSession session) throws SQLException {
	   // List<ClsTarifBean> tarifbean = new ArrayList<ClsTarifBean>();
	    JSONArray RESULTDATA=new JSONArray();
	    Connection conn = ClsConnection.getMyConnection();
		try {
				...
				Statement stmtTarif = conn.createStatement ();
	        	String strSql="select m1.renttype rentaltype,m1.cdw,m1.pai,m1.kmrest,m1.exkmrte,m1.gps,m1.babyseater,m1.cooler,m1.disclevel1,m1.disclevel2,m1.disclevel3,m1.cdw1,m1.pai1,m1.oinschg,"+
	        			"m1.chaufchg,m1.chaufexchg,m1.exhrchg,m1.packageblockday,m1.packageblocktarif,m1.packageextradaytarif from gl_tarifm m2 left join gl_tarifd m1 on m2.doc_no=m1.doc_no "+
						" where m1.gid = '"+gid+"' and m2.doc_no='"+docno+"'";
				ResultSet resultSet = stmtTarif.executeQuery (strSql);
				RESULTDATA=ClsCommon.convertToJSON(resultSet);
				stmtTarif.close();
...
public  JSONArray getNewSlab() throws SQLException {
    Connection conn = null;
    JSONArray RESULTDATA=new JSONArray();
	try {
			conn=ClsConnection.getMyConnection();
			Statement stmtTarif = conn.createStatement ();
        	String strSql="select 'Slab 1' rentaltype";
			ResultSet resultSet = stmtTarif.executeQuery (strSql);
			RESULTDATA=ClsCommon.convertToJSON(resultSet);
			stmtTarif.close();
			conn.close();
...
public  JSONArray getNewPackage() throws SQLException {
    Connection conn = null;
    JSONArray RESULTDATA=new JSONArray();
	try {
			conn=ClsConnection.getMyConnection();
			Statement stmtTarif = conn.createStatement ();
        	String strSql="select 'Package 1' rentaltype";
			ResultSet resultSet = stmtTarif.executeQuery (strSql);
			RESULTDATA=ClsCommon.convertToJSON(resultSet);
			stmtTarif.close();
			conn.close();
