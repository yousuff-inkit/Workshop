...
public class ClsFixedAssetDepreciationPostingAction extends ActionSupport{
	...
	public String printAction() throws ParseException, SQLException{
		...
		fixedAssetDepreciationPostingBean=fixedAssetDepreciationPostingDAO.getPrint(request,docno,branch,header);
		
		setUrl(ClsCommon.getPrintPath("FADP"));
		setLblcompname(fixedAssetDepreciationPostingBean.getLblcompname());
		setLblcompaddress(fixedAssetDepreciationPostingBean.getLblcompaddress());
		setLblpobox(fixedAssetDepreciationPostingBean.getLblpobox());
		setLblprintname(fixedAssetDepreciationPostingBean.getLblprintname());
		setLblcomptel(fixedAssetDepreciationPostingBean.getLblcomptel());
		setLblcompfax(fixedAssetDepreciationPostingBean.getLblcompfax());
		setLblbranch(fixedAssetDepreciationPostingBean.getLblbranch());
		setLbllocation(fixedAssetDepreciationPostingBean.getLbllocation());
		setLblservicetax(fixedAssetDepreciationPostingBean.getLblservicetax());
		setLblpan(fixedAssetDepreciationPostingBean.getLblpan());
		setLblcstno(fixedAssetDepreciationPostingBean.getLblcstno());
		setLblvoucherno(fixedAssetDepreciationPostingBean.getLblvoucherno());
		setLbldate(fixedAssetDepreciationPostingBean.getLbldate());
		setLblnetamount(fixedAssetDepreciationPostingBean.getLblnetamount());
		setLblnetamountwords(fixedAssetDepreciationPostingBean.getLblnetamountwords());
		setLbldebittotal(fixedAssetDepreciationPostingBean.getLbldebittotal());
		setLblcredittotal(fixedAssetDepreciationPostingBean.getLblcredittotal());
		setLbldepreciationtotal(fixedAssetDepreciationPostingBean.getLbldepreciationtotal());
		setLblpreparedby(fixedAssetDepreciationPostingBean.getLblpreparedby());
		setLblpreparedon(fixedAssetDepreciationPostingBean.getLblpreparedon());
		setLblpreparedat(fixedAssetDepreciationPostingBean.getLblpreparedat());
		
		// for hide
		setFirstarray(fixedAssetDepreciationPostingBean.getFirstarray());
		setSecarray(fixedAssetDepreciationPostingBean.getSecarray());
		setTxtheader(fixedAssetDepreciationPostingBean.getTxtheader());
