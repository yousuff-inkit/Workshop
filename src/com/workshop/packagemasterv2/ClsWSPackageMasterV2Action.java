...
public class ClsWSPackageMasterV2Action extends ActionSupport{
	...
	public String saveAction() throws ParseException, SQLException{
		...
		ClsWSPackageMasterV2Action masteraction=new ClsWSPackageMasterV2Action();
		ArrayList<String> sparearray=new ArrayList<>();
		ArrayList<String> labourarray=new ArrayList<>();
		ClsWSPackageMasterV2DAO dao=new ClsWSPackageMasterV2DAO();
		if(!mode.equalsIgnoreCase("view")){
			...
			masteraction.setCmbenginesize(getCmbenginesize());
	...
	private void setValues(ClsWSPackageMasterV2Action masteraction,
		...
		setHidcmbenginesize(masteraction.getCmbenginesize());
	}
}
