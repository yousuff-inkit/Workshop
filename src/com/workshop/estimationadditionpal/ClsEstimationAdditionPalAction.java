...
public class ClsEstimationAdditionPalAction extends ActionSupport{
	...
	ClsEstimationAdditionPalDAO estimationdao=new ClsEstimationAdditionPalDAO();
	...
	public String saveAction() throws ParseException, SQLException{
		...
		if(!mode.equalsIgnoreCase("view")){
			...
			if(mode.equalsIgnoreCase("A")){
				...
				getGipclaimno(),getGipdatetime(),getEstimatedays(),getCmbserviceadvisor(),getSparetotal(),getSparediscount(),getNetspare());
				if(insertval>0){
