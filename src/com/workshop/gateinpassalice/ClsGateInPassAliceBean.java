package com.workshop.gateinpassalice;

public class ClsGateInPassAliceBean {
	
	private int gridlength,clname,apprvalchk,backjob,excesschk,movno,luxury,hidluxury,hidcompno;   
	public int getHidcompno() {
		return hidcompno;
	}
	public void setHidcompno(int hidcompno) {
		this.hidcompno = hidcompno;
	}
	private String docno,date,brchName,vehuserothers,vehregno,vehplatecode,cmbbrand,hidcmbbrand,cmbmodel,hidcmbmodel,cmbyom,hidcmbyom,
	               cldocno,vehusername,vehusermobile,vehuseremail,clientname,insucompany,clientdetails,salesmandocno,
	               description,intime,cmbinfuel,remarks,serviceduekm,vehothers,vehkm,cmbfueltype,cmbrepairtype,estdate,esttime,maintenanceremarks,
	               policereport,policedate,policestation,cmbinsutype,cmbfaulttype,claim,lpo,lpoamount,excessamount,clientid;
	private String mode,msg,deleted,formdetailcode,refno,lblcompanyname;
	...
	public String getSalesmandocno() {
		return salesmandocno;
	}
	public void setSalesmandocno(String salesmandocno) {
		this.salesmandocno = salesmandocno;
	}
	...
	public void setVehkm(String vehkm) {
		this.vehkm = vehkm;
	}
	...
	public String getCmbrepairtype() {
		return cmbrepairtype;
	}
	public void setCmbrepairtype(String cmbrepairtype) {
	...
	public String getCmbinsutype() {
		return cmbinsutype;
	}
	public void setCmbinsutype(String cmbinsutype) {
		this.cmbinsutype = cmbinsutype;
	}
	public String getCmbfaulttype() {
		return cmbfaulttype;
	}
	public void setCmbfaulttype(String cmbfaulttype) {
