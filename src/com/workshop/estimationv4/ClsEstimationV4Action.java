...
public class ClsEstimationV4Action extends ActionSupport{

	ClsEstimationV4DAO estimationdao=new ClsEstimationV4DAO();
	...
	public String saveAction() throws ParseException, SQLException{
		...
		if(!mode.equalsIgnoreCase("view")){
			...
			if(mode.equalsIgnoreCase("A")){
				...
				ClsEstimationV4Action masteraction=new ClsEstimationV4Action();
