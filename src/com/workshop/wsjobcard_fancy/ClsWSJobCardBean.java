...
public class ClsWSJobCardBean {
	private String brchName,docno,vocno,date,promdate,user,promtime,msg,deleted,formdetailcode,brchname,cmbreftype;
	private String refno,hidrefno,regno,cldocno,color,cdate,vehicledetails,userdetails,mode;
	...
	private String lbldates, lbluser, lblcolor,lblcdate, gipdate, lblgipno;
	...
	public String getLblcdate() {
		return lblcdate;
	}

	public void setLblcdate(String lblcdate) {
		this.lblcdate = lblcdate;
	}
