...
public class ClsWSEstimationFancyAction extends ActionSupport{

	ClsWSEstimationFancyDAO estimationdao=new ClsWSEstimationFancyDAO();
	ClsCommon objcommon=new ClsCommon();
	ClsConnection connDAO = new ClsConnection();
	ClsWSEstimationBean bean=new ClsWSEstimationBean();
	ClsWSEstimationFancyBean been=new ClsWSEstimationFancyBean();
		...
		if(!mode.equalsIgnoreCase("view")){
			...
			if(mode.equalsIgnoreCase("A")){
				int insertval=estimationdao.insert(getGatedocno(),getSparepartstotal(),getLabourtotal(),getDiscount(),getEsttotal(),sqldate,
						...
						getServicestotal(),getNetservices(),getHidchklumsum(),getLumsumamount(),getSparetotal(),getSparediscount(),getSparenettotal()
						);
				if(insertval>0){
				...
				boolean status=estimationdao.edit(getGatedocno(),getSparepartstotal(),getLabourtotal(),getDiscount(),getEsttotal(),sqldate,
						...
						getServicesdiscount(),getServicestotal(),getNetservices(),getHidchklumsum(),getLumsumamount(),getSparetotal(),
