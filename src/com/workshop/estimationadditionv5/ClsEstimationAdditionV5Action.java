...
public class ClsEstimationAdditionV5Action extends ActionSupport{
	...
	ClsEstimationAdditionV5DAO estimationdao=new ClsEstimationAdditionV5DAO();
	...
	public String saveAction() throws ParseException, SQLException{
		...
		if(!mode.equalsIgnoreCase("view")){
			...
			if(mode.equalsIgnoreCase("A")){
				...
				ClsEstimationAdditionV5Action masteraction=new ClsEstimationAdditionV5Action();
				...
				getGipclaimno(),getGipdatetime(),getEstimatedays(),getCmbserviceadvisor(),getSparetotal(),getSparediscount(),
				getNetspare(),getCmbentitytype(),getDistservicediscount(),getDistsparediscount(),masteraction);
				if(insertval>0){
				...
				boolean status=estimationdao.edit(getGatedocno(),getSparepartstotal(),getLabourtotal(),getDiscount(),getEsttotal(),sqldate,
						...
						getHidchkrandomlumsum(),getRandomlumsumamt(),getHeader(),getNotes(),getInternalremarks(),
						getGipclaimno(),getGipdatetime(),getEstimatedays(),getCmbserviceadvisor(),getSparetotal(),getSparediscount(),getNetspare(),getCmbentitytype(),getDistservicediscount(),getDistsparediscount(),masteraction);
				if(status){
