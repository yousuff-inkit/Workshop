...
public class ClsInvoiceV3Bean {
	private String lblcompname,lblcompaddress,lblprintname,lblbranch,lbllocation,lblcomptel,lblcompfax;
	private String lbldate,lblinvno,lblrefno,lblclient,lbladdress,lblmobile,lblemail,lblvehicle,lblchassis,excessamount;
	...
	private String lblproformatotal,lblproformatax,lblproformanetamount,lblproformaround,lblproformaamountwords;
	...
	private String totalfancy;
	private String lblclientfancy,lbladdressfancy,lblmobilefancy,lblemailfancy,lblclienttrnfancy,lblclaimnofancy,lbllponofancy;
	...
	public String getLblclaimnofancy() {
		return lblclaimnofancy;
	}

	public void setLblclaimnofancy(String lblclaimnofancy) {
		this.lblclaimnofancy = lblclaimnofancy;
	}

	public String getLbllponofancy() {
		return lbllponofancy;
	}

	public void setLbllponofancy(String lbllponofancy) {
		this.lbllponofancy = lbllponofancy;
	}

	public String getLblclientfancy() {
		return lblclientfancy;
	}

	public void setLblclientfancy(String lblclientfancy) {
		this.lblclientfancy = lblclientfancy;
	}

	public String getLbladdressfancy() {
		return lbladdressfancy;
	}

	public void setLbladdressfancy(String lbladdressfancy) {
		this.lbladdressfancy = lbladdressfancy;
	}

	public String getLblmobilefancy() {
		return lblmobilefancy;
	}

	public void setLblmobilefancy(String lblmobilefancy) {
		this.lblmobilefancy = lblmobilefancy;
	}

	public String getLblemailfancy() {
		return lblemailfancy;
	}

	public void setLblemailfancy(String lblemailfancy) {
		this.lblemailfancy = lblemailfancy;
	}

	public String getLblclienttrnfancy() {
		return lblclienttrnfancy;
	}

	public void setLblclienttrnfancy(String lblclienttrnfancy) {
		this.lblclienttrnfancy = lblclienttrnfancy;
	}
	...
	public String getTotalfancy() {
		return totalfancy;
	}

	public void setTotalfancy(String totalfancy) {
		this.totalfancy = totalfancy;
	}
