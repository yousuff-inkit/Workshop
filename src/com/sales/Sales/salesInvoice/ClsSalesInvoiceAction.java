...
public class ClsSalesInvoiceAction {
	...
	private String txtrefno,txtclientmob;
	...
	private String lbldate,lbltype,lblvendoeacc,lblvendoeaccName, expdeldate,lbldelterms ,lblpaytems,lblround, lbldesc1,lblrefno,lblsubtotal,lbltotal,lblordervalue,lblordervaluewords;
	...
	private String lblclientaddress,lblclientcity,lblclientcountry,lblclientmob,lblinvno,lblcompemail,lblamountinwordsakmal;
	...
	public String printAction() throws ParseException, SQLException{
		 ...
		 if(formcode.equalsIgnoreCase("CASH"))
		 {
			 setLblprintnameakamal("Cash Invoice");
			 
		 }
		 else  
		 {
			 setLblprintnameakamal("Credit Invoice"); 
		 }
  	     ...
  	     setLblvendoeaccName(bean.getLblvendoeaccName());
		     setExpdeldate(bean.getExpdeldate());
		    	   ...
		    	   //doca print
					...
					//	 getLblakmaldates getLbllpono  getLbldono setLblamountinwords
