...
public class ClsGoodsissuenoteBean {
    ...
    private String contperson,mob,date,loc_name,flname,desc,refname,costdoc;
	 ...
	 public String  lbldate ,lbltype, lblrefno ,lbldocno,  lblprjname ,lblclname ,lblsite, lbldesc1,jobcardno,gipno,brand,model,regno,plate;
	...
	public String getGipno() {
		return gipno;
	}

	public void setGipno(String gipno) {
		this.gipno = gipno;
	}
