...
public class ClsTransferIssueAction {
	...
	private String lbldate,lblrefno,lbldocno,lblreftype,lblbranchfrom,lbllocationfrom,lblbranchto,lbllocationto,lblremarks;
	...
	public String savetransferIssueAction(){
		...
		try{
			...
			if(mode.equalsIgnoreCase("A")){
				...
				val=DAO.insert(getTxtrefno(),date,getCmbreftype(),getBranchfrmid(),getLocationfrmid(),getBranchtoid(),getLocationtoid(),getTxtremark(),
						getTxtproductamt(),getTxtnettotal(),getNettotal(),getRoundOf(),getOrderValue(),getMode(),getFormdetailcode(),prodarray,session,request);
	...
	public String printAction() throws ParseException, SQLException{
	   ...
	   setLblbranchto(bean.getLblbranchto());
	   setLbllocationto(bean.getLbllocationto());
	   setLblremarks(bean.getLblremarks());
		
		  //cl details
		 
		 setLblprintname("Inventory Transfer Issue");
