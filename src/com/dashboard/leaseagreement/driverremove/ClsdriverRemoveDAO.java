package com.dashboard.leaseagreement.driverremove;
     	...
     	String sqltest="";
			...
			try {
					...
					Statement stmt = conn.createStatement (); 
	            		...
	            		String sql ="	select agmt.doc_no,agmt.voc_no,if(agmt.perfleet=0,agmt.tmpfleet,agmt.perfleet) fleet_no,r.brhid,v.flname,r.cldocno,r.srno,a.refname,dr.name drname, 'Edit' btnsave from  gl_lagmt agmt inner join  gl_ldriver r on r.rdocno=agmt.doc_no and r.cldocno=agmt.cldocno\r\n" + 
