...
import com.dashboard.projectexecution.assignjobfollowup.AssignJobFollowupBean;
import com.dashboard.projectexecution.assignjobfollowup.AssignJobFollowupDAO;

public class AssignJobFollowupAction {

	AssignJobFollowupDAO AssignJobFollowupDAO= new AssignJobFollowupDAO();
	AssignJobFollowupBean AssignJobFollowupBean;
	...
	public String printAction1() throws ParseException, SQLException{
		...
		AssignJobFollowupBean=AssignJobFollowupDAO.getPrint(request,docno,dtype,srno,branch);
		
		setLblclname(AssignJobFollowupBean.getLblclname());
		setLblsite(AssignJobFollowupBean.getLblsite());
		setLblcompname(AssignJobFollowupBean.getLblcompname());
		setLblcompaddress(AssignJobFollowupBean.getLblcompaddress());
		setLblcomptel(AssignJobFollowupBean.getLblcomptel());
		setLblcompfax(AssignJobFollowupBean.getLblcompfax());
		setLblbranch(AssignJobFollowupBean.getLblbranch());
		setLbllocation(AssignJobFollowupBean.getLbllocation());
		setLblprintname("JOB SHEET");
		setFirstarray(AssignJobFollowupBean.getFirstarray());
		setLblcntprsn(AssignJobFollowupBean.getLblcntprsn());
		setLblcontact(AssignJobFollowupBean.getLblcontact());
		setLblamc(AssignJobFollowupBean.getLblamc());
		setLbldocnno(AssignJobFollowupBean.getLbldocnno());
		setLbljobdat(AssignJobFollowupBean.getLbljobdat());
		/*setLblcompaddress(AssignJobFollowupBean.getLblcompaddress());
		setLblprintname(AssignJobFollowupBean.getLblprintname());
		setLblprintname1(AssignJobFollowupBean.getLblprintname1());
		setLblcomptel(AssignJobFollowupBean.getLblcomptel());
		setLblcompfax(AssignJobFollowupBean.getLblcompfax());
		setLblbranch(AssignJobFollowupBean.getLblbranch());
		setLbllocation(AssignJobFollowupBean.getLbllocation());
		setLblname(AssignJobFollowupBean.getLblname());
		setLblacno(AssignJobFollowupBean.getLblacno());
		setLbladdress(AssignJobFollowupBean.getLbladdress());
		setLblmobno(AssignJobFollowupBean.getLblmobno());
		setLblcodeno(AssignJobFollowupBean.getLblcodeno());
