package com.dashboard.analysis.revenuereportpivot;
...
public class ClsRevenueReportDAO {
	...
	public JSONArray getDetailData(String fromdate,String todate,String hidclient,String hidclientslm,String hidrepairtype,String id) throws SQLException {
        JSONArray RESULTDATA=new JSONArray();
        Connection  conn = null;
