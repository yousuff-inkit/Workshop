package com.dashboard.analysis.revenuereportapex;
...
public class ClsRevenueReportDAO {
	...
	public JSONArray getDetailData(String fromdate,String todate,String hidclient,String hidclientslm,String hidrepairtype,String id,String hidserviceadvisor) throws SQLException {
        JSONArray RESULTDATA=new JSONArray();
        Connection  conn = null;
...
*/
	...
	public JSONArray getDetailExportData(String fromdate,String todate,String hidclient,String hidclientslm,String hidrepairtype,String id,String hidserviceadvisor)throws SQLException
	{
		JSONArray RESULTDATA=new JSONArray();
        Connection  conn = null;
        if(!id.equalsIgnoreCase("1")){
