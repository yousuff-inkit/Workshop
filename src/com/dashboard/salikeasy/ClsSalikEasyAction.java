...
import com.dashboard.salik.ClsSalikBean;
import com.dashboard.salik.ClsSalikDAO;
import com.dashboard.salikeasy.*;

public class ClsSalikEasyAction {

	ClsSalikBean salikBean=new ClsSalikBean();
	ClsCommon objcommon=new ClsCommon();
	ClsSalikDAO saliknormaldao=new ClsSalikDAO();
...
//		System.out.println("chk=========== "+invoice);
		...
		if(mode.equalsIgnoreCase("A")){
			...
			ArrayList<String> invoicearray=salikdao.insert(getCmbbranch(),sqlfromdate,sqltodate,getTxtcldocno(),getRentaltype(),getTxtagreementno(),session,getCmbtype(),request);
	...
	public String printTobeInvoicedAction() throws ParseException, SQLException{
		...
		salikBean=saliknormaldao.getPrintToBeInvoiced(request,branch,fromDate,toDate,agmtno,rentaltype,cldocno);
	...
	public String printAction() throws ParseException, SQLException{
		...
		salikBean=saliknormaldao.getPrint(request,branch,fromDate,toDate,"","","");
		setLblcompname(salikBean.getLblcompname());
		setLblcompaddress(salikBean.getLblcompaddress());
