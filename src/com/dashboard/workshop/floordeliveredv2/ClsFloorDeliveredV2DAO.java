package com.dashboard.workshop.floordeliveredv2;
...
public class ClsFloorDeliveredV2DAO {
	...
	public JSONArray getFloorMgmtData(String id,String brhid,String fromdate,String todate) throws SQLException{
		...
		try{
			...
			String strsql="select gate.doc_no gatedocno,est.voc_no estvocno,est.doc_no estdocno,flr.totalloss,flr.brhid,br.branchname,flr.esttotal,flr.jobdate,flr.deliverystatus,flr.regno,flr.rowno,case when flr.z1 like "+
