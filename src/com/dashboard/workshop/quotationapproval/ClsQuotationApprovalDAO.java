package com.dashboard.workshop.quotationapproval;
import  com.common.*;
		...
		private ArrayList<String> getLabourCharges(String docno, Connection conn) throws SQLException {
			...
			try{
				...
				while(rs.next()){
					...
					temp=i+"::"+rs.getString("jobtype")+"::"+rs.getString("jobdesc")+"::"+rs.getString("hrs")+"::"+rs.getString("rate")+"::"+rs.getString("total");
						i++;
					jbarray.add(temp);
