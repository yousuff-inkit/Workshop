...
public class ClsTerminationBenefitsAction extends ActionSupport{

	ClsCommon commonDAO= new ClsCommon();
	ClsTerminationBenefitsDAO terminationBenefitsPostingDAO= new ClsTerminationBenefitsDAO();
	ClsTerminationBenefitsBean terminationBenefitsPostingBean;
	...
	//Termination Benefits Details Grid 
	...
	java.sql.Date terminationBenfitDate;
	...
	public String saveAction() throws ParseException, SQLException{
		...
		terminationBenfitDate = commonDAO.changeStringtoSqlDate(getTerminationBenefitsPostingDate());
		...
		if(mode.equalsIgnoreCase("A")){
			...
			/*Termination Benefits Details Grid Ends*/
			...
			/*Journal Voucher Grid Ends*/
						...
						int val=terminationBenefitsPostingDAO.insert(getFormdetailcode(),getBrchName(),terminationBenfitDate,getTxtterminalbenefitstotal(),getTxtleavesalarytotal(),getTxttravelstotal(),employeedetailsarray,journalvouchersarray,session,request,mode);
						if(val>0.0){
							setTxtjvno(val);
							setHidterminationBenefitsPostingDate(terminationBenfitDate.toString());
	...
	public String printAction() throws ParseException, SQLException{
		...
		terminationBenefitsPostingBean=terminationBenefitsPostingDAO.getPrint(request,docno,branch,header);
		
		setUrl(commonDAO.getPrintPath("TEB"));
		setLblcompname(terminationBenefitsPostingBean.getLblcompname());
		setLblcompaddress(terminationBenefitsPostingBean.getLblcompaddress());
		setLblpobox(terminationBenefitsPostingBean.getLblpobox());
		setLblprintname(terminationBenefitsPostingBean.getLblprintname());
		setLblcomptel(terminationBenefitsPostingBean.getLblcomptel());
		setLblcompfax(terminationBenefitsPostingBean.getLblcompfax());
		setLblbranch(terminationBenefitsPostingBean.getLblbranch());
		setLbllocation(terminationBenefitsPostingBean.getLbllocation());
		setLblservicetax(terminationBenefitsPostingBean.getLblservicetax());
		setLblpan(terminationBenefitsPostingBean.getLblpan());
		setLblcstno(terminationBenefitsPostingBean.getLblcstno());
		setLblvoucherno(terminationBenefitsPostingBean.getLblvoucherno());
		setLbldate(terminationBenefitsPostingBean.getLbldate());
		setLblterminalbenefits(terminationBenefitsPostingBean.getLblterminalbenefits());
		setLblleavesalary(terminationBenefitsPostingBean.getLblleavesalary());
		setLbltravel(terminationBenefitsPostingBean.getLbltravel());
		setLblnetamount(terminationBenefitsPostingBean.getLblnetamount());
		setLblnetamountwords(terminationBenefitsPostingBean.getLblnetamountwords());
		setLbldebittotal(terminationBenefitsPostingBean.getLbldebittotal());
		setLblcredittotal(terminationBenefitsPostingBean.getLblcredittotal());
		setLbldepreciationtotal(terminationBenefitsPostingBean.getLbldepreciationtotal());
		setLblpreparedby(terminationBenefitsPostingBean.getLblpreparedby());
		setLblpreparedon(terminationBenefitsPostingBean.getLblpreparedon());
		setLblpreparedat(terminationBenefitsPostingBean.getLblpreparedat());
		
		// for hide
		setFirstarray(terminationBenefitsPostingBean.getFirstarray());
		setSecarray(terminationBenefitsPostingBean.getSecarray());
		setTxtheader(terminationBenefitsPostingBean.getTxtheader());
	
		return "print";
	}
	
	public void setData(){
		setTxtterminalbenefitstotal(getTxtterminalbenefitstotal());
		setTxtleavesalarytotal(getTxtleavesalarytotal());
		setTxttravelstotal(getTxttravelstotal());
