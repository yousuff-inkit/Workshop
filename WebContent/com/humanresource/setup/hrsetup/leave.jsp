        ...
        <div class='modern-ui hidden-scrollbar'>
            ...
            <div class="middle-panel">
                ...
                <div class="field-row">
                    ...
                    <input type="text" name="leave" id="leave" style="flex:1;" placeholder="Leave" value='<s:property value="leave"/>'>
            ...
            <div class="middle-panel">
                <span class="middle-panel-title">Leave Records</span>
                <div id="leavegrid" class="grid-container"></div>
            </div>
