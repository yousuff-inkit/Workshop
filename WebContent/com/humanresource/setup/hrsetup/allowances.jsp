...
<script type="text/javascript">
	$(document).ready(function () {    
	    ...
	    $("#allowancedate").jqxDateTimeInput({ width: '125px', height: 24 ,formatString : "dd.MM.yyyy", theme: 'energyblue' });
        ...
        setTimeout(function () {
            ...
            $("#allowancedate").find(".jqx-action-button").css({
                "top": "0px",
                "height": "24px"
            });
        }, 0);
    ...
    <form id="frmallowance" action="saveAllowance" method="post" autocomplete="off">
        ...
        <div class='modern-ui hidden-scrollbar'>
            ...
            <div class="middle-panel">
                <span class="middle-panel-title">Allowance Details</span>
                ...
                <div class="field-row">
                    ...
                    <label class="lbl-right" style="width:90px; margin-left:15px;">Allowance</label>
                    <input type="text" name="allowancecode" id="allowancecode" style="width:125px;" placeholder="Code" value='<s:property value="allowancecode"/>'>
                    
                    <label class="lbl-right" style="width:60px; margin-left:15px;">Name</label>
                    <input type="text" name="allowance" id="allowance" style="flex:1;" placeholder="Allowance Name" value='<s:property value="allowance"/>'>
                    
                    <label class="lbl-right" style="width:60px; margin-left:15px;">Doc No</label>
                    <input type="text" name="docno" id="docno" style="width:100px;" value='<s:property value="docno"/>' readonly tabindex="-1">
                </div>
                ...
                <div class="field-row">
                    ...
                    <input type="text" name="accname" id="accname" style="flex:1;" readonly value='<s:property value="accname"/>'>
                </div>
            ...
            <div class="middle-panel">
                <span class="middle-panel-title">Allowance Records</span>
                <div id="allowancegrid" class="grid-container"></div>
            </div>
