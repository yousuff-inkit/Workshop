...
#search {
	...
	function getdata(employeeName,empId,contactNo,processPrint){
		 $("#refreshdiv").load('employeeDetailsSearchGrid.jsp?employeename='+employeeName.replace(/ /g, "%20")+'&empid='+empId+'&contactno='+contactNo+'&processPrint='+processPrint);
		}
...
<table width="100%">
  ...
  <td width="7%" align="right">ID#</td>
    ...
    <input type="hidden" name="txtempprocessprint" id="txtempprocessprint" value='<s:property value="txtempprocessprint"/>'></td>   
  </tr>
  <tr>
