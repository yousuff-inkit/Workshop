...
<%@page import="javax.servlet.http.HttpSession" %>
 ...
 String processPrint = request.getParameter("processPrint")==null?"0":request.getParameter("processPrint");%>
<script type="text/javascript">
	   var tempProcessPrint='<%=processPrint%>';
        ...
        $(document).ready(function () { 
            ...
            $("#employeeDetailsSearch").jqxGrid(
            {
             ...
             $('#employeeDetailsSearch').on('rowdoubleclick', function (event) {
                ...
                if(tempProcessPrint=='0') {
	                document.getElementById("txtprintemployeedocno").value = $('#employeeDetailsSearch').jqxGrid('getcellvalue', rowindex1, "doc_no");
	                document.getElementById("txtprintemployeeid").value = $('#employeeDetailsSearch').jqxGrid('getcellvalue', rowindex1, "codeno");
	            	document.getElementById("txtprintemployeename").value = $('#employeeDetailsSearch').jqxGrid('getcellvalue', rowindex1, "name");
                } else {
