...
<table width="100%">
  <tr>
    ...
    <td width="14%"><div id="terminatedDate" name="terminatedDate"  value='<s:property value="terminatedDate"/>'></div></td>
  ...
  <tr>
    <td colspan="5"><div id="refreshdiv"><jsp:include page="htreMainSearchGrid.jsp"></jsp:include></div></td>
  </tr>
</table>
  </div>
</body>
