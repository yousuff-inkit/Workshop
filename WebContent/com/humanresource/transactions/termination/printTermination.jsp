...
<form id="frmTerminationPrint" action="terminationPrint" method="post" autocomplete="off" target="_blank">
...
<table width="100%">
	<tr>
    <td width="10%" align="left">Voucher No.</td>
    <td width="22%">: <label name="lblvoucherno" id="lblvoucherno" ><s:property value="lblvoucherno"/></label></td>
    <td colspan="3" width="13%" align="right">Voucher Date&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td>: <label name="lbldate" id="lbldate" ><s:property value="lbldate"/></label></td>
  </tr>
  <tr>
    <td width="10%" align="left">Employee ID</td>
    <td width="22%">: <label name="lblemployeeid" id="lblemployeeid" ><s:property value="lblemployeeid"/></label></td>
    <td width="13%" align="left">Employee Name</td>
    <td colspan="3">: <label name="lblemployeename" id="lblemployeename" ><s:property value="lblemployeename"/></label></td>
  </tr>
  <tr>
    <td align="left">Designation</td>
    <td>: <label name="lbldesignation" id="lbldesignation" ><s:property value="lbldesignation"/></label></td>
    <td align="left">Department</td>
    <td width="27%">: <label name="lbldepartment" id="lbldepartment" ><s:property value="lbldepartment"/></label></td>
    <td align="left" width="9%">Category</td>
    <td width="19%">: <label name="lblcategory" id="lblcategory" ><s:property value="lblcategory"/></label></td>
  </tr>
  <tr>
    <td align="left">Date of Join</td>
    <td>: <label name="lbldateofjoin" id="lbldateofjoin" ><s:property value="lbldateofjoin"/></label></td>
    <td align="left">Appraisal Dt.</td>
    <td>: <label name="lblappraisaldt" id="lblappraisaldt" ><s:property value="lblappraisaldt"/></label></td>
    <td align="left">Notify. Date</td>
    <td>: <label name="lblnotifydate" id="lblnotifydate" ><s:property value="lblnotifydate"/></label></td>
  </tr>
</table><br/>
</fieldset><br/>
