...
%> 
 ...
 <script type="text/javascript">
 		...
 		var data2='<%=DAO.employeeDetailsSearch(session,empname,mob,employeedesignation,employeedepartment,empid,doj,check)%>';
 		...
 		$(document).ready(function () { 
            ...
            $("#employeeDetailsSearch").jqxGrid(
            {
			  ...
			  $('#employeeDetailsSearch').on('rowdoubleclick', function (event) {
                ...
                document.getElementById("txtemployeedepartment").value=$('#employeeDetailsSearch').jqxGrid('getcellvalue',rowindex1, "department");
                document.getElementById("txtemployeedesignation").value=$('#employeeDetailsSearch').jqxGrid('getcellvalue',rowindex1, "designation");
                document.getElementById("txtemployeecategory").value=$('#employeeDetailsSearch').jqxGrid('getcellvalue',rowindex1, "category");
                $("#joiningDate").jqxDateTimeInput('val', $("#employeeDetailsSearch").jqxGrid('getcellvalue', rowindex1, "dtjoin"));
                $("#appraisalDate").jqxDateTimeInput('val', $("#employeeDetailsSearch").jqxGrid('getcellvalue', rowindex1, "appriasal"));
