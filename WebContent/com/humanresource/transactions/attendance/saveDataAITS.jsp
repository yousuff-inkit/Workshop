		...
		if(funtype.equalsIgnoreCase("1")){
    	    ...
    	    if(checkweekoff.equalsIgnoreCase("0")){
    	    	...
    	    	for(int j=0;j<weeklyoffarray.size();j++){
                	...
                	if(oldattendance.equalsIgnoreCase("U")){leave3total=String.valueOf(Integer.parseInt(leave3total)-1);} 
                	if(oldattendance.equalsIgnoreCase("C")){leave4total=String.valueOf(Integer.parseInt(leave4total)-1);}
                	...
                	if(oldattendance.equalsIgnoreCase("U2")){leave3total=String.valueOf(Integer.parseInt(leave3total)-(0.5));}
                	if(oldattendance.equalsIgnoreCase("C2")){leave4total=String.valueOf(Integer.parseInt(leave4total)-(0.5));} 
