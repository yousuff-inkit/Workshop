...
<%	
	...
	try{
		...
		String leave1total=request.getParameter("leave1total")==null || request.getParameter("leave1total").trim().equalsIgnoreCase("")?"0":request.getParameter("leave1total");
		String leave2total=request.getParameter("leave2total")==null || request.getParameter("leave2total").trim().equalsIgnoreCase("")?"0":request.getParameter("leave2total");
		String leave3total=request.getParameter("leave3total")==null || request.getParameter("leave3total").trim().equalsIgnoreCase("")?"0":request.getParameter("leave3total");
		String leave4total=request.getParameter("leave4total")==null || request.getParameter("leave4total").trim().equalsIgnoreCase("")?"0":request.getParameter("leave4total");
		String leave5total=request.getParameter("leave5total")==null || request.getParameter("leave5total").trim().equalsIgnoreCase("")?"0":request.getParameter("leave5total");
		String leave6total=request.getParameter("leave6total")==null || request.getParameter("leave6total").trim().equalsIgnoreCase("")?"0":request.getParameter("leave6total");
		...
		if(funtype.equalsIgnoreCase("1")){
			...
			if(markall.equalsIgnoreCase("1")){
					...
					sql="UPDATE hr_timesheet t,hr_empm m SET t."+cellcolumn+"="+attendance+",t.tot_ot="+overtimevalue+",t.tot_hot="+holidayovertimevalue+" WHERE t.empid=m.doc_no and t.payroll_processed=0 and t.year="+year+" and t.month="+month+""+sql1+"";
    	    ...
    	    if(checkweekoff.equalsIgnoreCase("0")){
    	    	...
    	    	for(int j=0;j<weeklyoffarray.size();j++){
    	    		...
    	    		if(oldattendance.equalsIgnoreCase("A")){leave1total=String.valueOf(Integer.parseInt(leave1total)-1);} 
                	if(oldattendance.equalsIgnoreCase("C")){leave2total=String.valueOf(Integer.parseInt(leave2total)-1);}
                	if(oldattendance.equalsIgnoreCase("S")){leave3total=String.valueOf(Integer.parseInt(leave3total)-1);} 
                	if(oldattendance.equalsIgnoreCase("U")){leave4total=String.valueOf(Integer.parseInt(leave4total)-1);}
                	if(oldattendance.equalsIgnoreCase("M")){leave5total=String.valueOf(Integer.parseInt(leave5total)-1);}
                	if(oldattendance.equalsIgnoreCase("T")){leave6total=String.valueOf(Integer.parseInt(leave6total)-1);}
                	if(oldattendance.equalsIgnoreCase("A2")){leave1total=String.valueOf(Integer.parseInt(leave1total)-(0.5));} 
                	if(oldattendance.equalsIgnoreCase("C2")){leave2total=String.valueOf(Integer.parseInt(leave2total)-(0.5));}
                	if(oldattendance.equalsIgnoreCase("S2")){leave3total=String.valueOf(Integer.parseInt(leave3total)-(0.5));}
                	if(oldattendance.equalsIgnoreCase("U2")){leave4total=String.valueOf(Integer.parseInt(leave4total)-(0.5));} 
                	if(oldattendance.equalsIgnoreCase("M2")){leave5total=String.valueOf(Integer.parseInt(leave5total)-(0.5));}
                	if(oldattendance.equalsIgnoreCase("T2")){leave6total=String.valueOf(Integer.parseInt(leave6total)-(0.5));} 
			...
			if(markall.equalsIgnoreCase("1")){
					...
					sql="UPDATE hr_timesheet t,hr_empm m SET t."+cellcolumn+"="+attendance+",t.tot_ot="+overtimevalue+",t.tot_hot="+holidayovertimevalue+" WHERE t.empid=m.doc_no and t.payroll_processed=0 and t.year="+year+" and t.month="+month+""+sql3+"";
					val= stmt.executeUpdate(sql);
