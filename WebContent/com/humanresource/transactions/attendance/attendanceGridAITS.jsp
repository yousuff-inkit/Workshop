        ...
        $(document).ready(function () { 	
            ...
            $("#attendanceGridID").on("bindingcomplete", function (event) {
					 ...
					 for(var k=0 ; k < leavetype ; k++){
						 ...
						 if($('#cmbleavetype option').eq(k).text().trim()=='Compensatory Off'){
            ...
            $("#attendanceGridID").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Compensatory Off', datafield: 'leave4total', width: '8%', cellsalign: 'center', align: 'center', cellbeginedit: function (row) {
							...
							{ text: 'Emergency Leave', datafield: 'leave6total', width: '8%', cellsalign: 'center', align: 'center', cellbeginedit: function (row) {
                ...
                for(var i=1;i<=parseInt(totdays);i++)
         		{
                	...
                	if(value=='U'){leave3total=leave3total+1;}
                	if(value=='C'){leave4total=leave4total+1;}
                	...
                	if(value=='U2'){leave3total=leave3total+(0.5);}
                	if(value=='C2'){leave4total=leave4total+(0.5);}
