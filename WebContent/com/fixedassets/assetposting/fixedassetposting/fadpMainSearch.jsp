...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#fadpdate").jqxDateTimeInput({ width: '120px', height: '24px', formatString: "dd.MM.yyyy", value: null });
    ...
    function loadSearch() {
        var partyname = document.getElementById("txtpartyname") ? document.getElementById("txtpartyname").value : "";
        var docNo = document.getElementById("txtdocno") ? document.getElementById("txtdocno").value : "";
        var date = $('#fadpdate').jqxDateTimeInput('val') || "";
        var amount = document.getElementById("txtamount") ? document.getElementById("txtamount").value : "";
        
        /* Added safe extraction since brchName is missing from the HTML body */
    ...
    function getdata(partyname, docNo, date, amount, branch) {
        /* Safely encoding URI components to handle special characters and spaces natively */
...
<div id="search" class="modern-ui">
    ...
    <div class="search-panel">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <colgroup>
                <col width="8%" />  <col width="18%" /> <col width="8%" />  <col width="23%" /> <col width="8%" />  <col width="20%" /> <col width="15%" /> 
            </colgroup>
            
            <tr>
                <td class="lbl-right">Date</td>
                <td>
                    <div id="fadpdate" name="fadpdate" value='<s:property value="fadpdate"/>'></div>
                ...
                <!-- Spacer columns to push button to the right -->
                <td colspan="2"></td> 
