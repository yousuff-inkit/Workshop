...
$(document).ready(function () {     
     ...
     $("#fgmdate").jqxDateTimeInput({width : '125px', height : 24, formatString : "dd.MM.yyyy", theme: 'energyblue'});
    
     /* force internal alignment AFTER render */
     setTimeout(function () {
        $("#fgmdate").find("input").css({
            "margin-top": "0px",
            "line-height": "24px",
            "font-size": "12px", 
            "font-family": "Arial, sans-serif", 
        ...
        $("#fgmdate").find(".jqx-action-button").css({
            "top": "0px",
            "height": "24px"
        });
     }, 0);
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel" style="background: #fdfdfd;">
        ...
        <div class="field-row" style="margin-bottom:0;">
            ...
            <input type="text" name="fgmcode" id="fgmcode" style="width:150px;" placeholder="Group Code" value='<s:property value="fgmcode"/>'>
            
            <label class="lbl-right" style="width:80px; margin-left:8px;">Name</label>
            <input type="text" name="fgmname" id="fgmname" style="flex:1;" placeholder="Group Name" value='<s:property value="fgmname"/>'>
        </div>
    </div>

    <!-- Group Grid -->
    <div id="grpgrid" style="margin-bottom:15px;">
