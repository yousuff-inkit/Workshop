...
<form id="frmexp" action="saveExp" autocomplete="OFF" >
...
<tr>
<td align="right" width="10%">Description</td><td  width="60%" colspan="2"><input type="text" id="desc1" name="desc1" tabindex="-1"  style="width:90%;"readonly="readonly" value='<s:property value="desc1"/>'  onkeypress="hidemsg();" /> </td>  
    <td width="10%">&nbsp;</td>
      <td width="20%">&nbsp;</td>
