		        	...
		        	if(r==false)
		 			...
		 			/*    $("#descdetailsGrid").jqxGrid('clear');
		      		  ...
		      		  var load="1";
		       		  ...
		       		  $("#sevdesc").load("serviecgrid.jsp?reqdoc="+ document.getElementById("reqmasterdocno").value+"&chk="+chk+"&from="+from+"&search="+search+"&cmbbilltype="+cmbbilltype+"&dates="+dates+"&puraccid="+puraccid);	
