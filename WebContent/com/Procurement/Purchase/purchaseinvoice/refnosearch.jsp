...
.myButtons:active {
	...
	function getdatas(docnoss,refnosss,datess,aa,headacccode,reftype){
		 ...
		 $("#refsearch").load('subrefnosearch.jsp?docnoss='+docnoss+'&datess='+datess+'&refnosss='+refnosss+'&aa='+aa+'&headacccode='+headacccode+'&reftype='+reftype);
	       ...
	       $.messager.confirm('Message', 'Do you want to Import?', function(r){
		        	...
		        	if(r==false)
	        		 ...
	        		 var dates=document.getElementById("masterdate").value; 
		       		  ...
		       		  $("#sevdesc").load("serviecgrid.jsp?reqdoc="+document.getElementById("reqmasterdocno").value+"&chk="+chk+"&from="+from+"&search="+search+"&dates="+dates+"&cmbbilltype="+cmbbilltype+"&puraccid="+puraccid);	
