...
%>
       ...
       if(dtype=='GRN' || dtype=='PO')
    	   ...
    	   prddata = '<%=purchaseDAO.searchreqProduct(reqmasterdocno,session,dtype,dates,cmbbilltype,puraccid)%>';   
    	   
    	   }
       else
    	   {
    	   
    	   prddata= '<%=purchaseDAO.searchProduct(session,dates,cmbbilltype,puraccid)%>';
    	   }
