...
if(temp2!='NA')
{
	...
	descdata1='<%=purchaseDAO.reqgridreload(reqdoc,from,session,search,dates,cmbbilltype)%>';  
    		  ...
    		  { 
      	    	...
      	    	/* if(document.getElementById("reftype").value=="PR")
        		{
        		 ...
        		 var cmbbilltype=document.getElementById("cmbbilltype").value;
						        	 ...
						        	 productSearchContent('productSearch.jsp?reqmasterdocno='+reqmasterdocno+'&dtype='+document.getElementById("reftype").value+"&dates="+dates+"&cmbbilltype="+cmbbilltype);
						    	 var rowindextemp = event.args.rowindex;
						    	    document.getElementById("rowindex").value = rowindextemp;  
