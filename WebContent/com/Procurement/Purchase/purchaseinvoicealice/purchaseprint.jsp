...
<table width="100%" > 
  ...
  <td width="8%" align="right">Vendor</td>
    ...
    <td>: <label id="lbltrnno" name="lbltrnno"><s:property value="lbltrnno"/></label></td> 
...
<td  >&nbsp;</td>
 ...
 <td ><b></b></td>
    <td align="right" ><b>Total</b></td>
     <td align="right" ><label id="lblsubtotalexp"><s:property value="lblsubtotalexp"/></label></td>
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td width="65%" align="right" style="font-weight: bold">Tax</td>
    <td width="14%"><label id="lbltax"><s:property value="lbltax"/></label></td>
    <td width="10%" align="right" style="font-weight: bold">Net Total</td>
    <td width="11%"><label id="lblnetamount"><s:property value="lblnetamount"/></td>
  </tr>
  <tr>
    <td align="right" style="font-weight: bold">Amount in words</td>
    <td colspan="3"><label id="lblordervaluewords"><s:property value="lblordervaluewords"/></label> &nbsp;&nbsp;&nbsp;&nbsp;
