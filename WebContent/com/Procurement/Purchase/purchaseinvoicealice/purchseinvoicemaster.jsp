...
function funReset(){
	//$('#purchaseInvAlice')[0].reset(); 
}
function funReadOnly(){
	$('#purchaseInvAlice input').attr('readonly', true );
	$('#purchaseInvAlice select').attr('disabled', true );
...
function funRemoveReadOnly(){
	 ...
	 $('#FixedDiv').hide();
	$('#purchaseInvAlice input').attr('readonly', false );
  ...
  chkmultiqty();
	...
	getround();
	$('#purchaseInvAlice select').attr('disabled', false );
  ...
  for(var i=0 ; i < rows.length ; i++){
			  ...
			  // var myvar = rows[i].tarif; 
				  ...
				  newTextBox.val(rows[i].psrno+"::"+rows[i].prodoc+" :: "+rows[i].unitdocno+" :: "+rows[i].qty+" :: "
						   ...
						   +$('#serviecGrid').jqxGrid('getcelltext', i, "exp_date")+"::"+rows[i].taxdocno+"::"+"0000"+" :: "+rows[i].jobcarddocno); 
 ...
 function funrefdisslno()
 {
	...
	function funRoundAmt4(value,id){
	 ...
	 function reloads()
	 {
	 	  ...
	 	  $("#part").load('part.jsp?dates='+dates+"&cmbbilltype="+cmbbilltype);
	 	  $("#pnames").load('name.jsp?dates='+dates+"&cmbbilltype="+cmbbilltype);
	 }
	 ...
	 function setgrid()
		{
		    ...
		    else
		    {
		     ...
		     $('#serviecGrid').jqxGrid('setcellvalue',  rowlength-1, "jobcarddocno", document.getElementById("jobcarddocno").value);
		     $('#serviecGrid').jqxGrid('setcellvalue',  rowlength-1, "jobcardvocno", document.getElementById("jobcardvocno").value);
...
//	 	     $('#serviecGrid').jqxGrid('setcellvalue',  rowlength-1, "expfoc", document.getElementById("extrafocs").value);
		     ...
		     else
		     {
				...
				document.getElementById("jobCardSearchInput").value ="";
				$('#jobcarddiv').load('jobCardSearch.jsp');
		     document.getElementById("jobcardvocno").value ="";
				document.getElementById("jobcarddocno").value ="";
			   ...
			   $('#expdate').val(null);
				   ...
				   $("#serviecGrid").jqxGrid('addrow', null, {});
				   document.getElementById("jqxInput1").focus();
				   document.getElementById("jobCardSearchInput").focus(); 
		}
...
<form id="purchaseInvAlice" action="saveActionpurInvAlice" method="post" autocomplete="off"> 
...
<legend>Item Details</legend>
   ...
   <tr>
	   <td align="center"><div id="jobcarddiv"><jsp:include page="jobCardSearch.jsp"></jsp:include></div> </td>
...
<input type="hidden" id="jobcarddocno" name="jobcarddocno" >
<input type="hidden" id="jobcardvocno" name="jobcardvocno" >
</form>
</div> 
<div id="searchwindow">
   <div ></div>  
