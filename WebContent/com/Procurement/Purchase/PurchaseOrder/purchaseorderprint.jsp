...
<table width="100%">
  ...
  <td><jsp:include page="../../../common/printHeaderCarfareWorkshop.jsp"></jsp:include></td>
...
<table width="100%"> 
  ...
  <td width="6%" align="left">Vendor</td>
    ...
    <td   align="left">: <label id="lbldoc" name="lbldoc"><s:property value="lbldoc"/></label></td> 
      ...
      <tr>
  		<td width="6%" align="left">TRNO</td>
	    <td width="40%" align="left">: <label id="lblclienttrno" name="lblclienttrno"><s:property value="lblclienttrno"/></label></td>
	    <td   align="left">&nbsp;</td>
	    <td   align="left">&nbsp;</td> 
...
<%int i=0; %>
 ...
 <table width="100%">
   <tr>
		<td align="right" width="100%" ><b>Total Amount :</b>      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <label id="lblTotalAmounnt"><s:property value="lblTotalAmounnt"/></label>&nbsp;&nbsp;  </td>
 </tr>
 <tr>
<td align="right" width="100%" ><b>Discount :</b>      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
<td align="right" width="100%" ><b>Net Tax :</b>      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <label id="lblnettax"><s:property value="lblnettax"/></label>&nbsp;&nbsp;  </td>
