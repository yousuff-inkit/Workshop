...
<script type="text/javascript">
        ...
        $(document).ready(function () { 	
    	   ...
    	   $('#purchasedetails').jqxGrid('setcellvalue', rowno, "qty" ,'');
    	   
    	   
         	 
 
                 $('#purchasedetails').jqxGrid('setcellvalue', rowno, "unit" ,$('#qtysearchgrid').jqxGrid('getcellvalue', rowindextemp, "unit"));
	                $('#purchasedetails').jqxGrid('setcellvalue', rowno, "unitdocno" ,$('#qtysearchgrid').jqxGrid('getcellvalue', rowindextemp, "doc_no"));
