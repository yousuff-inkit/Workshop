...
var nipurordermain= '<%=purchaserequestforquoteDAO.mainsearch(session,docnoss,accountss,accnamess,datess,aa) %>'; 
            ...
            $("#mainsearshgrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Account', datafield: 'account', width: '10%' },
								{ text: 'Account Name', datafield: 'description', width: '38%' },
   ...
   /*              document.getElementById("docno").value = $('#mainsearshgrid').jqxGrid('getcellvalue',rowindex1, "voc_no");
        	 ...
        	 $('#acctype').attr('disabled', false);
        	 funSetlabel();
            document.getElementById("purchaseReqforqout").submit();
            }); 
