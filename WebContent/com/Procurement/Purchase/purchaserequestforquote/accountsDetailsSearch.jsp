...
<script type="text/javascript">
	...
	function loadAccountSearch() {
		    var masterdate=document.getElementById("date").value;
			...
			getAccountDetails(accountsno,accountsname,currs,check,masterdate,cmbreftype,reqmasterdocno);
	}
		
	function getAccountDetails(accountsno,accountsname,currs,check,masterdate,cmbreftype,reqmasterdocno){

		 $("#refreshAccountDetailsDiv").load("accountsDetailsFromGrid.jsp?accountno="+accountsno+'&accountname='+accountsname.replace(/ /g, "%20")+'&currency='+currs+'&check='+check+'&masterdate='+masterdate+'&cmbreftype='+cmbreftype+'&reqmasterdocno='+reqmasterdocno);
	}
