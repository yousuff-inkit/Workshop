...
%>
       ...
       if(dtype=='CEQ' || dtype=='PR')
    	   ...
    	   prddata = '<%=purchaserequestforquoteDAO.searchreqProduct(reqmasterdocno,session,accdocno,dtype)%>';   
    	   
    	   }
       else
    	   {
    	   
    	   prddata= '<%=purchaserequestforquoteDAO.searchProduct(session,accdocno)%>';
    	   }
