...
.myButtons:active {
	...
	function getdatas(docnoss,refnosss,datess,aa,headacccode){
		 ...
		 $("#refsearch").load('subrefnosearch.jsp?docnoss='+docnoss+'&datess='+datess+'&refnosss='+refnosss+'&aa='+aa+'&headacccode='+headacccode);
	...
	function searchdata()
	{
       ...
       if(rows[i].chk==true)
           ...
           document.getElementById("refmasterdoc_no").value=temp1.replace(/,\s*$/, "");
		        	...
		        	if(r==false)
		        	  {
		        		...
		        		return false; 
		       		  ...
		       		  $("#sevdesc").load("serviecgrid.jsp?reqdoc="+document.getElementById("refmasterdoc_no").value+"&chk="+chk+"&from="+from);	
