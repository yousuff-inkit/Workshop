...
<script type="text/javascript">
	$(document).ready(function () {
		 document.getElementById("txtnewdates").value=$('#trfSetUpDate').val();
	}); 
	...
	function loadAccountSearch() {
			...
			getAccountDetails(atype,accountsno,accountsname,currs,dates,check);
	}
		
	function getAccountDetails(atype,accountsno,accountsname,currs,dates,check){
		 $("#refreshAccountDetailsDiv").load("accountDetailsSearchGrid.jsp?atype="+atype+'&accountno='+accountsno+'&accountname='+accountsname.replace(/ /g, "%20")+'&currency='+currs+'&dates='+dates+'&check='+check);
	}
