...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel" style="background: #fdfdfd;">
        ...
        <div class="field-row">
            ...
            <select id="cmbcriteria" name="cmbcriteria" style="width:220px;" onchange="dateDisable();getPDCAccounts();getPDCPostAccount();clearClientInfo();" value='<s:property value="cmbcriteria"/>'>
