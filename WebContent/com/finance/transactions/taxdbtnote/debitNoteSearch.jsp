...
<script type="text/javascript">
	...
	function getAccountDetails(accountsno,accountsname,currs,type,date,check){
		 $("#refreshAccountSearchDetailsDiv").load("debitNoteSearchGrid.jsp?accountno="+accountsno+'&accountname='+accountsname.replace(/ /g, "%20")+'&currency='+currs+'&atype='+type+'&date='+date+'&creditdate='+document.getElementById("jqxDebitNoteDate").value+'&check='+check);
	}
...
<table width="100%">
  ...
  <tr>
    <td colspan="5"><div id="refreshAccountSearchDetailsDiv"><jsp:include page="debitNoteSearchGrid.jsp"></jsp:include></div></td>
  </tr>
</table>
</div>
</body>
