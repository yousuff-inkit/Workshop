...
$(document).ready(function() {
    ...
    $("#jqxUnclearedChequeReceiptDate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy", theme: 'energyblue'});
    ...
    setTimeout(function () {
        $("#jqxUnclearedChequeReceiptDate, #maindate, #jqxChequeDate").find("input").css({
            "margin-top": "0px",
            "line-height": "24px",
            "font-size": "12px", 
            "font-family": "Arial, sans-serif", 
        ...
        $("#jqxUnclearedChequeReceiptDate, #maindate, #jqxChequeDate").find(".jqx-action-button").css({
            "top": "0px",
            "height": "24px"
        });
    }, 0);
    ...
    $('#unclearedChequeReceiptGridWindow').jqxWindow($.extend({}, popupConfig, {width: '51%', title: 'Accounts Search'})).jqxWindow('close');
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel">
        <span class="middle-panel-title">Uncleared Cheque Receipt Details</span>
        
        <div class="field-row">
            <label class="lbl-right" style="width:80px;">Date</label>
            <div style="width: 125px;">
                <div id="jqxUnclearedChequeReceiptDate" name="jqxUnclearedChequeReceiptDate" onchange="datechange();" value='<s:property value="jqxUnclearedChequeReceiptDate"/>'></div>
            </div>
            ...
            <input type="text" id="docno" name="txtunclearedchequereceiptdocno" style="width:125px;" value='<s:property value="txtunclearedchequereceiptdocno"/>' tabindex="-1" readonly/>
    ...
    <div style="display: flex; gap: 15px;">
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            <span class="middle-panel-title">Receipt To (Bank)</span>
            ...
            <div class="field-row">
                ...
                <select id="cmbfromcurrency" name="cmbfromcurrency" style="width:125px;" value='<s:property value="cmbfromcurrency"/>' onchange="getRate(this.value,$('#jqxUnclearedChequeReceiptDate').val());">
                    <option></option>
                </select>
            ...
            <div class="field-row">
                ...
                <input type="text" id="txtchequeno" name="txtchequeno" style="width:125px;" value='<s:property value="txtchequeno"/>' />
        ...
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            <span class="middle-panel-title">Received From</span>
            ...
            <div class="field-row">
                <label class="lbl-right" style="width:80px;">Currency</label>
                <select id="cmbtocurrency" name="cmbtocurrency" style="width:125px;" value='<s:property value="cmbtocurrency"/>' onchange="getRatevalue(this.value,$('#jqxUnclearedChequeReceiptDate').val());">
                    <option></option>
                </select>
            ...
            <div class="field-row" style="margin-bottom:0;">
                <label class="lbl-right" style="width:80px;">Amount</label>
                <input type="text" id="txttoamount" name="txttoamount" style="width:125px; text-align:right;" value='<s:property value="txttoamount"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountTo();getCrTotal();" />
    ...
    <div class="middle-panel">
        ...
        <div id="jqxUnclearedChequeReceiptGrid" class="grid-container">
            <jsp:include page="unclearedChequeReceiptGrid.jsp"></jsp:include>
        </div>
