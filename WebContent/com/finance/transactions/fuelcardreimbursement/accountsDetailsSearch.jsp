...
<script type="text/javascript">
	...
	function loadAccountSearch() {
			...
			getAccountDetails(accountsno,accountsname,currs,dates,check);
	}
		
	function getAccountDetails(accountsno,accountsname,currs,dates,check){
		 $("#refreshAccountDetailsDiv").load("accountDetailsSearchGrid.jsp?accountno="+accountsno+'&accountname='+accountsname.replace(/ /g, "%20")+'&currency='+currs+'&dates='+dates+'&check='+check);
	}
