...
<script type="text/javascript">
        ...
        var data1= '<%=DAO.bankPaymentGridSearch(type1, accountno, accountname, currency, date, check) %>'; 
        $(document).ready(function () { 	
            ...
            $('#jqxBankPaymentSearch').on('rowdoubleclick', function (event) {
                ...
                $('#jqxBankPayment').jqxGrid('setcellvalue', rowindex1, "docno" ,$('#jqxBankPaymentSearch').jqxGrid('getcellvalue', rowindex2, "doc_no"));
                $('#jqxBankPayment').jqxGrid('setcellvalue', rowindex1, "accounts" ,$('#jqxBankPaymentSearch').jqxGrid('getcellvalue', rowindex2, "account"));
                $('#jqxBankPayment').jqxGrid('setcellvalue', rowindex1, "accountname1" ,$('#jqxBankPaymentSearch').jqxGrid('getcellvalue', rowindex2, "description"));
                $("#jqxBankPayment").jqxGrid('setcellvalue', rowindex1, "currency" ,$("#jqxBankPaymentSearch").jqxGrid('getcellvalue', rowindex2, "curr"));
                $("#jqxBankPayment").jqxGrid('setcellvalue', rowindex1, "currencytype" ,$("#jqxBankPaymentSearch").jqxGrid('getcellvalue', rowindex2, "type"));
                $("#jqxBankPayment").jqxGrid('setcellvalue', rowindex1, "currencyid" ,$("#jqxBankPaymentSearch").jqxGrid('getcellvalue', rowindex2, "curid"));
                $("#jqxBankPayment").jqxGrid('setcellvalue', rowindex1, "grtype" ,$("#jqxBankPaymentSearch").jqxGrid('getcellvalue', rowindex2, "gr_type"));
                $("#jqxBankPayment").jqxGrid('setcellvalue', rowindex1, "rate" ,$("#jqxBankPaymentSearch").jqxGrid('getcellvalue', rowindex2, "c_rate"));
              
			    var rows = $('#jqxBankPayment').jqxGrid('getrows');
            	var rowlength= rows.length;
            	var rowindex2 = rowlength - 1;
          	    var docno=$("#jqxBankPayment").jqxGrid('getcellvalue', rowindex2, "docno");
