...
<%@page import="javax.servlet.http.HttpSession" %>
 <%
 String atype = request.getParameter("type")==null?"0":request.getParameter("type");
        ...
        $("#jqxAccountsSearch").jqxGrid(
        {
         ...
         $('#jqxAccountsSearch').on('rowdoubleclick', function (event) {
            ...
            if(temp=="2"){
	        	...
	        	document.getElementById("cmbfromcurrency").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "curid");
            	...
            	document.getElementById("txttodocno").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "doc_no");
                document.getElementById("txttoaccid").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "account");
            	document.getElementById("txttoaccname").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "description");
            	document.getElementById("cmbtocurrency").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "curid");
            	funRoundRate($('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "rate"),"txttorate");
            	document.getElementById("hidtocurrencytype").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "type");
            }
