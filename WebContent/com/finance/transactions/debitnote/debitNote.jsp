...
<table width="100%">
  <tr>
    ...
    <td colspan="2"><div id="jqxDebitNoteDate" name="jqxDebitNoteDate" onchange="datechange();" value='<s:property value="jqxDebitNoteDate"/>'></div>
  ...
  <tr>
    ...
    <option value="AP">AP</option><option value="AR">AR</option><option value="HR">HR</option></select>
  ...
  <tr>
    ...
    <td colspan="3"><input type="text" id="txtrate" name="txtrate" style="width:15%;text-align: right;" value='<s:property value="txtrate"/>' tabindex="-1"/></td>
  </tr>
  <tr>
