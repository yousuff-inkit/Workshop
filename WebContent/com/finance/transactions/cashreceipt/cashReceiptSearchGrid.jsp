...
<script type="text/javascript">
        ...
        var data1= '<%=DAO.cashReceiptGridSearch(type1, accountno, accountname, currency, date, check) %>';
        $(document).ready(function () { 	
            ...
            $('#jqxCashReceiptSearch').on('rowdoubleclick', function (event) {
                ...
                $('#jqxCashReceipt').jqxGrid('setcellvalue', rowindex1, "docno" ,$('#jqxCashReceiptSearch').jqxGrid('getcellvalue', rowindex2, "doc_no"));
                $('#jqxCashReceipt').jqxGrid('setcellvalue', rowindex1, "accounts" ,$('#jqxCashReceiptSearch').jqxGrid('getcellvalue', rowindex2, "account"));
                $('#jqxCashReceipt').jqxGrid('setcellvalue', rowindex1, "accountname1" ,$('#jqxCashReceiptSearch').jqxGrid('getcellvalue', rowindex2, "description"));
                $("#jqxCashReceipt").jqxGrid('setcellvalue', rowindex1, "currency" ,$("#jqxCashReceiptSearch").jqxGrid('getcellvalue', rowindex2, "curr"));
                $("#jqxCashReceipt").jqxGrid('setcellvalue', rowindex1, "currencyid" ,$("#jqxCashReceiptSearch").jqxGrid('getcellvalue', rowindex2, "curid"));
                $("#jqxCashReceipt").jqxGrid('setcellvalue', rowindex1, "currencytype" ,$("#jqxCashReceiptSearch").jqxGrid('getcellvalue', rowindex2, "type"));
                $("#jqxCashReceipt").jqxGrid('setcellvalue', rowindex1, "grtype" ,$("#jqxCashReceiptSearch").jqxGrid('getcellvalue', rowindex2, "gr_type"));
                $("#jqxCashReceipt").jqxGrid('setcellvalue', rowindex1, "rate" ,$("#jqxCashReceiptSearch").jqxGrid('getcellvalue', rowindex2, "c_rate"));
                
				var rows = $('#jqxCashReceipt').jqxGrid('getrows');
            	var rowlength= rows.length;
            	var rowindex2 = rowlength - 1;
          	    var docno=$("#jqxCashReceipt").jqxGrid('getcellvalue', rowindex2, "docno");
