...
<script type="text/javascript">
	$(document).ready(function() {
		 ...
		 $('#jqxBankReceiptDate').on('change', function (event) {
				 ...
				 funDateInPeriod(bankreceiptdate);
		 });
...
#frmBankReceipt input[type="text"],
#frmBankReceipt select,
.textbox { 
...
#frmBankReceipt input[type="text"]:focus,
#frmBankReceipt select:focus,
.textbox:focus { 
    border-color: #007bff; 
}

#frmBankReceipt input[readonly],
#frmBankReceipt input:disabled,
#frmBankReceipt select:disabled,
.textbox[readonly] { 
...
<script type="text/javascript">
    $(document).ready(function() {
         ...
         setTimeout(function () {
             $("#jqxBankReceiptDate, #maindate, #jqxChequeDate").find("input").css({
                 "margin-top": "0px",
                 "line-height": "24px",
                 "font-size": "12px", 
                 "font-family": "Arial, sans-serif", 
             ...
             $("#jqxBankReceiptDate, #maindate, #jqxChequeDate").find(".jqx-action-button").css({
                 "top": "0px",
                 "height": "24px"
             });
         }, 0);
         ...
         $("#jqxBankReceiptDate").jqxDateTimeInput({ width: '100%', height: '24px', formatString:"dd.MM.yyyy"});
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row" style="margin-bottom:0;">
            ...
            <div style="width: 125px; flex-shrink:0;">
                <div id="jqxBankReceiptDate" name="jqxBankReceiptDate" onchange="datechange();" value='<s:property value="jqxBankReceiptDate"/>'></div>
            ...
            <div style="display:flex; align-items:center; gap:8px; flex:1; min-width:0;">
                <input type="text" id="docno" name="txtbankreceiptdocno" tabindex="-1" value='<s:property value="txtbankreceiptdocno"/>' readonly style="width:120px; flex-shrink:0;" />
    ...
    <!-- Dual Panel: Bank (Left) & Payment From (Right) -->
        ...
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                ...
                <div class="input-search-container" style="width: 120px; flex-shrink:0;">
                    ...
                    <svg class="magnifier-icon" onclick="var date = $('#jqxBankReceiptDate').jqxDateTimeInput('getDate'); $('#maindate').jqxDateTimeInput('val', date); accountFromSearchContent('<%=contextPath%>/com/finance/accountsDetailsSearch.jsp?date='+date);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </div>
            ...
            <div class="field-row">
                ...
                <select id="cmbfromcurrency" name="cmbfromcurrency" style="width:120px; flex-shrink:0;" value='<s:property value="cmbfromcurrency"/>' onchange="getRate(this.value,$('#jqxBankReceiptDate').val());">
                    <option></option>
                </select>
            ...
            <div class="field-row">
                <label class="lbl-right" style="width:80px; flex-shrink:0; display:flex; align-items:center; justify-content:flex-end; gap:4px;">
                    <input type="checkbox" id="chckpdc" name="chckpdc" style="margin:0; height:auto !important; width:auto !important;" onclick="funCheck();funPDCDate($('#hidchckpdc').val(),$('#jqxBankReceiptDate').jqxDateTimeInput('getDate'),$('#jqxChequeDate').jqxDateTimeInput('getDate'));"> PDC
                </label>
        ...
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                ...
                <div class="input-search-container" style="width: 120px; flex-shrink:0;">
                    ...
                    <svg class="magnifier-icon" onclick="var date = $('#jqxBankReceiptDate').jqxDateTimeInput('getDate'); $('#maindate').jqxDateTimeInput('val', date); accountToSearchContent('<%=contextPath%>/com/finance/clientAccountDetailsSearch.jsp?atype='+$('#cmbtotype').val()+'&date='+date);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </div>
            ...
            <div class="field-row">
                ...
                <select id="cmbtocurrency" name="cmbtocurrency" value='<s:property value="cmbtocurrency"/>' onchange="getRatevalue(this.value,$('#jqxBankReceiptDate').val());" style="width:120px; flex-shrink:0;">
                    <option></option>
                </select>
    ...
    <div class="middle-panel">
        ...
        <div id="bankApplyInvoicing1" class="grid-container">
            <center><jsp:include page="applyBankReceiptInvoicingGrid.jsp"></jsp:include></center>
        </div> 
...
<div id="bankReceiptGridWindow"><div></div><div></div></div>  
