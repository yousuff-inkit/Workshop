...
#frmCashPayment input[type="text"]:focus,
#frmCashPayment select:focus,
.textbox:focus { 
    border-color: #007bff; 
}

#frmCashPayment input[readonly],
#frmCashPayment input:disabled,
#frmCashPayment select:disabled,
.textbox[readonly] { 
...
<script type="text/javascript">
    $(document).ready(function() {
         ...
         setTimeout(function () {
             $("#jqxCashPaymentDate, #maindate").find("input").css({
                 "margin-top": "0px",
                 "line-height": "24px",
                 "font-size": "12px", 
                 "font-family": "Arial, sans-serif", 
             ...
             $("#jqxCashPaymentDate, #maindate").find(".jqx-action-button").css({
                 "top": "0px",
                 "height": "24px"
             });
         }, 0);
         ...
         $("#jqxCashPaymentDate").jqxDateTimeInput({ width: '100%', height: '24px', formatString:"dd.MM.yyyy"});
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row" style="margin-bottom:0;">
            ...
            <div style="width: 125px; flex-shrink:0;">
                <div id="jqxCashPaymentDate" name="jqxCashPaymentDate" onchange="datechange();" value='<s:property value="jqxCashPaymentDate"/>'></div>
                <input type="hidden" id="hidjqxCashPaymentDate" name="hidjqxCashPaymentDate" value='<s:property value="hidjqxCashPaymentDate"/>'/>
            </div>
            ...
            <div style="display:flex; align-items:center; gap:8px; flex-shrink:0;">
                <input type="text" id="docno" name="txtcashpaydocno" tabindex="-1" value='<s:property value="txtcashpaydocno"/>' readonly style="width:120px;" />
                <button class="myButton" type="button" id="btnvaluechange" name="btnvaluechange" onclick="funwarningopen();">Value Change</button>
            </div>
        </div>
    </div>

    <!-- Dual Panel: Cash (Left) & Payment To (Right) -->
        ...
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                ...
                <div class="input-search-container" style="width: 120px; flex-shrink:0;">
                    ...
                    <svg class="magnifier-icon" onclick="var date = $('#jqxCashPaymentDate').jqxDateTimeInput('getDate'); $('#maindate').jqxDateTimeInput('val', date); accountFromSearchContent('<%=contextPath%>/com/finance/accountsDetailsSearch.jsp?date='+date);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </div>
            ...
            <div class="field-row">
                ...
                <select id="cmbfromcurrency" name="cmbfromcurrency" style="width:120px; flex-shrink:0;" value='<s:property value="cmbfromcurrency"/>' onload="getRate(this.value,$('#jqxCashPaymentDate').val());" onchange="getRate(this.value,$('#jqxCashPaymentDate').val());">
                    <option></option>
                </select>
        ...
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                ...
                <div class="input-search-container" style="width: 120px; flex-shrink:0;">
                    ...
                    <svg class="magnifier-icon" onclick="var date = $('#jqxCashPaymentDate').jqxDateTimeInput('getDate'); $('#maindate').jqxDateTimeInput('val', date); accountToSearchContent('<%=contextPath%>/com/finance/clientAccountDetailsSearch.jsp?atype='+$('#cmbtotype').val()+'&date='+date);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </div>
            ...
            <div class="field-row">
                ...
                <select id="cmbtocurrency" name="cmbtocurrency" value='<s:property value="cmbtocurrency"/>' onload="getRatevalue(this.value,$('#jqxCashPaymentDate').val());" onchange="getRatevalue(this.value,$('#jqxCashPaymentDate').val());" style="width:120px; flex-shrink:0;">
                    <option></option>
                </select>
    ...
    <div class="middle-panel">
        ...
        <div id="jqxCashPaymentGrid" class="grid-container">
            <jsp:include page="cashPaymentGrid.jsp"></jsp:include>
        </div>
        <div class="field-row" style="margin-top: 15px; justify-content: flex-end; margin-bottom:0;">
