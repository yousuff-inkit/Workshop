...
<title>GatewayERP(i)</title>
	...
	function getdata(partyname,docNo,date,amount,check){
		 $("#refreshdiv").load('cpvMainSearchGrid.jsp?partyname='+partyname.replace(/ /g, "%20")+'&docNo='+docNo+'&date='+date+'&amount='+amount+'&check='+check);
	}
...
<table width="100%">
  ...
  <tr>
    <td colspan="5"><div id="refreshdiv"><jsp:include page="cpvMainSearchGrid.jsp"></jsp:include></div></td>
  </tr>
</table>
  </div>
</body>
