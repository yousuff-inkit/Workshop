...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#paydate").jqxDateTimeInput({ width: '120px', height: '24px', formatString:"dd.MM.yyyy", value:null});
    ...
    function loadSearch() {
        ...
        var date = $('#paydate').jqxDateTimeInput('val') || "";
    ...
    function getdata(partyname, docNo, date, amount, check){
        ...
        $("#refreshdiv").load('mcpMainSearchGrid.jsp?partyname=' + encodeURIComponent(partyname) + 
...
<div id="search" class="modern-ui">
    ...
    <div class="search-panel">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="txtpettydocno" id="txtpettydocno" autocomplete="off" value='<s:property value="txtpettydocno"/>'>
                </td>
                
                <td class="lbl-right">Amount</td>
                <td>
                    <input type="text" name="txtpettyamount" id="txtpettyamount" autocomplete="off" value='<s:property value="txtpettyamount"/>'>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div id="paydate" name="paydate" value='<s:property value="paydate"/>'></div>
                    <input type="hidden" name="hidpaydate" id="hidpaydate" value='<s:property value="hidpaydate"/>'>
                </td>
    ...
    <div class="grid-container">
        <div id="refreshdiv">
            <jsp:include page="mcpMainSearchGrid.jsp"></jsp:include>
        </div>
    </div>
