...
<script type="text/javascript">
	...
	function getAccountDetails(accountsno,accountsname,currs,formcode,searchtype,dates,check){
		 $("#refreshAccountDetailsDiv").load("../../../../accountDetailsSearchGrid.jsp?accountno="+accountsno+'&accountname='+accountsname.replace(/ /g, "%20")+'&currency='+currs+'&dtype='+formcode+'&searchtype='+searchtype+'&dates='+dates+'&check='+check);
	}
