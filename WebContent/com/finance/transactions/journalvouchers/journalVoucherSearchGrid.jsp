        ...
        $(document).ready(function () { 	
            ...
            $('#jqxJournalVoucherSearch').on('rowdoubleclick', function (event) {
                ...
                var rowindex2 = event.args.rowindex;
	             $('#jqxJournalVoucher').jqxGrid('setcellvalue', rowindex1, "docno" ,$('#jqxJournalVoucherSearch').jqxGrid('getcellvalue', rowindex2, "doc_no"));
	             $('#jqxJournalVoucher').jqxGrid('setcellvalue', rowindex1, "accounts" ,$('#jqxJournalVoucherSearch').jqxGrid('getcellvalue', rowindex2, "account"));
	             $('#jqxJournalVoucher').jqxGrid('setcellvalue', rowindex1, "accountname1" ,$('#jqxJournalVoucherSearch').jqxGrid('getcellvalue', rowindex2, "description"));
	             $("#jqxJournalVoucher").jqxGrid('setcellvalue', rowindex1, "currencyid" ,$("#jqxJournalVoucherSearch").jqxGrid('getcellvalue', rowindex2, "curid"));
	             $("#jqxJournalVoucher").jqxGrid('setcellvalue', rowindex1, "grtype" ,$("#jqxJournalVoucherSearch").jqxGrid('getcellvalue', rowindex2, "gr_type"));
	             $("#jqxJournalVoucher").jqxGrid('setcellvalue', rowindex1, "rate" ,$("#jqxJournalVoucherSearch").jqxGrid('getcellvalue', rowindex2, "c_rate"));
	             $("#jqxJournalVoucher").jqxGrid('setcellvalue', rowindex1, "currencytype" ,$("#jqxJournalVoucherSearch").jqxGrid('getcellvalue', rowindex2, "type"));
	             $('#jqxJournalVoucher').jqxGrid('setcellvalue', rowindex1, "accvalid" ,'0');
				 $('#jqxJournalVoucher').jqxGrid('setcellvalue', rowindex1, "grtypevalid" ,'0');
					
				  var rows = $('#jqxJournalVoucher').jqxGrid('getrows');
	              var rowlength= rows.length;
	              var rowindex2 = rowlength - 1;
	          	  var docno=$("#jqxJournalVoucher").jqxGrid('getcellvalue', rowindex2, "docno");
