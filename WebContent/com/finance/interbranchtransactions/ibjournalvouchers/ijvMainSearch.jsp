...
<table width="100%">
  ...
  <tr>
    ...
    <td colspan="2"><input type="text" id="txtdescription" name="txtdescription" autocomplete="off" style="width:65%;" value='<s:property value="txtdescription"/>'></td>
    <td align="center"><input type="button" name="btnsearch" id="btnsearch" class="myButton" value="Search"  onclick="loadSearch();"></td>
  </tr>
  <tr>
    <td colspan="6"><div id="refreshdiv"><jsp:include page="ijvMainSearchGrid.jsp"></jsp:include></div></td>
  </tr>
</table>
  </div>
</body>
