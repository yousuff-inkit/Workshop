...
<script type="text/javascript">
        ...
        $(document).ready(function () { 	
            ...
            $('#jqxBranchSearch').on('celldoubleclick', function (event) {
                ...
                $('#jqxIbCashReceipt').jqxGrid('setcellvalue', rowindex1, "brhid" ,$('#jqxBranchSearch').jqxGrid('getcellvalue', rowindex2, "doc_no"));
                $('#jqxIbCashReceipt').jqxGrid('setcellvalue', rowindex1, "branch" ,$('#jqxBranchSearch').jqxGrid('getcellvalue', rowindex2, "branchname"));
