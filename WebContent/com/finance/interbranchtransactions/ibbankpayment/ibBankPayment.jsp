...
<script type="text/javascript">
	$(document).ready(function() {
		 ...
		 $("#jqxIbBankPaymentDate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy", theme: 'energyblue'});
		 ...
		 setTimeout(function () {
		 	$("#jqxIbBankPaymentDate, #maindate, #jqxChequeDate").find("input").css({
		 		"margin-top": "0px",
		 		"line-height": "24px",
		 		"font-size": "12px", 
		 		"font-family": "Arial, sans-serif", 
		 	...
		 	$("#jqxIbBankPaymentDate, #maindate, #jqxChequeDate").find(".jqx-action-button").css({
		 		"top": "0px",
		 		"height": "24px"
		 	});
		 }, 0);
		 ...
		 $('#ibBankPaymentGridWindow').jqxWindow($.extend({}, popupConfig, {width: '51%', title: 'Accounts Search'})).jqxWindow('close');
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel">
        <span class="middle-panel-title">IB Bank Payment Details</span>
        
        <div class="field-row">
            <label class="lbl-right" style="width:80px;">Date</label>
            <div style="width: 125px;">
                <div id="jqxIbBankPaymentDate" name="jqxIbBankPaymentDate" onchange="datechange();" value='<s:property value="jqxIbBankPaymentDate"/>'></div>
            </div>
            ...
            <input type="text" id="docno" name="txtibbankpaydocno" style="width:125px;" value='<s:property value="txtibbankpaydocno"/>' tabindex="-1" readonly/>
    ...
    <div style="display: flex; gap: 15px;">
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                ...
                <select id="cmbfromcurrency" name="cmbfromcurrency" style="width:125px;" value='<s:property value="cmbfromcurrency"/>' onchange="getRate(this.value,$('#jqxIbBankPaymentDate').val());">
                    <option></option>
                </select>
            ...
            <div class="field-row">
                <label class="lbl-right" style="width:80px;">
                    <input type="checkbox" id="chckpdc" name="chckpdc" onclick="funCheck();funPDCDate($('#hidchckpdc').val(),$('#jqxIbBankPaymentDate').jqxDateTimeInput('getDate'),$('#jqxChequeDate').jqxDateTimeInput('getDate'));" style="vertical-align: middle; margin: 0 4px 0 0; cursor: pointer; height: auto !important;"/>PDC
                </label>
                ...
                <input type="text" id="txtchequeno" name="txtchequeno" style="width:100px;" onblur="getChequeNoAlreadyExists(this.value,$('#txtfromdocno').val(),$('#mode').val(),$('#docno').val());" value='<s:property value="txtchequeno"/>' />
        ...
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                ...
                <select id="cmbtobranch" name="cmbtobranch" style="flex:1;" onchange="funIBDateInPeriod($('#jqxIbBankPaymentDate').val(),this.value);" value='<s:property value="cmbtobranch"/>'>
                    <option></option>
                </select>
            ...
            <div class="field-row">
                <label class="lbl-right" style="width:80px;">Currency</label>
                <select id="cmbtocurrency" name="cmbtocurrency" style="width:125px;" value='<s:property value="cmbtocurrency"/>' onchange="getRatevalue(this.value,$('#jqxIbBankPaymentDate').val());">
                    <option></option>
                </select>
    ...
    <div class="middle-panel">
        ...
        <div id="jqxIbBankPaymentGrid" class="grid-container">
