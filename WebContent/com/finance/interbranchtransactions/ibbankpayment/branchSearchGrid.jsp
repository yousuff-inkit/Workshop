...
<script type="text/javascript">
        ...
        $(document).ready(function () { 	
            ...
            $('#jqxBranchSearch').on('celldoubleclick', function (event) {
                ...
                $('#jqxIbBankPayment').jqxGrid('setcellvalue', rowindex1, "brhid" ,$('#jqxBranchSearch').jqxGrid('getcellvalue', rowindex2, "doc_no"));
                $('#jqxIbBankPayment').jqxGrid('setcellvalue', rowindex1, "branch" ,$('#jqxBranchSearch').jqxGrid('getcellvalue', rowindex2, "branchname"));
