...
$(document).ready(function() {
    ...
    $("#jqxIBCashPaymentDate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy", theme: 'energyblue'});
    $("#maindate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy", theme: 'energyblue'});
    
    setTimeout(function () {
        $("#jqxIBCashPaymentDate, #maindate").find("input").css({
            "margin-top": "0px",
            "line-height": "24px",
            "font-size": "12px", 
            "font-family": "Arial, sans-serif", 
        ...
        $("#jqxIBCashPaymentDate, #maindate").find(".jqx-action-button").css({
            "top": "0px",
            "height": "24px"
        });
    }, 0);
    ...
    $('#accountDetailsToWindow').jqxWindow($.extend({}, popupConfig)).jqxWindow('close');  
    $('#accountDetailsFromWindow').jqxWindow($.extend({}, popupConfig)).jqxWindow('close');
    $('#ibCashPaymentGridWindow').jqxWindow($.extend({}, popupConfig, {title: 'Search'})).jqxWindow('close');
...
function funRemoveReadOnly(){
    ...
    $('#txtfromaccid, #txtfromaccname, #txttoaccid, #txttoaccname, #txtapplyinvoiceamt, #txtapplyinvoiceapply, #txtapplyinvoicebalance, #txtdrtotal, #txtcrtotal, #docno').attr('readonly', true );
...
function funSearchLoad(){
    changeContent('icpvMainSearch.jsp'); 
}
	
function funChkButton() {}

function funFocus(){
    $('#jqxIBCashPaymentDate').jqxDateTimeInput('focus'); 	    		
}
...
function datechange(){
    ...
    if($('#cmbtobranch').val()!='' && $('#cmbtobranch').val()!=null){
        funIBDateInPeriod($('#jqxIBCashPaymentDate').val(),$('#cmbtobranch').val());
        if(parseInt($('#brchName').val().trim())==parseInt($('#cmbtobranch').val().trim())){
            document.getElementById("errormsg").innerText="Invalid Transaction !!! Main Branch and Inter-Branch should not be same.";
            return 0;
        }
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel" style="background: #fdfdfd;">
        <span class="middle-panel-title">Inter-Branch Cash Payment Details</span>
        
        <div class="field-row">
            <label class="lbl-right" style="width:80px;">Date</label>
            <div style="width: 125px;">
                <div id="jqxIBCashPaymentDate" name="jqxIBCashPaymentDate" onchange="datechange();" value='<s:property value="jqxIBCashPaymentDate"/>'></div>
            </div>
            ...
            <input type="text" id="docno" name="txtibcashpaydocno" style="width:125px;" value='<s:property value="txtibcashpaydocno"/>' tabindex="-1" readonly/>
    ...
    <div style="display: flex; gap: 15px;">
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                ...
                <select id="cmbfromcurrency" name="cmbfromcurrency" style="width:125px;" value='<s:property value="cmbfromcurrency"/>' onchange="getRate(this.value,$('#jqxIBCashPaymentDate').val());">
                    <option></option>
                </select>
        ...
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                ...
                <select id="cmbtobranch" name="cmbtobranch" style="width:125px;" onchange="funIBDateInPeriod($('#jqxIBCashPaymentDate').val(),this.value);" value='<s:property value="cmbtobranch"/>'>
                    <option></option>
                </select>
                ...
                <select id="cmbtotype" name="cmbtotype" style="width:120px;" onchange="clearClientInfo();" value='<s:property value="cmbtotype"/>'>
            ...
            <div class="field-row">
                <label class="lbl-right" style="width:80px;">Currency</label>
                <select id="cmbtocurrency" name="cmbtocurrency" style="width:125px;" value='<s:property value="cmbtocurrency"/>' onchange="getRatevalue(this.value,$('#jqxIBCashPaymentDate').val());">
                    <option></option>
                </select>
            ...
            <div class="field-row" style="margin-bottom:0;">
                <label class="lbl-right" style="width:80px;">Amount</label>
                <input type="text" id="txttoamount" name="txttoamount" style="width:125px; text-align:right;" value='<s:property value="txttoamount"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountTo();getAmount();getDrTotal();" />
    ...
    <div class="middle-panel">
        ...
        <div id="jqxIbCashApplyInvoicing1" class="grid-container" style="margin-bottom:15px;">
            <jsp:include page="applyIbCashInvoicingGrid.jsp"></jsp:include>
        </div> 
        ...
        <div class="field-row" style="justify-content:flex-end; margin-bottom:0;">
            ...
            <input type="text" id="txtapplyinvoicebalance" name="txtapplyinvoicebalance" style="width:120px; text-align:right; font-weight:bold;" value='<s:property value="txtapplyinvoicebalance"/>' tabindex="-1" readonly/>
        </div>
    </div>

    <div class="middle-panel">
        <span class="middle-panel-title">Details</span>
        <div id="jqxIBCashPaymentGrid" class="grid-container">
            <jsp:include page="ibCashPaymentGrid.jsp"></jsp:include>
        </div>
