...
<script type="text/javascript">
    $(document).ready(function () {
        /* Standardized JQX setup to 120px/24px to match reference */
    ...
    function getdata(partyname, docNo, date, amount, check){
        /* Safely encoding URI components instead of manual string replace */
        $("#refreshdiv").load('icpvMainSearchGrid.jsp?partyname=' + encodeURIComponent(partyname) + 
...
<div id="search" class="modern-ui">
    ...
    <div class="grid-container">
        <div id="refreshdiv">
            <jsp:include page="icpvMainSearchGrid.jsp"></jsp:include>
        </div>
    </div>
