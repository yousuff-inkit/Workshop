...
<script type="text/javascript">
        ...
        $(document).ready(function () { 	
            ...
            $('#jqxBranchSearch').on('celldoubleclick', function (event) {
                ...
                $('#jqxIbCashPayment').jqxGrid('setcellvalue', rowindex1, "brhid" ,$('#jqxBranchSearch').jqxGrid('getcellvalue', rowindex2, "doc_no"));
                $('#jqxIbCashPayment').jqxGrid('setcellvalue', rowindex1, "branch" ,$('#jqxBranchSearch').jqxGrid('getcellvalue', rowindex2, "branchname"));
