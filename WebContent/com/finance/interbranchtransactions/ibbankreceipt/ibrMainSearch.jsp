...
<table width="100%">
  <tr>
    ...
    <td colspan="3"><input type="text" name="txtpartyname" id="txtpartyname" autocomplete="off" style="width:80%" value='<s:property value="txtpartyname"/>'></td>
    <td width="11%" align="right">Doc No</td>
    <td colspan="2"><input type="text" name="txtdocno" id="txtdocno" autocomplete="off" value='<s:property value="txtdocno"/>'></td>
  ...
  <tr>
    ...
    <td width="14%"><input type="text" name="txtamount" id="txtamount" autocomplete="off" value='<s:property value="txtamount"/>'></td>
    <td align="right">Cheque No</td>
    <td width="14%"><input type="text" id="txtchqno" name="txtchqno" autocomplete="off" value='<s:property value="txtchqno"/>'></td>
  ...
  <tr>
    <td colspan="8"><div id="refreshdiv"><jsp:include  page="ibrMainSearchGrid.jsp"></jsp:include></div></td>
  </tr>
</table>
  </div>
</body>
