...
String accountss = request.getParameter("accountss")==null?"NA":request.getParameter("accountss");
 ...
 String invnos = request.getParameter("invno")==null?"0":request.getParameter("invno");
...
var nipurmain= '<%=viewDAO.mainsearch(session,docnoss,accountss,accnamess,datess,reftypess,aa,description,invnos) %>'; 
       ...
       /*          showfilterrow: true, 
                ...
                columns: [
							...
							{ text: 'Account', datafield: 'account', width: '8%' },
								...
								{ text: 'Amount', datafield: 'netamount', width: '9%' ,cellsformat: 'd2', cellsalign: 'right', align:'right'},
									...
									{ text: 'delterm', datafield: 'delterm', width: '8%',hidden:true },
									 { text: 'payterm',  datafield: 'payterm', width: '5%' ,hidden:true},
										...
										{ text: 'Description', datafield: 'desc1', width: '30%' },
										 ...
										 { text: 'invno', datafield: 'invno', width: '8%'},
