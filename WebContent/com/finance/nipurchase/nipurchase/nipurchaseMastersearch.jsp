...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	function getdata(docnoss,accountss,accnamess,datess,reftypess,aa,description,invno){
		 ...
		 $("#refreshdivs").load('submasterSearch.jsp?docnoss='+docnoss+'&accountss='+accountss+'&accnamess='+accnamess+'&datess='+datess+'&reftypess='+reftypess+'&aa='+aa+'&description='+description+"&invno="+invno);
...
<table width="100%" >
  ...
  <option value="DIR" >DIR</option>
    ...
    <td align="right" width="10%">Description</td><td  width="20%"><input type="text" name="description" style="width:90%;" id="description" value='<s:property value="description"/>'></td>
   </tr>
   <tr >
  
    <td align="right" width="6%">Inv No</td>
    <td align="left"><input type="text" name="invnos" id="invnos" style="width:80%;"  value='<s:property value="invnos"/>'></td>
