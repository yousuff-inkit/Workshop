...
;
	...
	var aa="yes";
		getdata(docnoss,accountss,accnamess,datess,aa,descriptionss);
 

	}
	function getdata(docnoss,accountss,accnamess,datess,aa,descriptionss){
		
		 $("#refreshdivs").load('Subsearch.jsp?docnoss='+docnoss+'&accountss='+accountss+'&accnamess='+accnamess+'&datess='+datess+'&aa='+aa+'&descriptions='+descriptionss);
...
<table width="100%" >
  ...
  <table width="100% ">
    ...
    <td align="right" width="10%">Description</td><td  width="30%" colspan="4"><input type="text" name="descriptionss" style="width:100%;" id="descriptionss" value='<s:property value="descriptionss"/>'></td>
    
    <td  width="20%" align="center"><input type="button" name="searchs" id="searchs" class="myButton" value="Search"  onclick="loadSearchs()">
</td>
