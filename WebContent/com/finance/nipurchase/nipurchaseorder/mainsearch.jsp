...
<script type="text/javascript">
    ...
    function loadSearchs() {
        ...
        var descriptionss = document.getElementById("descriptionss").value || "";
        var aa = "yes";
...
<div id="search" class="modern-ui">
    ...
    <div class="search-panel">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <colgroup>
                <col width="8%" />  <col width="16%" /> <col width="8%" />  <col width="16%" /> <col width="10%" />  <col width="27%" /> <col width="15%" /> 
            </colgroup>
            ...
            <tr>
                ...
                <td colspan="3">
                    <input type="text" name="descriptionss" id="descriptionss" autocomplete="off" value='<s:property value="descriptionss"/>'>
                </td>
            </tr>
        </table>
    </div>
