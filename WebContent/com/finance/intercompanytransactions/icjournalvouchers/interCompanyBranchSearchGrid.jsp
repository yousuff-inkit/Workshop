...
<script type="text/javascript">
        ...
        $(document).ready(function () { 	
            ...
            $('#jqxBranchSearch').on('celldoubleclick', function (event) {
                ...
                $('#icJournalVoucherGridID').jqxGrid('setcellvalue', rowindex1, "intrcompid" ,$('#jqxBranchSearch').jqxGrid('getcellvalue', rowindex2, "doc_no"));
                $('#icJournalVoucherGridID').jqxGrid('setcellvalue', rowindex1, "compbranch" ,$('#jqxBranchSearch').jqxGrid('getcellvalue', rowindex2, "intercompname"));
                $('#icJournalVoucherGridID').jqxGrid('setcellvalue', rowindex1, "intrbrhid" ,$('#jqxBranchSearch').jqxGrid('getcellvalue', rowindex2, "brhid"));
                $('#icJournalVoucherGridID').jqxGrid('setcellvalue', rowindex1, "dbname" ,$('#jqxBranchSearch').jqxGrid('getcellvalue', rowindex2, "dbname"));
