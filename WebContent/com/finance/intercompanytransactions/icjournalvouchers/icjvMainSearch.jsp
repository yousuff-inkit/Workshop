...
<title>GatewayERP(i)</title>
	...
	function getdata(docNo,dates,descriptions,refNo,amounts,check){
		 $("#refreshdiv").load('icjvMainSearchGrid.jsp?docNo='+docNo+'&dates='+dates+'&descriptions='+descriptions.replace(/ /g, "%20")+'&refNo='+refNo+'&amounts='+amounts+'&check='+check);
		}
...
<table width="100%">
  ...
  <tr>
    <td colspan="6"><div id="refreshdiv"><jsp:include page="icjvMainSearchGrid.jsp"></jsp:include></div></td>
  </tr>
</table>
  </div>
</body>
