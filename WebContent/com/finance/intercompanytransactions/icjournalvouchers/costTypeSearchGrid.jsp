...
<script type="text/javascript">
     	...
     	$(document).ready(function () { 	
          ...
          $('#costtypeSearch').on('celldoubleclick', function (event) {
                ...
                $('#icJournalVoucherGridID').jqxGrid('setcellvalue', rowindex1, "costtype" ,$('#costtypeSearch').jqxGrid('getcellvalue', rowindex2, "costtype"));
                $('#icJournalVoucherGridID').jqxGrid('setcellvalue', rowindex1, "costgroup" ,$('#costtypeSearch').jqxGrid('getcellvalue', rowindex2, "costgroup"));
