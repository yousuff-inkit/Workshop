...
<script type="text/javascript">
        ...
        $(document).ready(function () { 	
            ...
            $('#jqxBranchSearch').on('celldoubleclick', function (event) {
                ...
                $('#icCashReceiptGridId').jqxGrid('setcellvalue', rowindex1, "intrcompid" ,$('#jqxBranchSearch').jqxGrid('getcellvalue', rowindex2, "doc_no"));
                $('#icCashReceiptGridId').jqxGrid('setcellvalue', rowindex1, "compbranch" ,$('#jqxBranchSearch').jqxGrid('getcellvalue', rowindex2, "intercompname"));
                $('#icCashReceiptGridId').jqxGrid('setcellvalue', rowindex1, "intrbrhid" ,$('#jqxBranchSearch').jqxGrid('getcellvalue', rowindex2, "brhid"));
                $('#icCashReceiptGridId').jqxGrid('setcellvalue', rowindex1, "dbname" ,$('#jqxBranchSearch').jqxGrid('getcellvalue', rowindex2, "dbname"));
