...
<script type="text/javascript">
	...
	function getAccountDetails(accountsno,accountsname,currs,type,dbname,date,check){
		 $("#refreshAccountSearchDetailsDiv").load("icPettyCashSearchGrid.jsp?accountno="+accountsno+'&accountname='+accountsname.replace(/ /g, "%20")+'&currency='+currs+'&atype='+type+'&dbname='+dbname.replace(/ /g, "%20")+'&date='+date+'&check='+check);
	}
...
<table width="100%">
  ...
  <tr>
    <td colspan="5"><div id="refreshAccountSearchDetailsDiv"><jsp:include page="icPettyCashSearchGrid.jsp"></jsp:include></div></td>
  </tr>
</table>
</div>
</body>
