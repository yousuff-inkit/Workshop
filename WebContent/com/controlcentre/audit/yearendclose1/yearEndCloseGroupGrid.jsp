...
<script type="text/javascript">
        ...
        $(document).ready(function () { 
            ...
            if(temp1>0){   
        	 	data1='<%=DAO.yearEndCloseProYearGridReloading(trNo)%>';      
       	 	} else {
       		    data1='<%=DAO.yearEndCloseProYearGridLoading(accountingYearFrom,ycloseDateFrom,yearEndDate)%>';
       	 	}
            ...
            $("#yearEndCloseGroupGridID").jqxGrid(
            {
                width: '70%',
                height: 150,
                source: dataAdapter,
            ...
            if(temp1>0){
            	$("#yearEndCloseGroupGridID").jqxGrid('disabled', true);
            }
          
});
        
</script>
<div id="yearEndCloseGroupGridID"></div>
