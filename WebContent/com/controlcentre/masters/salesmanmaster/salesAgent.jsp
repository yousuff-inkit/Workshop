...
<script type="text/javascript">
    $(document).ready(function () {     
        // Date Setup
        $("#salesagentdate").jqxDateTimeInput({width: '100%', height: 24, formatString: "dd.MM.yyyy", theme: 'energyblue'});
        ...
        if(document.getElementById("formdet")) {
            document.getElementById("formdet").innerText="Estimator(WMP)";
            document.getElementById("formdetail").value="Estimator";
            document.getElementById("formdetailcode").value="WMP";
            window.parent.formCode.value="WMP";
            window.parent.formName.value="Estimator";
        }
        ...
        var source =
         ...
         $('#jqxSalesagentSearch1').on('rowdoubleclick', function (event) 
                { 
                    ...
                    document.getElementById("cmbactive").value = $("#jqxSalesagentSearch1").jqxGrid('getcellvalue', rowindex1, "active");
                 }); 
    });
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel" style="margin-bottom: 15px;">
        <span class="middle-panel-title">Estimator Details</span>
    ...
    <!-- Estimator Search Grid Displayed Automatically -->
    <div id="jqxSalesagentSearch1" style="margin-top: 15px;"></div>
