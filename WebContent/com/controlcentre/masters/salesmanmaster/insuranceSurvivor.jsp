...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel" style="margin-bottom: 15px;">
        <span class="middle-panel-title">Insurance Surveyor Details</span>
        ...
        <div class="field-row" style="margin-bottom:0;">
            ...
            <div class="input-search-container" style="flex:1; max-width:150px;">
                <input type="text" name="cldocno" id="cldocno" value='<s:property value="cldocno"/>' onKeyDown="getAcc(event);" readonly placeholder="Press F3">
            ...
            <input type="text" name="clientname" id="clientname" value='<s:property value="clientname"/>' style="flex:1; margin-left:8px;" readonly>
    ...
    <!-- Insurance Surveyor Search Grid Displayed Automatically -->
