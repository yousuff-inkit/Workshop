...
$(document).ready(function () {      
     // Date Setup
     $("#salesmandate").jqxDateTimeInput({ width: '100%', height: 24, formatString:"dd.MM.yyyy", theme: 'energyblue'});
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel" style="margin-bottom: 15px;">
        ...
        <div class="field-row">
            ...
            <input type="text" name="salesmanid" id="salesmanid" placeholder="Code" value='<s:property value="salesmanid"/>' style="width:100px;">
            
            <label class="lbl-right" style="width:60px; margin-left:15px;">Name</label>
            <input type="text" name="salesmanname" id="salesmanname" placeholder="Code Name" value='<s:property value="salesmanname"/>' style="flex:1;">
            
            <label class="lbl-right" style="width:60px; margin-left:15px;">Email</label>
            <input type="email" name="salesmanmail" id="salesmanmail" style="flex:1; max-width:250px;" placeholder="someone@example.com" value='<s:property value="salesmanmail"/>' >
        </div>
        ...
        <div class="field-row" style="margin-bottom:0;">
            ...
            <input type="text" name="telephone" id="telephone" value='<s:property value="telephone"/>' style="flex:1; max-width:250px;">
        </div>
    </div>

    <!-- Salesman Search Grid Displayed Automatically -->
    <div id="jqxSalesmanSearch1" style="margin-top: 15px;"></div>
