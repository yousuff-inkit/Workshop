...
<script type="text/javascript">
    $(document).ready(function () {     
        ...
        // Date Setup
        $("#checkindate").jqxDateTimeInput({width: '100%', height: 24, formatString: "dd.MM.yyyy", theme: 'energyblue'});
        
        /* force internal alignment AFTER render */
        setTimeout(function () {
             $("#checkindate").find("input").css({
                 "margin-top": "0px",
                 "line-height": "24px",
                 "font-size": "12px", 
                 "font-family": "Arial, sans-serif", 
             ...
             $("#checkindate").find(".jqx-action-button").css({
                 "top": "0px",
                 "height": "24px"
             });
        }, 0);
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel" style="margin-bottom: 15px;">
        <span class="middle-panel-title">Referred By Details</span>
        ...
        <div class="field-row" style="margin-bottom:0;">
            ...
            <div class="input-search-container" style="flex:1; max-width:150px;">
                <input type="text" name="cldocno" id="cldocno" value='<s:property value="cldocno"/>' onKeyDown="getVendor(event);" readonly placeholder="Press F3">
            ...
            <input type="text" name="refname" id="refname" value='<s:property value="refname"/>' style="flex:1; margin-left:8px;" readonly>
    ...
    <!-- Referred By / Checkin Search Grid Displayed Automatically -->
    <div id="jqxCheckinSearch1" style="margin-top: 15px;"></div>
