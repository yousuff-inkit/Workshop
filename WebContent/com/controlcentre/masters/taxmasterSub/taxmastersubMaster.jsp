...
<!DOCTYPE html>
      ...
      function getaccountType(event)
      {
		...
		function taxSearch(url) {
			$('#taxwindow').jqxWindow('open');
			$.get(url).done(function(data) {
				$('#taxwindow').jqxWindow('setContent', data);
				$('#taxwindow').jqxWindow('bringToFront');
			});
		}
		...
		{
					$('#frmsubmaster input').attr('readonly', true );
					
					$('#frmsubmaster select').attr('disabled', true );
		...
		{
					$('#frmsubmaster input').attr('readonly', false );
					$('#frmsubmaster select').attr('disabled', false );
 	...
 	<body onload="setValues();">
			...
			<form id="frmsubmaster" action="saveActionsubmaster" autocomplete="off">
			...
			<fieldset >
					<table width="100%" > 
 						...
 						<tr>
  						 ...
  						 <tr>
    						  ...
    						  <td>
    						  		 <input type="radio" id="prdt" name="type" onchange="fundisable();" value="prdt"><label for="prdt" >Product</label>&nbsp;
									 <input type="radio" id="serv" name="type" onchange="fundisable();" value="serv"><label for="serv" >Service</label>
							  </td>
 						 ...
 						 <tr>
  						 ...
  						 <tr>
  					     		<td  align="right" ><label >Sequence No</label></td>
  					     		<td  align="left" ><select style="width: 75%;height:20PX;" id="cmbseqno"  name="cmbseqno" >
    						...
    						<tr>
    								 <td width="9%" align="right">Applied on</td>
  									 <td ><input type="text" id="txtappliedon" name="txtappliedon" style="width:80%;" placeholder="Press F3 for Search" readonly="true" onKeyDown="gettaxType(event);" value='<s:property value="txtappliedon"/>'></td>
					...
					<input type="hidden" id="hidseqno" name="hidseqno" value='<s:property value="hidseqno"/>'>
					 <input type="hidden" id="deleted" name="deleted"  value='<s:property value="deleted"/>'/>
					
					<input type="hidden" id="hidtaxdocid" name="hidtaxdocid" value='<s:property value="hidtaxdocid"/>'>			
					<input type="hidden" id="hidtaxid" name="hidtaxid" value='<s:property value="hidtaxid"/>'>
