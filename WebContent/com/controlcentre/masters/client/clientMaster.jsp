...
<tr>
  <td colspan="2" align="center">Taxable Entity <input type="checkbox" name="chknontax" id="chknontax" value='<s:property value="chknontax" />' onclick="$(this).attr('value', this.checked ? 1 : 0);"></td>
    ...
    <td  width="6%"><select id="cmbprivillege" name="cmbprivillege" style="width:100%;" value='<s:property value="cmbprivillege"/>'>
	    ...
	    <option value="5">Red</option></select>
...
<fieldset id="fieldsetinsurtype">
	<legend>Insurance Type Details</legend>
	<table width="100%" id="tblinsurtype">
		<tr>
			<td>
		    	<div id="insurtypegriddiv"> 
		  			<jsp:include page="insurTypeGrid.jsp"></jsp:include></div>
			</td>
		</tr>
	</table>  
</fieldset> 
