 <%@page import="com.controlcentre.masters.shippingdetail.ClsShippingdetailsDAO"%>
<% ClsShippingdetailsDAO viewDAO = new ClsShippingdetailsDAO(); %> 
...
<script type="text/javascript">
 ...
 var masterdata='<%=viewDAO.mastersearchFrom(clname,mob)%>';
  ...
  $(document).ready(function () { 	
     ...
     $("#mastersearch").jqxGrid(
     {
         ...
         columns: [
				...
				{ text: 'Name', datafield: 'clname', width: '12%' },
				{ text: 'Address', datafield: 'claddress', width: '25%'   },
				{ text: 'Mob', datafield: 'mob', width: '55%' },
     ...
     $('#mastersearch').on('rowdoubleclick', function (event) {
 	  ...
 	  var rowindex1=event.args.rowindex;
            ...
            document.getElementById("clname").value=$('#mastersearch').jqxGrid('getcelltext', rowindex1, "clname"); 
            ...
            document.getElementById("shipemail").value=$('#mastersearch').jqxGrid('getcelltext', rowindex1, "tel"); 
            document.getElementById("shiptelephone").value=$('#mastersearch').jqxGrid('getcelltext', rowindex1, "mob"); 
            document.getElementById("shipmob").value=$('#mastersearch').jqxGrid('getcelltext', rowindex1, "email"); 
