...
if(temp2>0)
{
	 ...
	 var agmtdata='<%=ClsSupplierDAO.cpGridload(session,cldocno)%>'; 
...
{ text: 'Email',  datafield: 'email',  width: '14%',editable:true,renderer: columnsrenderer,cellsalign: 'center',align: 'center',cellclassname:'column'},
{ text: 'Area',  datafield: 'area',  width: '15%',editable:false,renderer: columnsrenderer,cellsalign: 'center',align: 'center',cellclassname:'column'},
