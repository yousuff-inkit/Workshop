            ...
            $("#leaseCDWGridSearch").jqxGrid(
                    {
                        ...
                        columns: [
							...
							{ text: 'Replacement',datafield:'chkreplace',width:'10%',hidden:true},
							...
							{ text: 'Excesscdw',datafield:'excesscdw',width:'10%',hidden:true},
							
        					
        	              ]
                    });
            $('#leaseCDWGridSearch').on('rowdoubleclick', function (event) {
                var rowindex1=event.args.rowindex;
                document.getElementById("docno").value= $('#leaseCDWGridSearch').jqxGrid('getcellvalue', rowindex1, "doc_no"); 
                document.getElementById("name").value = $("#leaseCDWGridSearch").jqxGrid('getcellvalue', rowindex1, "name");
				document.getElementById("remarks").value = $("#leaseCDWGridSearch").jqxGrid('getcellvalue', rowindex1, "remarks");
				document.getElementById("description").value = $("#leaseCDWGridSearch").jqxGrid('getcellvalue', rowindex1, "description");
                $("#date").jqxDateTimeInput('val', $("#leaseCDWGridSearch").jqxGrid('getcellvalue', rowindex1, "date"));
                if($("#leaseCDWGridSearch").jqxGrid('getcellvalue', rowindex1, "chkreplace")=="1"){
