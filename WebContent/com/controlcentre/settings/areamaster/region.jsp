...
<script type="text/javascript">
	$(document).ready(function () {    
	    $("#date_reg").jqxDateTimeInput({ width: '125px', height: 24, formatString: "dd.MM.yyyy", theme: 'energyblue' });
	    
	    /* force internal alignment AFTER render */
		 setTimeout(function () {
		 	$("#date_reg").find("input").css({
		 		"margin-top": "0px",
		 		"line-height": "24px",
		 		"font-size": "12px", 
		 		"font-family": "Arial, sans-serif", 
		 	...
		 	$("#date_reg").find(".jqx-action-button").css({
		 		"top": "0px",
		 		"height": "24px"
		 	});
		 }, 0);
    ...
    <div class='modern-ui hidden-scrollbar'>
        ...
        <div class="middle-panel">
            ...
            <div class="field-row" style="margin-bottom:0;">
                ...
                <input type="text" name="region" id="region" style="width:250px;" value='<s:property value="region"/>'>
            </div>
        </div>

        <div class="middle-panel">
            <span class="middle-panel-title">Search Details</span>
