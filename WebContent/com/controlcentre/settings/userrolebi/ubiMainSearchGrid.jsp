...
%> 
 ...
 <script type="text/javascript">
 			...
 			var data2='<%=urb.ubiMainSearch(rolename, docNo, date)%>';
            ...
            $("#jqxUserRoleSearch").jqxGrid(
            {
                ...
                columns: [
					 ...
					 { text: 'Role Id', datafield: 'roleid', hidden: true, width: '10%' },
					]
            });
        	...
        	$("#jqxUserRoleSearch").jqxGrid('addrow', null, {});   
			  ...
			  $('#jqxUserRoleSearch').on('rowdoubleclick', function (event) {
				...
				document.getElementById("txtroleid").value= $('#jqxUserRoleSearch').jqxGrid('getcellvalue', rowindex1, "roleid");
