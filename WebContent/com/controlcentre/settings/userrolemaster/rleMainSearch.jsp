...
<title>GatewayERP(i)</title>
	...
	function getdata(rolename,docNo,date){
		 $("#refreshdiv").load('rleMainSearchGrid.jsp?rolename='+rolename+'&docNo='+docNo+'&date='+date);
		}
...
<table width="100%">
  ...
  <tr>
    <td colspan="5"><div id="refreshdiv"><jsp:include page="rleMainSearchGrid.jsp"></jsp:include></div></td>
  </tr>
</table>
  </div>
</body>
