...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	function getdata(clname,mob,lcno,passno,nation,dob){
		 ...
		 $("#refreshdiv").load('clientAccountDetailsGrid.jsp?clname='+clname+'&mob='+mob+'&lcno='+lcno+'&passno='+passno+'&nation='+nation+'&dob='+dob);
...
<table width="100%" >
  ...
  <tr>
   ...
   <jsp:include  page="clientAccountDetailsGrid.jsp"></jsp:include> 
