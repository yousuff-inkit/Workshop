...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	function getdata(docno,clientname,mobile,email){
		var dtype='<%=request.getParameter("dtype")==null?"":request.getParameter("dtype")%>';
		 $("#refreshdiv").load("../../../../com/search/clientaccountsearch/vendorSearchGrid.jsp?docno="+docno+"&clientname="+clientname+"&mobile="+mobile+"&email="+email+"&dtype="+dtype);
...
<table width="100%">
  <tr>
    ...
    <td width="23%"><input type="text" name="vndsearchdocno" id="vndsearchdocno" style="width:90%;height:20px;" value='<s:property value="vndsearchdocno"/>'></td>
    <td width="6%" align="right" style="font-size:9px;">Name</td>
    <td width="45%"><input type="text" name="vndsearchname" id="vndsearchname" style="width:100%;height:20px;" value='<s:property value="vndsearchname"/>'></td>
   </tr>
   <tr>
    <td width="17%" align="right" style="font-size:9px;">Mobile No.</td>
    <td width="23%"><input type="text" name="vndsearchmobile" id="vndsearchmobile" style="width:90%;height:20px;" value='<s:property value="vndsearchmobile"/>'></td>
    <td width="6%" align="right" style="font-size:9px;">Email</td>
    <td width="45%"><input type="text" name="vndsearchemail" id="vndsearchemail" style="width:100%;height:20px;" value='<s:property value="vndsearchemail"/>'></td>
