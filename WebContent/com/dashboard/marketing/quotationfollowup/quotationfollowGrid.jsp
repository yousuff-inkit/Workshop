...
{ 
	 ...
	 qutdatas='<%=cmd.quotfollowtsearch(barchval,fromdate,todate)%>'; 
...
$(document).ready(function () {
    ...
    $("#qutfollowgrid").jqxGrid(
    {
        ...
        columns: [   
                  { text: 'SL#', sortable: false, filterable: false, editable: false,
				     ...
				     { text: 'Client',datafield: 'name', width: '13%' },
    ...
    $('#qutfollowgrid').on('rowdoubleclick', function (event) 
	  ...
	  document.getElementById("branchids").value=$('#qutfollowgrid').jqxGrid('getcellvalue', rowindex1, "branch");
