 ...
 <%
	...
	String relodestatus = request.getParameter("relodestatus")==null?"NA":request.getParameter("relodestatus").trim();
 %> 
...
{ 
	 ...
	 qutdata='<%=cmd.quotlistsearch(barchval,fromdate,todate,relodestatus)%>'; 
