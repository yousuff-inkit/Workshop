...
var	salperson= '<%=cmd.salpersonSearch()%>';
...
$(document).ready(function () {
    ...
    $('#salpersonsearchGrid').on('rowdoubleclick', function (event) 
    		{ 
    	
    	var rowindex1=event.args.rowindex;
    		  
    			  document.getElementById("salperson").value= $('#salpersonsearchGrid').jqxGrid('getcellvalue', rowindex1, "sal_name"); 
	                document.getElementById("hidsalperson").value = $("#salpersonsearchGrid").jqxGrid('getcellvalue', rowindex1, "doc_no");
...
<div id="salpersonsearchGrid"></div>