...
%> 
 ...
 <script type="text/javascript">
	...
	var accountData='<%=DAO.accountsDetails(session, accountno, accountname,date, check)%>';
 	$(document).ready(function () { 
        ...
        $("#jqxAccountsSearch").jqxGrid(
        {
         ...
         $('#jqxAccountsSearch').on('rowdoubleclick', function (event) {
        	...
        	document.getElementById("txtchqbankname").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "description");
        	document.getElementById("txtchqbankdocno").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "doc_no");
