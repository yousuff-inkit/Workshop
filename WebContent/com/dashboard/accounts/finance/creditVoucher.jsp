...
<script type="text/javascript">
		...
		if(temp1=='CNO' || temp1=='DNO'){
			if(temp!='NA'){
				  data3='<%=DAO.finance(branchval, fromDate, toDate, accDocno, dType, docRangeFrom, docRangeTo, amtRangeFrom, amtRangeTo, chk)%>';
				  var dataExcelExport2='<%=DAO.financeExcelExport(branchval, fromDate, toDate, accDocno, dType, docRangeFrom, docRangeTo, amtRangeFrom, amtRangeTo,chk)%>';
			}
		}
