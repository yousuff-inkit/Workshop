...
<script type="text/javascript">
		...
		if(temp1=='CPV' || temp1=='CRV' || temp1=='ICPV' || temp1=='ICRV' || temp1=='PC' || temp1=='FCR'){
			if(temp!='NA'){
				  data1='<%=DAO.finance(branchval, fromDate, toDate, accDocno, dType, docRangeFrom, docRangeTo, amtRangeFrom, amtRangeTo,chk)%>';
				  var dataExcelExport='<%=DAO.financeExcelExport(branchval, fromDate, toDate, accDocno, dType, docRangeFrom, docRangeTo, amtRangeFrom, amtRangeTo,chk)%>';
			}
		}
