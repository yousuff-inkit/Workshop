        ...
        $(document).ready(function () {
            ...
            $('#accountDetailsGridID').on('rowdoubleclick', function (event) { 
            	  ...
            	  $("#accountDetailsDetailedGridID").jqxGrid({ disabled: false});
         		  $("#accountDetailsDetailedDiv").load("balanceSheetSymbolDetailedAccountDetailsGrid.jsp?trno="+$('#accountDetailsGridID').jqxGrid('getcellvalue', rowindex1, "tr_no")+'&check='+check);
