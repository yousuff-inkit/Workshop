...
<script type="text/javascript">
	...
	function hidedata(){
	 ...
	 function funreload(event){
		 ...
		 $("#balanceSheetDiv").load("balanceSheetSymbolGrid.jsp?branchval="+branchval+'&fromdate='+fromdate+'&todate='+todate+'&level1='+level1+'&level2='+level2+'&level3='+level3+'&level4='+level4+'&check='+check);
		}
		
		function funExportBtn(){
		  if(parseInt(window.parent.chkexportdata.value)=="1") {
		  	JSONToCSVCon(dataExcelExport, 'BalanceSheetSymbol', true);
		  } else {
...
<td width="80%">
	<table width="100%">
		 <tr>
		    <td><div id="balanceSheetDiv"><jsp:include page="balanceSheetSymbolGrid.jsp"></jsp:include></div></td>
		 </tr> 
	</table>
</td></tr>
</table>
