...
<td width="20%" >
	...
	<tr><td colspan="2">&nbsp;</td></tr>
	<tr><td colspan="2"><center><button class="myButton" type="button" id="btnIndividual" name="btnIndividual" onclick="funOutStandingStatement();">Outstanding Statement</button>
	<button type="button" class="icon" id="btnOutExcel" title="Export Outstanding Statement to Excel" onclick="funOutExcelBtn()">
							<img alt="excelDocument" src="<%=contextPath%>/icons/excel_new.png">
						</button></center></td></tr>
    <tr><td colspan="2"><center><button class="myButton" type="button" id="btnnormalprint" name="btnnormalprint" onclick="funageingprint();">Print</button></center></td></tr>  
	<tr><td colspan="2" hidden="true"><center><button class="myButton" type="button" id="btnIndividual" name="btnIndividual" onclick="funauditletterprint();">Audit Balance Confirmation Letter</button></center></td></tr>
	<tr><td colspan="2" hidden="true" ><center><button class="myButton" type="button" id="btnApply" name="btnApply" onclick="funAutoApply();">Auto Apply</button></center></td></tr>
