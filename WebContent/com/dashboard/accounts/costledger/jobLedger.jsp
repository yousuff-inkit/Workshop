	...
	function funExportBtn(){
		...
		if(document.getElementById("rddetailed").checked==true){
		  $("#costLedgerDetailedDiv").excelexportjs({  
       		...
       		worksheetName:"Detail Job Ledger"
       		}); 
		}
		else{
			 $("#costLedgerSummaryDiv").excelexportjs({  
       		...
       		worksheetName:"Summary Job Ledger"
       		}); 
		}
	} 
...
<td width="20%" >
	...
	<td width="80%" align="left"><select id="cmbcosttype" name="cmbcosttype" style="width:60%;" onchange="clearCostCodeInfo();" value='<s:property value="cmbcosttype"/>'><option value="9">Job card </option></select>
    </td></tr>
