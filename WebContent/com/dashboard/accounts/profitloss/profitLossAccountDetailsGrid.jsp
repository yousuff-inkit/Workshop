<%@page import="com.dashboard.accounts.profitloss.ClsProfitLoss" %>
<% ClsProfitLoss DAO=new ClsProfitLoss(); %>
        ...
        $(document).ready(function () {
            ...
            $('#accountDetailsGridID').on('rowdoubleclick', function (event) { 
            	  ...
            	  $("#accountDetailsDetailedGridID").jqxGrid({ disabled: false});
         		  $("#accountDetailsDetailedDiv").load("profitLossDetailedAccountDetailsGrid.jsp?trno="+$('#accountDetailsGridID').jqxGrid('getcellvalue', rowindex1, "tr_no")+'&check='+check);
