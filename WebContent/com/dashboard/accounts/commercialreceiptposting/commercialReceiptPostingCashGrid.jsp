	...
	$(document).ready(function () {
	    ...
	    $("#postingCashGrid").jqxGrid(
	    {
	        ...
	        columns: [
							...
							{ text: 'Doc No', datafield: 'documentno', width: '7%',cellclassname: cellclassname },
							{ text: 'Client A/c', datafield: 'clacno', width: '7%'  ,cellclassname: cellclassname },
							{ text: 'Client', datafield: 'refname', width: '27%',cellclassname: cellclassname },
							{ text: 'Description', datafield: 'paydesc', width: '32%',cellclassname: cellclassname },
							{ text: 'Paid As', datafield: 'paidas', width: '7%',cellclassname: cellclassname },
							{ text: 'Amount', datafield: 'netamt', width: '10%',cellsformat:'d2',cellsalign:'right',align:'right' ,cellclassname: cellclassname },
	    ...
	    if(rowcount==0){
	    	$("#postingCashGrid").jqxGrid("addrow", null, {});	
	    }
	    
	    $("#postingCashGrid").on('cellvaluechanged', function (event) {
	    ...
	    for (i = 0; i < rows.length; i++) {
				if(selectedrows[j]==i){
					 var amount = $('#postingCashGrid').jqxGrid('getcellvalue', i, "netamt");
	                 var amountcomm= $("#postingCashGrid").jqxGrid('getcellvalue', i, "totalamount");
