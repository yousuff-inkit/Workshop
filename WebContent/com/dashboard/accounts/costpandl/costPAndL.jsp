...
<script type="text/javascript">
	...
	function funExportBtn(){
		JSONToCSVCon(dataExcelExport, 'CostProfitAndLoss', true);
	} 
	...
	function funreload(event){
		 ...
		 $("#costPAndLDiv").load("costPAndLGrid.jsp?branchval="+branchval+'&fromdate='+fromdate+'&todate='+todate+'&costtype='+costtype+'&costcode='+costcode+'&check='+check);
...
<td width="80%">
	<table width="100%">
		...
		<tr>
			 <td><div id="costPAndLDiv"><jsp:include page="costPAndLGrid.jsp"></jsp:include></div></td>
		</tr>
	</table>
</tr>
</table>
