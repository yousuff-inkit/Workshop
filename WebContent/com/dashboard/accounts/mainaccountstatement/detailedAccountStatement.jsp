...
<%ClsMainAccountStatementDAO cmd=new ClsMainAccountStatementDAO(); %>
...
<%   String branchval = request.getParameter("branchval")==null?"NA":request.getParameter("branchval").trim();
     ...
     String chckopening = request.getParameter("chckopenings")==null?"0":request.getParameter("chckopenings").trim();%>
...
<script type="text/javascript">
       ...
       var data1='<%=cmd.accountStatementDetail(branchval, fromDate, toDate, acctype, accdocno, chckopening)%>';
       var name='<%=name%>';
        ...
        $(document).ready(function (){ 
            ...
            var datas='<%=cmd.accountStatementDetailGrid()%>';
            var ordersSource =
            {
            	datatype: "json",
                datafields: [
