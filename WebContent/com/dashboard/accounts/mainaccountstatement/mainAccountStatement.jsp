...
<script type="text/javascript">
	...
	$(document).ready(function () {
	     ...
	     document.getElementById("hidchckopening").value = 0;
	     document.getElementById("chckopening").checked = false;
	...
	function openingcheck(){
		 if(document.getElementById("chckopening").checked){
			 document.getElementById("hidchckopening").value = 1;
	...
	function funreload(event){
		 ...
		 var chckopening = $('#hidchckopening').val();
		...
		if(acctype==''){
		 ...
		 $("#mainAccountStatementDiv").load("mainAccountStatementGrid.jsp?branchval="+branchval+'&fromdate='+fromdate+'&todate='+todate+'&acctype='+acctype+'&accdocno='+accdocno+'&chckopening='+chckopening+'&check=1');
		}
	...
	function funClearInfo(){
		 ...
		 document.getElementById("hidchckopening").value = 0;
		 if(document.getElementById("hidchckopening").value==0){
			 document.getElementById("chckopening").checked = false;
		 }
		...
		$("#mainAccountStatement").jqxGrid('clear');$("#mainAccountStatement").jqxGrid('addrow', null, {});
	...
	function funPrintAccountStatement(){
    	if ($("#cmbtype").val()!="") {
	        ...
	        var win= window.open(reurl[0]+"printMainAccountStatement?atype="+document.getElementById("cmbtype").value+'&acno='+document.getElementById("txtdocno").value+'&netamount='+document.getElementById("txtnetamount").value+'&branch='+document.getElementById("cmbbranch").value+'&fromDate='+document.getElementById("fromdate").value+'&toDate='+$('#todate').val()+'&chckopening='+$('#hidchckopening').val(),"_blank","top=150,left=250,Width=1020,Height=500,location=no,scrollbars=no,toolbar=yes");
	        win.focus();
	     }
	    else {
	...
	function funExportBtn(){
		 if(parseInt(window.parent.chkexportdata.value)=="1") {
			 ...
			 $("#mainAccountStatement").jqxGrid('exportdata', 'xls', 'MainAccountStatement');
		 }
	 }
...
<td width="20%" >
	...
	<jsp:include page="../../heading.jsp"></jsp:include>
	 ...
	 <tr><td colspan="2"><input type="checkbox" id="chckopening" name="chckopening" value="" onchange="openingcheck();" onclick="$(this).attr('value', this.checked ? 1 : 0)" /> 
      <input type="hidden" id="hidchckopening" name="hidchckopening" style="width:60%;height:20px;" readonly="readonly" value='<s:property value="hidchckopening"/>'/></td></tr>
	 <tr>
...
<td width="80%">
	<div id="mainAccountStatementDiv"><jsp:include page="mainAccountStatementGrid.jsp"></jsp:include></div></td>
</tr>
</table>
