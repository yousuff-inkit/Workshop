...
<td width="20%" >
	...
	<tr><td colspan="2" align="center"><input type="checkbox" id="chckopnprint" name="chckopnprint" value="" onchange="opnprintcheck();" onclick="$(this).attr('value', this.checked ? 1 : 0)" /> 
	...
	<button class="myButton" type="button" id="btnPrintAccount" name="btnPrintAccount" onclick="funPrintAccountStatement(event);">Account Statement</button></td></tr>
