  			...
  			if (x.readyState == 4 && x.status == 200) {
		          ...
		          if(parseInt(columns)==1) {
		        	  ...
		        	  $("#overlay, #PleaseWait").show();
		     		  ...
		     		  $("#analysisDiv").load("profitLossAnalysisGrid.jsp?branchval="+branchval+'&fromdate='+fromdate+'&todate='+todate+'&frequencytype='+frequencytype+'&noofdays='+noofdays+'&check='+check+'&level1='+level1+'&level2='+level2+'&level3='+level3+'&level4='+level4);
		          }
    		}
		}
	...
	function noOfDays(){
	 ...
	 function  funClearInfo(){
		...
		function funPrint(){
			 ...
			 var path= "com/dashboard/analysis/profitlossanalysispal/profitlossanalysisprint.action?branchval="+branchval+'&fromdate='+fromdate+'&todate='+todate+'&amountlen='+amountlen+'&frequencytype='+frequencytype+'&noofdays='+noofdays;  
    				...
    				<td width="20%" >
    					<fieldset style="background: #ECF8E0;">
	 						<table width="100%"  >
								...
								<input type="hidden" id="rowslen" name="rowslen"></td></tr>  
								<tr><td colspan="2">&nbsp;</td></tr>
							    <tr><td colspan="2">&nbsp;</td></tr>
							</table>
						</fieldset>
