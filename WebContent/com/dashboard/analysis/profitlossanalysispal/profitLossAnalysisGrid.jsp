<%@page import="com.dashboard.analysis.profitlossanalysispal.ClsProfitLossAnalysis" %>   
 ...
 <script type="text/javascript">
 		...
 		$(document).ready(function () {          
			var data ="";
 			...
 			if(check=='1'){
 				data = '<%=cpla.analysisGrid(branchval, fromDate, toDate, frequencyType, noOfDays, check, level1, level2, level3, level4)%>';     
