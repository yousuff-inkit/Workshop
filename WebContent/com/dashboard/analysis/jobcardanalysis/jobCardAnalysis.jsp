  ...
  //  alert(jcno+"  "+techid);
    ...
    if(document.getElementById("rdall").checked==true){
    	$("#overlay, #PleaseWait").show(); 
   	   	$("#revenuereportdiv").load("detailGrid.jsp?fromdate="+fromdate+"&todate="+todate+"&id=1"+"&hidclient="+hidclient+"&hidclientslm="+hidclientslm+"&hidrepairtype="+hidrepairtype+"&hidinvoicestatus="+hidinvoicestatus);
	   	...
	   	if(x=="clt"){
	   		/* alert(x); */
	   		$("#overlay, #PleaseWait").show(); 
	   	   	$("#revenuereportdiv").load("summaryGrid.jsp?fromdate="+fromdate+"&todate="+todate+"&id=1"+"&hidclient="+hidclient+"&hidclientslm="+hidclientslm+"&hidrepairtype="+hidrepairtype+"&hidinvoicestatus="+hidinvoicestatus+"&sumtype=clt"); 
	   		
	   	}else if(x=="sm"){
	   		$("#overlay, #PleaseWait").show(); 
	   	   	$("#revenuereportdiv").load("summaryGrid.jsp?fromdate="+fromdate+"&todate="+todate+"&id=1"+"&hidclient="+hidclient+"&hidclientslm="+hidclientslm+"&hidrepairtype="+hidrepairtype+"&hidinvoicestatus="+hidinvoicestatus+"&sumtype=sm"); 
	   		
	   	}else if(x=="rt"){
	   		$("#overlay, #PleaseWait").show(); 
	   	   	$("#revenuereportdiv").load("summaryGrid.jsp?fromdate="+fromdate+"&todate="+todate+"&id=1"+"&hidclient="+hidclient+"&hidclientslm="+hidclientslm+"&hidrepairtype="+hidrepairtype+"&hidinvoicestatus="+hidinvoicestatus+"&sumtype=rt"); 
	   		
	   	}else if(x=="dly"){
	   		$("#overlay, #PleaseWait").show(); 
	   	   	$("#revenuereportdiv").load("summaryGrid.jsp?fromdate="+fromdate+"&todate="+todate+"&id=1"+"&hidclient="+hidclient+"&hidclientslm="+hidclientslm+"&hidrepairtype="+hidrepairtype+"&hidinvoicestatus="+hidinvoicestatus+"&sumtype=dly"); 
	   		
	   	}else if(x=="mly"){
	   		$("#overlay, #PleaseWait").show(); 
	   	   	$("#revenuereportdiv").load("summaryGrid.jsp?fromdate="+fromdate+"&todate="+todate+"&id=1"+"&hidclient="+hidclient+"&hidclientslm="+hidclientslm+"&hidrepairtype="+hidrepairtype+"&hidinvoicestatus="+hidinvoicestatus+"&sumtype=mly"); 
	   		
	   	}else if(x=="yly"){
	   		$("#overlay, #PleaseWait").show(); 
	   	   	$("#revenuereportdiv").load("summaryGrid.jsp?fromdate="+fromdate+"&todate="+todate+"&id=1"+"&hidclient="+hidclient+"&hidclientslm="+hidclientslm+"&hidrepairtype="+hidrepairtype+"&hidinvoicestatus="+hidinvoicestatus+"&sumtype=yly"); 
	   		
	   	}else if(x=="invs"){
	   		$("#overlay, #PleaseWait").show(); 
	   	   	$("#revenuereportdiv").load("summaryGrid.jsp?fromdate="+fromdate+"&todate="+todate+"&id=1"+"&hidclient="+hidclient+"&hidclientslm="+hidclientslm+"&hidrepairtype="+hidrepairtype+"&hidinvoicestatus="+hidinvoicestatus+"&sumtype=invs"); 
		   ...
		   <td><div id="todate"></div></td>
			...
			<tr><td colspan="2">
				  <fieldset>
				      ...
				      <option value="">--Select--</option><option value="clt">Client</option><option value="sm">Sales Man</option><option value="rt">Repair Type</option>
				      <option value="dly">Daily</option><option value="mly">Monthly</option><option value="yly">Yearly</option><option value="invs">Invstatus</option>
					  </select>
				...
				<table width="100%">
				  <tr>
					...
					<option value="client">Client</option><option value="clientslm">Salesman</option><option value="repairtype">Repair Type</option><option value="invoicestatus">Invoice Status</option></select></td>
...
<td width="80%">
	<table width="100%">
		<tr>
			  ...
			  <input type="hidden" name="repairtype" id="repairtype"><input type="hidden" name="hidrepairtype" id="hidrepairtype"></td></tr>
			  <input type="hidden" name="invoicestatus" id="invoicestatus"><input type="hidden" name="hidinvoicestatus" id="hidinvoicestatus"></td></tr>
