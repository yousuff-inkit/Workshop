...
if(id=='1'){
	rrdetaildata=<%=DAO.getDetailData(fromdate,todate,hidclient,hidclientslm,hidrepairtype,hidinvoicestatus,id)%>;
	rrexportdata=<%=DAO.getDetailExportData(fromdate,todate,hidclient,hidclientslm,hidrepairtype,hidinvoicestatus,id)%>;
