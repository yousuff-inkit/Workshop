...
<script type="text/javascript">
	...
	$(document).ready(function () {  
     ...
     var fromdate = $('#fromdate').val();
	    	  ...
	    	  $("#revenuereportdiv").load("detailGrid.jsp?fromdate="+fromdate+"&todate="+todate+"&id=1");
	          evt.preventDefault();              
	      })
	    })  
	    
	function funExportBtn(){  
			 JSONToCSVCon(rrexportdata,'Revenue Report',true);   
	}
 ...
 <table>
  ...
  <tr>  
	 <td align="right" colspan="2"> <div id="divPivotGridDesigner" style="height: 490px; width: 250px;"></div></td></tr>
            ...
            <td width="80%">
                <div id="revenuereportdiv" style="height:540px; width: 1090px;"><jsp:include page="detailGrid.jsp"></jsp:include>
                </div>  
            </td>
        </tr>
    </table>
