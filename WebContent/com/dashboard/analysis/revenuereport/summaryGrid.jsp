        ...
        columns: [
             ...
             cellsrenderer: function (row, column, value) {
              return "<center><div style='margin:4px;'>" + (value + 1) + "</div></center>";
       				...
       				{ text: 'Labour',datafield:'labour',width:'13%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
       				{ text: 'Spares',datafield:'spares',width:'13%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
