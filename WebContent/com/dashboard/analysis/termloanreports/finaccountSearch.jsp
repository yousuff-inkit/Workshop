...
<table width="100%" >
  <tr>
    ...
    <td width="12%"><input type="text" name="txtaccountsno1" id="txtaccountsno1" style="width:85%;height:20px;" value='<s:property value="txtaccountsno1"/>'></td>
   <td align="left" width="68%"colspan="2" style="font-size:9px;">Account Name&nbsp;<input type="text" name="txtaccountsname1" id="txtaccountsname1" style="width:70%;height:20px;" value='<s:property value="txtaccountsname1"/>'></td>
