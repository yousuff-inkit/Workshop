...
<%ClsAccountAnalysis DAO=new ClsAccountAnalysis(); %>
	...
	var data3;
      ...
      var name='<%=name%>';
        ...
        $(document).ready(function () {
        	$("#accountAnalysisAccountDetailsDetailedGridID").jqxGrid({ disabled: true});
        	...
        	$("#excelExport").click(function() {
        		if(parseInt(window.parent.chkexportdata.value)=="1") {
        			JSONToCSVCon(data3, "AccountAnalysis", true);
    			 } else {
    				$("#accountAnalysisAccountDetailsGridID").jqxGrid('exportdata', 'xls', name);
    			 }
    		});
            ...
            $("#accountAnalysisAccountDetailsGridID").jqxGrid(
            {
                width: '98%',
                height: 300,
                source: dataAdapter,
            ...
            $('#accountAnalysisAccountDetailsGridID').on('rowdoubleclick', function (event) { 
            	  var rowindex1=event.args.rowindex;
            	  var check=1;
            	  $("#overlay, #PleaseWait").show();
            	  $("#accountAnalysisAccountDetailsDetailedGridID").jqxGrid({ disabled: false});
         		  $("#accountDetailsDetailedDiv").load("accountAnalysisDetailedAccountDetailsGrid.jsp?trno="+$('#accountAnalysisAccountDetailsGridID').jqxGrid('getcellvalue', rowindex1, "tr_no")+'&check='+check);
...
<div id="accountAnalysisAccountDetailsGridID"></div>