...
<script type="text/javascript">
	  ...
	  var temp2='<%=toDate%>';
	  	...
	  	if(temp!='NA'){ 
	  		data='<%=cva.vehicleAsssetGridLoading(branchval, fromDate, toDate, fleetNo, group, model,rptType, check)%>';
	  		var dataExcelExport='<%=cva.vehicleAsssetExcelExport(branchval, fromDate, toDate, fleetNo, group, model,rptType, check)%>';
	  	}
        ...
        $(document).ready(function () {
			...
			$("#overlay, #PleaseWait").hide();
			 ...
			 $('#vehicleAssetGrid').on('rowdoubleclick', function (event) {
					...
					var path="com/dashboard/analysis/vehicleassetregister/vehicleDetailedAssetGrid.jsp";
