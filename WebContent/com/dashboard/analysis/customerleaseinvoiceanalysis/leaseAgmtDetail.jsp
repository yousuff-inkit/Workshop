...
function funExportBtn(){
	 ...
	 JSONToCSVCon(summarydataExcel, 'Customer LeaseWise Invoicean', true);
...
function funreload(event)
{
	...
	if(document.getElementById("rdosummary").checked==true){
		$('#summarydiv').load('leaseAgmtSummaryGrid.jsp?id=1&fromdate='+fromdate+'&todate='+todate+"&status="+document.getElementById("status").value+'&branch='+branch);
	}
