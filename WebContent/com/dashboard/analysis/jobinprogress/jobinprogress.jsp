...
function funreload(event)
{
  ...
  //  alert(jcno+"  "+techid);
        ...
        $("#overlay, #PleaseWait").show(); 
   	   	$("#revenuereportdiv").load("detailGrid.jsp?todate="+todate+"&id=1"+"&hidclient="+hidclient+"&hidclientslm="+hidclientslm+"&hidrepairtype="+hidrepairtype+"&hidserviceadvisor="+hidserviceadvisor);
 ...
 */		
	...
	function funAccwisePrint(){
        ...
        var reurl=url.split("jobinprogress.jsp");
        var hidclient=document.getElementById("hidclient").value;
        var hidclientslm=document.getElementById("hidclientslm").value;
        var hidrepairtype=document.getElementById("hidrepairtype").value;
        var hidserviceadvisor=document.getElementById("hidserviceadvisor").value;
       ...
       /*  $("#txtdocno").prop("disabled", false); */
        var win= window.open(reurl[0]+"../../../../com/dashboard/analysis/jobinprogress/printJobInProgress?client="+hidclient+'&clientslm='+hidclientslm+'&repairtype='+hidrepairtype+'&hidserviceadvisor='+hidserviceadvisor+'&type='+type+'&branch='+branch+'&toDate='+$('#todate').val()+'&email=Nil&print=1',"_blank","top=150,left=250,Width=1020,Height=500,location=no,scrollbars=no,toolbar=yes");
        win.focus();
	...
	function funMnthwisePrint(){
        ...
        /* $("#txtdocno").prop("disabled", false); */
        var win= window.open(reurl[0]+"../../../../com/dashboard/analysis/jobinprogress/JobInProgressmnthwise?branch="+branch+'&toDate='+$('#todate').val()+'&email=Nil&print=1',"_blank","top=150,left=250,Width=1020,Height=500,location=no,scrollbars=no,toolbar=yes");
        win.focus();
						...
						<td width="20%" align="center">
								...
								<table width="100%">
									<jsp:include page="../../heading.jsp"></jsp:include>
		 							<!-- <tr>
		   								<td width="37%" align="right"><label class="branch">Tran From Date</label></td><td width="63%"><div id="fromdate"></div></td>
		   							</tr> -->
		 							<tr>
		 							<td width="37%" align="right"><label class="branch">UpTo Date</label></td><td width="63%"><div id="todate"></div></td>
					  							...
					  							<table width="100%">
				      								<tr>
					      								<td width="40%" align="left">
					      									<!-- <input type="hidden" id="rdall" name="rdo" onclick="summaryDisable();" value="rdall">
					      									 -->	<input type="hidden" id="rdall" name="rdo" value="rdall">
					      								<label for="rdall" hidden="true" class="branch">Detail</label>
					      								</td>
					      								<td width="60%">&nbsp;</td>
				      								</tr>
				      								<%-- <tr>
