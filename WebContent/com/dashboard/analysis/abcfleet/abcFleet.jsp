...
function funreload(event)
{
	...
	if(dateval==1){ */
		...
		if(grpby1==""){
			$("#fleetgroupdiv").hide();
			$("#fleetdiv").show();
			$("#fleetdiv").load("abcFleetGrid.jsp?branch="+branch+"&fromdate="+fromdate+"&todate="+todate+"&hidbrand="+hidbrand+"&hidmodel="+hidmodel+"&hidgroup="+hidgroup+"&hidyom="+hidyom+"&id=1&hidfleet="+hidfleet);
		}
		else{
			$("#fleetdiv").hide();
			$("#fleetgroupdiv").show();
			$("#fleetgroupdiv").load("abcFleetGroupGrid.jsp?branch="+branch+"&fromdate="+fromdate+"&todate="+todate+"&hidbrand="+hidbrand+"&hidmodel="+hidmodel+"&hidgroup="+hidgroup+"&hidyom="+hidyom+"&id=1&hidfleet="+hidfleet+"&grpby="+grpby1);
		}
...
<td width="77%">
	<table width="100%">
		<tr>
			 <td> <div id="fleetdiv"><jsp:include page="abcFleetGrid.jsp"></jsp:include></div> 
			  <div id="fleetgroupdiv" hidden="true"><jsp:include page="abcFleetGroupGrid.jsp"></jsp:include></div>
			 </td>
