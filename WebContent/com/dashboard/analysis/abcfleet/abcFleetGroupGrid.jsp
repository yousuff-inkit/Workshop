...
var fleetgroupdata;
   if(id=='1'){
	   fleetgroupdata='<%=fleetdao.getFleetGroupData(branch, fromdate, todate, hidbrand, hidmodel, hidyom, temp, hidfleet,grpby)%>'; 
   }
else{
	fleetgroupdata;
}
    ...
    $("#abcFleetGroupGrid").on("bindingcomplete", function (event) {
