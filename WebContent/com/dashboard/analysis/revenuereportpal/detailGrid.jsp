<%@page import="com.dashboard.analysis.revenuereportpal.*"%>
<%
...
$(document).ready(function () {
        ...
        datafields: [
                		...
                		{name : 'estno',type:'string'},
                  		...
                  		{name : 'esttotalvalue',type:'number'},
   						...
   						{name : 'estnettotal',type:'number'},
   						{name : 'estlabourtotal',type:'number'},
   						{name : 'estsparetotal',type:'number'},
   						{name : 'invsparetotal',type:'number'},
   						{name : 'invlabourtotal',type:'number'},
                  		],
    ...
    $("#rrDetailGrid").jqxGrid(
    {
        ...
        columns: [
					...
					{ text: 'EST Spares',hidden:true,datafield:'spares',width:'8%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
					{ text: 'EST Labour',datafield:'estlabourtotal',width:'8%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
					{ text: 'EST Spares',datafield:'estsparetotal',width:'8%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
					{ text: 'Est Total', datafield: 'estnettotal', width: '8%' ,cellsalign:'right',align:'right',cellsformat:'d2',aggregates: ['sum']},
       				{ text: 'Total Excess',datafield:'excesstotal',width:'8%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
       				{ text: 'Total Inv Value',datafield:'totalinv',width:'8%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
       				{ text: 'Total Inv Labour',datafield:'invlabourtotal',width:'8%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
       				{ text: 'Total Inv Spares',datafield:'invsparetotal',width:'8%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
       				{ text: 'NI Purchase Parts',datafield:'actualspare',width:'8%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
       				{ text: 'Net',datafield:'net',width:'8%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
       				{ text: 'Lubricants',datafield:'lubricants',hidden:true,width:'8%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
       				{ text: 'Consumables',datafield:'consumables',hidden:true,width:'8%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
       				{ text: 'Others',datafield:'others',width:'8%',hidden:true,align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
