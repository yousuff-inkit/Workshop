        ...
        columns: [
             ...
             cellsrenderer: function (row, column, value) {
              return "<center><div style='margin:4px;'>" + (value + 1) + "</div></center>";
       				...
       				{ text: 'Client Category',datafield:'category',width:'15%'},
       				{ text: 'Total Inv Value',datafield:'totalinv',width:'13%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
       				{ text: 'Labour',hidden:true,datafield:'invlabourtotal',width:'13%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
       				{ text: 'Spares',hidden:true,datafield:'invsparetotal',width:'13%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
       				{ text: 'Lubricants',hidden:true,datafield:'lubricants',width:'13%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
       				{ text: 'Consumables',hidden:true,datafield:'consumables',width:'13%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
       				{ text: 'Others',hidden:true,datafield:'others',width:'13%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
