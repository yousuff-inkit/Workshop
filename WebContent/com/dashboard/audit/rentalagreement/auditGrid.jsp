...
<script type="text/javascript">
      ...
      var temp='<%=branchval%>';
	  	...
	  	if(temp!='NA'){ 
	  		   data1='<%=ca.rentalAuditGridLoading(branchval,check)%>';  
        ...
        $(document).ready(function () {
            ...
            $("#audit").jqxGrid(
            {
                ...
                columns: [
						...
						{ text: 'Client Name', datafield: 'client', width: '22%' },
						{ text: 'Vehicle', datafield: 'vehicle', width: '17%' },
	                    ...
	                    { text: 'Advance Amt.', datafield: 'advanceamount', cellsformat: 'd2', cellsalign:'right', align:'right', width: '8%'},
	                    { text: 'Security Amt.', datafield: 'securityamount', cellsformat: 'd2', cellsalign:'right', align:'right', width: '8%' },
