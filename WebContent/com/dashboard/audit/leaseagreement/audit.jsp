...
$(document).ready(function () {
	...
	function getLeaseAgreement(){
		...
		var path= "com/operations/agreement/leaseagreement/leaseAgrementDetails.action?mode=view&masterdoc_no="+docno;
		top.addTab( detName,reurl[0]+""+path);
	}	
	
	function funExportBtn(){
		 JSONToCSVCon(data1, 'Lease Agreement Audit List', true);
	 }
...
<td width="20%" >
	...
	<tr><td colspan="2">&nbsp;</td></tr>
	<tr><td colspan="2"><button class="myButton" type="button" id="btnLAG" name="btnLAG" onclick="getLeaseAgreement(event);">Lease Agreement</button>&nbsp;<button class="myButton" type="button" id="btnaudit" name="btnaudit" onclick="funAudit(event);">Audit</button></td></tr>
	<tr><td colspan="2">&nbsp;</td></tr>
	<tr><td colspan="2">&nbsp;</td></tr>
	<tr><td colspan="2">&nbsp;</td></tr> 
	<tr><td colspan="2">&nbsp;</td></tr>
