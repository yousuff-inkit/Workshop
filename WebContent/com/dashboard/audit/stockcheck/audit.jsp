...
$(document).ready(function () {
	...
	function funreload(event){
			 ...
			 $("#jqxVehStockDetailGrid").jqxGrid('clear');
			 $("#jqxVehStockDetailGrid").jqxGrid('disabled', true);
		}
	...
	function funAudit(event){
		...
		if(docno==''){
			 $.messager.alert('Message','Choose an Stock.','warning');
			 return 0;
		 }
...
<td width="80%">
	<table width="100%">
		...
		<tr>
			 <td><div id="auditDetailDiv"><jsp:include page="auditDetailGrid.jsp"></jsp:include></div></td>
		</tr>
	</table>
</tr>
</table>
