...
function funExportBtn(){
	// $("#retunlist").jqxGrid('exportdata', 'xls', 'Purchase Invoice Return List');
	JSONToCSVCon(datass, 'Purchase Invoice Return List', true);
}
...
function funreload(event)
{
	  ...
	  else
	  {
    	 ...
    	 $("#listdiv").load("purchaselistreturnGrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate+"&statusselect="+statusselect+"&acno="+acno);
	  }
}
        ...
        <div class="master-container">
                    ...
                    <div class="filter-card">
                        <table class="release-filter-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="accname" name="accname" value='<s:property value="accname"/>' readonly="readonly" tabindex="-1">
                                </td>
                            </tr>
                        </table>
            ...
            <div class="main-content-area">
                ...
                <div class="grid-content-container">
                    <div id="listdiv"><jsp:include page="purchaselistreturnGrid.jsp"></jsp:include></div>
                </div>
