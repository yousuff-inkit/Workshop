...
function funExportBtn(){
	   $("#grnlistgrid").jqxGrid('exportdata', 'xls', 'Goods Receipt Note List');
	 }
...
function funreload(event)
{
	 ...
	 var acno=$("#acno").val();
	  ...
	  $("#listdiv").load("grnlistGrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate+"&statusselect="+statusselect+"&acno="+acno);
...
<td width="80%">
	<table width="100%">
		<tr>
			 <td><div id="listdiv"><jsp:include page="grnlistGrid.jsp"></jsp:include></div></td>
		</tr>
	</table>
</tr>
</table>
