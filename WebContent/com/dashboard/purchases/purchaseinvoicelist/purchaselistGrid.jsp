...
{ 
	 ...
	 datas='<%=searchDAO.purchaselistsearch(barchval,fromdate,todate,statusselect,acno)%>'; 
	 
	 datass='<%=searchDAO.purchaselistsearchex(barchval,fromdate,todate,statusselect,acno)%>'; 
