...
function funExportBtn(){
	   $("#grrlistgrid").jqxGrid('exportdata', 'xls', 'Goods Receipt Note Return List');
	 }
...
function funreload(event)
{
	  ...
	  $("#listdiv").load("grnreturnlistGrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate+"&statusselect="+statusselect+"&acno="+acno);
...
<%--    <tr><td colspan="2">&nbsp;</td></tr> 
	...
	<option value="PIV">Purchase Invoice</option>   
	</select> </td></tr>
	<tr> --%>
	 <tr><td colspan="2">&nbsp;</td></tr> 
...
<td width="80%">
	<table width="100%">
		<tr>
			 <td><div id="listdiv"><jsp:include page="grnreturnlistGrid.jsp"></jsp:include></div></td>
		</tr>
	</table>
</tr>
</table>
