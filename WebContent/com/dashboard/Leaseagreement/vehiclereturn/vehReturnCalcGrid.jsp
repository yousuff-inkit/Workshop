...
<% ClsVehicleReturnDAO returndao=new ClsVehicleReturnDAO(); 
	...
	String salesvalue=request.getParameter("salesvalue")==null?"":request.getParameter("salesvalue");
...
var calculatedata;
if(id=="1"){
	calculatedata='<%=returndao.calculateDataNew(fleetno,type,id,agmtno,clientacno,salesvalue,stockvehiclestatus)%>';
}
    ...
    $("#vehReturnCalcGrid").jqxGrid(
    {
       ...
       sortable:true,
        columns: [  
					 ...
					 { text: 'Amount',datafield: 'amount',width:'10%',align:'right',cellsalign:'right',aggregates: ['sum'],cellsformat:'d2'}
