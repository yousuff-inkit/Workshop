<%@page import="com.dashboard.leaseagreement.vehiclereturnnew.*" %>
<% ClsVehicleReturnNewDAO returndao=new ClsVehicleReturnNewDAO(); 
...
//    	$('#rentalInvoiceGrid').jqxGrid({ sortable: true});
    ...
    $("#vehReturnGrid").jqxGrid(
    {
       ...
       sortable:true,
        columns: [  
					 ...
					 { text: 'Agmt Close Date', datafield: 'closedate', width: '8%',cellsformat:'dd.MM.yyyy'},
					 { text: 'Stock Vehicle Status',datafield:'stockvehiclestatus',width:'5%',hidden:true}
					]
    ...
    $('#vehReturnGrid').on('rowdoubleclick', function (event){
    	...
    	$('#agmtno,#hidagmtno,#fleetno,#curdepr,#remarks').val('');
    	$('#returndate').jqxDateTimeInput('setDate',new Date());
