...
<td width="20%" >
	...
	<jsp:include page="../../heading.jsp"></jsp:include>
	 ...
	 <tr><td colspan="2" align="center"><input type="radio" name="chktype"  checked="checked" id="chksummary" value="summary" onchange="funChangeType(this.value)"><label class="branch">Summary</label>&nbsp;&nbsp;&nbsp;<input type="radio" name="chktype" id="chkdetail" value="detail" onchange="funChangeType(this.value)"><label class="branch">Detail</label></td></tr>
	   <tr><td colspan="2" align="center">&nbsp;<input type="radio" name="chk"  checked="checked" id="outchk" value="out" onchange="funchkval()"><label class="branch">Out Date</label>&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="chk" id="inchk" value="in" onchange="funchkval()"><label class="branch">In Date</label></td></tr>
