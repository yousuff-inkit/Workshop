...
<td width="80%">
	<table width="100%">
		<tr>
			 <td><div id="detlist"><jsp:include page="alfahimdetailsGrid.jsp"></jsp:include></div></td>
		</tr>
	</table>
</tr>
</table>
