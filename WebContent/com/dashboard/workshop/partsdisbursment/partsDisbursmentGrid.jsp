        ...
        $("#floorMgmtGrid").jqxGrid(
                {
                    ...
                    columns: [
						...
						{ text: 'Pending Cash',datafield: 'pendingcash', width: '10%',pinned:true,cellsformat:'d2',align:'right',cellsalign:'right'},
						{ text: 'Pending Credit',datafield: 'pendingcredit', width: '10%',pinned:true,cellsformat:'d2',align:'right',cellsalign:'right'},
    	              ]
                });
