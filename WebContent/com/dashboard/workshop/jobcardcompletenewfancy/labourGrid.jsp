<%@page import="com.dashboard.workshop.jobcardcompletenewfancy.*" %>
     ...
     var dataAdapter = new $.jqx.dataAdapter(source,
            ...
            $("#labourcostGrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Row No', datafield: 'rowno', width: '13%' ,editable:false,hidden:true},
							{ text: 'Job Desc',datafield:'jobdesc',width:'33%' ,editable:false},
							{ text: 'Remarks', datafield: 'remarks', width: '33%'  ,editable:false},
