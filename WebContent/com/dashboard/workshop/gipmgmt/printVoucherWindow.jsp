...
$(document).ready(function() {
    var otherdetailconfig ="0";
    $.get('getOtherDetailsPrintConfig.jsp',function(data){
    	$('#otherdetailsconfig').val(data);
		otherdetailconfig=$('#otherdetailsconfig').val(); 
 ...
 function funWithJobDetailsPrint(){
 	...
 	function funWithoutJobDetailsPrint(){ 
			...
			var gatedocno=$('#floorMgmtGrid').jqxGrid('getcellvalue',rowindex,'docno');
 			...
 			var brhid=$('#floorMgmtGrid').jqxGrid('getcellvalue',rowindex,'brhid'); 
			var jobdet=0;
			var path= "com/workshop/wsjobcardpal/WSJobCardPrintPalAction1?docno="+jobdocno+"&gatedocno="+gatedocno+"&estdocno="+estdocno+"&branch="+brhid+"&refno="+estdocno+"&jobdet="+jobdet+"&detailarray="+encodeURIComponent(gridarray)+"&otherdetailconfig="+otherdetailconfig;  
			var win= window.open(reurl[0]+path,"_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");		
			win.focus();	
	}
</script>
...
<input type="hidden" name="otherdetailsconfig" id="otherdetailsconfig">
<br/><br/><br/><br/><br/><br/>
  </div>
</body>
</html>