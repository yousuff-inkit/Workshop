        ...
        columns: [
             ...
             cellsrenderer: function (row, column, value) {
              return "<center><div style='margin:4px;'>" + (value + 1) + "</div></center>";
       				...
       				{ text: 'Bill To Acno',datafield:'billtoacno',width:'11%', editable: false,hidden:false},
       				...
       				{ text: 'Amount', datafield: 'amount', width:"5%",cellsformat:'d2',align:'right',cellsalign:'right', editable: false},
       				{ text: 'Disc.%', datafield: 'discountpercent', width:"5%",cellsformat:'d2',align:'right',cellsalign:'right'},
       				{ text: 'Discount', datafield: 'discount', width:"5%",cellsformat:'d2',align:'right',cellsalign:'right'},
       				{ text: 'Net',datafield:'net',width:'5%',cellsformat:'d2',align:'right',cellsalign:'right', editable: false},
       				{ text: 'VAT',datafield:'vat',width:'4%',cellsformat:'d2',align:'right',cellsalign:'right', editable: false},
       				{ text: 'Total',datafield:'total',width:'5%',cellsformat:'d2',align:'right',cellsalign:'right', editable: false},
       				{ text: 'Excess', datafield: 'excess', width:'5%',cellsformat:'d2',align:'right',cellsalign:'right', editable: false},
       				{ text: 'Round Off', datafield: 'roundoff', width:'5%',cellsformat:'d2',align:'right',cellsalign:'right'},
       				{ text: 'Net Bill', datafield: 'netbill', width:'5%',cellsformat:'d2',align:'right',cellsalign:'right', editable: false}
					]
    });
