...
var list = ['Shared', 'Insur.Company'];
 if(id=='1'){
	  amountdata='<%=jobsdao.getAmountData(jobcard,id,seccldocno)%>';
        ...
        columns: [
             ...
             cellsrenderer: function (row, column, value) {
              return "<center><div style='margin:4px;'>" + (value + 1) + "</div></center>";
       				...
       				{ text: 'Discount', datafield: 'discount', width:"6%",cellsformat:'d2',align:'right',cellsalign:'right',hidden:false},
