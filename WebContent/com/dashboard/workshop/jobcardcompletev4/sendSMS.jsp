...
<%
	...
	try{
        ...
        if(smsconfig==1){
        	...
        	String smsstatus=smsaction.doSendSms(session, mobile, clientname, cldocno, "0.0", gipdocno+"", basedate, dtype, brhid, conn);
