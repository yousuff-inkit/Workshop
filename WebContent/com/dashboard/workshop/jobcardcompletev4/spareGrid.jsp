<%@page import="com.dashboard.workshop.jobcardcompletev4.*"%>
<%ClsJobCardCompleteV4DAO gatedao=new ClsJobCardCompleteV4DAO();
	...
	var rendererstring=function (aggregates){
     ...
     var source =
     {
         ...
         datafields: [
				...
				{name : 'lumsumstatus',type:'string'},
				{name : 'chkcomplete',type:'bool'},
				{name : 'detdocno',type:'string'},
				{name : 'dettype',type:'string'},
     ...
     var dataAdapter = new $.jqx.dataAdapter(source,
            ...
            $("#sparePartsNewGrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Lump Sum Status', datafield: 'lumsumstatus', width: '8%',editable:false,hidden:true},
							{ text: 'PSR No', datafield: 'psrno', width: '8%',editable:false, hidden:true },
							{ text: 'Detail Doc No', datafield: 'detdocno', width: '8%',editable:false, hidden:true },
							{ text: 'Detail Type', datafield: 'dettype', width: '8%',editable:false, hidden:true },
							...
							{ text: 'Est.Addition', datafield: 'addition',width:'8%',columntype:'dropdownlist',
 							...
 							{ text: 'Completed', datafield: 'chkcomplete', width: '6%',editable:true,columntype:'checkbox'}
