...
$(document).ready(function () {
	...
	$('#btninvsave').click(function(){
    	...
    	for(var i=0;i<rowsCount;i++){
    		...
    		if(billtoacno=="" || billtoacno=="0" || billtoacno==null || billtoacno=="undefined"){
		...
		for(var j=0;j<rows.length;j++){
			...
			var insurcomp=$('#insurcomp').val();
			var chkclaim=$('#estimationGrid').jqxGrid('getcellvalue',j,'chkclaim');
			if(insurcomp=='0' && chkclaim==true){
				$.messager.alert('Warning','Insurance Company Mandatory for claim');
				return false;
			}
		}
