        ...
        $("#floorMgmtGrid").jqxGrid(
                {
                    ...
                    columns: [
    					...
    					{ text: 'WT1', datafield: 'z1', width: '4%',cellclassname: cellclassname1,
    					...
    					{ text: 'WT2', datafield: 'z2', width: '4%',cellclassname: cellclassname2,
    						renderer: function (defaultText, alignment, height) {
    							//alert(defaultText+"::"+alignment+"::"+height);
    					...
    					{ text: 'DNT', datafield: 'z3', width: '4%',cellclassname: cellclassname3,
    						renderer: function (defaultText, alignment, height) {
    							//alert(defaultText+"::"+alignment+"::"+height);
    					...
    					{ text: 'PNT', datafield: 'z4', width: '4%',cellclassname: cellclassname4,
    						renderer: function (defaultText, alignment, height) {
    							//alert(defaultText+"::"+alignment+"::"+height);
    					...
    					{ text: 'DRY', datafield: 'z5', width: '4%',cellclassname: cellclassname5,
    						renderer: function (defaultText, alignment, height) {
    							//alert(defaultText+"::"+alignment+"::"+height);
    					...
    					{ text: 'POL', datafield: 'z6', width: '4%',cellclassname: cellclassname6,
    						renderer: function (defaultText, alignment, height) {
    							//alert(defaultText+"::"+alignment+"::"+height);
    					...
    					{ text: 'FIT', datafield: 'z7', width: '4%',cellclassname: cellclassname7,
    						renderer: function (defaultText, alignment, height) {
    							//alert(defaultText+"::"+alignment+"::"+height);
    					...
    					{ text: 'MWT', datafield: 'z8', width: '4%',cellclassname: cellclassname8,
    						renderer: function (defaultText, alignment, height) {
    							//alert(defaultText+"::"+alignment+"::"+height);
    					...
    					{ text: 'MEC', datafield: 'z9', width: '4%',cellclassname: cellclassname9,
    						renderer: function (defaultText, alignment, height) {
    							//alert(defaultText+"::"+alignment+"::"+height);
    					...
    					{ text: 'WAS', datafield: 'z10', width: '4%',cellclassname: cellclassname10,
    						renderer: function (defaultText, alignment, height) {
    							//alert(defaultText+"::"+alignment+"::"+height);
    					...
    					{ text: 'PDI', datafield: 'z11', width: '4%',cellclassname: cellclassname11,
    						renderer: function (defaultText, alignment, height) {
    							//alert(defaultText+"::"+alignment+"::"+height);
    					...
    					{ text: 'DEL', datafield: 'z12', width: '4%',cellclassname: cellclassname12,
    						renderer: function (defaultText, alignment, height) {
    							//alert(defaultText+"::"+alignment+"::"+height);
    					...
    					{ text: 'OTS', datafield: 'z13', width: '4%',cellclassname: cellclassname13,
    						renderer: function (defaultText, alignment, height) {
    							//alert(defaultText+"::"+alignment+"::"+height);
						...
						{ text: 'QSE', datafield: 'z14', width: '4%',cellclassname: cellclassname14,
    						renderer: function (defaultText, alignment, height) {
    							//alert(defaultText+"::"+alignment+"::"+height);
