...
var floordata=[];
if(id=="1"){
	floordata='<%=floordao.getGOPMgmtData(fromdate,todate,id,brhid)%>';
}
	$(document).ready(function(){
        ...
        $("#gateoutpassdetailsGrid").jqxGrid(
                {
                	width: '100%',
                    height: 450,
                    source: dataAdapter,
				 ...
				 $('#gateoutpassdetailsGrid').on('rowdoubleclick', function (event) 
				  { 
				    var args = event.args;
				    // row's bound index.
				    ...
				    var ev = event.args.originalEvent;
				 	...
				 	var docno=$('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'docno');
				 	$('#docno').val(docno);
			        getfileattachConfig(docno);
				 	$('#estdocno,#refno').val($('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'estdocno'));
				 	$('#gatedocno').val($('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'docno'));
				 	$('#branch').val($('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'brhid'));
					/* $('#checklistdiv').load('checklistGrid.jsp?gatedocno='+$('#gatedocno').val());*/

				 	var vocno=$('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'vocno');
				 	var refname=$('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'refname');
				 	var cldocno=$('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'cldocno');
				 	var insurcldocno=$('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'insurcldocno');
				 	...
				 	$('#createclientmobile').val($('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'gipclientmobile'));
				 	$('#createclientemail').val($('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'email'));
				 	$('#createclientaddress').val($('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'gipclientaddress'));
				 	$('#createclienttrn').val($('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'gipclienttrn'));
				 	
				 	$('#policereportno').val($('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'policerep'));
				 	$('#hidcmbdrvlicence').val($('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'drvlicence'));
				 	$('#hidcmbemiratesid').val($('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'emiratesid'));
				 	$('#hidcmbcolor').val($('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'colorid'));
				 	$('#hidcmbclaimtype').val($('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'faulttype'));
				 	$('#hidcmbpriority').val($('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'priority'));
				 	$('#hidmarketingperson').val($('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'estimatorid'));
				 	$('#marketingperson').val($('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'estimator'));
				 	$('#hidcmbinstype').val($('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'insutype'));
				 	$('#chklistremarks').val($('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'chklistremarks'));
				 	$('#hidreferencedby').val($('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'referencedby'));
				 	$('#referencedby').val($('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'referencedbyname'));

					/* $('#policereportdate').jqxDateTimeInput('setDate',$('#gateoutpassdetailsGrid').jqxGrid('getcellvalue', boundIndex, "policerepdate"));
	                $('#regexpirydate').jqxDateTimeInput('setDate',$('#gateoutpassdetailsGrid').jqxGrid('getcellvalue', boundIndex, "regexpirydate")); */
	                setValues();

				 	
				 	var catid=$('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'gipclientcat');
				 	$('#cmbcreateclientcat').val(catid).trigger('change');
				 	var virtual=$('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'chkvirtual');
				 	if(virtual==true){
				 	...
				 	$('#qotpono').val($('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'pono'));
				 	document.getElementById("qotexcessamt").disabled=true;
				 	if($('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'chkexcess')=='1'){
				 		document.getElementById("chkqotexcess").checked=true;
				 		document.getElementById("qotexcessamt").value=$('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'excessamt');
					...
					$.get('getEstAddCount.jsp',
						{
							estdocno:$('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'estdocno'),
							brhid:$('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'brhid')
						},
						function(data){
							...
							$('.otherpanel .dropdown .dropdown-menu li').click(function(index,value){
								...
								if(addition=="0"){
									...
									var docno=$('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'estdocno');
									var estvocno=$('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'estvocno');
									var gatedoc=$('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'docno');
									var brhid=$('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'brhid');
									...
									var reurl=url.split("com/");
									var docno=$('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'estdocno');
									var jobdocno=$('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'jobdocno');
									var estvocno=$('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'estvocno');
									var gatedoc=$('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'docno');
									var brhid=$('#gateoutpassdetailsGrid').jqxGrid('getcellvalue',boundIndex,'brhid');
...
<div id="gateoutpassdetailsGrid"></div>