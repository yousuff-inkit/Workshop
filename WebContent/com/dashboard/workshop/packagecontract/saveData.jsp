...
try{
	...
	String strinsertmaster="insert into ws_packagecontract(doc_no,voc_no,date, cldocno, packagedocno, fromdate, todate, remarks, brhid, userid, status)values("+docno+","+vocno+",CURDATE(),"+cldocno+","+packagedocno+",'"+sqlfromdate+"','"+sqltodate+"','"+remarks+"',"+brhid+","+userid+",3)";
