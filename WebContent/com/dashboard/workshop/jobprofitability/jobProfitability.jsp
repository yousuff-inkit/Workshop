...
function funreload(event)
{
  ...
  //  alert(jcno+"  "+techid);
    	...
    	$("#overlay, #PleaseWait").show(); 
   	   	$("#revenuereportdiv").load("detailGrid.jsp?fromdate="+fromdate+"&todate="+todate+"&id=1"+"&hidclient="+hidclient+"&hidclientslm="+hidclientslm+"&hidrepairtype="+hidrepairtype+"&chkfollowup="+chkfollowup);
...
/*function setRemove(){
	...
	function funExportBtn(){
		...
		JSONToCSVConvertor(rrexportdata, 'Job Profitability List', true);
		//alert("inside Export");
		}
...
<td width="20%" align="center">
	...
	<table width="100%">
		...
		<tr>
		<td width="37%" align="right"><label class="branch">INV Date</label></td>
		<td colspan="2"><input type="checkbox" id="chckfollowup" name="chckfollowup" value="" onchange="followupcheck();" onclick="$(this).attr('value', this.checked ? 1 : 0)" /> 
                                 <input type="hidden" id="hidchckfollowup" name="hidchckfollowup" value='<s:property value="hidchckfollowup"/>'/></td>
		...
		<%-- 	<tr><td colspan="2">
				  <fieldset>
				      ...
				      <option value="dly">Daily</option><option value="mly">Monthly</option><option value="yly">Yearly</option>
					  </select>
				...
				<%--<tr><td colspan="2">
				 <table width="100%">
				  <tr>
					...
					<option value="client">Client</option><option value="clientslm">Salesman</option><option value="repairtype">Repair Type</option></select></td>
