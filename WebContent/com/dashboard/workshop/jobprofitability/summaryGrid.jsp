...
if(id=='1'){
	rrdetaildata=<%=DAO.getSummaryData(fromdate,todate,hidclient,hidclientslm,hidrepairtype,id,sumtype,"0")%>;
        ...
        columns: [
             ...
             cellsrenderer: function (row, column, value) {
              return "<center><div style='margin:4px;'>" + (value + 1) + "</div></center>";
       				...
       				{ text: 'Refname',datafield:'refname',width:'17%'},
       				{ text: 'Total Inv Value',datafield:'totalinv',width:'13%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
       				{ text: 'EST Labour',datafield:'labour',width:'13%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
       				{ text: 'EST Spares',datafield:'spares',width:'13%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
