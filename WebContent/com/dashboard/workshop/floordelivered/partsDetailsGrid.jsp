...
if(id=="1"){
	partsdetailsdata='<%=floordao.getPartsData(id,jobcarddocno,rowno)%>';
}
        ...
        $("#partsDetailsGrid").jqxGrid(
                {
                    ...
                    //Add row method
                    columns: [
						{ text: 'Sr. No.',datafield: '',columntype:'number', width: '10%',cellclassname: cellclassname,cellsrenderer: function (row, column, value) {
    					...
    					{ text: 'Pur. Qty',datafield: 'outqty', width: '10%',cellsformat:'d',cellclassname: cellclassname},
