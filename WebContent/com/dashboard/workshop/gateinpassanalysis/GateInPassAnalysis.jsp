...
function funreload(event)
{
    ...
    $("#overlay, #PleaseWait").show();
   	$("#countdiv").load("countGrid.jsp?fromdate="+fromdate+"&todate="+todate+"&id=1&branch="+branch+"&cldocno="+cldocno+"&gipdocno="+gipdocno+"&regno="+regno);
}
...
function funExportBtn(){
    $("#detaildiv").excelexportjs({
        ...
        worksheetName:"Analysis of "+document.getElementById("docstatus").value
    });
}
        ...
        <div class="master-container">
            ...
            <div class="sidebar-filters">
                <div class="sidebar-scroll-content">
                    ...
                    <!-- Secondary Grid embedded in Sidebar -->
