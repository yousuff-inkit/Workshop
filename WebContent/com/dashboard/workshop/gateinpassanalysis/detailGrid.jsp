...
<%
ClsGateInPassAnalysisDAO gatedao=new ClsGateInPassAnalysisDAO();
...
if(id=='1'){
	detaildata='<%=gatedao.getDetailData(id,fromdate,todate,cldocno,gipdocno,regno,process,branch)%>';
}
else{
	detaildata=[];
	detailexceldata=[];
