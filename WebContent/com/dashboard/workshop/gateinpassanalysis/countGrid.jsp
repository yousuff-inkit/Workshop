...
<script type="text/javascript">
  ...
  var countdata;
  if(id=="1"){
	  countdata='<%=DAO.getCountData(id,fromdate,todate,cldocno,gipdocno,regno,branch)%>';
  }
		$(document).ready(function () { 	
          ...
          $('#countGrid').on('rowdoubleclick', function (event) {
                ...
                $('#detaildiv').load('detailGrid.jsp?process='+process+'&id='+id+'&branch='+branch+'&fromdate='+fromdate+'&todate='+todate+'&cldocno='+cldocno+'&gipdocno='+gipdocno+'&regno='+regno);
            }); 
        });
    </script>
