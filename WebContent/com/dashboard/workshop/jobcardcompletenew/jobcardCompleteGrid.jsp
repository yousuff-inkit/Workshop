...
if(id=='1'){
gatedata='<%=gatedao.getJobcardData(clientname,fromdate,todate,id)%>';
}
else{
	gatedata=[];
gateexceldata=[];
...
$(document).ready(function () {
    ...
    $("#jqxJobcardCompleteGrid").jqxGrid(
    {
       ...
       columnsresize: true,
        columns: [
       				...
       				{ text: 'Job Advisor',datafield:'jobadvisor',width:'10%'},
       				{ text: 'Service Advisor',datafield:'serviceadvisor',width:'10%'},
    ...
    $('#jqxJobcardCompleteGrid').on('rowdoubleclick', function (event) 
      		{ 
			  	...
			  	document.getElementById("txtremarks").value = $('#jqxJobcardCompleteGrid').jqxGrid('getcellvalue', rowindex, "remarks");
