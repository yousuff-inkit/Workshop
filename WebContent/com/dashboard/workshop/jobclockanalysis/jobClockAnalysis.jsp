		   ...
		   <td><div id="todate"></div></td>
			...
			<tr><td colspan="2">
				  <fieldset>
				      ...
				      <option value="">--Select--</option><option value="tech">Technician</option><option value="jc">Job Card</option>
					  </select>
...
<td width="80%">
	<table width="100%">
		<tr>
			 <td><div id="jobclockanalysisdiv"><jsp:include page="jobClockAnalysisGrid.jsp"></jsp:include></div></td>
