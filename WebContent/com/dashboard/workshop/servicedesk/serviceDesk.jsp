    ...
    <div class="row rowgap">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="primarypanel custompanel">
        	...
        	<button type="button" class="btn btn-default" id="btninfo" data-toggle="tooltip" title="Info" data-placement="bottom">
        		<i class="fa fa-info-circle dropdown-toggle " aria-hidden="true" data-toggle="dropdown"></i>
        		<ul class="dropdown-menu">
    				<li><a href="#">P-Parked</a></li>
    				<li style="background-color:#79B6FF"><a href="#">S-Started</a></li>
    				<li style="background-color:#79FFA0"><a href="#">C-Completed</a></li>
    				<li style="background-color:#FF8579"><a href="#">N-Not Attended</a></li>
  				</ul>
        	</button>
        ...
        <div class="actionpanel custompanel">
          <button type="button" class="btn btn-default" id="btnvehmovupdate" data-target="#modalvehmovupdate" style="display:none;"><i class="fa fa-car " aria-hidden="true" data-toggle="tooltip" title="Vehicle Movement Update" data-placement="bottom"></i></button>
          <button type="button" class="btn btn-default" id="btnjobstatus"  data-target="#modaljobstatus"  style="display:none;"><i class="fa fa-filter " aria-hidden="true" data-toggle="tooltip" title="Job Status" data-placement="bottom"></i></button>
          <button type="button" class="btn btn-default" id="btnteamselection" data-target="#modalteamselection" style="display:none;"><i class="fa fa-users " aria-hidden="true" data-toggle="tooltip" title="Team Selection" data-placement="bottom"></i></button>
        ...
        <div class="warningpanel custompanel">
          <div class="btn-group" role="group">
          	<button type="button" class="btn btn-default" id="btndelivery" data-toggle="tooltip" title="To Be Delivered" data-placement="bottom" data-filtervalue="1" data-datafield="deliverystatus" data-filtertype="stringfilter" data-filtercondition="contains"><i class="fa fa-location-arrow " aria-hidden="true"></i></button>
          	<span class="badge badge-notify badge-delivery">3</span>
          </div>
          <div class="btn-group" role="group">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#btnexcel').click(function(){
        	...
        	JSONToCSVCon(exceldata, 'Service Desk List', true); --%>
        	$("#floorMgmtGrid").excelexportjs({
        		...
        		worksheetName: "Service Desk List"
        	});
        });
...
function getInitData(){
		...
		x.open("GET","../floormgmt/getInitData.jsp",true);
		x.send();
    }
  </script>
</body>
