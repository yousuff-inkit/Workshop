	...
	$(document).ready(function(){
        ...
        var source =
        {
            ...
            datafields: [
 						...
 						{name : 'disbursconfirmstatus',type:'number'}
        ...
        var cellclassname = function (row, column, value, data) {
        	if(data.disbursconfirmstatus==1){
            	return "greenClass";
            }
        };
        ...
        $("#cashGrid").jqxGrid(
                {
                    ...
                    columns: [
    					...
    					{ text: 'Confirm Status',datafield: 'disbursconfirmstatus', width: '57%',hidden:true,cellclassname: cellclassname,editable:false},
			...
			$('#cashGrid').on('rowselect', function (event) 
    		{
    		    ...
    		    var disbursconfirmstatus=$('#cashGrid').jqxGrid('getcellvalue',rowBoundIndex, "disbursconfirmstatus");
    		    if(disbursconfirmstatus==1){
    		    ...
    		    if (event.args.rowindex.length === rowsCount) {
    		    	for(var i=0;i<rowsCount;i++){
    		    		var disbursconfirmstatus=parseInt($('#cashGrid').jqxGrid('getcellvalue',i,'disbursconfirmstatus'));
    		    		if(disbursconfirmstatus>0){
