...
<table width="100%">
   ...
   <td width="63%"><input type="text" name="txtremarks" id="txtremarks" style="height:20px;width:90%;" value='<s:property value="txtremarks"/>' ></td>
 					...
 					<tr>
 						<td align="right"><label class="branch" hidden=true>Account From</label></td>
 						<td align="left"><input  hidden=true type="text" name="fromaccount" id="fromaccount" readonly placeholder="Press F3 to Search" onkeydown="getFromAccount();" style="height:18px;"></td>
 					</tr>
 					<tr>
 						<td colspan="2"><input  hidden=true type="text" name="fromaccountname" id="fromaccountname" style="width:100%;height:18px;" readonly disabled></td>
 					</tr>
 					<input type="hidden" name="fromacno" id="fromacno" >
 					<tr>
 						<td align="right"><label class="branch"  hidden=true>Account To</label></td>
 						<td align="left"><input  hidden=true type="text" name="toaccount" id="toaccount" readonly placeholder="Press F3 to Search" onkeydown="getToAccount();" style="height:18px;"></td>
 					</tr>
 					<tr>
 						<td colspan="2"><input type="text"  hidden=true name="toaccountname" id="toaccountname" style="width:100%;height:18px;" readonly disabled></td>
 					</tr>
