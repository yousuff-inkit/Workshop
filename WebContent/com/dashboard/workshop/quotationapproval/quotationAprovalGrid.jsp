        ...
        columns: [
             ...
             cellsrenderer: function (row, column, value) {
              return "<center><div style='margin:4px;'>" + (value + 1) + "</div></center>";
       				...
       				{ text: 'Vehicle Details',datafield:'vehicledetails',width:'36.5%'},
       				{ text: 'Labour Total',datafield:'labouttot',width:'9%',align:'right',cellsalign:'right',cellsformat:'d2'},
       				{ text: 'Spare Total',datafield:'sparetot',width:'9%',align:'right',cellsalign:'right',cellsformat:'d2'},
       				{ text: 'Discount',datafield:'discount',width:'9%',align:'right',cellsalign:'right',cellsformat:'d2'},
       				{ text: 'Net Total',datafield:'nettotal',width:'9%',align:'right',cellsalign:'right',cellsformat:'d2'},
       				{ text: 'Show Details',datafield:'view',width:'9%',columntype:'button'},
       				{ text: 'Brhid', datafield:'brhid',hidden:true},
       				{ text: 'gipno', datafield:'gipno',hidden:true},
       				{ text: 'labaddition', datafield:'labaddition',hidden:true},
    ...
    var spadd;
     ...
     function funEstmView(docno,gipno1){
    	  ...
    	  var url=document.URL;
			...
			var path= "com/workshop/wsestimationnew/estimiviw.action?mode=view&docno="+docno+"&gipnoo="+gipno1+"&id=2";
     ...
     function funAdditionEstmView(docno,jcno,add){
   	  ...
   	  var url=document.URL;
			...
			var path= "com/workshop/estimationaddition/saveEstimationAddition.action?mode=view&docno="+docno+"&jcno="+jcno+"&addition="+add+"&id=2";
			top.addTab( detName,reurl[0]+""+path);
   	 }
