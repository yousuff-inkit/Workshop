...
<!-- 		<div style="width:100%;  float:left; text-align:center;">
	 ...
	 <form action="printQuotationAproval" method="get">
		...
		<table width="100%" border="0">
		  ...
		  <tr>
		    ...
		    <td width="15%"><strong>Service Advisor</strong></td>
		    <td>: <label id="lblserviceadvisor" name="lblserviceadvisor"><s:property value="lblserviceadvisor"/></label></td>
		  </tr>
	...
	<div>
		...
		<thead>
		  ...
		  <tr>
		    ...
		    <td width="20%" align="right"><strong>Unit Price</strong></td>
		     <td width="20%" align="right"><strong>Total Amount</strong></td>
		  ...
		  <tbody>
		    <s:iterator var="jbcostarray" status="arr" value='#request.JBCOSTPRINTCARFARE' >
								...
								<s:iterator status="arr" value="#jbcostarray" var="jbcostrow"> 
									<tr>
 										...
 										<s:iterator status="arr" value="#jbcostrow.split('::')" var="jbcost"> 
											<s:if test="#arr.index<2">
												<td align="left"><s:property value="#jbcost"/></td>
											</s:if>
											<s:else >
		...
		<table width="100%" border="1" style="border-collapse: collapse">
		  <tr>
		    <td width="15%" align="right"><strong>Total Parts</strong></td>
		    <td width="15%" align="right"><strong>Total Labour</strong></td>
		    <td width="15%" align="right"><strong>VAT</strong></td>
		    <td width="55%" align="center"><strong>Total Amount</strong></td>
		  </tr>
		  <tr>
		...
		<h3>Note:Above Quoted prices are valid for 30 days only. </h3>	
	</div>
	<br><br>
