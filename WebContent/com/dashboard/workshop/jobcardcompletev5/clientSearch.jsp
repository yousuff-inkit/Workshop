...
<script type="text/javascript">
	...
	function getdata(clientname,check){
		var clientmode='<%=clientmode%>';
		 $("#clientSearchGridDiv").load('clientSearchGrid.jsp?clientname='+clientname.replace(/ /g, "%20")+'&check='+check+'&clientmode='+clientmode);
	}
...
<table width="100%">
  ...
  <tr>
    <td colspan="5"><div id="clientSearchGridDiv"><jsp:include page="clientSearchGrid.jsp"></jsp:include></div></td>
  </tr>
</table>
  </div>
</body>
