...
<table width="100%" >
  <tr >
   ...
   <tr>
    ...
    <td align="left" width="70%"><input type="text" name="partno" id="partno"  style="height:120%;" value='<s:property value="partno"/>'></td>
    ...
    <td align="left" width="70%"><input type="text" name="stock" id="stock"  style="height:120%;" value='<s:property value="stock"/>'></td>
