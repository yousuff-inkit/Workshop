            ...
            var source =
            {
                ...
                datafields: [
										...
										{name : 'description', type: 'string'  },
                   						...
                   						{name : 'estimationvocno',type:'string'},
            ...
            $("#jqxFleetGrid").jqxGrid(
            {
                ...
                columns: [
                          { text: 'SL#', sortable: false, filterable: false, editable: false,
							  ...
							  { text: 'Docno', datafield: 'voc_no', width: '8%'},
							  ...
							  { text: 'Reg No', datafield: 'regno', width: '8%' },
								...
								{ text: 'Model', datafield: 'model', width: '8%' },
								  ...
								  { text: 'Estimation No.', datafield: 'estimationvocno', width: '7%' },
								  ...
								  { text: 'Service Advisor', datafield: 'serviceadvisor', width: '16%' },
								  { text: 'Estimator', datafield: 'estimator', width: '14%' },
								  { text: 'Bill To', datafield: 'billto', width: '14%' },
	              ]
            });
