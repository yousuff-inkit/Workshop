...
<%@page import="javax.servlet.http.HttpSession" %>
 ...
 String jcno = request.getParameter("jcno")==null?"0":request.getParameter("jcno");%>
<script type="text/javascript">
        
		var id='<%=id%>';
		var data4;
		if(id=='1'){
			 data4= '<%=DAO.jobCardData(date,jcno,id)%>';
		}else{
			data4=[];
		}
    	   ...
    	   // prepare the data
            ...
            $("#jcSearchGrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Doc No',  datafield: 'voc_no', width: '30%' },
             ...
             $('#jcSearchGrid').on('rowdoubleclick', function (event) {
            	...
            	var rowindex1=event.args.rowindex;
             	...
             	document.getElementById("jcno").value =$('#jcSearchGrid').jqxGrid('getcellvalue',rowindex1,'doc_no');
