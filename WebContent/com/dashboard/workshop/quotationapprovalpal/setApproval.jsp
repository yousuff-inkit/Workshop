...
try{
	 ...
	 conn.setAutoCommit(false);
		...
		String strSql1 = "update ws_estlabour set approved="+action+" where rdocno="+estDocno+" and confirmed=1 and approved=0 and addition="+addition;
		String strSql2 = "update ws_estspare set approved="+action+" where rdocno="+estDocno+" and confirmed=1 and approved=0 and addition="+addition;
