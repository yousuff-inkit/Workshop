	...
	/*   function  funPrint()
	 ...
	 function hidebutton(){
	    ...
	    function getJobcard(){
			...
			var path= "com/workshop/wsjobcard/jobcardviw.action?mode=view&docno="+jobdocno+"&id=2";
			top.addTab( detName,reurl[0]+""+path);
		}	
	    function getEstimationadd(){
			...
			var path= "com/workshop/estimationalice/estimation.jsp?id=3&gipno="+gipno;
			top.addTab( detName,reurl[0]+""+path);
		}	
...
function getEstimation(){
			...
			var detName= "Estimation";
			var path= "com/workshop/wsestimationalice/estimiviw.action?mode=view&docno="+estimno+"&gipnoo="+gipnoo+"&id=2";
			top.addTab( detName,reurl[0]+""+path);
		}
...
<tr>
<td colspan="2">	
	<fieldset width="100%"><legend>Add</legend>
	<table>
	<tr>
	 <td align="center"><input type="button" class="myButton" name="estimate" id="estimate"  value="Estimation" onclick="checkStatusAjax();"></td>
	<td> <input type="button" class="myButton" name="jobcart" id="jobcart"  value="Job Card" onclick="getJobcardadd();"></td>
