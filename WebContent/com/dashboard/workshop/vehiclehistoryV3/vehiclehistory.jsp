...
<script type="text/javascript">
	...
	function funreload(event){
		...
		$('#detaillabourdiv').load('detailLabourGrid.jsp?branchval='+branchval+'&regno='+regno+'&pltid='+encodeURIComponent(pltid)+'&fromdate='+fromdate+'&todate='+todate+'&id=1');
		$('#detailsparediv').load('detailSpareGrid.jsp?branchval='+branchval+'&regno='+regno+'&pltid='+encodeURIComponent(pltid)+'&fromdate='+fromdate+'&todate='+todate+'&id=1'); 
	...
	function getProduct(){
	 ...
	 function funExportBtn(){
		 ...
		 $("#detailSpareGrid").excelexportjs({
				containerid: "detailSpareGrid",   
				datatype: 'json',
				dataset: null,
				gridId: "detailSpareGrid",
				columns: getColumns("detailSpareGrid") ,   
				worksheetName:"Vehicle history Parts Reports"  
			});  
		 $("#detailLabourGrid").excelexportjs({
				containerid: "detailLabourGrid",   
				datatype: 'json',
				dataset: null,
				gridId: "detailLabourGrid",
				columns: getColumns("detailLabourGrid") ,   
	...
	function funPrintalfahin(){
        ...
        var win= window.open(reurl[0]+"printVehicleHistoryV3?dtype="+dtype+'&branchval='+branchval+'&regno='+regno+'&pltid='+pltid+'&fromdate='+fromdate+'&todate='+todate+'&id=1&cmbrepairtype='+cmbrepairtype,"_blank","top=150,left=250,Width=1020,Height=500,location=no,scrollbars=no,toolbar=yes");
        win.focus();
    			...
    			<fieldset style="background: #ECF8E0;">
					<table width="100%">
						<jsp:include page="../../heading.jsp"></jsp:include>
	 					<tr>
	 						<td width="20%" align="right" ><label class="branch">From</label></td>
                    	...
                    	<tr><td align="right"><label class="branch">Repair Type</label></td><td align="left"><select name="cmbrepairtype" id="cmbrepairtype" style="height:20px;width:90%;"><option value="">--Select--</option></select></td></tr>
     					<tr><td colspan="2" align="center"><textarea id="clientinfo" style="height:100px;width:200px;font: 10px Tahoma;resize:none" name="clientinfo"  readonly="readonly"><s:property value="clientinfo" ></s:property></textarea></td></tr>
       					<tr hidden="true">
							...
							<td align="left">
								<input type="text" id="txtpartno" name="txtpartno" style="width:60%;height:20px;" readonly="readonly" placeholder="Press F3 to Search" value='<s:property value="txtpartno"/>' onKeyDown="getProduct(event);"/>
								<input type="hidden" id="psrno" name="psrno" value='<s:property value="psrno"/>' />
							</td>
						</tr>
						<tr hidden="true">
							<td>&nbsp;</td>
							<td><input type="text" id="txtproductname" name="txtproductname" style="width:100%;height:20px;" readonly="readonly" value='<s:property value="txtproductname"/>' tabindex="-1"/></td>
						</tr> 
						...
						<tr><td colspan="2" align="center"><button class="myButton" type="button" id="btnPrintalfahin" name="btnPrintalfahin" onclick="funPrintalfahin(event);">Print</button>&nbsp;&nbsp;<button class="myButton" type="button" id="btnprinttype" name="btnprinttype" onclick="funPrintRepairType(event);">Print Repair Type</button></td></tr>    
 						<tr><td colspan="2" align="center">
 								<button class="myButton" type="button" id="btnclear" name="btnclear" onclick="funClear(event);">Clear</button>
 								<button style="display:none;" class="myButton" type="button" id="btnPrintpartwise" name="btnPrintpartwise" onclick="funPrintpartwise(event);">Part Wise</button></td></tr>
 						<tr>
 							<td colspan="2">
     					...
     					<tr><td><div style="width:100%;height:170px;"></div></td></tr>
  					</table>
				</fieldset>
			</td>
			<td width="80%" >
				<fieldset><legend>Services</legend>
					<table width="100%" >
						<tr><td><div id="detaillabourdiv"><jsp:include page="detailLabourGrid.jsp"></jsp:include></div></td></tr>
					</table>
				</fieldset>
				<fieldset><legend>Spare Parts</legend>
					<table width="100%" >
						<tr><td><div id="detailsparediv"><jsp:include page="detailSpareGrid.jsp"></jsp:include></div></td></tr>
					</table>
				</fieldset>
				<%-- <div id="detailgriddiv"><jsp:include page="detailNewGrid.jsp"></jsp:include></div> --%>
			</td>
		</tr>
	</table>
</div>
