...
function funreload(event)
{
	...
	function viewEstimation(event){
		...
		var reurl=url.split("com/");
		 ...
		 if(labaddition==0 || spaddition==0){
			...
			var path= "com/workshop/wsestimationfancy/estimationFancyView.action?mode=view&docno="+docno+"&gipnoo="+gipno+"&id=2";
	...
	function funConfirm(){
		...
		var labaddition=$('#labaddition').val();
		
		//if((labaddition.equalsIgnoreCase("undefined"))||(labaddition.equalsIgnoreCase(""))||(labaddition.equalsIgnoreCase("0"))){
		...
		//alert("labaddition in jsp=="+labaddition);
	...
	//	alert("insuretype in jsp=="+insuretype);
...
// 				alert(items);
		...
		x.open("GET", "confirmation.jsp?docno="+docno+"&brhid="+brhid+"&labaddition="+labaddition+"&insuretype="+insuretype, true);
		x.send();
	}
	function funExportBtn(){
...
<input type="text" name="hidlabaddition" id="hidlabaddition"/>
