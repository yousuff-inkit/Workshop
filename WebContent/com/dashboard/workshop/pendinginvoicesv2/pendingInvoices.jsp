...
{
	$('#frmPendingInvoices input,select,textarea').val('');
	$('#pendingInvoicesGrid,#followupGrid').jqxGrid('clear');
	$('#followupdate,#todate').jqxDateTimeInput('setDate',new Date());
						    ...
						    <fieldset style="background: #ECF8E0;">
								<table  width="100%"  >
									<jsp:include page="../../heading.jsp"></jsp:include>
								  	...
								  	<tr><td colspan="2" align="center"><label id="lblname" style="color:blue;font-size:10px"></label></td></tr>
									...
									<tr><td colspan="2" align="center">&nbsp;<button type="button" class="myButtons"  name="btnPrint" id="btnPrint"   class="myButtons" onclick="funPrintBtn();">Print</button></td></tr>
