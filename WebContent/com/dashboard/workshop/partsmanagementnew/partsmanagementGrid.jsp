...
//alert(check);
 if(check!=0){  
	floordata='<%=partsdao.getPartsMgmtData(id,brhid)%>';
	floordataexcel='<%=partsdao.getPartsMgmtDataexcel(id)%>';
        ...
        $("#floorMgmtGrid").jqxGrid(
                {
                    ...
                    columns: [
						...
						{ text: 'Job Date',datafield: 'jobdate', width: '6%',pinned:true,cellsformat:'dd.MM.yyyy',cellclassname: cellclassname},
    					...
    					{ text: 'Vehicle Details',datafield: 'vehicledetails', width: '24%',pinned:true,cellclassname: cellclassname},
    					{ text: 'Bill To',datafield: 'billto', width: '15%',pinned:true,cellclassname: cellclassname},
    					{ text: 'Client',datafield: 'refname', width: '15%' ,pinned:true,cellclassname: cellclassname},
    					{ text: 'Service',datafield:'service',width: '7%',pinned:true,cellclassname: cellclassname},
						...
						{ text: 'Est.Hrs', datafield: 'esthrs', width: '5%',cellclassname: cellclassname},
						{ text: 'Actual Hrs', datafield: 'actualhrs', width: '5%',cellclassname: cellclassname},
						{ text: 'Hrs Diff', datafield: 'hrsdiff', width: '5%',cellclassname: cellclassname},
						...
						{ text: 'Part Remarks', datafield: 'partremarks', width: '8%',cellclassname: cellclassname},
						...
						{ text: 'refno', datafield: 'refno', width: '8%',cellclassname: cellclassname},
