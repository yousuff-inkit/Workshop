...
<%--	<jsp:include page="../../../common/printHeader.jsp"></jsp:include> --%>
	 ...
	 <form action="printQuotationAproval" method="get">
		...
		<table width="100%" border="0">
		  ...
		  <tr>
		    ...
		    <td width="25%" rowspan="6" style="vertical-align:top">: <label id="lblModel" name="lblModel"><s:property value="lblModel"/>
	...
	<div>
		...
		<thead>
		  <tr >
		    <th colspan="10" scope="col" Style="border-width: 2px;">Spare Parts</th>
		  </tr>
		  <tr>
		    <td width="5%"><strong>S#</strong></td>
		    <td width="38%"><strong>Description</strong></td>
		    <td width="9%"><strong>Qty</strong></td>
		    <td width="10%"><strong>Genuine Rate</strong></td>
		    <td width="10%"><strong>Market Rate</strong></td>
		    <td width="10%"><strong>Used Rate</strong></td>
		    <td width="10%"><strong>Genuine Total</strong></td>
		    <td width="10%"><strong>Market Total</strong></td>
		    <td width="10%"><strong>Used Total</strong></td>
		    <td width="10%"><strong>Approved Value</strong></td>
		  </tr>
		  </thead>
		  <tbody>
		    <s:iterator var="sparearray" status="arr" value='#request.SPAREPRINT' >
		...
		<thead>
		  <tr >
		    <th colspan="4" scope="col" Style="border-width: 2px;">Labour Charges</th>
		  </tr>
		  <tr>
		...
		<thead>
		  <tr>
		        <th colspan="4" Style="border-width: 2px;">Job Listing</th>
		  </tr>
		  <tr>
	...
	<br><br><br>
		<table width="100%" border="0" cellpadding="4">
		  <tr>
		    <td width="18%" rowspan="4"><h2>Total</h2></td>
		    <td width="14%"><strong>Spare Parts</strong></td>
		    <td width="27%">: <label id="lblSparePartsTotal" name="lblSparePartsTotal"><s:property value="lblSparePartsTotal"/></td>
		    <%-- <td width="14%" Style="display: none"><strong>Discount</strong></td>
		    <td width="27%" Style="display: none">: <label id="lblDiscount" name="lblDiscount"><s:property value="lblDiscount"/></td> --%>
		      <td><strong>Labour</strong></td>
		    <td>: <label id="lblLabourTotal" name="lblLabourTotal"><s:property value="lblLabourTotal"/></td>
		    
		  </tr>
		  <tr>
		  <td><strong>VAT</strong></td>
		    <td>: <label id="lblvat" name="lblvat"><s:property value="lblvat"/></td>
		   	
		  <td ><strong>Estimation</strong></td>
		    <td >: <label id="lblEstimation" name="lblEstimation"><s:property value="lblEstimation"/></td>
		  </tr>
		  <tr>
		  ...
		  <tr>
		    ...
		    <td colspan="2"><strong>Estimation in words</strong></td>
		    <td>: <label id="lblvattotal" name="lblvattotal"><s:property value="lblvattotal"/></td>
		    <td>&nbsp;</td>
		    <td>&nbsp;</td>
		  </tr>
		</table>
