...
<form id="frmGateOutPrint" action="printGateOutPass" autocomplete="off" target="_blank">
...
<td width="5%" align="right"></td>
  ...
  <td width="25%" align="right"><b>J/C No.&nbsp;&nbsp;&nbsp;:</b></td>
...
<td width="5%" align="right"></td>
  ...
  <td width="15%" align="right"><b>Without Payment :</b> </td>
  <td width="15%" align="center"><label id="lbltype" name="lbltype"><s:property value="lbltype"/></label></td> 
  ...
  <tr >
<td width="5%" align="right"></td>
  <td width="15%"><b>Name Of Customer</b></td><td  align="left"> :<label id="lblcustomer" name="lblcustomer"><s:property value="lblcustomer"/></label></td>
  <td width="25%" align="right"><b>person&nbsp;&nbsp;&nbsp;:</b></td>
...
<td width="5%" align="right"></td>
  ...
  <td width="25%" align="right"><b>Time&nbsp;&nbsp;&nbsp;:</b></td>
