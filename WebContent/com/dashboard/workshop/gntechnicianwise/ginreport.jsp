...
function getitem(event){
 ...
 function funExportBtn(){
 	...
 	JSONToCSVCon(exceldata, 'Goods Issue Note Report of '+$('#technician').val(), true);
} 
	 ...
	 var todate= $("#todate").val();
	  ...
	  var psrno = document.getElementById("psrno").value; 
	   ...
	   var aa="yes";
		   ...
		   $("#listdetdiv").load("ginreportGrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate+"&psrno="+psrno+"&aa="+aa+"&technician="+technician);
...
<td width="20%" >
	...
	<tr><td>&nbsp;</td></tr>	
 <tr><td align="right"><label class="branch">Technician</label></td>
	<td align="left"><input type="text" id="technician" name="technician" style="width:70%;height:20px;" readonly="readonly" placeholder="Press F3 to Search" value='<s:property value="technician"/>' onKeyDown="getTechnician(event);"/></td></tr>
