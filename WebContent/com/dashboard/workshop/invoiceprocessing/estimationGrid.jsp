...
$(document).ready(function () {
        ...
        columns: [
             ...
             cellsrenderer: function (row, column, value) {
              return "<center><div style='margin:4px;'>" + (value + 1) + "</div></center>";
       				...
       				{ text: 'Labour Total',datafield:'labourtotal',width:'9%',cellsformat:'d2',align:'right',cellsalign:'right', editable: false ,aggregates: ['sum'],aggregatesrenderer:rendererstring},
       				{ text: 'Parts Total',datafield:'sparetotal',width:'9%',cellsformat:'d2',align:'right',cellsalign:'right', editable: false,aggregates: ['sum'],aggregatesrenderer:rendererstring},
       				{ text: 'Net Total', datafield: 'nettotal', width:"9%",cellsformat:'d2',align:'right',cellsalign:'right', editable: false,aggregates: ['sum'],aggregatesrenderer:rendererstring},
       				{ text: 'Claim', datafield: 'chkclaim', width:"6%",columntype:'checkbox',cellbeginedit:isEditableMain},
       				{ text: 'Claim No',datafield:'claimno',width:'14%',cellbeginedit:isEditable},
       				{ text: 'Excess',datafield:'excess',width:'10%',cellbeginedit:isEditable,cellsformat:'d2',cellsalign:'right',align:'right'},
    ...
    $('#estimationGrid').on('rowdoubleclick', function (event) 
      		{ 
    			
  	  			var rowindex1=event.args.rowindex;
  	  			//document.getElementById("Docno").value = $('#estimationGrid').jqxGrid('getcellvalue', rowindex1, "gipdocno");
