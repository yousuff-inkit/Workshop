...
$(document).ready(function () {
    ...
    var source =
    {
        ...
        datafields: [
						...
						{name : 'billamt',type:'number'},
						{name : 'excessamt',type:'number'},
						{name : 'totalamt',type:'number'},
						{name : 'insurtypename',type:'string'},
						{name : 'invbrhid',type:'string'},
	...
	enabletooltips: true,
        ...
        columns: [
					...
					{ text: 'SL#', sortable: false, filterable: false, editable: false, cellclassname:cellclassname,
						...
						{ text: 'Job No', datafield: 'jobvocno', width: '5%' , cellclassname:cellclassname },
						{ text: 'jobdocno ', datafield: 'jobdocno', width: '5%' , cellclassname:cellclassname },
						...
						{ text: 'Insur Type',datafield:'insurtypename',width:'15%', cellclassname:cellclassname},
						{ text: 'Mobile', datafield: 'per_mob', width: '7%' , cellclassname:cellclassname},
						{ text: 'Bill Amount', datafield: 'billamt', width: '7%',cellsformat:'d2',cellsalign:'right',align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring , cellclassname:cellclassname},
						{ text: 'Less Excess', datafield: 'excessamt', width: '7%',cellsformat:'d2',cellsalign:'right',align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring , cellclassname:cellclassname},
						{ text: 'Total', datafield: 'totalamt', width: '7%',cellsformat:'d2',cellsalign:'right',align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring , cellclassname:cellclassname},
						{ text: 'Total', datafield: 'total', width: '7%',cellsformat:'d2',cellsalign:'right',align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring , cellclassname:cellclassname,hidden:true},
    ...
    $('#invoiceListGrid').on('rowdoubleclick', function (event) 
      		{ 
    			
  	  			var rowindex1=event.args.rowindex;
  	  			$('#invno').val($('#invoiceListGrid').jqxGrid('getcellvalue',rowindex1,'invdocno'));
				$('#invbrhid').val($('#invoiceListGrid').jqxGrid('getcellvalue',rowindex1,'invbrhid'));
				$('#jobdocno').val($('#invoiceListGrid').jqxGrid('getcellvalue',rowindex1,'jobdocno'));
      		});	 
});
