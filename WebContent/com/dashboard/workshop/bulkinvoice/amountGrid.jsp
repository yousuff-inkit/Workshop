<%@page import="com.dashboard.workshop.bulkinvoice.*"%>
<%
ClsBulkInvoiceDAO jobsdao=new ClsBulkInvoiceDAO();
...
var list = ['Shared', 'Insur.Company'];
 if(id=='1'){
	  amountdata='<%=jobsdao.getAmountData(cldocno,id,branch,todate)%>';
        ...
        columns: [
             ...
             cellsrenderer: function (row, column, value) {
              return "<center><div style='margin:4px;'>" + (value + 1) + "</div></center>";
       				...
       				{ text: 'Job Doc No', datafield: 'jobvocno', width:'7%', editable: false},
       				{ text: 'Insur Status',datafield:'insurstatus',width:'11%', editable: false,hidden:true},
       				{ text: 'Bill To Acno',datafield:'billtoacno',width:'11%', editable: false,hidden:true},
       				...
       				{ text: 'Billed To',datafield:'acname',width:'16%', editable: false},
       				{ text: 'Claim #',datafield:'claimno',width:'6%', editable: false},
       				{ text: 'Description',datafield:'description',width:'19%'},
       				{ text: 'Amount', datafield: 'amount', width:"7%",cellsformat:'d2',align:'right',cellsalign:'right', editable: false},
       				{ text: 'Discount', datafield: 'discount', width:"7%",cellsformat:'d2',align:'right',cellsalign:'right'},
       				{ text: 'Net',datafield:'net',width:'7%',cellsformat:'d2',align:'right',cellsalign:'right', editable: false},
       				...
       				{ text: 'Excess', datafield: 'excess', width:'7%',cellsformat:'d2',align:'right',cellsalign:'right', editable: false},
       				{ text: 'Round Off', datafield: 'roundoff', width:'5%',cellsformat:'d2',align:'right',cellsalign:'right'},
       				{ text: 'Net Bill', datafield: 'netbill', width:'7%',cellsformat:'d2',align:'right',cellsalign:'right', editable: false},
       				{ text: 'Job Doc No', datafield: 'jobdocno', width:'7%', editable: false,hidden:true},
