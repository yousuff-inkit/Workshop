<%@page import="com.dashboard.workshop.floordeliveredv2.*" %>
<%
ClsFloorDeliveredV2DAO floordao=new ClsFloorDeliveredV2DAO();
...
var floordata=[];
if(id=="1"){
	floordata='<%=floordao.getFloorMgmtData(id,brhid,fromdate,todate)%>';
}
        ...
        $("#floorMgmtGrid").jqxGrid(
                {
                    ...
                    columns: [
    					...
    					{ text: 'Est Doc No',datafield: 'estvocno', width: '3%',hidden:true,cellclassname: cellclassname},
						...
						{ text: 'Est.Total', datafield: 'esttotal', width: '5%',pinned:true,cellclassname: cellclassname,cellsformat:'d2',align:'right',cellsalign:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring},
				...
				{ 
					...
					$.get('getEstAddCount.jsp',
						...
						function(data){
							...
							$('.detailpanel .dropdown .dropdown-menu').html($.parseHTML(htmldata));	
							$('.detailpanel .dropdown .dropdown-menu li').click(function(index,value){
								var addition=$(this).attr('data-addition');
								$('#estaddition').val(addition);
								$('#modalprintest').modal('show');
								return false;
							});
						});
				});
