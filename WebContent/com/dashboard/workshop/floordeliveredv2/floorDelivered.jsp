<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="com.dashboard.workshop.floordelivered.*" %>
<%ClsFloorDeliveredDAO floordao=new ClsFloorDeliveredDAO();
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <div class="container-fluid">
    <div class="row rowgap">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="dropdown" style="display:inline-block;">
  				<button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-list" aria-hidden="true" data-toggle="tooltip" title="Print Estimation" data-placement="bottom"></i>
        ...
        <div class="btn-group" role="group">
          ...
          <!-- <button type="button" class="btn btn-default" id="btnupdateextdate" data-target="#modalupdateextdate"><i class="fa fa-calendar-plus-o " aria-hidden="true" data-toggle="tooltip" title="Extended Date Updation" data-placement="bottom"></i></button> -->
        </div>
        ...
        <div class="textpanel custompanel" style="max-width:350px;height:55px;">
	...
	<div id="modalprintest" class="modal fade" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
            		<h4 class="modal-title">Print Estimation</h4>
				</div>
				<div class="modal-body">
					<div class="container-fluid">
						<div class="row">
							<div class="col-xs-12">
								<select name="printchk" id="printchk" value='<s:property value="printchk"/>' class="form-control">
						...
						<div class="row">
							<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6"><button type="button" class="btn btn-default" id="btnprintest1">With VAT Line Discount</button></div>
							<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6"><button type="button" class="btn btn-default" id="btnprintest2">Without VAT Line Discount</button></div>
						</div>
						<div class="row">	
							<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6"><button type="button" class="btn btn-default" id="btnprintest3">With VAT</button></div>
							<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6"><button type="button" class="btn btn-default" id="btnprintest4">Without VAT</button></div>
						</div>
					</div>
				</div>
			</div>
	...
	<!-- Extended Date Update Modal-->
    <div id="modalupdateextdate" class="modal fade" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">Extended Date Updation</h4>
          </div>
          <div class="modal-body">
          	<div class="container-fluid">
            	<div class="row rowgap">
            	...
            	<div class="row rowgap">
            		...
            		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            			<input type="text" name="extdateremarks" id="extdateremarks" class="form-control">
					</div>
            	</div>
            	<div class="row rowgap">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align:center;">
						<button type="button" name="btnextdateupdate" id="btnextdateupdate" class="btn btn-default">UPDATE</button>
					</div>
				</div>
            </div>
          </div>
...
<!--           <div class="modal-footer">
  ...
  <input type="hidden" name="estaddition" id="estaddition">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var onemonthbefore=basedate;
        onemonthbefore.setMonth(basedate.getMonth()-1);
        $('#fromdate').jqxDateTimeInput('setDate',onemonthbefore);
        $('.load-wrapp').hide();
        
        $('#btnextdateupdate').click(function(){
        	if($('#jobcarddocno').val()==''){
        		Swal.fire({
					type: 'error',
					title: 'Warning',
        	...
        	if($('#extdate').jqxDateTimeInput('getDate')==null){
        		Swal.fire({
					type: 'error',
					title: 'Warning',
        ...
        $('#btnsubmit').click(function(){
        	...
        	$('#floormgmtgriddiv').load('floorMgmtGrid.jsp?id=1&brhid='+brhid+'&fromdate='+fromdate+'&todate='+todate);
        });
        ...
        function funUpdateExtDate(){
    	var jobcarddocno=$('#jobcarddocno').val();
        var extdate=$('#extdate').jqxDateTimeInput('val');
        var remarks=$('#extdateremarks').val();
		...
		x.open("GET","updateExtDate.jsp?extdate="+extdate+"&remarks="+remarks.replace(/ /g, "%20")+"&jobcarddocno="+jobcarddocno,true);
		x.send();
    }
        function bayUpdate(){
        	$('.load-wrapp').show();
        ...
        $('#btnprintest1,#btnprintest2,#btnprintest3,#btnprintest4').click(function(){
        		var url=document.URL;
				var reurl=url.split("com/");
				var docno=$('#floorMgmtGrid').jqxGrid('getcellvalue',$('#rowindex').val(),'estdocno');   
				var gatedoc=$('#floorMgmtGrid').jqxGrid('getcellvalue',$('#rowindex').val(),'gatedocno');
				var printchk=$('#printchk').val(); 
				var estvocno=$('#floorMgmtGrid').jqxGrid('getcellvalue',$('#rowindex').val(),'estvocno');
				var brhid=$('#floorMgmtGrid').jqxGrid('getcellvalue',$('#rowindex').val(),'brhid');
				var addition=$('#estaddition').val();
				var path="";
				var printvalue=$(this).attr('id');
				if(printvalue=="btnprintest3"){
					path= "com/workshop/estimationv3/printEstimationv3.action?estDocno="+estvocno+"&docno="+docno+"&gatedocno="+gatedoc+"&branch="+brhid+"&addition="+addition+"&withvat="+3+"&printchk="+printchk;
				}
				else if(printvalue=="btnprintest4"){
					path= "com/workshop/estimationv3/printEstimationv3.action?estDocno="+estvocno+"&docno="+docno+"&gatedocno="+gatedoc+"&branch="+brhid+"&addition="+addition+"&withvat="+4+"&printchk="+printchk;	
				}
				else if(printvalue=="btnprintest1"){
					path="com/workshop/estimationv3/printEstimationv3.action?estDocno="+estvocno+"&docno="+docno+"&gatedocno="+gatedoc+"&branch="+brhid+"&addition="+addition+"&withvat="+1+"&printchk="+printchk;	
				}
				else{
					path="com/workshop/estimationv3/printEstimationv3.action?estDocno="+estvocno+"&docno="+docno+"&gatedocno="+gatedoc+"&branch="+brhid+"&addition="+addition+"&withvat="+0+"&printchk="+printchk;
				}      
