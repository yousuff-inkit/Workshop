...
String docno=request.getParameter("gatedocno")==null?"":request.getParameter("gatedocno");
...
var id='<%=id%>';
if(id=="1"){
	sparepartsdata='<%=gatedao.getAssessmentSpareData(docno, id)%>';
}
