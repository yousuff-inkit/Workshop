...
function funExportBtn(){
	 ...
	 if (document.getElementById('radio_salik').checked) {
	   $("#jqxloaddataGrid").jqxGrid('exportdata', 'xls', 'Salik Daily Report');
	 }
	 if (document.getElementById('radio_traffic').checked) {
		   $("#jqxloadtrafficdataGrid").jqxGrid('exportdata', 'xls', 'Traffic Daily Report');
	}

}


function funExportDateWiseBtn(){
	
	 if (document.getElementById('radio_salik').checked) {
	   $("#jqxSatCount").jqxGrid('exportdata', 'xls', 'Salik Daily Count');
	 }
	 if (document.getElementById('radio_traffic').checked) {
		   $("#jqxSatCount").jqxGrid('exportdata', 'xls', 'Traffic Daily Count');
	}
...
function funreload(event)
{
	 ...
	 if (document.getElementById('radio_salik').checked) {
		 ...
		 $("#overlay, #PleaseWait").show();
		  $("#loadsalikdata").load("SATloadDetails.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate+"&satcateg="+satcateg);
		 ...
		 $("#overlay, #PleaseWait").show();
		  $("#loadtrafficdata").load("SATTrafficloadDetails.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate+"&satcateg="+satcateg);
		  
		}
	 $("#satCountgrid").load("satCountgrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate+"&satcateg="+satcateg);
...
function funExportBtn(){
	...
	if (document.getElementById('radio_salik').checked) {
		...
		JSONToCSVConvertor(salikdailyexceldata, 'Salik Daily List', true);
		 }
		 if (document.getElementById('radio_traffic').checked) {
			
			 JSONToCSVConvertor(trafficdailyexceldata, 'Traffic Daily List', true);
		}
...
<td width="20%" >
   ...
   <tr><td colspan="2">&nbsp;</td></tr> 
	 	<tr ><td align="right" > <label class="branch">Salik</label></td> <td ><input type="radio" id="radio_salik" name="category" value="salik" onchange="fundisable();"> 
	 	...
	 	<!-- <tr >
	  <td colspan="2"
      align="right" ><textarea id="searchdetails" name="searchdetails" style="resize:none;font: 10px Tahoma;width:100%;" rows="10"  readonly></textarea></td>
	  </tr> -->
	  <tr>
	<td colspan="2" ><div id="satCountgrid"><jsp:include page="satCountgrid.jsp"></jsp:include>
	</div></td>
	</tr> 
	<tr><td colspan="2">&nbsp;</td></tr>
