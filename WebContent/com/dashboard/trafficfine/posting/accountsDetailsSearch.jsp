...
function loadAccountSearch() {
	var cmbtype='<%=request.getParameter("cmbtype")%>';
			...
			getAccountDetails(accountsno,accountsname,dates,check,cmbtype);
	}
		
	function getAccountDetails(accountsno,accountsname,dates,check,cmbtype){
		 $("#refreshAccountDetailsDiv").load("accountDetailsSearchGrid.jsp?accountno="+accountsno+'&accountname='+accountsname.replace(/ /g, "%20")+'&dates='+dates+'&check='+check+'&cmbtypes='+cmbtype);
	}
