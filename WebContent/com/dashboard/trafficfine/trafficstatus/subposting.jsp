...
<script type="text/javascript">
	...
	if(temp1!='NA')
{
		vehdatas1= '<%=ctd.postingDetails(fromdate,todate,ticketno,regno)%>';
...
$(document).ready(function () {
    ...
    $('#postdetails').on('rowdoubleclick', function (event) 
    		{ 
    		    ...
    		    $("#fleetdiv").load("detailsgrid.jsp?relodestatus="+relodestatus+"&froms="+'<%=fromdate%>'+"&tos="+'<%=todate%>'+"&ticketno="+'<%=ticketno%>');
