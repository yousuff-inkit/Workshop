...
$(document).ready(function () {
	...
	function funExportBtn(){
	 ...
	 if(parseInt(window.parent.chkexportdata.value)=="1")
	  {
	  	JSONToCSVCon(data1, 'Traffic-Fine-Invoiced', true);
	  }
	 else
	  {
	                 
	    	$("#jqxInvoiced").jqxGrid('exportdata', 'xls', 'Traffic-Fine-Invoiced');
	  }
	...
	function funTrafficInvoicePrint(){
        var url=document.URL;
        var reurl=url.split("invoiced.jsp");
        var win= window.open(reurl[0]+"printTrafficInvoice?&branch="+document.getElementById("cmbbranch").value+'&fromDate='+document.getElementById("fromdate").value+'&toDate='+$("#todate").val(),"_blank","top=150,left=250,Width=1020,Height=500,location=no,scrollbars=no,toolbar=yes");
        win.focus();
   }
...
<td width="20%" >
	...
	<button class="myButton" type="button" id="btnTrafficInvoicePrint" name="btnTrafficInvoicePrint" onclick="funTrafficInvoicePrint();">Print</button></td></tr> 
	<tr><td colspan="2">&nbsp;</td></tr>
	<tr><td colspan="2">&nbsp;</td></tr>
	<tr><td colspan="2">&nbsp;</td></tr> 
	<tr><td colspan="2">&nbsp;</td></tr>
