	...
	ArrayList<String> rowValues= new ArrayList<String>();
	 ...
	 try{
		 ...
		 conn = ClsConnection.getMyConnection();
			...
			String sql=" SELECT TICKET_NO,FLEET_NO,cast(concat(TRAFFIC_DATE,' ',TIME) as datetime) TRA_DATE,t.pcolor,t.source FROM GL_TRAFFIC T left JOIN GL_VEHMASTER VEH ON (trim(VEH.REG_NO)=trim(T.REGNO) and t.pcolor=veh.pltid)  where t.isallocated=0 and trim(t.PCOLOR)<>''  and t.status in (0,3) ";
