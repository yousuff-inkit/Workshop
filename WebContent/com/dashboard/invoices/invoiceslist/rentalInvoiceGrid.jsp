...
{ 
  	...
  	invoiceexceldata='<%=cild.invoicelistExcel(branchval,fromDate,toDate,cldocno,rentaltype,agmtNo,clstatuss,cmbtariftype)%>';    
	  invoicedata='<%=cild.invoicelist(branchval,fromDate,toDate,cldocno,rentaltype,agmtNo,clstatuss,cmbtariftype)%>';
