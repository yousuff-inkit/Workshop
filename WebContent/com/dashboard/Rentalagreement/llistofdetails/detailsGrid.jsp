<%@ page import="com.dashboard.rentalagreement.ClsrentalagreementDAO" %>
 ...
 { 
	 ...
	 dataildata='<%=crad.detailsgrids(barchval,fromdate,todate,cldocno,status,fleet,group,brand,model,type,outchk,inchk,catid,salesman)%>';
	 
	  datasssss='<%=crad.detailsgrid(barchval,fromdate,todate,cldocno,status,fleet,group,brand,model,type,outchk,inchk,catid,salesman)%>';
 aa=0;
 }
            ...
            { 
                ...
                editable:false,
			         ...
			         columns: [
							...
							{ text: 'Contract Fleet', datafield: 'ofleet_no', width: '8%' },
							{ text: 'Contract Reg No', datafield: 'oreg_no', width: '8%' },                                          
							{ text: 'Client Id', datafield: 'cldocno', width: '6%' },
							...
							{ text: 'Out Date', datafield: 'odate', width: '6%',cellsformat:'dd.MM.yyyy'},
						     ...
						     { text: 'Manual RA', datafield: 'mrno', width: '6%'},
								{ text: 'In Date', datafield: 'indate', width: '6%',cellsformat:'dd.MM.yyyy'},
