...
<%-- <jsp:include page="../../../../includes.jsp"></jsp:include> --%>
 <script type="text/javascript">
       var driverdata='<%=crad.getDriverData()%>';	
    	   ...
    	   var id='<%=request.getParameter("id")%>';
            ...
            $('#driverSearch').on('rowdoubleclick', function (event) {
            	var rowindex1=event.args.rowindex;
            		...
            		document.getElementById("outdriverid").value=$("#driverSearch").jqxGrid('getcellvalue', rowindex1, "dr_id");
            		document.getElementById("outdriver").value=$("#driverSearch").jqxGrid('getcellvalue', rowindex1, "name");
