...
/*   .yellowClass
 ...
 { 
	  ...
	  shotterm='<%=dao.tariffchangedetailsgrid(barchval,fromdate,todate,cldocno,status,fleet,group,brand,model,type)%>';
 aa=0;
 }
	  ...
	  aa=1;
                ...
                columns: [
							...
							{ text: 'Out Date', datafield: 'odate', width: '6%',cellsformat:'dd.MM.yyyy',cellclassname: cellclassname},
							 ...
							 { text: 'branchname', datafield: 'branchname', width: '10%' ,hidden:true},
								...
								{ text: 'rinvdate', datafield: 'rinvdate', width: '10%' ,cellsformat:'dd.MM.yyyy',hidden:true},
								{ text: 'cldocno', datafield: 'cldocno', width: '10%' ,cellsformat:'d2',hidden:true },
        ...
        //newly added  	 
        	 document.getElementById("orentaltype").value=$('#detailsgrid').jqxGrid('getcellvalue', rentalrow, "rentaltype");
        	 document.getElementById("oinvdate").value=$('#detailsgrid').jqxGrid('getcelltext', rentalrow, "rinvdate");
        	 document.getElementById("oadvchk").value=$('#detailsgrid').jqxGrid('getcellvalue', rentalrow, "radvc");
        	 document.getElementById("oinvtype").value=$('#detailsgrid').jqxGrid('getcellvalue', rentalrow, "rinvtype");
        	 document.getElementById("rvocno").value=$('#detailsgrid').jqxGrid('getcellvalue', rentalrow, "voc_no");
        	 document.getElementById("rcldocno").value=$('#detailsgrid').jqxGrid('getcellvalue', rentalrow, "cldocno");
		...
		// $("#ratetariff").load("rateDescription.jsp?rdocno="+masterdoc); 
