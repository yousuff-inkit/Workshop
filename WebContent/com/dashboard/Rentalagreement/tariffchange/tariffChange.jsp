...
<tr><td  ><label class="branch">Invoice</label></td><td><select name="invoice" id="invoice" style="width:70%;"  value='<s:property value="invoice"/>'  >
  ...
  <option value="2">Period</option>
	 ...
	 <tr>
	<td colspan="2"><div id='paychaaaaa' style="width: 100% ; align:right; height: 40px;"></div></td> 
	</tr> 
	</table>
	</fieldset>
	...
	<input type="hidden" id="orentaltype"  name="orentaltype" style="text-align: right;"  value='<s:property value="orentaltype"/>' >
	<input type="hidden" id="oinvdate"  name="oinvdate" style="text-align: right;"  value='<s:property value="oinvdate"/>' >
	<input type="hidden" id="oadvchk"  name="oadvchk" style="text-align: right;"  value='<s:property value="oadvchk"/>' >
	<input type="hidden" id="oinvtype"  name="oinvtype" style="text-align: right;"  value='<s:property value="oinvtype"/>' >
	<input type="hidden" id="rvocno"  name="rvocno" style="text-align: right;"  value='<s:property value="rvocno"/>' >
	<input type="hidden" id="rcldocno"  name="rcldocno" style="text-align: right;"  value='<s:property value="rcldocno"/>' >
