...
<table width="100%" >
  <tr >
   ...
   <table    width="100%">
   <tr>
    <td align="right" width="6.5%"><label class="textdetail">Name</label></td>
...
<!--     <td align="right"><label class="textdetail"></label></td>
  ...
  <td><button type="button" id="btnok2" name="btnok1" class="myButton">OK</button>&nbsp;&nbsp;<button type="button" id="btnclearc" name="btnclear" class="myButton" >Cancel</button></td>
