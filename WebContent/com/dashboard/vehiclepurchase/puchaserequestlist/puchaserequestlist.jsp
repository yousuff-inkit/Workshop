...
function funExportBtn(){
	   $("#reqlistgrid").jqxGrid('exportdata', 'xls', 'Puchase Request List');
	 }
...
function funreload(event)
{
	 ...
	 var statusselect=$("#statusselect").val();
	  ...
	  $("#enqlistdiv").load("reqlistGrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate+"&statusselect="+statusselect);
...
<td width="20%" >
	...
	<option value="POD">Purchase Order</option>
...
<td width="80%">
	<table width="100%">
		<tr>
			 <td><div id="enqlistdiv"><jsp:include page="reqlistGrid.jsp"></jsp:include></div></td>
		</tr>
	</table>
</tr>
</table>
