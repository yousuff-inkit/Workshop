...
<td width="20%" >
	...
	<td width="30%" align="right"><label class="branch"> Up To</label></td>
    <td align="left"><div id="uptodate" name="uptodate" value='<s:property value="uptodate"/>'></div></td>
	</tr> 
	<tr><td colspan="2">&nbsp;</td></tr>
	<tr><td align="right"><label class="branch"> Avg KM/Month</label></td>
	<td align="left"><input type="text" name="avgkm" id="avgkm" style="height:20px;width:80%;" value='<s:property value="avgkm"/>' ></td></tr> 
	 <tr>
	<td>
...
<td width="80%">
	<table width="100%">
		<tr>
			 <td><div id="servicedueDiv"><jsp:include page="servicedueGrid.jsp"></jsp:include></div>
