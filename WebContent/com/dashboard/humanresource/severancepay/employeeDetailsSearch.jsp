...
#search {
	...
	$(document).ready(function () {
 	...
 	function loadSearch() {
		...
		getdata(employeeName,empId,contactNo,partyStatus);
	}
	function getdata(employeeName,empId,contactNo,partyStatus){
		 $("#refreshdiv").load('employeeDetailsSearchGrid.jsp?employeename='+employeeName.replace(/ /g, "%20")+'&empid='+empId+'&contactno='+contactNo+'&partyStatus='+partyStatus);
		}
...
<table width="100%">
  ...
  <td width="7%" align="right" style="font-size:9px;">ID#</td>
    <td width="26%"><input type="text" name="txtpartyid" id="txtpartyid" style="width:70%;height:20px;" value='<s:property value="txtpartyid"/>'>
    <input type="hidden" name="txtpartystatus" id="txtpartystatus" style="width:70%;height:20px;" value='<s:property value="txtpartystatus"/>'></td>
