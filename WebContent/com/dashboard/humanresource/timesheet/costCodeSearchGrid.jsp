        ...
        var costtype='<%=dtype1%>';
           ...
           $('#costcodeSearch').on('rowdoubleclick', function (event) {
                ...
                if($('#txtorgridclick').val()=='1') {
		             ...
		             $('#timeSheetDetailsGridID').jqxGrid('setcellvalue', rowindex1, "costcode" ,$('#costcodeSearch').jqxGrid('getcellvalue', rowindex2, "code"));
		             $('#timeSheetDetailsGridID').jqxGrid('setcellvalue', rowindex1, "costcodename" ,$('#costcodeSearch').jqxGrid('getcellvalue', rowindex2, "name"));
                } else if($('#txtorgridclick').val()=='3') {
	                 document.getElementById("txtselectedcostiddocno").value = $('#costcodeSearch').jqxGrid('getcellvalue', rowindex2, "code");
	            	 document.getElementById("txtselectedcostid").value = $('#costcodeSearch').jqxGrid('getcellvalue', rowindex2, "name");
                } 
