		...
		$(document).ready(function () { 	
          ...
          $('#costtypeSearch').on('celldoubleclick', function (event) {
                ...
                if($('#txtorgridclick').val()=='1') {
                	...
                	$('#timeSheetDetailsGridID').jqxGrid('setcellvalue', rowindex1, "costtype" ,$('#costtypeSearch').jqxGrid('getcellvalue', rowindex2, "costtype"));
                	$('#timeSheetDetailsGridID').jqxGrid('setcellvalue', rowindex1, "costgroup" ,$('#costtypeSearch').jqxGrid('getcellvalue', rowindex2, "costgroup"));
