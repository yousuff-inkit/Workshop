...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	function getdata(clname,mob){
		...
		var id=1;
		$("#refreshdiv1").load('searchClientGrid.jsp?clname='+clname+'&mob='+mob+'&id='+id);
...
<table width="100%" >
  <tr >
   ...
   <tr>
    ...
    <td align="right"><label class="branch">MOB</label></td>
  ...
  <tr>
   ...
   <jsp:include  page="searchClientGrid.jsp"></jsp:include> 
