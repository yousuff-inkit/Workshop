...
function funExportBtn(){
	...
	JSONToCSVCon(servicereportlistexcel, 'Service Report List', true);
	   }
...
function funreload(event)
{
	 ...
	 var rds=$('#ctype').val();
	 var contrctid= $("#txtcontract").val();
	 var clientid=$('#txtclientaccountdocno').val();
	 var assgrpid=$('#sergroupid').val();
	
	 
	 $("#overlay, #PleaseWait").show();
	 $("#loadgriddata").load("gridDetails.jsp?barchval="+barchval+"&froms="+fromdate+"&tos="+todate+"&rds="+rds+"&contrctid="+contrctid+"&clientid="+clientid+"&assgrpid="+assgrpid);
