...
$(document).ready(function () {
 	$("#excelExport").click(function() {
 		 JSONToCSVConvertor(vehicleexceldata, 'Non Pool Vehicle List', true);
...
/* function funExportBtn(){
    ...
    alert(vehicleexceldata);
    
  //va    obj = invoiceexceldata;

  JSONToCSVConvertor(vehicleexceldata, 'Vehicle List', true);
  } */
function JSONToCSVConvertor(JSONData, ReportTitle, ShowLabel) {
  ...
  function funloaddata()
  {
  	...
  	// alert("1");
  	$("#fleetdiv").load("vehListGrid.jsp?chk="+aa);
...
<button type="button" class="icon" id="btnSubmit" title="Load" onclick="funloaddata()">
	...
	<table width="100%">
		<tr>
			 <td><div id="fleetdiv"><jsp:include page="vehListGrid.jsp"></jsp:include></div></td>
		</tr>
	</table>
