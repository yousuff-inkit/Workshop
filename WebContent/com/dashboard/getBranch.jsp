...
ClsConnection ClsConnection=new ClsConnection();
	...
	try{
		...
		String strSql = " select b.branchname,b.doc_no,u.permission from my_brch b  left join my_user u on u.doc_no='"+session.getAttribute("USERID") +"' " 
		...
		response.getWriter().write(brnchId+"####"+brnch+"####"+perm);
