...
<div id="search" class="modern-ui">
    ...
    <div class="search-panel">
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td>
                    <input type="text"
                           name="detsearchproductname"
                           id="detsearchproductname">
                </td>

                <td align="center">
                    <input type="button"
                           name="detsearchproductbtn"
                           id="detsearchproductbtn"
                           class="myButton"
                           value="Search">
                </td>
    ...
    <div class="grid-container">
        ...
        <div id="detsearchproductdiv">

            <jsp:include page="productSearchdet.jsp"></jsp:include>
