...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		$('#stockLedgerDiv').show();
	     ...
	     $("body").prepend("<div id='PleaseWait' style='display: none;position:absolute; z-index: 1;top:180px;right:550px;'><img src='../../../../icons/31load.gif'/></div>");
		   ...
		   $('#submodelwindow').jqxWindow({ width: '50%',height: '70%',  maxHeight: '80%' ,maxWidth: '50%' , title: 'Sub Model Search' ,position: { x: 250, y: 60 }, keyboardCloseKey: 27});
		   $('#submodelwindow').jqxWindow('close');
		   $('#productwindow').jqxWindow({ width: '50%',height: '70%',  maxHeight: '80%'  ,maxWidth: '50%' , title: 'Product Search' ,position: { x: 250, y: 60 }, keyboardCloseKey: 27});
		   ...
		   $('#productwindow1').jqxWindow({ width: '50%',height: '70%',  maxHeight: '80%'  ,maxWidth: '50%' , title: 'Product Search' ,position: { x: 250, y: 60 }, keyboardCloseKey: 27});
		   $('#productwindow1').jqxWindow('close');   
			   ...
			   $('#name').dblclick(function(){
					 ...
					 productSearchContent1('productSearchMasterDet.jsp','productwindow1');
	...
	function funExportBtn(){
		if (document.getElementById('rsumm').checked) {
		   ...
		   //$("#partSearchgrid").jqxGrid('exportdata', 'xls', 'Stock Ledger Summary');
			$("#stockLedgerDiv").excelexportjs({
				...
				worksheetName: "Stock Ledger Summary Data"
			});
		}
		if (document.getElementById('rdet').checked) {
			$("#stockLedgerDetDiv").excelexportjs({
				...
				worksheetName: "Stock Ledger Detail Data"
			});	
	...
	function getProduct(){
		...
		var subcatid=$('#hidsubcatid').val().trim();
			 ...
			 productSearchContent1('productSearchMasterSum.jsp?brandid='+brandid+'&catid='+catid+'&subcatid='+subcatid, 'productwindow');
        ...
        <div class="master-container">
                    ...
                    <div class="filter-card">
                        ...
                        <div id="detial">
                            <table class="release-filter-table">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <textarea id="searchdetails1" name="searchdetails1" style="height: 120px;" readonly></textarea>
                                    </td>
                                </tr>
                            </table>
                        </div>
            ...
            <div class="main-content-area">
                ...
                <div class="grid-content-container">
                    <div id="stockLedgerDiv"><jsp:include page="stockLedgerGridSummary.jsp"></jsp:include></div>
                    <div id="stockLedgerDetDiv"><jsp:include page="stockLedgerGridDetail.jsp"></jsp:include></div> 
                </div>
