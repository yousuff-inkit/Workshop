       ...
       var temp='<%=branchval%>';
        ...
        $(document).ready(function (){ 
        	...
        	$("#btnExcel").click(function() {
    			$("#salesDetailsGridID").jqxGrid('exportdata', 'xls', 'DayBook');
    		});
            ...
            var initrowdetails = function (index, parentElement, gridElement, record) {
                ...
                var row = index;
	            var id = $("#salesDetailsGridID").jqxGrid('getrowdata', row)['unit_price'];
                ...
                if (grid != null) {
                    grid.jqxGrid({
                        ...
                        columns: [
							...
							{ text: 'Client', datafield: 'desc1', width: '32%' },
							{ text: 'Qty', datafield: 'qty', width: '11%', cellsformat: 'd2' },
							{ text: 'Unit', datafield: 'units', width: '15%', align: 'right' },
							{ text: 'Unit Price', datafield: 'unit_price',  width: '15%', cellsformat: 'd2', cellsalign: 'right', align: 'right' },
