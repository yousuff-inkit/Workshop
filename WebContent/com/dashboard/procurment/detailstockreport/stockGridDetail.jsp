                  ...
                  { text: 'SL#', sortable: false, filterable: false, editable: false,
                      ...
                      cellsrenderer: function (row, column, value) {
           	         ...
           	         { text: 'Product Name', datafield: 'productname'},
           	   	 	 {text: 'Brand Name', datafield: 'brandname', width: '13%' ,},
           	   	 	 
           	   	 {text: 'Category', datafield: 'category', width: '13%' ,},
           	         { text: ' Branch', datafield: 'branchname',  width: '13%'  },
           	      	 {text: 'Floor', datafield: 'floor', width: '10%' },
         	    	 {text: 'Rack', datafield: 'rack', width: '6%' },
         	    	 {text: 'Bin', datafield: 'bin', width: '6%' },
           	         { text: ' Location', datafield: 'loc_name',  width: '11%'  },
           	   	 	 
           	         { text: ' Qty', datafield: 'qty',  width: '5%',cellsformat:'d2'},
           	         { text: 'Cost Price', datafield: 'cost_price',  width: '8%' ,cellsformat:'d2',cellsalign: 'right', align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring},
 		          	 { text: 'Total', datafield: 'amount',  width: '8%' ,cellsformat:'d2',cellsalign: 'right', align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring}, 
