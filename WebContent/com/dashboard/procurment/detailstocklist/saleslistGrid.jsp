...
{ 
	 ...
	 datas33='<%=searchDAO.salelistsearch(barchval,fromdate,todate,psrno,load)%>'; 
...
$(document).ready(function () {
   ...
   var rendererstring=function (aggregates){
    ...
    var cellclassname =  function (row, column, value, data) {
   	  ...
   	  var ss= $('#saleslistgrid').jqxGrid('getcellvalue', row, "clstatus");
   		          if(parseInt(ss)>0)
   		  		{
        ...
        columns: [   
                  { text: 'SL#', sortable: false, filterable: false, editable: false,cellclassname: cellclassname,
                   ...
                   /// doc_no, voc_no, date, type, expdeldt, qty, brand, model, color  
                     { text: 'Doc No',datafield: 'voc_no', width: '10%' ,cellclassname: cellclassname},
         			 { text: 'Date', datafield: 'date', width: '15%',cellsformat:'dd.MM.yyyy',cellclassname: cellclassname},
                     ...
                     { text: 'Account Name', datafield: 'acname' ,cellclassname: cellclassname },
           	        /*  { text: 'Product Id', datafield: 'productid',  width: '13%',cellclassname: cellclassname }, 
           	         ...
           	         { text: ' FOC', datafield: 'foc',  width: '10%' ,cellsformat:'d2',cellclassname: cellclassname,hidden:true},
           	         { text: 'Sale Price', datafield: 'sp',  width: '9%' ,cellsformat:'d2',cellclassname: cellclassname},
		             ...
		             { text: ' Total Amount', datafield: 'nettaxamount',  width: '15%' ,cellsformat:'d2',cellsalign: 'right', align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring,cellclassname: cellclassname},  */
    ...
    $("#saleslistgrid").jqxGrid('addrow', null, {});
    	}
});


</script>
<div id="saleslistgrid"></div>