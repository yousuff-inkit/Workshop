...
<script type="text/javascript">
	...
	var datadocsearch;
	if(mode=="1"){
		datadocsearch='<%=inspdao.getDoc(reftype,branch,docno,fleetno,regno,date,mode,"")%>';
	}
	else{
		datadocsearch=[];
	}
...
{ text: 'Ref Name', datafield:'refname', width:'25%',hidden:true }
            ...
            $('#docSearch').on('rowdoubleclick', function (event) {
            	var rowindex1=event.args.rowindex;
   				document.getElementById("refdocno").value=$("#docSearch").jqxGrid('getcellvalue', rowindex1, "doc_no");
   				document.getElementById("refvocno").value=$("#docSearch").jqxGrid('getcellvalue', rowindex1, "voc_no");
