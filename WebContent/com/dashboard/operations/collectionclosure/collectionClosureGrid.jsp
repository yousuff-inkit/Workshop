...
<script type="text/javascript">
      ...
      var temp='<%=branchval%>';
	  	...
	  	if(temp!='NA'){ 
	  		   data1='<%=cod.collectionClosureGridLoading(branchval,fromDate, toDate)%>';
			   var dataExcelExport='<%=cod.collectionClosureGridExcelExport(branchval,fromDate, toDate)%>';
	  	}
        ...
        $(document).ready(function () {
            ...
            $("#collectionClosure").jqxGrid(
            {
                ...
                columns: [
	                    ...
	                    { text: 'Client', datafield: 'refname', width: '26%' },
