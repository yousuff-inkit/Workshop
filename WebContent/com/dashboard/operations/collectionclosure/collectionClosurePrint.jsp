...
<form id="frmCollectionClosure" action="printCollectionClosure" method="post" autocomplete="off" target="_blank">
...
<tr height="25" style="background-color: #F6CECE;">
    ...
    <td width="22%" align="center" class=tablereceipt><b>Client</b></td>
