...
$(document).ready(function () {
	 ...
	 $("#todate").jqxDateTimeInput({ width: '125px', height: '15px',formatString:"dd.MM.yyyy"});
       ...
       $('#clientsearchwindow').jqxWindow({ width: '48%', height: '66%',  maxHeight: '76%' ,maxWidth: '49%' , title: 'Client Search' ,position: { x: 250, y: 60 }, keyboardCloseKey: 27});
		 ...
		 $('#hidagmtno').dblclick(function(){
			 ...
			 $('#agmtnowindow').jqxWindow('open');
				$('#agmtnowindow').jqxWindow('focus');
				 agmtSearchContent('agmtSearch.jsp?branch='+document.getElementById("cmbbranch").value, $('#agmtnowindow'));
			});
     ...
     var todate=$('#todate').jqxDateTimeInput('val');
  	...
  	var cldocno=document.getElementById("hidclient").value;
    	 ...
    	 $("#overlay, #PleaseWait").show();
    		 $("#tariffgroupdiv").load("tariffgroupvariationGrid.jsp?branch="+branch+"&fromdate="+fromdate+"&todate="+todate+"&agmtno="+agmtno+"&cldocno="+cldocno+"&id=1");	 
...
<tr colspan="2"><td>&nbsp;</td></tr>
 <tr>
   <td width="28%" align="right"><label class="branch">From Date</label></td><td ><div id="fromdate"></div></td></tr>
 <tr>
 ...
 <tr colspan="2"><td>&nbsp;</td></tr>
  <tr>
   ...
   <td><input type="text" name="hidagmtno" id="hidagmtno" placeholder="Press F3 to Search" onkeydown="getAgmtno(event);" readonly style="width:100%;height:20px;"></td>
 </tr>
  <tr>
   <td align="right"><label class="branch">Client</label></td>
   <td><input type="text" name="client" id="client"  placeholder="Press F3 to Search" onkeydown="getClient(event);" readonly style="width:100%;height:20px;">
...
<tr colspan="2"><td>&nbsp;</td></tr><tr colspan="2"><td>&nbsp;</td></tr><tr colspan="2"><td>&nbsp;</td></tr>
<tr colspan="2"><td>&nbsp;</td></tr><tr colspan="2"><td>&nbsp;</td></tr><tr colspan="2"><td>&nbsp;</td></tr>
<tr colspan="2"><td>&nbsp;</td></tr><tr colspan="2"><td>&nbsp;</td></tr><tr colspan="2"><td>&nbsp;</td></tr>
<tr colspan="2"><td>&nbsp;</td></tr>
...
<td width="77%">
	<table width="100%">
		<tr>
			 <td> <div id="tariffgroupdiv"><jsp:include page="tariffgroupvariationGrid.jsp"></jsp:include></div>
