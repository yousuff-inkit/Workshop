...
var loaddata1='<%=cuv.getAgmtno(branch,sclname,smob,rno,flno,sregno,smra,agmttype)%>';
        ...
        $(document).ready(function () { 
          ...
          /*   $("#jqxmainsearch").jqxGrid('addrow', null, {}); */
				       ...
				       //     	document.getElementById("hidagmtno").value=$('#jqxmainsearch').jqxGrid('getcellvalue', rowindex1, "voc_no");
				               document.getElementById("agmtno").value=$('#jqxmainsearch').jqxGrid('getcellvalue', rowindex1, "voc_no");
