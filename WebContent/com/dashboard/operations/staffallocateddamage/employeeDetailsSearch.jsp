...
.textdetail {
	...
	$(document).ready(function () {
		$("#date").jqxDateTimeInput({ width: '110px', height: '15px',formatString:"dd.MM.yyyy",value:null});
...
<table width="100%" >
  ...
  <tr>
    ...
    <td align="left" width="16%"><div id="date" name="date"  value='<s:property value="date"/>'></div>
