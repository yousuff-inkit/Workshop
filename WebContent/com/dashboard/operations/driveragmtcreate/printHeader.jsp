...
<table width="100%" class="normaltable">
  <tr>
    <td width="18%" rowspan="6"><img src="<%=contextPath%>/icons/epic.jpg" width="200" height="91"  alt=""/></td>
    <td width="45%" rowspan="2">&nbsp;</td>
    <td width="40%"><font size="3"><label id="lblcompname" name="lblcompname" ><s:property value="lblcompname"/></label></font></td>
  </tr>
  <tr>
