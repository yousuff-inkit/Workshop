...
<table width="100%" >
  <tr >
   ...
   <table  width="100%" >
   <tr>
    <td align="right" width="15%"><label style="font-size: 12px;" >Name</label></td>
    <td align="left" width="60%"><input type="text" name="Cl_name" id="Cl_name"   style="width:96.5%;height:20PX;" value='<s:property value="Cl_name"/>'></td>
    <td align="right"><label  style="font-size: 12px;">MOB</label></td>
    <td align="left"><input type="text" name="Cl_mob" id="Cl_mob" style="height:20PX;" value='<s:property value="Cl_mob"/>'></td>
 
    </tr>
    <tr>
    
        <td align="right"><label  style="font-size: 12px;">Sales Person</label></td>
    <td align="left" width="70%"><input type="text" name="Cl_clientsale" id="Cl_clientsale"  style="width:96.5%;height:20PX;" value='<s:property value="Cl_clientsale"/>'></td>
