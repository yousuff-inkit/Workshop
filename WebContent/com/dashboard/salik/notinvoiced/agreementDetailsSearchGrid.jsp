...
<%@page import="javax.servlet.http.HttpSession" %>
 <%
 String branchval = request.getParameter("branch")==null?"0":request.getParameter("branch").trim();
...
%> 
 ...
 var data2='<%=csd.agreementSearch(branchval,sclname,smob,rno,flno,sregno,rentaltype)%>';
        ...
        $(document).ready(function () { 
            ...
            $('#jqxAgreementSearch').on('rowdoubleclick', function (event) {
                ...
                document.getElementById("agmtvocno").value = $('#jqxAgreementSearch').jqxGrid('getcellvalue', rowindex1, "voc_no");
