...
$(document).ready(function () {
	...
	function funreload(event){
		...
		var docdateval=funDateInPeriod($('#todate').jqxDateTimeInput('getDate'));
		 ...
		 $("#notInvoicedDiv").load('notInvoicedGrid.jsp?branchval='+branchval+'&fromdate='+fromdate+'&todate='+todate+'&cldocno='+cldocno+'&rentaltype='+rentaltype+'&agmtno='+agmtno+'&type='+type);
	}
