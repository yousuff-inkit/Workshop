...
<script type="text/javascript">
	...
	x.open("GET","saveData.jsp?salikaccount="+salikaccount+"&expenseaccount="+expenseaccount+"&rano="+rano+"&fleetno="+fleetno+"&amount="+amount+"&mainbranch="+mainbranch+"&docno="+docno+"&srno="+srno+"&amountcount="+amountcount+"&empid="+empid+"&tagno="+tagno+"&postdate="+postdate,true);
	x.send();
	}
...
<td width="20%" >
    ...
    <input type="hidden" id="txttagno" name="txttagno" style="width:100%;height:20px;" value='<s:property value="txttagno"/>'/>
