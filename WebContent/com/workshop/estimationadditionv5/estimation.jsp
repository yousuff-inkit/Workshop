...
function funReadOnly() {
	$('#frmEstimationAdditionV5 input').attr('readonly',true);
}
function funRemoveReadOnly() {
	//$('#frmEstimationAdditionV4 input').attr('readonly',false);
	//$('#docno').attr('readonly',true);
	$("#frmEstimationAdditionV5 input:not(.readonly)").attr('readonly',false);
	if($('#mode').val()=='A'){
...
function setValues() {
	...
	if($('#docno').val()!=''){
		var b=$('#docno').val();
		$('#complaintdiv').load('../../../com/workshop/estimationadditionv5/complaintGrid.jsp?docno='+$('#gatedocno').val()+'&branch='+$('#brchName').val()+'&id=1');	
	...
	if($('#docno').val()!=''){
		$('#sparepartsdiv').load('../../../com/workshop/estimationadditionv5/sparePartsNewGrid.jsp?docno='+$('#docno').val()+'&id=1&addition='+addition);
	}
	if($('#docno').val()!=''){
		$('#labourcostdiv').load('../../../com/workshop/estimationadditionv5/labourcostGrid.jsp?docno='+$('#docno').val()+'&id=1&addition='+addition);		
	}
	if($('#gatedocno').val()!=''){
		$('#sparepartsamountdiv').load('../../../com/workshop/estimationadditionv5/sparePartsAmountGrid.jsp?gatedocno='+$('#gatedocno').val()+'&id=1&addition='+addition);		
	}
...
<body onLoad="setValues();">
	<div id="mainBG" class="homeContent" data-type="background"> 
		<form id="frmEstimationAdditionV5" action="saveEstimationAdditionV5" method="post" autocomplete="off" class="form-inline">
