...
<%
	ClsEstimationAdditionV5DAO estimatedao=new ClsEstimationAdditionV5DAO();
...
if(id=="1"){
	partssearchdata='<%=estimatedao.getPartsData(id,partno,prdctnme,stock,unit)%>';
    ...
    { 
	  	...
	  	if(mode=='3'){
			...
			$('#partssearchwindow').jqxWindow('close');
	  		...
	  		$('#sparepartsGrid').jqxGrid('setcellvalue',partindex,'description',$('#partsSearchGrid').jqxGrid('getcellvalue',rowindex1,'productname'));
	    ...
	    $('#sparepartsGrid').jqxGrid('setcellvalue',partindex,'rate',$('#partsSearchGrid').jqxGrid('getcellvalue',rowindex1,'fixingprice'));
