...
$('#btnCalculate').click(function(){
	...
	//alert(servicetotal+":::"+genuinetotal+":::"+markettotal+":::"+usedtotal+":::"+approvedtotal+":::"+date+":::"+docno+":::"+gatedocno+":::"+lumsumamount+":::"+chklumsum+":::"+addition+":::"+$('#mode').val());
...
function funReadOnly() {
	$('#frmWSEstimationAdditionFancy input').attr('readonly',true);
}
function funRemoveReadOnly() {
	$('#frmWSEstimationAdditionFancy input').attr('readonly',false);
...
function setValues() {
 ...
 function funPrintBtn(){
	 if($('#docno').val()!='' && $('#docno').val()!='0'){
		...
		var path= "com/dashboard/workshop/quotationapproval/printQuotationAproval.action?estDocno="+$('#vocno').val()+"&docno="+docno+"&gatedocno="+gatedoc+"&addition="+addition;
...
<body onLoad="setValues();">
	<div id="mainBG" class="homeContent" data-type="background"> 
		<form id="frmWSEstimationAdditionFancy" action="saveEstimationAdditionFancy" method="post" autocomplete="off" class="form-inline">
  ...
  <tr><td colspan="8" align="center">
  		<table width="100%">
  			<tr>
				...
				<td><input type="text" name="sparemarkup" id="sparemarkup" value='<s:property value="sparemarkup"/>' readonly  style="text-align:right;" onKeyPress="javascript:return isNumber (event,id)" onBlur="funRoundAmt(value,id);"/></td>
				<td align="right">Discount</td>
				<td><input type="text" name="sparediscount" id="sparediscount" value='<s:property value="sparediscount"/>' readonly  style="text-align:right;" onKeyPress="javascript:return isNumber (event,id)" onBlur="funRoundAmt(value,id);"/></td>
