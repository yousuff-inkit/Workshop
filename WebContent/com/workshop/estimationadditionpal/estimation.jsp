    ...
    <form id="frmWSEstimationAdditionPal" action="saveEstimationAdditionPal" method="post" autocomplete="off" class="form-inline">
        ...
        <div class="modern-ui hidden-scrollbar">
            ...
            <div class="middle-panel">
                <span class="middle-panel-title">Estimation Addition</span>
                <div class="field-row">
                    ...
                    <input type="text" name="vocno" id="vocno" readonly="readonly" tabindex="-1" value='<s:property value="vocno"/>' class="readonly" style="width:120px;">
                    <input type="text" name="addition" id="addition" readonly tabindex="-1" value='<s:property value="addition"/>' class="readonly" style="width:50px; margin-left:8px;">
            ...
            <div class="middle-panel">
                ...
                <div class="field-row">
                    <label class="lbl-right" style="width:100px;">Job Card Doc No</label>
                    <div class="input-search-container" style="flex:1; max-width:150px;">
                        <input type="text" name="jobcardvocno" id="jobcardvocno" readonly placeholder="Press F3" value='<s:property value="jobcardvocno"/>' class="readonly" onkeydown="getGateInPass(event);">
                        <svg class="magnifier-icon" onclick="$('#jobcardvocno').dblclick();" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                    </div>
                ...
                <div class="field-row">
                    <label class="lbl-right" style="width:100px;">Ins. Company</label>
                ...
                <div class="field-row">
                    <label class="lbl-right" style="width:100px;">Claim No</label>
                    ...
                    <input type="text" name="header" id="header" value='<s:property value="header"/>' style="flex:2;">
                </div>

                <div class="field-row">
                    <label class="lbl-right" style="width:100px;">GIP Date Time</label>
                    ...
                    <input type="text" name="notes" id="notes" value='<s:property value="notes"/>' style="flex:2;">
                </div>

                <div class="field-row">
                    <label class="lbl-right" style="width:100px;">Estimate Days</label>
                    ...
                    <input type="text" name="internalremarks" id="internalremarks" value='<s:property value="internalremarks"/>' style="flex:2;">
                </div>

                <div class="field-row" style="margin-bottom:0;">
                    <label class="lbl-right" style="width:100px;">Service Advisor</label>
                    <select name="cmbserviceadvisor" id="cmbserviceadvisor" style="flex:1; max-width:250px;">
                        <option value="">--Select--</option>
                    </select>
                </div>

                <input type="hidden" name="hidcmbserviceadvisor" id="hidcmbserviceadvisor" value='<s:property value="hidcmbserviceadvisor"/>'/>
                <input type="hidden" name="gatevocno" id="gatevocno" class="readonly" readonly value='<s:property value="gatevocno"/>'>
