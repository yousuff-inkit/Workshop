...
String partstotal=request.getParameter("approvedtotal")==null?"":request.getParameter("approvedtotal");
 ...
 */
String straddition=request.getParameter("addition")==null?"0":request.getParameter("addition");
String mode=request.getParameter("mode")==null?"":request.getParameter("mode");

String lumsumamount=request.getParameter("lumsumamount")==null || request.getParameter("lumsumamount").toString().trim().equalsIgnoreCase("undefined") || request.getParameter("lumsumamount").toString().trim().equalsIgnoreCase("")?"0":request.getParameter("lumsumamount").toString();
String chklumsum=request.getParameter("chklumsum")==null || request.getParameter("chklumsum").toString().trim().equalsIgnoreCase("undefined") || request.getParameter("chklumsum").toString().trim().equalsIgnoreCase("")?"0":request.getParameter("chklumsum");

String chkservicelumsum=request.getParameter("chkservicelumsum")==null || request.getParameter("chkservicelumsum").toString().trim().equalsIgnoreCase("undefined") || request.getParameter("chkservicelumsum").toString().trim().equalsIgnoreCase("")?"0":request.getParameter("chkservicelumsum").toString();
String servicelumsumamt=request.getParameter("servicelumsumamt")==null || request.getParameter("servicelumsumamt").toString().trim().equalsIgnoreCase("undefined") || request.getParameter("servicelumsumamt").toString().trim().equalsIgnoreCase("")?"0":request.getParameter("servicelumsumamt").toString();
String chkrandomlumsum=request.getParameter("chkrandomlumsum")==null || request.getParameter("chkrandomlumsum").toString().trim().equalsIgnoreCase("undefined") || request.getParameter("chkrandomlumsum").toString().trim().equalsIgnoreCase("")?"0":request.getParameter("chkrandomlumsum").toString();
String randomlumsumamt=request.getParameter("randomlumsumamt")==null || request.getParameter("randomlumsumamt").toString().trim().equalsIgnoreCase("undefined") || request.getParameter("randomlumsumamt").toString().trim().equalsIgnoreCase("")?"0":request.getParameter("randomlumsumamt").toString();
System.out.println(servicetotal+"::"+partstotal+"::"+date+"::"+docno+"::"+gatedocno+"::"+straddition+"::"+mode+"::"+lumsumamount+"::"+chklumsum+"::"+chkservicelumsum+"::"+servicelumsumamt+"::"+chkrandomlumsum+"::"+randomlumsumamt);
...
try{
	...
	System.out.println(chklumsum+"///"+lumsumamount+"///"+straddition);
	Statement stmt=conn.createStatement();
	double nettotal=0.0,vatpercent=0.0,vatvalue=0.0;
	double vatnettotal=0.0;
	int cldocno=0,tax=0,clienttax=0;
	int addition=Integer.parseInt(straddition.equalsIgnoreCase("")?"0":straddition);
...
//	System.out.println(strchecktax);
	...
	for(int i=0;i<amtarray.size();i++){
		...
		String stramtinsert="insert into ws_estspareamt(gatedocno,description,taxpercent,approved,status,addition)values("+temp[0]+",'"+temp[1]+"',"+temp[2]+","+temp[3]+",3,"+addition+")";
	...
	/*if(docno.equalsIgnoreCase("")){
		if(chklumsum.equalsIgnoreCase("1") && Double.parseDouble(lumsumamount)>0){
			...
			vatnettotal=nettotal+(vatvalue*nettotal);
			System.out.println(vatnettotal+"//"+nettotal+"//"+vatvalue+"//");
			ArrayList<String> amtarray=new ArrayList();
			amtarray.add(gatedocno+"::"+"Total Parts Cost::"+null+"::"+partstotal);
			amtarray.add(gatedocno+"::"+"Total Services Cost::"+null+"::"+servicetotal);
			amtarray.add(gatedocno+"::"+"Sub Total::"+null+"::"+nettotal);
