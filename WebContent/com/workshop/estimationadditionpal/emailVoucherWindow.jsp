...
<script type="text/javascript">
	...
	function funSendPrintEmail(vattype){
		...
		$.post('uploadPrints.jsp',{'addition':addition,'estdocno':estdocno,'docno':docno,'gatedocno':gatedocno,'brhid':brhid,'printchk':printchk,'withvat':withvat},function(data,status){
			console.log(data);
