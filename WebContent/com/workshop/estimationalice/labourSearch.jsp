...
$('#btnjobsearch').click(function(){
	...
	$('#laboursearchdiv').load('labourSearchGrid.jsp?jobdocno='+jobdocno+'&date='+date+'&jobtype='+jobtype.replace(/ /g, "%20")+'&id=1&labourindex='+labourindex+'&gatedocno='+gatedocno);
});
});
...
<body>
	<table width="100%" border="0">
  		<tr>
            ...
            <td width="9%" align="right">Job Desc</td>
            <td width="46%" colspan="3"><input type="text" name="searchjobtype" id="searchjobtype" style="width:99%;"></td>
	...
	<div id="searchjobdate" hidden="true"></div>
</body>
</html>