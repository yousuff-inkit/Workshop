...
<script>
	$(document).ready(function(e) {
        ...
        $('#btnmastersearch').click(function(e) {
			...
			$('#mastersearchdiv').load('masterSearchGrid.jsp?branch='+branch+'&docno='+docno+'&date='+date+'&gatevocno='+gatevocno+'&cldocno='+cldocno+'&clientname='+clientname+'&id=1&brhid='+brhid);
        });
    });
</script>
</head>
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td colspan="3"><input type="text" name="msearchclientname" id="msearchclientname" style="width:99%;"></td>
    <td align="center"><button type="button" name="btnmastersearch" id="btnmastersearch" class="myButton">Search</button></td>
    
  </tr>
  <tr>
    <td colspan="6"><div id="mastersearchdiv"><jsp:include page="masterSearchGrid.jsp"></jsp:include></div></td>
  </tr>
</table>
