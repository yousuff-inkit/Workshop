...
<%ClsWSEstimationAliceDAO gatedao=new ClsWSEstimationAliceDAO();
            ...
            $("#sparePartsNewGrid").jqxGrid(
            {
               ...
               handlekeyboardnavigation: function (event) {
                ...
                columns: [
							...
							{ text: 'Total', datafield: 'approvedvalue', width: '8%',editable:true,align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum'],aggregatesrenderer:renderertotal},
			              ],
