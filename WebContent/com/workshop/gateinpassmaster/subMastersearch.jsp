...
<%ClsGateInPassDAO DAO= new ClsGateInPassDAO();%>
 <%
...
%> 
 ...
 var id='<%=id%>';
 if(id=="1"){
  searchdata='<%=DAO.searchMaster(session,msdocno,Cl_namess,dates,mobile,regno,id,refno,brhid)%>';
}	
  $(document).ready(function () { 	
     ...
     $("#subsearch").jqxGrid(
     {
        ...
        selectionmode: 'singlerow',
         ...
         columns: [
				...
				{ text: 'Virtual', datafield: 'chkvirtual', width: '20%',hidden:true },
				]
     });
     ...
     $('#subsearch').on('celldoubleclick', function (event) {
        ...
        $('#hidchkvirtual').val($('#subsearch').jqxGrid('getcellvalue', rowindex1, "chkvirtual"));
        	 setValues();
        	 getModel($('#hidcmbbrand').val());
