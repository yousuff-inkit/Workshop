...
<script>
	$(document).ready(function(e) {
        ...
        $('#btnmastersearch').click(function(e) {
			...
			$('#mastersearchdiv').load('masterSearchGrid.jsp?branch='+branch+'&docno='+docno+'&date='+date+'&brand='+brand+'&model='+model+'&packagename='+packagename+'&id=1&brhid='+brhid);
        });
    });
</script>
</head>
...
<table width="100%" border="0">
  <tr>
    ...
    <td ><select name="msearchbrand" id="msearchbrand" onchange="getMSearchModel(value);"><option value="">--Select--</option></select></td>
