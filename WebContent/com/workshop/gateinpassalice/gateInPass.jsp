...
String compno=request.getParameter("compno")==null?"":request.getParameter("compno");     
%>
...
function funReadOnly() {
	$('#frmGateInPassAlice input').attr('readonly',true);
...
function funRemoveReadOnly() {
	$('#frmGateInPassAlice input').attr('readonly',false);
...
function getAutoClientDetails(){
	...
	x.open("GET", "getAutoClientDetails.jsp?comp="+$('#hidcompno').val(), true);
	x.send();
}
function setValues() {
...
//var win= window.open(reurl[0]+"/epicraprint1.jsp","_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
  var win= window.open(reurl[0]+"GateinpassprintAlice?docno="+document.getElementById("docno").value+"&formdetailcode=GIP","_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
  win.focus(); 
	   } 
...
<body onLoad="setValues();">   
	<div id="mainBG" class="homeContent" data-type="background">    
		<form id="frmGateInPassAlice" action="GateInPassSaveAlice" method="post" autocomplete="off" class="form-inline">
...
<td align="left"><div id="regexpirydate" name="regexpirydate" value='<s:property value="regexpirydate"/>'></div></td>
					...
					<input type="hidden" name="hidcompno" id="hidcompno" value='<s:property value="hidcompno"/>'/>
				</div>
			</form>
		</div>
