...
$(document).ready(function () { 
	...
	var labourcosturl='getGridData.jsp?type=LABOUR&docno='+param_docno+'&id='+id+'&contractdocno='+param_contractdocno;
	...
	if(id=="1"){
		...
		labourcostdata='<%=gatedao.getPackageLabourData(docno,id,contractdocno )%>';   
	}
	var rendererstring=function (aggregates){
     	...
     	//	console.log('Config:'+rawconfig.serviceConsumables.method+',Value:'+value);
     ...
     var dataAdapter = new $.jqx.dataAdapter(source,
            ...
            $("#Menu").on('itemclick', function (event) {
                ...
                if ($.trim($(args).text()) == "Edit Selected Row") {
                    ...
                    if(entitytype=="0"){
						...
						if(parseInt(nontaxcount)==0){
							$('#cmbentitytype').val(1).trigger('change');
						}
					}
                }
            });
            ...
            $("#labourcostGrid").on("cellvaluechanged", function (event) {
            	...
            	if(dataField=="jobdiscount" || dataField=="jobvatpercent" || dataField=="hrs" || dataField=="rate" || dataField=="jobqty"){
            		...
            		var pkgqty=parseFloat($('#labourcostGrid').jqxGrid('getcellvalue',rowindex,'pkgqty'));
            		...
            		if(hrs>pkgqty && pkgdocno!=''){
            			document.getElementById("errormsg").innerText="";
            			document.getElementById("errormsg").innerText="Maximum Allowed "+pkgqty+" Only";
            			$('#labourcostGrid').jqxGrid('setcellvalue',rowindex,'hrs',oldvalue);
            			return false;
            		}
            		else{
            			//document.getElementById("errormsg").innerText="";
