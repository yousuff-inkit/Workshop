...
function funReadOnly() {
	$('#frmEstimationV4 input').attr('readonly',true);
var id='<%=id%>';
	 if(id=="3"){
		 var ajaxbrhid='<%=brhid%>';
		if(ajaxbrhid!="" && ajaxbrhid!=null && ajaxbrhid!="undefined"){
...
function funRemoveReadOnly() {
	$('#frmEstimationV4 input').attr('readonly',false);
...
<body onLoad="setValues();">
	<div id="mainBG" class="homeContent" data-type="background"> 
		<form id="frmEstimationV4" action="saveEstimationV4" method="post" autocomplete="off" class="form-inline">
