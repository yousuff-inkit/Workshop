...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	$(document).ready(function () {
 	...
 	function loadSearch() {
 		...
 		var partno=document.getElementById("partno").value.replace(" ","%20");
 		var prdctnme=document.getElementById("prdctnme").value.replace(" ","%20");
	...
	function getdata(partno,prdctnme,stock,unit,partindex){
		...
		var mode='<%=mode%>';
		$("#refreshdiv1").load('partsSearchGrid.jsp?partno='+partno+'&prdctnme='+prdctnme+'&stock='+stock+'&unit='+unit+'&partindex='+partindex+'&id=1&srvcadvisorconfig='+srvcadvisorconfig+'&mode='+mode);
