...
$('#btnsearchdoc').click(function(){
	...
	$('#gateinpassdiv').load('gateInPassSearchGrid.jsp?gatedocno='+gatedocno+'&regno='+regno+'&date='+date+'&cldocno='+cldocno+'&clientname='+clientname+'&id=1&brhid='+brhid);
});
});
...
<body>
	<table width="100%" border="0">
  		<tr>
            ...
            <td width="20%"><input type="text" name="searchgatedocno" id="searchgatedocno"></td>
            <td width="20%" align="right">Reg No</td>
            <td width="29%"><input type="text" name="searchfleetregno" id="searchfleetregno"></td>
