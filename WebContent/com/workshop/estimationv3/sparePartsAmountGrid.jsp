...
var id='<%=id%>';
if(id=="1"){
	sparepartsamountdata='<%=gatedao.getSparepartsAmountData(gatedocno,id)%>';
}
     ...
     var dataAdapter = new $.jqx.dataAdapter(source,
            ...
            $("#sparePartsAmountGrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Total', datafield: 'approvedtotal', width: '10%',align:'right',cellsalign:'right',cellsformat:'d2',aggregates: ['sum']},
			              ]
            });
