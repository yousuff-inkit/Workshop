...
function funReadOnly() {
	$('#frmEstimationV3 input').attr('readonly',true);
var id='<%=id%>';
	 if(id=="3"){
		 var ajaxbrhid='<%=brhid%>';
		if(ajaxbrhid!="" && ajaxbrhid!=null && ajaxbrhid!="undefined"){
...
function funRemoveReadOnly() {
	$('#frmEstimationV3 input').attr('readonly',false);
...
function setValues() {
	...
	if($('#docno').val()!=''){
		var b=$('#docno').val();
		$('#complaintdiv').load('../../../com/workshop/estimationv3/complaintGrid.jsp?docno='+$('#gatedocno').val()+'&branch='+$('#brchName').val()+'&id=1');	
		$('#jobtypeinputdiv').load('jobtypeinput.jsp?id=1');
		CheckEditStatus($('#docno').val());
	}
	if($('#docno').val()!=''){
		$('#sparepartsdiv').load('../../../com/workshop/estimationv3/sparePartsNewGrid.jsp?docno='+$('#docno').val()+'&id=1');
	}
	if($('#docno').val()!=''){
		$('#labourcostdiv').load('../../../com/workshop/estimationv3/labourcostGrid.jsp?docno='+$('#docno').val()+'&id=1');		
	}
	if($('#gatedocno').val()!=''){
		$('#sparepartsamountdiv').load('../../../com/workshop/estimationv3/sparePartsAmountGrid.jsp?gatedocno='+$('#gatedocno').val()+'&id=1');		
	}
...
<body onLoad="setValues();">
	<div id="mainBG" class="homeContent" data-type="background"> 
		<form id="frmEstimationV3" action="saveEstimationV3" method="post" autocomplete="off" class="form-inline">
  ...
  <tr class="package-row">
  	...
  	<td><input type="text" name="packagename" id="packagename" value='<s:property value="packagename"/>' readonly placeholder="Press F3 to Search" onkeydown="getPackage(event);">
