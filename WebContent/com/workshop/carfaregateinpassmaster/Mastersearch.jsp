...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	$(document).ready(function () {
 	...
 	function loadSearch() {
	    ...
	    getdata1(Cl_namess,msdocno,dates,mobile,regno);
			}
 	
	  function getdata1(Cl_namess,msdocno,dates,mobile,regno){
		  
		  var id=1;
		
		 $("#refreshdivmas").load('subMastersearch.jsp?Cl_namess='+Cl_namess+'&msdocno='+msdocno+'&dates='+dates+'&mobile='+mobile+'&regno='+regno+'&id='+id);
...
<table width="100%"  >
  <tr>
   ...
   <table>
   <tr width="100%">
   <td align="right" width="10%">Docno</td>
    ...
    <td align="right" width="10%" >Date</td>
      <td align="left" width="35%"><div id="datess" name="datess" value='<s:property value="datess"/>'></td>
