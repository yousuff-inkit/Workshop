        ...
        $(document).ready(function () { 
            ...
            $("#jqxRegisterSearch").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Exist',  datafield: 'exist', width: '100%',hidden:true  },
							{ text: 'GIP No',  datafield: 'gipvocno', width: '100%',hidden:true  },
						]
            });
              ...
              $('#jqxRegisterSearch').on('rowdoubleclick', function (event) {
                ...
                document.getElementById("regnoexistgipvocno").value = $('#jqxRegisterSearch').jqxGrid('getcellvalue', rowindex1, "gipvocno");
              	document.getElementById("regnoexist").value = $('#jqxRegisterSearch').jqxGrid('getcellvalue', rowindex1, "exist");
                ...
                if(document.getElementById("regnoexist").value=="1"){
                	$.messager.alert('Warning','Reg No already exists in GIP #'+document.getElementById("regnoexistgipvocno").value);
                }
