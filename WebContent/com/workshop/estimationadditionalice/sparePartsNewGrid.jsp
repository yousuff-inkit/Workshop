<%@page import="com.workshop.estimationadditionalice.ClsEstimationAdditionAliceDAO" %>
<%ClsEstimationAdditionAliceDAO gatedao=new ClsEstimationAdditionAliceDAO();
     ...
     var dataAdapter = new $.jqx.dataAdapter(source,
            ...
            $("#sparePartsNewGrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Description', datafield: 'description', width: '74%',editable:true },		
							{ text: 'Qty', datafield: 'qty', width: '6%',editable:true },
							{ text: 'Rate',datafield: 'sprate', width: '8%',editable:true,align:'right',cellsalign:'right',cellsformat:'d2'},		
							{ text: 'Total', datafield: 'approvedvalue', width: '8%' ,cellsformat:'d2',editable:false,cellsalign:'right',align:'right',aggregates: ['sum'],aggregatesrenderer:total},
            ...
            $("#sparePartsNewGrid").on("cellvaluechanged", function (event) {
            	...
            	if(datafield=="qty" || datafield=="sprate"){
            		...
            		$('#sparePartsNewGrid').jqxGrid('setcellvalue',rowindex,'approvedvalue',(rate*qty));
            	}
            });
        });
    </script>
