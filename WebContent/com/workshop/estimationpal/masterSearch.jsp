...
<script type="text/javascript">
    $(document).ready(function(e) {
        ...
        $('#btnmastersearch').click(function(e) {
            ...
            // Safe URL encoding applied to all query parameters
            $('#mastersearchdiv').load('masterSearchGrid.jsp?branch=' + encodeURIComponent(branch) +
                                       '&docno=' + encodeURIComponent(docno) +
                                       '&date=' + encodeURIComponent(date) +
                                       '&gatevocno=' + encodeURIComponent(gatevocno) +
    ...
    <div class="search-panel">
        <table class="form-grid" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td class="lbl-right">GIP#</td>
                <td>
                    <input type="text" name="msearchgatevocno" id="msearchgatevocno" autocomplete="off">
                </td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="msearchcldocno" id="msearchcldocno" placeholder="Client ID" autocomplete="off">
                </td>
                
                <!-- Spanning 5 columns so the Client Name field fills available space -->
                <td colspan="5">
                    <input type="text" name="msearchclientname" id="msearchclientname" placeholder="Client Name" autocomplete="off">
                </td>
                
                <!-- Search button aligned on the far right -->
                <td align="center">
                    <button type="button" name="btnmastersearch" id="btnmastersearch" class="myButton">Search</button>
