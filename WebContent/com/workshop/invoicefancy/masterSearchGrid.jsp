...
var id='<%=id%>';
if(id=="1"){
	searchdata='<%=invoicedao.getSearchData(docno,date,jobcardno,regno,cldocno,clientname,id,
			session,brhid)%>';
}
        $(document).ready(function () { 	
            ...
            $("#masterSearchGrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Invoice To Account',datafield:'invoicetoaccount',hidden:true},
							{ text: 'Invoice To Acno',datafield:'invoicetoacno',hidden:true},
							{ text: 'Invoice To Acname', datafield: 'invoicetoacname', width: '45%',hidden:true },
           ...
           $('#masterSearchGrid').on('rowdoubleclick', function (event) {
                ...
                $('#invoicetoacno,#tempinvoicetoacno').val($('#masterSearchGrid').jqxGrid('getcellvalue', rowindex, "invoicetoacno"));
