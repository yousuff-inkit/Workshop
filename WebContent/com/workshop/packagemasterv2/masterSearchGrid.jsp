...
String enginesize=request.getParameter("enginesize")==null?"":request.getParameter("enginesize");
%>
...
var id='<%=id%>';
if(id=="1"){
	searchdata='<%=gatedao.getMasterSearch(brand,packagename,docno,date,id,brhid,model,enginesize)%>';
}
     ...
     var dataAdapter = new $.jqx.dataAdapter(source,
            ...
            $("#masterSearchGrid").jqxGrid(
            {
                ...
                columns: [
                            ...
                            { text:'Package Name',datafield:'packagename',width:'40%'},
							...
							{ text: 'Engine Size Doc No',datafield:'enginesizedocno',width:'47%',hidden:true},
							{ text: 'Engine Size',datafield:'enginesize',width:'30%'},
							{ text: 'Brand',datafield:'brand',width:'20%',hidden:true},
            ...
            $("#masterSearchGrid").on("rowdoubleclick", function (event) {
                ...
                $('#cmbenginesize').val($('#masterSearchGrid').jqxGrid('getcellvalue',row1,'enginesizedocno'));
