...
<script type="text/javascript">
	$(document).ready(function(e) {
        ...
        $('#btnmastersearch').click(function(e) {
			...
			var giprefno=$('#msearchgiprefno').val();
			giprefno=encodeURIComponent(giprefno);
			$('#mastersearchdiv').load('masterSearchGrid.jsp?refno='+refno+'&reftype='+reftype+'&date='+date+'&docno='+docno+'&id=1'+'&cldocno='+cldocno+'&accno='+accno+'&giprefno='+giprefno);
        });
    });
</script>
</head>
...
<table width="100%" border="0">
  <tr>
    ...
    <td width="19%" align="right">Ref Type</td>
    <td width="10%"><select name="msearchreftype" id="msearchreftype"><option value="">--Select--</option><option value="GIP">Gate In Pass</option><option value="EST">Estimation</option></select></td>
    <!-- <td width="6%" rowspan="2"><input type="button" name="btnmastersearch" id="btnmastersearch" value="Search" class="myButton"></td> -->
  	<td>GIP Ref No</td>
  	<td><input type="text" name="msearchgiprefno" id="msearchgiprefno"></td>
  </tr>
  <tr>
    ...
    <td colspan="2"><input type="text" name="mserchaccnos" id="mserchaccnos" style="width:99%;"></td>
    <td><input type="button" name="btnmastersearch" id="btnmastersearch" value="Search" class="myButton"></td>
  </tr>
  <tr>
