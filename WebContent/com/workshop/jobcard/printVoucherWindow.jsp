...
$(document).ready(function(){
	$('#btnjobcardprint').click(function(){
		...
		// alert(reurl[0]+"WSJobCardPrintAction.action");
	   var win= window.open(reurl[0]+"WSJobCardPrintAction.action?docno="+docno+"&addition="+addition,"_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
	   win.focus();
	   win_voucher.close();
