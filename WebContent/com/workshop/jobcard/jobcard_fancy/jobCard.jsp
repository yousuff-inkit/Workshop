...
$(document).ready(function() {
    ...
    $("#promdate").jqxDateTimeInput({  width:'125px',height : '15px', formatString : "dd.MM.yyyy",minDate:new Date(), value:new Date()});
    $("#promtime").jqxDateTimeInput({  width:'55px',height : '15px', formatString : "HH:mm",showCalendarButton:false,value:new Date()});
...
/*Back Date Restriction in Promdate*/
		
			/*	function funBackDate(){
				var currentDate = new Date();
				var value = document.getElementById("#promdate");
				  if(value < currentDate){
				 System.out.println("Previous date entries are not allowed.");
				return 0;	 	 
	 	 }
	 	 } */	 	 
...
function funPrintBtn(){
	 if($('#docno').val()!='' && $('#docno').val()!='0'){
		...
		//alert(gatedocno);
		//alert("docno="+$('#docno').val()+"&gatedocno="+gatedocno+"&estdocno="+estdocno);
		/* var path= "com/dashboard/workshop/quotationapproval/printQuotationAproval.action?estDocno="+estdocno; */
		var path= "com/workshop/wsjobcard_fancy/WSJobCardPrintFancyAction?docno="+$('#docno').val()+"&gatedocno="+gatedocno+"&estdocno="+estdocno+"&branch="+$('#brchName').val()+"&refno="+$('#hidrefno').val();  
...
<div>
<form id="frmWSJobCardfancy" action="saveWSJobCardfancy">
	...
	<table width="100%" border="0" >
      ...
      <tr>
        <td width="13%" height="31" align="right">Promise Date</td>
        <td width="14%"><div id="promdate" name="promdate" value='<s:property value="promdate"/>'></td>
        <td width="13%" height="31" align="right">Promise Time</td>
        <td width="14%"><div id="promtime" name="promtime" value='<s:property value="promtime"/>'></div></td>
