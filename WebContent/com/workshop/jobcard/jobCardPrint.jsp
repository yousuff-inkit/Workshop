...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$("#barcode").JsBarcode($('#txtvocno1').val());
	});
</script>
</head>
...
<table width="100%" border="0">
  <tr><td colspan=8 align="right"><svg id="barcode" ></svg></td></tr>
  <tr>
    <td width="7%">Date</td>
  ...
  <tr>
    <td colspan="9">
    	<table width="100%">
        	<tr>
            	<td width="50%"><fieldset><legend>Customer Details</legend>
    		
          <table width="100%" border="0">
            <tr>
              <td width="20%">Customer No</td>
...
<input type="hidden" id="txtvocno1" value='<s:property value="lblvocno"/>' >
</table>
</div>
</body>
</html>