...
String giprefno=request.getParameter("reftype")==null?"":request.getParameter("giprefno");
%>
...
var id='<%=id%>';
if(id=="1"){
	searchdata='<%=jobdao.getSearchData(refno,date,docno,reftype,id,cldocno,accno,giprefno)%>';
}
        $(document).ready(function () { 	
            ...
            $("#masterSearchGrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text : 'GIP Ref No',datafield:'giprefno'},
