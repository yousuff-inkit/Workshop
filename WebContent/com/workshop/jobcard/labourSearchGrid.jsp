...
var id='<%=id%>';
if(id=="1"){
	laboursearchdata='<%=gatedao.getLabourSearchData(jobdocno,jobtype,date,id)%>';
}
     ...
     var dataAdapter = new $.jqx.dataAdapter(source,
            ...
            $("#labourSearchGrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text:'Job Type',datafield:'jobtype',width:'32%'},
							{ text:'Job Type Id',datafield:'jobtypeid',width:'47%',hidden:true},
							{ text:'Hours', datafield:'hrs',width:'15%',cellsformat:'d2',cellsalign:'right',align:'right'},
							{ text:'Rate', datafield:'rate',width:'15%',cellsformat:'d2',cellsalign:'right',align:'right'},
							{ text:'Job Desc', datafield:'jobdesc',width:'15%',hidden:true}
			              ]
            });
            ...
            $("#labourSearchGrid").on("rowdoubleclick", function (event) {
                ...
                $('#labourcostGrid').jqxGrid('setcellvalue',labourindex,'rate',$('#labourSearchGrid').jqxGrid('getcellvalue',row1,'rate'));
                $("#labourcostGrid").jqxGrid("addrow", null, {});
                var hrs=parseFloat($('#labourSearchGrid').jqxGrid('getcellvalue',row1,'hrs'));
                var rate=parseFloat($('#labourSearchGrid').jqxGrid('getcellvalue',row1,'rate'));
