...
<script>
	$(document).ready(function(e) {
        ...
        $('#btnmastersearch').click(function(e) {
			...
			$('#mastersearchdiv').load('masterSearchGrid.jsp?branch='+branch+'&docno='+docno+'&date='+date+'&gatevocno='+gatevocno+'&cldocno='+cldocno+'&clientname='+clientname+'&id=1&brhid='+brhid+'&regno='+regno);
        });
    });
</script>
</head>
