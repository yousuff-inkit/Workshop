    ...
    var source =
     {
         ...
         datafields: [
				...
				{name : 'billtocldocno',type:'string'},
				{name : 'billtorefname',type:'string'},
     ...
     var dataAdapter = new $.jqx.dataAdapter(source,
            ...
            $("#masterSearchGrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text : 'Bill To', datafield:'billto',width:'50%',hidden:true},
							{ text : 'Bill To Cldocno', datafield:'billtocldocno',width:'50%',hidden:true},
							{ text : 'Bill To Refname', datafield:'billtorefname',width:'50%',hidden:true},
            ...
            $("#masterSearchGrid").on("rowdoubleclick", function (event) {
                ...
                $('#cmbbillto,#hidcmbbillto,#billtocldocno,#billtorefname').val('');
                $('#cmbbillto').val($('#masterSearchGrid').jqxGrid('getcellvalue',row1,'billto'));
                $('#hidcmbbillto').val($('#masterSearchGrid').jqxGrid('getcellvalue',row1,'billto'));
                $('#billtocldocno').val($('#masterSearchGrid').jqxGrid('getcellvalue',row1,'billtocldocno'));
                $('#billtorefname').val($('#masterSearchGrid').jqxGrid('getcellvalue',row1,'billtorefname'));
                
                if($('#masterSearchGrid').jqxGrid('getcellvalue',row1,'billto')=="0"){
                	$('#cmbbillto,#hidcmbbillto,#billtocldocno,#billtorefname').val('');
                }
