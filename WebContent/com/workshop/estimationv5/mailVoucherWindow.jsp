...
<script type="text/javascript">
 	function funWithVatPrint(){      
		...
		var path= "com/workshop/estimationv3/printEstimationv3.action?mail=1&estDocno="+$('#vocno').val()+"&docno="+docno+"&gatedocno="+gatedoc+"&branch="+$('#brchName').val()+"&addition="+0+"&withvat="+1+"&printchk="+printchk;       
		...
		var email="",cldocno="0",client="";
		var win= window.open(reurl[0]+path,"_blank","top=250,left=310,Width=700,Height=600,location=no,scrollbars=yes,toolbar=yes");
		window.open("<%=contextPath%>/com/emailnew/Email.jsp?formcode=EST&docno="+docno+"&brchid="+brhid+"&frmname="+fname+"&recipient="+email+"&cldocno="+cldocno+"&client="+client+"&userid="+userid+"&dtype="+frmdet,"E-Mail","menubar=0,resizable=1,width=900,height=950");	          	
		win.focus();*/
		funSendPrintEmail(1);
 	}    
 	...
 	function funWithoutVatPrint(){      
		...
		var gatedoc=$('#gatedocno').val(); 
		var printchk=$('#printchk').val(); 
		var path= "com/workshop/estimationv3/printEstimationv3.action?mail=1&estDocno="+$('#vocno').val()+"&docno="+docno+"&gatedocno="+gatedoc+"&branch="+$('#brchName').val()+"&addition="+0+"&withvat="+0+"&printchk="+printchk;       
		console.log(reurl[0]+" = "+path);
		var win= window.open(reurl[0]+path,"_blank","top=250,left=310,Width=700,Height=600,location=no,scrollbars=yes,toolbar=yes");	          	
		win.focus();    	
	*/
