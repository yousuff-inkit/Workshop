...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel" style="background: #fdfdfd;">
        <span class="middle-panel-title">Bay Details</span>
        ...
        <div class="field-row" style="margin-bottom:0;">
            ...
            <input type="text" name="code" id="code" style="width:150px;" value='<s:property value="code"/>'>
            ...
            <label class="lbl-right" style="width:80px; margin-left:15px;">Job Type</label>
    ...
    <!-- Bay Grid Details -->
    <div id="baygriddiv" style="margin-bottom:15px;">
        <jsp:include page="bayGrid.jsp"></jsp:include>
    </div>
