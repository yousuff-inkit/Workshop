...
function loadSearch() {
		...
		getdatas(sdocno,sdate,scldocno,sclientname,rtype);


}

function getdatas(sdocno,sdate,scldocno,sclientname,rtype){
	$('#jobCardSearchGrid').load('jobCardDetailsSearchGrid.jsp?doccno='+sdocno+'&date='+sdate+'&cldocno='+scldocno+'&clientname='+sclientname+'&rtype='+rtype+'&id=1');
}
</script>
