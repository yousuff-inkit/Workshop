...
<table width="100%">
  ...
  <tr>
    ...
    <td width="18%">: <label name="lblchassis" id="lblchassis" ><s:property value="lblchassis"/></label></td>
  ...
  <tr>
  	...
  	<td colspan="5">: <label name="lblremarks" id="lblremarks" ><s:property value="lblremarks"/></label></td>
</table>
</fieldset>
<br>
<hr>
...
<table width="100%" >
  ...
  <tr>
    <td width="197" align="left">VAT 5% :</td>
    <td width="752">&nbsp;</td>
    <td width="163">&nbsp;</td>
   ...
   <tr>
    ...
    <td width="752">&nbsp;</td>
    <td width="163">&nbsp;</td>
    <td width="146" align="right"><b><label id="lblround" name="lblround"><s:property value="lblround"/></label></b></td>
  </tr>
  <tr>
...
<table width="100%">
 <tr>
     <td colspan="3" align="center"><fieldset><font style="color: #D8D8D8;font-size: 11px;"></font></fieldset></td>
  </tr>
  <tr>
...
<table width="100%" >
  <tr>
    ...
    <td width="752">&nbsp;</td>
    <td width="163">&nbsp;</td>
    <td width="146" align="right"><b><label id="lblproformatotal" name="lblproformatotal"><s:property value="lblproformatotal"/></label></b></td>
  </tr>
  <tr>
    <td width="197" align="left">VAT 5% :</td>
    <td width="752">&nbsp;</td>
    <td width="163">&nbsp;</td>
    <td width="146" align="right"><b><label id="lblproformatax" name="lblproformatax"><s:property value="lblproformatax"/></label></b></td>
  </tr>
  <tr>
    <td width="197" align="left">Round Off :</td>   
    <td width="752">&nbsp;</td>
    <td width="163">&nbsp;</td>
    <td width="146" align="right"><b><label id="lblproformaround" name="lblproformaround"><s:property value="lblproformaround"/></label></b></td>
  </tr>
  <tr>
    <td align="left"><b>Net Amount :</b></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td align="right"><b><label id="lblproformanetamount" name="lblproformanetamount"><s:property value="lblproformanetamount"/></label><b></td>
  </tr>
  <tr>
    <td align="left"><b>Amount In Words : </b></td>
    <td colspan="3" align="right"><b><label id="lblproformaamountwords" name="lblproformaamountwords"><s:property value="lblproformaamountwords"/></label></b></td>
    </tr>
</table>
<!--<table width="100%" >
  <tr>
