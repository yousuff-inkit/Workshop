...
<script type="text/javascript">
 	...
 	function printHeaderVoucher() {
		...
		var path= "com/workshop/invoice/WSInvoicePrintAction.action?docno="+$('#docno').val()+"&header=1";
...
<table width="100%">
  <tr>
    <td align="center"><input type="button" name="btnvoucherhead" id="btnvoucherhead" class="myButton" value="With Header"  onclick="printHeaderVoucher();"></td>
    <!-- <td align="center"><input type="button" name="btncheque" id="btncheque" class="myButton" value="Cheque"  onclick="printCheque();"></td> -->
    <td align="center"><input type="button" name="btnvoucherwithouthead" id="btnvoucherwithouthead" class="myButton" value="Without Header"  onclick="printWithOutHeader();"></td>
  </tr>
</table>
<br/><br/><br/><br/><br/><br/>
  </div>
