...
$(document).ready(function () { 
     ...
     var dataAdapter = new $.jqx.dataAdapter(source,
            ...
            $("#labourSearchGrid").on("rowdoubleclick", function (event) {
                ...
                $('#labourcostGrid').jqxGrid('setcellvalue',labourindex,'taxable',$('#labourSearchGrid').jqxGrid('getcellvalue',row1,'taxable'));
                if($('#labourSearchGrid').jqxGrid('getcellvalue',row1,'taxable')=='0'){
