<%@page import="com.workshop.wsestimationnew.*" %>
<%
ClsWSEstimationNewDAO gatedao=new ClsWSEstimationNewDAO();
...
var id='<%=id%>';
if(id=="1"){
	laboursearchdata='<%=gatedao.getLabourSearchData(jobdocno,jobtype,date,id,gatedocno)%>';
}
     ...
     var dataAdapter = new $.jqx.dataAdapter(source,
            ...
            $("#labourSearchGrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text:'Hours', datafield:'hrs',width:'7%',cellsformat:'d2',cellsalign:'right',align:'right'},
