...
try{
	...
	String strconfig="select method from gl_config where field_nme='RestrictNonVATPrint'";
	ResultSet rsconfig=stmt.executeQuery(strconfig);
	int restrictNonVATPrint=0;
	while(rsconfig.next()){
		restrictNonVATPrint=rsconfig.getInt("method");
	}
	objconfig.put("restrictNonVATPrint",restrictNonVATPrint);
