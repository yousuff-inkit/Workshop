     ...
     var dataAdapter = new $.jqx.dataAdapter(source,
            ...
            $("#sparepartsGrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Rate', datafield: 'rate', width: '6%' ,cellsformat:'d2',editable:false,cellsalign:'right',align:'right'},
							{ text: 'Markup %', datafield: 'markuppercent', width: '6%',editable:true },
							{ text: 'Total', datafield: 'total', width: '6%' ,editable:false,cellsformat:'d2',cellsalign:'right',align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring},
							{ text: 'Remarks', datafield: 'remarks', width: '26%',editable:true }
			              ]
            });
