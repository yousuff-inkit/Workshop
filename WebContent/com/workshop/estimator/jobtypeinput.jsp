<%@page import="com.workshop.estimator.ClsEstimationDAO"%>   
...
$(document).ready(function () {
    ...
    // Create a jqxInput
    $("#jobtypeinput").jqxInput({ source: dataAdapter, placeHolder: "Job Type:", displayMember: "jobtype", valueMember: "doc_no", width: 250, height: 20});
