...
$(document).ready(function () { 
	var renderergenuine=function (aggregates){
     	...
     	if($('#genuinetotal').val()!=''){
	     	...
	     	var sparemarkup=0.0;
	     	if($('#sparemarkup').val()!='' && $('#sparemarkup').val()!=null && $('#sparemarkup').val()!="undefined" && typeof($('#sparemarkup').val())!="undefined"){
	     	...
	     	var discount=0.0;
	     	if($('#sparediscount').val()!='' && $('#sparediscount').val()!=null && $('#sparediscount').val()!="undefined" && typeof($('#sparediscount').val())!="undefined"){
	     		discount=parseFloat($('#sparediscount').val());	
	     	}
	...
	var rendererapproved=function (aggregates){
     	...
     	if($('#approvedtotal').val()!=''){
     		if($('#sparemarkup').val()!=''){
     			...
     			var approvedtotal=parseFloat($('#approvedtotal').val());
    	     	var discount=$('#sparediscount').val();
     ...
     var dataAdapter = new $.jqx.dataAdapter(source,
            ...
            $("#sparePartsNewGrid").on("cellvaluechanged", function (event) {
            	...
            	if(datafield=="qty" || datafield=="genuinerate" || datafield=="marketrate" || datafield=="usedrate"){
            		...
            		var sparetype=$('#sparePartsNewGrid').jqxGrid('getcellvalue',rowindex,'approval');
            		if($('#mode').val()=='E'){
            			if(sparetype=="Genuine"){
