	...
	var rendererstring=function (aggregates){
     	...
     	if(value!="" && value!=null && value!="undefined"){
     		...
     		if($('#servicestotal').val()!=''){
	     		...
	     		if($('#labdiscount').val()!="" && $('#labdiscount').val()!=null && $('#labdiscount').val()!="undefined" && typeof($('#labdiscount').val())!="undefined"){
	     			discountpercent=parseFloat($('#labdiscount').val())/100;
	     		}
	     		$('#servicesdiscount').val((services*discountpercent).toFixed(2));
     ...
     var dataAdapter = new $.jqx.dataAdapter(source,
            ...
            $("#labourcostGrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Hrs', datafield: 'hrs', width: '8%' ,cellsformat:'d2',cellsalign:'right',align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring},   
							{ text: 'Rate', datafield: 'rate', width: '8%' ,cellsformat:'d2',cellsalign:'right',align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring},
