...
<script>
	$(document).ready(function(e) {
        ...
        $('#btnmastersearch').click(function(e) {
			...
			var reg=$('#regno').val();
			$('#mastersearchdiv').load('masterSearchGrid.jsp?branch='+branch+'&docno='+docno+'&date='+date+'&gatevocno='+gatevocno+'&cldocno='+cldocno+'&clientname='+clientname+'&regno='+reg+'&id=1');
        });
    });
</script>
</head>
...
<table width="100%" border="0">
  ...
  <tr>
    <td colspan="7"><div id="mastersearchdiv"><jsp:include page="masterSearchGrid.jsp"></jsp:include></div></td>
  </tr>
</table>
