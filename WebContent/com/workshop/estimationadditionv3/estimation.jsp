...
function funReadOnly() {
	$('#frmEstimationAdditionV3 input').attr('readonly',true);
}
function funRemoveReadOnly() {
	//$('#frmEstimationAdditionV3 input').attr('readonly',false);
	//$('#docno').attr('readonly',true);
	$("#frmEstimationAdditionV3 input:not(.readonly)").attr('readonly',false);
	if($('#mode').val()=='A'){
...
function setValues() {
	...
	if($('#docno').val()!=''){
		var b=$('#docno').val();
		$('#complaintdiv').load('../../../com/workshop/estimationadditionv3/complaintGrid.jsp?docno='+$('#gatedocno').val()+'&branch='+$('#brchName').val()+'&id=1');	
		$('#jobtypeinputdiv').load('jobtypeinput.jsp?id=1');
		CheckEditStatus($('#docno').val());
	
	}
	if($('#docno').val()!=''){
		$('#sparepartsdiv').load('../../../com/workshop/estimationadditionv3/sparePartsNewGrid.jsp?docno='+$('#docno').val()+'&id=1&addition='+addition);
	}
	if($('#docno').val()!=''){
		$('#labourcostdiv').load('../../../com/workshop/estimationadditionv3/labourcostGrid.jsp?docno='+$('#docno').val()+'&id=1&addition='+addition);		
	}
	if($('#gatedocno').val()!=''){
		$('#sparepartsamountdiv').load('../../../com/workshop/estimationadditionv3/sparePartsAmountGrid.jsp?gatedocno='+$('#gatedocno').val()+'&id=1&addition='+addition);		
	}
...
<body onLoad="setValues();">
	<div id="mainBG" class="homeContent" data-type="background"> 
		<form id="frmEstimationAdditionV3" action="saveEstimationAdditionV3" method="post" autocomplete="off" class="form-inline">
