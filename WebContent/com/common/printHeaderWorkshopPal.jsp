...
<table width="100%" class="normaltable">
  <tr>
    <td width="30%" rowspan="6"><img id="headerimg" src="" width="100%" alt=""/></td>     
    <td width="35%" rowspan="2">&nbsp;<input type="hidden" id="lblprintpath" name="lblprintpath" value='<s:property value="lblprintpath"/>'> </td>     
