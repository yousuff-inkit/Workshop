...
ClsConnection ClsConnection=new ClsConnection();
	...
	try{
	 ...
	 String strSql = "select doc_no, type_name, type_code from my_attach_type where dtype in('"+dtype+"','GEN') and status=3" ;
		...
		//System.out.println("dfghj"+refname+"####"+refcode+"####"+refdocno);
