...
<label><hr  size=1 color="black"></label>
 ...
 <h3 style="background-color: #E6E6E8; color: #D84E72; font-family: Myriad Pro;">&nbsp;Management Note :</h3>
<%int k=0; %>
...
<table width="95%" align="center" style="border-collapse: collapse;">
  <tr style="border-collapse: collapse;background-color: #E6E6E8; color: rgb(102, 51, 255);font-family: Myriad Pro;">
    <td width="6%" height="25px" align="center"><b>Sr No.</b></td>
    <td width="14%" align="left"><b>Field Name</b></td>
