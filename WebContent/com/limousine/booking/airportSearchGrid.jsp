...
var airportdata= '<%=bookdao.getAllAirportData()%>';
       ...
       $('#airportSearch').on('rowdoubleclick', function (event) {
            	var rowindex=event.args.rowindex;
            		...
            		$("#"+gridname).jqxGrid('setcellvalue', gridrowindex, "airport", $('#airportSearch').jqxGrid('getcellvalue', rowindex, "airport"));
                    $("#"+gridname).jqxGrid('setcellvalue', gridrowindex, "airportid", $('#airportSearch').jqxGrid('getcellvalue', rowindex, "doc_no"));		
