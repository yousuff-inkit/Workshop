     ...
     var unitsearch= '<%=DAO.unitSearch(session) %>' ;
		$(document).ready(function () { 	
          ...
          $('#unitsearch').on('celldoubleclick', function (event) {
                ...
                $('#materialGrid').jqxGrid('setcellvalue', uomrow, 'unit',$('#unitsearch').jqxGrid('getcellvalue', rowindex1, "unit"));
                $('#materialGrid').jqxGrid('setcellvalue', uomrow, 'unitdocno',$('#unitsearch').jqxGrid('getcellvalue', rowindex1, "doc_no"));
