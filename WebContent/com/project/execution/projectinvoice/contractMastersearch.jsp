...
<style>
	...
	getdata(Cl_names,msdocno,Cl_mobno,cntrdates,dtype,ptype);
 

	}
 	
	function getdata(Cl_names,msdocno,Cl_mobno,cntrdates,dtype,ptype){

		 $("#refreshdivmas").load('contractsubMastersearch.jsp?Cl_names='+Cl_names+'&msdocno='+msdocno+'&Cl_mobno='+Cl_mobno+'&cntrdate='+cntrdates+'&dtype='+dtype+'&ptype='+ptype);
