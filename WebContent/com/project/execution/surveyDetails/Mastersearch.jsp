...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	function getdata1(Cl_names,msdocno,Cl_enqno,surdate){
		...
		var id=1;
		 ...
		 $("#refreshdivmas").load('subMastersearch.jsp?Cl_names='+Cl_names+'&msdocno='+msdocno+'&Cl_enqno='+Cl_enqno+'&surdate='+surdate+'&id='+id);
  ...
  <tr>
   ...
   <td align="right">Docno</td>
    ...
    <td align="right" >Enquiry</td>
      <td align="left" width="28%"><input type="text" name="Cl_enqno" id="Cl_enqno" value='<s:property value="Cl_enqno"/>'></td>
      </tr>
        <tr>
        <td>Date </td>
