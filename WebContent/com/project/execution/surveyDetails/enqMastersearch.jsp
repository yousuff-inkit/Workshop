...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	getdata1(Cl_names,msdocno,Cl_mobno,enqdate);
 

	}
	function getdata1(Cl_names,msdocno,Cl_mobno,enqdate){
		
		var id=1;
		
		 $("#refreshdivmas").load('enqsubMastersearch.jsp?Cl_names='+Cl_names+'&msdocno='+msdocno+'&Cl_mobno='+Cl_mobno+'&enqdate='+enqdate+'&id='+id);
