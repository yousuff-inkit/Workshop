...
<%int i=0; %> 
    ...
    <td align="center" style="width:30%;" ><strong>Specification</strong></td>
    <td align="center" style="width:50%;" ><strong>Description</strong></td></tr>
    </table>
    </td>
   </tr>
   ...
   <s:elseif test="#arr.index==2">
   		 <td  style="width:50%;" class="tablereceipt">
   		 <s:property value="#des"/>
   		 </td></tr>
  </s:elseif>
