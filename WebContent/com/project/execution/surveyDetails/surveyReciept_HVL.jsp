...
<table width="100%">
  ...
  <tr>
    ...
    <td align="left">Enquiry No.</td>
    <td>: <label name="enqdoc_no" id="enqdoc_no" ><s:property value="enqdoc_no"/></label></td>
    <td align="left">&nbsp;</td>
    <td align="left">&nbsp;</td>
    <td>Contact Person</td>
    <td align="left">: <label name="txtcontact" id="txtcontact" ><s:property value="txtcontact"/></td>
    <td align="left">&nbsp;</td>
    <td align="left">&nbsp;</td>
    <td></td>
    <td align="left"></td>
...
<%int i=0; %> 
     <s:iterator status="arr" value="#stat.split('::')" var="des">
      ...
      <s:if test="#des!=''">
   	...
   	<td colspan="3">
   	<table width="100%" class="tablereceipt"><tr>
    <td align="center" style="width:33%;" ><strong>Specification</strong></td>
    <td align="center" style="width:33%;" ><strong>Quantity</strong></td>
    <td align="center" style="width:33%;" ><strong>Description</strong></td></tr>
    </table>
    </td>
   </tr>
   ...
   <s:elseif test="#arr.index==1">
   		<tr class="tablereceipt"><td class="tablereceipt"><s:property value="#des"/>
   		</td>
   		</s:elseif>
   <s:elseif test="#arr.index==2">
   		 <td  style="width:33%;" class="tablereceipt">
   		 <s:property value="#des"/>
   		 </td>
  </s:elseif>
