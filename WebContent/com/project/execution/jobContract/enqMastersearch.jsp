...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	$(document).ready(function () {
 	...
 	function enqloadSearch1() {
 		...
 		var dtype=document.getElementById("cmbreftype").value;
 		var formcode=document.getElementById("formdetailcode").value;
 		
	getdata1(Cl_names,msdocno,Cl_mobno,enqdate,clientid,dtype,formcode);
 

	}
	function getdata1(Cl_names,msdocno,Cl_mobno,enqdate,clientid,dtype,formcode){
		

		
		 $("#refreshdivmas").load('enqsubMastersearch.jsp?Cl_names='+Cl_names+'&msdocno='+msdocno+'&Cl_mobno='+Cl_mobno+'&enqdate='+enqdate+'&clientid='+clientid+'&dtype='+dtype+'&formcode='+formcode);
