...
<table width="100%"  >
  ...
  <tr>
   <td width="16%" align="left">SQT No</td>
   <td colspan="3">: <label id="sqtno" name="sqtno"><s:property value="sqtno"/></td>
   <td width="18%"></td>
    <td width="20%"></td>
   </tr>
  <tr>
...
<table width="50%">
<tr>
<td width="50%" align="left">Legal Charge</td>
   <td >: <label id="legalchrg" name="legalchrg"><s:property value="legalchrg"/></td>
