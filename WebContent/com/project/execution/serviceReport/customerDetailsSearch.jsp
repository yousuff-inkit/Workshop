...
#search {
	...
	function getdata(clientName,clientId,contactNo,check){
		 $("#refreshdiv").load('customerDetailsSearchGrid.jsp?clientname='+clientName.replace(/ /g, "%20")+'&clientid='+clientId+'&contactno='+contactNo+'&check='+check);
		}
...
<table width="100%">
  ...
  <tr>
    <td colspan="5"><div id="refreshdiv"><jsp:include page="customerDetailsSearchGrid.jsp"></jsp:include></div></td>
  </tr>
</table>
  </div>
</body>
