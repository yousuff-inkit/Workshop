...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	function getdata(docnoss,accountss,accnamess,datess,reftypess,aa,mobileno){
		 ...
		 $("#refreshdivs").load('submasterSearch.jsp?docnoss='+docnoss+'&accountss='+accountss+'&accnamess='+accnamess+'&datess='+datess+'&reftypess='+reftypess+'&aa='+aa+'&mobileno='+mobileno);
...
<table width="100%" >
  ...
  <option value="DIR" >DIR</option>
    ...
    <td align="left"  width="30%"><input type="text" name="mobileno" style="width:90%;" id="mobileno" value='<s:property value="mobileno"/>'></td>
