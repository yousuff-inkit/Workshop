...
<body style="background-color:#fff !important;bgcolor: white;font-size: 12px;" onload="hidedata();">
...
<form id="frmprintAMCContract" action="printAmcContract" autocomplete="off" target="_blank" >
 ...
 <table width="100%">
 <tr>
 <td width="20%" rowspan="6"><img src="<%=contextPath%>/icons/epic.jpg" width="200" height="50"  alt=""/></td>
 </tr>
<tr>
...
<table width="100%" >
  ...
  <tr>
    <td colspan="2" align="left"><b><label id="lblcompname" name="lblcompname" ><s:property value="lblcompname"/></label></b></td>
    <td colspan="2" align="left"></td>
    <td colspan="2" align="left"><b><label id="txtclient" name="txtclient" ><s:property value="txtclient"/></label></b></td>
  </tr>
  <tr>
    <td colspan="2" align="left"><label id="lblcompaddress" name="lblcompaddress" ><s:property value="lblcompaddress"/></label></td>
    <td colspan="2" align="center"><b>And</b></td>
    <td colspan="2" align="left"><label id="txtclientdet" name="txtclientdet" ><s:property value="txtclientdet"/></label></td>
  </tr>
  <tr>

    <td colspan="2" align="left">(Being the First party and herin after called <label name="lblcompname" id="lblcompname" ><s:property value="lblcompname"/>)</label></td>
    <td width="12%" align="left">&nbsp;</td>
    <td width="16%"></td>
    <td colspan="2" align="left">(Being the 2nd party herein after called CLIENT)</td>
  </tr>
...
<table width="100%" >
  <tr>
    ...
    <td width="36%"><label id="lblcheckedby" name="lblcheckedby"><s:property value="lblcheckedby"/></label></td>
    <td width="19%">Approved by</td>
    <td width="35%"><label id="lblrecievedby" name="lblrecievedby"><s:property value="lblrecievedby"/></label></td>
    </tr>
    <tr>
    <td width="10%">Date</td>
    <td width="36%"><label id="lblfinaldate" name="lblfinaldate"><s:property value="lblfinaldate"/></label></td>
    <td width="19%">Date</td>
    <td width="35%"></td>
    ...
    <tr>
    <td width="10%">Time</td>
    <td width="36%"><label id="lblfinaltime" name="lblfinaltime"><s:property value="lblfinaltime"/></label></td>
    <td width="19%">Time</td>
    <td width="35%"></td>
    </tr>
  <tr>
