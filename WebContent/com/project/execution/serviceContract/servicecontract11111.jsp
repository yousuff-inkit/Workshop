...
function funReadOnly(){
	 ...
	 $('#frmservicecntr input').attr('readonly', true);
	 $('#frmservicecntr input').attr('disabled', true);
	 $('#frmservicecntr select').attr('disabled', true);
...
function funRemoveReadOnly(){
	 ...
	 $('#frmservicecntr input').attr('disabled', false);
	 $('#frmservicecntr select').attr('disabled', false);
	 
	 $('#txtcntrval').attr('readonly', false);
	 $('#installments').attr('readonly', false);
...
function funpay(){
	...
	var instno=$("#installments").val();
	 ...
	 $("#paydiv").load("paymentGrid.jsp?startdate="+startdate+"&enddate="+enddate+"&amount="+amount+"&instno="+instno+"&gridload=1"); 
}
...
<br/> 
	<div id="mainBG" class="homeContent" data-type="background"> 
	  ...
	  <form id="frmservicecntr" action="saveservicecntr" method="post" autocomplete="off">
  ...
  <tr>
    ...
    <td colspan="3"><input type="text" name="txtmob2" id="txtmob2" style="width:30%;" value='<s:property value="txtmob2" />'></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="17%"><select id="cmbreftype" name="cmbreftype" style="width:60%;" onchange="refChange();" value='<s:property value="cmbreftype"/>'>
      <option value="DIR">DIR</option>
      <option value="SQOT">SQOT</option>
      <option value="JEST">JEST</option>
    </select></td>
    <td width="12%">&nbsp;</td>
    <td width="20%"><input type="text" id="rrefno" name="rrefno" placeholder="Press F3 to Search"  onKeyDown="getrefno(event);" value='<s:property value="rrefno"/>'/></td>
    <td width="41%">&nbsp;</td>
  </tr>
  <tr>
    <td align="right">Contract Value</td>
    <td><input type="text" id="txtcntrval" name="txtcntrval" value='<s:property value="txtcntrval"/>'/></td>
    <td align="right">Tax Per</td>
    <td><input type="text" id="txttaxper" name="txttaxper" onKeyDown="getrefno(event);" value='<s:property value="txttaxper"/>'/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td align="right"><input type="checkbox" name="chklegaldoc" id="chklegaldoc" ><label for="chklegaldoc">Legal Document</label></td>
  ...
  <tr>
    ...
    <button class="myButton" type="button" id="btnAdd" name="btnAdd" onclick="funpay();">Fill</button>
  ...
  <tr>
    ...
    <fieldset><legend>Service Scheduler</legend>
     <button class="myButton" type="button" id="btnAdd" name="btnAdd" onclick="funscheduler();">Fill</button>
