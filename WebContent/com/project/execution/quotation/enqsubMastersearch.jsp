...
%> 
 ...
 var enqmasterdata; 
  ...
  enqmasterdata='<%=DAO.enquirySrearch(session,msdocno,Cl_names,Cl_mobno,enqdate,clientid,id,cntype)%>';
     ...
     $('#subEnqirySearch').on('rowdoubleclick', function (event) 
 	  ...
 	  var rowindex1=event.args.rowindex;
        	...
        	var tr_no=document.getElementById("enquiryid").value;
             ...
             $("#siteDetailsDiv").load("siteGrid.jsp?trno="+tr_no+"&gridload=1");
 			 $("#serviceDetailsDiv").load("serviceGrid.jsp?trno="+tr_no+"&gridload=1");
