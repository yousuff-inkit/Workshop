				...
				var docno=$('#docno').val();
		  		...
		  		if(hedderstat==""){
		  			...
		  			return false;
						  ...
						  var win= window.open(reurl[0]+"printQuotation?docno="+docno+"&brhid="+brhid+"&trno="+trno+"&dtype="+dtype+"&id="+id+"&hedderstat="+hedderstat+"&header=1","_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
					     win.focus();  
...
<table width="100%">
  <tr>
  	...
  	<td align="right"><input type="radio" id="rdbhdrshow" name="rdo" onchange="funcheck();" value="Show Headder">With Headder</td>
    <td></td>
    <td  align="left"><input type="radio" id="rdbhdrhide" name="rdo" onchange="funcheck();" value="Hide Headder">Without Headder
