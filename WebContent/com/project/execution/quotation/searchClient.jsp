         ...
         //	var url1;
          ...
          /*   $("#Jqxclientsearch").jqxGrid('addrow', null, {}); */
				           ...
				           $('#Jqxclientsearch').on('rowdoubleclick', function (event) 
				               ...
				               document.getElementById("txtmob").value=$('#Jqxclientsearch').jqxGrid('getcellvalue', rowindex1, "per_mob");
				               document.getElementById("txtemail").value=$('#Jqxclientsearch').jqxGrid('getcellvalue', rowindex1, "mail1");
				               document.getElementById("txttel").value=$('#Jqxclientsearch').jqxGrid('getcellvalue', rowindex1, "pertel");
