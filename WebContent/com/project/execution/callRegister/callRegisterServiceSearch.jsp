...
<script type="text/javascript">
	...
	function loadServicesSearchGrid() {
			...
			getServicesDetails(services,items,contractno,check);
	}
		
	function getServicesDetails(services,items,contractno,check) {
		 $("#refreshCallRegisterServiceSearchDetailsDiv").load("callRegisterServiceSearchGrid.jsp?services="+services.replace(/ /g, "%20")+'&items='+items.replace(/ /g, "%20")+'&contractno='+contractno+'&check='+check);
	}
...
<table width="100%">
  ...
  <tr>
    <td colspan="5"><div id="refreshCallRegisterServiceSearchDetailsDiv"><jsp:include page="callRegisterServiceSearchGrid.jsp"></jsp:include></div></td>
  </tr>
</table>
</div>
</body>
