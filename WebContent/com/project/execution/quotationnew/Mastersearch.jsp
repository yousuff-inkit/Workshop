...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	getdata1(Cl_names,msdocno,surdate,cntrtype,sereftype,Cl_site,Cl_area,Cl_amount);
 

	}
	function getdata1(Cl_names,msdocno,surdate,cntrtype,sereftype,Cl_site,Cl_area,Cl_amount){
		
		var id=1;
		
		 $("#refreshdivmas").load('subMastersearch.jsp?Cl_names='+Cl_names+'&msdocno='+msdocno+'&sereftype='+sereftype+'&surdate='+surdate+'&cntrtype='+cntrtype+'&Cl_site='+Cl_site+'&Cl_area='+Cl_area+'&Cl_amount='+Cl_amount+'&id='+id);
