				...
				var docno=$('#docno').val();
		  		...
		  		if(hedderstat==""){
		  			...
		  			return false;
						  ...
						  var win= window.open(reurl[0]+"printQuotationnew?docno="+docno+"&brhid="+brhid+"&trno="+trno+"&dtype="+dtype+"&id="+id+"&hedderstat="+hedderstat+"&header=1"+"&reviseno="+reviseno+"&totalstat="+totalstat,"_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
					     win.focus();  
...
<table width="100%">
  <tr>
    ...
    <tr>
    <td align="right" width="50%"><input type="radio" id="rdbntotalshow" name="rdbntot" onchange="funtotshowcheck();" value="Show Total">With Total</td>
    
    <td  align="left" width="50%"><input type="radio" id="rdbntotalhide" name="rdbntot" onchange="funtotshowcheck();" value="Hide Total">Without Total
    							  <input type="text" id="totalstat" name="totalstat" value='<s:property value="totalstat"/>' /></td>
