...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	$(document).ready(function () {
 	...
 	function enqloadSearch1() {
 		...
 		var cntype=document.getElementById("hidradio").value;
		var reftype1=document.getElementById("cmbreftype").value;
 		
 		
	getdata1(Cl_names,msdocno,Cl_mobno,enqdate,clientid,cntype,reftype1);
 

	}
	function getdata1(Cl_names,msdocno,Cl_mobno,enqdate,clientid,cntype,reftype1){
		
			var id=1;
		
	$("#refreshdivmas").load('enqsubMastersearch.jsp?Cl_names='+Cl_names+'&msdocno='+msdocno+'&Cl_mobno='+Cl_mobno+'&enqdate='+enqdate+'&clientid='+clientid+'&id='+id+'&cntype='+cntype+'&reftype='+reftype1);
