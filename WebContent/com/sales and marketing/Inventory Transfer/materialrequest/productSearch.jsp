...
%> 
       <script type="text/javascript">
  		var id='<%=id%>';
  		if(id==1){
  			 var prdata= '<%=searchDAO.searchProduct(session,id)%>';
  		}
            ...
            $("#prosearch").jqxGrid(
            {
                ...
                columns: [
                          ...
                          { text: '', sortable: false, filterable: false, editable: false,
                              ...
                              { text: 'stock Qty', datafield: 'stockqty', width: '5%',hidden:true},
          ...
          $('#prosearch').on('rowdoubleclick', function (event) {
              ...
              if(parseInt($('#prosearch').jqxGrid('getcellvalue', rowindex2, "method"))==0)
        	   ...
        	   if(parseInt(aa)==1)
                ...
                document.getElementById("stockmsg").innerText=$('#prosearch').jqxGrid('getcellvalue', rowindex2, "stockqty");
                ...
                $('#serviecGrid').jqxGrid('setcellvalue', rowindex1, "stockqty" ,$('#prosearch').jqxGrid('getcellvalue', rowindex2, "stockqty"));
