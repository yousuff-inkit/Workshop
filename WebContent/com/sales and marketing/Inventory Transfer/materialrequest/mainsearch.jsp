...
<table width="100%" >
  <tr >
   ...
   <td align="right"  width="14%">Job No</td>
    <td align="left"  width="30%"><input type="text" name="prjdocnos" style="width:60%;" id="prjdocnos" value='<s:property value="prjdocnos"/>'></td>
