		        	...
		        	if(r==false)
		        	  {
		        		...
		        		$("#prodsearchtype").val("2");
		       		  ...
		       		  $("#delNoteDiv").load("deliveryNoteGrid.jsp?enqdoc="+ document.getElementById("refmasterdocno").value+'&locationid='+document.getElementById("locationid").value+"&chk="+chk+"&from="+from+"&cond=1");	
