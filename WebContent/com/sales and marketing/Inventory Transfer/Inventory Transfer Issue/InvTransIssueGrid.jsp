...
{   
 ...
 var rendererstring2=function (aggregates){
	  ...
	  var cellclassname = function (row, column, value, data) {
    		...
    		var ss= $('#jqxInvIssueGrid').jqxGrid('getcellvalue', row, "qty");
	          if(parseInt(ss)<=0)
	  		{
          ...
          applyFilter(dataField,$(this).val());  
            ...
            $("#jqxInvIssueGrid").jqxGrid(
            {
                ...
                handlekeyboardnavigation: function (event) {
                    ...
                    var cell4 = $('#jqxInvIssueGrid').jqxGrid('getselectedcell');
  	            ...
  	            if(typeof(aa)=="undefined")
  	              ...
  	              /*   if(parseInt(rows[0].method)==0)
  	            		...
  	            		var rows1 = $("#jqxInvIssueGrid").jqxGrid('getrows');
  	          	    var aa=0;
  	          	   ...
  	          	   if(parseInt(aa)==1)
  	            	  ...
  	            	  /* }
  	               	 ...
  	               	 var rows = $("#prosearch").jqxGrid('getrows');
  	                	   ...
  	                	   $('#jqxInvIssueGrid').jqxGrid('render');
  	              	  var rowindex1 =$('#rowindex').val();
  	               $('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowindex1, "proid" ,rows[0].part_no);
  	            
  	            $('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowindex1, "proname" ,rows[0].productname);
  	               
  	            
  	               
  	          
  	          
  	             $('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowindex1, "brandname" ,rows[0].brandname);
  	          
  	                $('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowindex1, "productid" ,rows[0].part_no);
  	                $('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowindex1, "productname" ,rows[0].productname);
  	                $('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowindex1, "prodoc" ,	rows[0].doc_no);
  	                $('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowindex1, "unit" ,rows[0].unit);
  	                $('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowindex1, "unitdocno" ,rows[0].unitdocno);
  	                $('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowindex1, "psrno" ,rows[0].psrno ); 
  	                $('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowindex1, "qty" ,rows[0].qty );
  	                $('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowindex1, "outqty" ,rows[0].outqty );
  	                $('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowindex1, "balqty" ,rows[0].balqty );
  	              $('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowindex1, "specid" ,rows[0].specid );
  	            $('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowindex1, "stkid" ,rows[0].stkid );
  	            $('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowindex1, "totqty" ,rows[0].totqty );
  	          $('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowindex1, "unitprice" ,rows[0].unitprice );
  	                
  	             // $("#jqxInvIssueGrid").jqxGrid('selectcell',rowindex1, "qty" );
  	        //  $("#jqxInvIssueGrid").jqxGrid('begincelledit', rowindex1, 'qty');
...
/*             //	var aa=$('#jqxInvIssueGrid').jqxGrid('getcellvalue', cell4.rowindex, "productid");
            	  var temp= $('#jqxInvIssueGrid').jqxGrid('getcellvalue', 0, "productid"); 
  	 ...
  	 $('#jqxInvIssueGrid').on('cellclick', function (event) {
    			 
    			 document.getElementById("errormsg").innerText="";	 
    			 
    		 }); 
            $('#jqxInvIssueGrid').on('cellbeginedit', function (event) {
            	...
            	var columnindex1=event.args.columnindex;
            	 ...
            	 var refmasterdocno=$("#refmasterdocno").val();
            		...
            		var df=event.args.datafield;
                	 ...
                	 productSearchContent('productSearch.jsp?prodsearchtype='+prodsearchtype+'&enqmasterdocno='+refmasterdocno+'&frmlocation='+document.getElementById("locationfrmid").value);
            	 var rowindextemp = event.args.rowindex;
            	    document.getElementById("rowindex").value = rowindextemp;  
            	    
           var temp= $('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowindextemp, "productid"); 
           ...
           { 
               ...
               $('#part_no').val($('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowindextemp, "proid"));
               
               
               $('#gridtext').val($('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowindextemp, "proid"));
               
               
               
              
               $('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowindextemp, "productid" ,$('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowindextemp, "proid"));
        	 ...
        	 var rowindextemp = event.args.rowindex;
        	    document.getElementById("rowindex").value = rowindextemp;  
        	      ...
        	      var temp= $('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowindextemp, "productname"); 
                ...
                // alert(temp);
                 if(temp==""||typeof(temp)=="undefined"|| typeof(temp)=="NaN")
        		   { 
              	   ...
              	   $('#productname').val($('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowindextemp, "proname"));
              	   
              	   $('#gridtext1').val($('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowindextemp, "proname"));
              	   
                     
                     $('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowindextemp, "productname" ,$('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowindextemp, "proname"));
            ...
            function valchange(rowBoundIndex,datafield)
            {
            	...
            	var searchtype=document.getElementById("prodsearchtype").value;
            	 qty= $('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowBoundIndex, "qty");	
            	 oldqty= $('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowBoundIndex, "oldqty");
            	 totqty= $('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowBoundIndex, "totqty");
            	 outqty= $('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowBoundIndex, "outqty");
            	 balqty= $('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowBoundIndex, "balqty");
            	 unitprice=	$('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowBoundIndex, "unitprice");
            	 totwtkg=$('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowBoundIndex, "totwtkg");
            	 kgprice=$('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowBoundIndex, "kgprice");
            	 unitprice=$('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowBoundIndex, "unitprice");
            	 total=$('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowBoundIndex, "total");
            	 discper=$('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowBoundIndex, "discper");
            	 discount=$('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowBoundIndex, "dis");
            	 netotal=$('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowBoundIndex, "netotal");
            	
            	 if(datafield=='qty'){
            		 tmpqty=qty+outqty;
            		 /* -oldqty */
                	 tmpqty1=oldqty+balqty;
                	 //$('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowBoundIndex, "oldqty",qty);
             		//$('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowBoundIndex, "outqty",tmpqty);
            	...
            	// $("#jqxInvIssueGrid").jqxGrid('showvalidationpopup', rowBoundIndex, "qty", "Quantity should not be greater than available  quantity "+balqty);
            	
            	 document.getElementById("errormsg").innerText="Quantity should not be greater than available  quantity "+balqty;
            	 
            	 //$('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowBoundIndex, "qty",tmpqty1);
            	 }
            	 
            	 else{
            		 document.getElementById("errormsg").innerText="";
            		 // $("#jqxInvIssueGrid").jqxGrid('hidevalidationpopups');
            	 }
             		 }
             	else if($('#mode').val()=="A"){
             		if(qty>balqty){
            	 ...
            	 if(qty>balqty){
            		 ...
            		 $('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowBoundIndex, "qty",balqty);
            	 }
            	 else if(qty<=balqty){
            		 document.getElementById("errormsg").innerText="";
            	 }
            	...
            	$('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowBoundIndex, "unitprice",unitprice);
            	$('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowBoundIndex, "total",total);
            	$('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowBoundIndex, "dis",discount);
            	$('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowBoundIndex, "discper",discper);
            	$('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowBoundIndex, "netotal",netotal);
        ...
        /*     		netotal=parseFloat(total)-parseFloat(discount);
            		...
            		var summaryData1= $("#jqxInvIssueGrid").jqxGrid('getcolumnaggregateddata', 'total', ['sum'],true);
            		var summaryData= $("#jqxInvIssueGrid").jqxGrid('getcolumnaggregateddata', 'netotal', ['sum'],true);
	        		var summaryData2= $("#jqxInvIssueGrid").jqxGrid('getcolumnaggregateddata', 'dis', ['sum'],true);
          ...
          document.getElementById("orderValue").value=summaryData.sum.replace(/,/g,''); 
            ...
            $("#jqxInvIssueGrid").on('cellvaluechanged', function (event) 
                    {
            	...
            	$('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowBoundIndex, "productid" ,$('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowBoundIndex, "proid"));
                $('#sidesearchwndow').jqxWindow('close');
            		   }
            	   
            	   if(datafield=="productname")
            		   {
            		   	$('#jqxInvIssueGrid').jqxGrid('setcellvalue', rowBoundIndex, "productname" ,$('#jqxInvIssueGrid').jqxGrid('getcellvalue', rowBoundIndex, "proname"));
                        $('#sidesearchwndow').jqxWindow('close');
   ...
   if (x.readyState==4 && x.status==200)
    {
      ...
      if(parseInt(items)>0)
       {
    	  ...
    	  $('#jqxInvIssueGrid').jqxGrid('showcolumn', 'brandname');
          ...
          else
      {
        	  ...
        	  $('#jqxInvIssueGrid').jqxGrid('hidecolumn', 'brandname');
