...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	var aa="yes";
		getdata(docnoss,accountss,datess,aa);
 

	}
	function getdata(docnoss,accountss,datess,aa){
		
		 $("#refreshdivs").load('subrefsearch.jsp?docnoss='+docnoss+'&types='+accountss+'&datess='+datess+'&aa='+aa);
...
<table width="100%" >
  <tr >
   ...
   <tr>
    ...
    <td align="left"><input type="text" name="types" id="types" style="width:80%;"  value='<s:property value="types"/>'></td>
    
   <td align="right"  width="14%">&nbsp;</td>
    <td align="left"  width="30%">&nbsp; <input type="hidden" name="accnamess" style="width:90%;" id="accnamess" value='<s:property value="accnamess"/>'></td>
  ...
  <tr>
   ...
   <jsp:include  page="subrefsearch.jsp"></jsp:include> 
