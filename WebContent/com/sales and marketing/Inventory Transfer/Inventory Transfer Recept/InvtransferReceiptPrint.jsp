...
<td width="50%">
<fieldset>
<legend><b>Inventory Issue From</b></legend>  
<table width="100%"  >
<tr>
...
<td width="50%">
<fieldset>
<legend><b>Inventory Receipt Details</b></legend>
<table width="100%" >
  <tr>
    <td width="21%"><div align="right">Location</div></td>
    <td width="79%"> : <label id="lbllocationto" name="lbllocationto"><s:property value="lbllocationto"/></label></td>
  </tr>
  <tr>
    <td><div align="right">Issue No</div></td>  
    <td> : <label id="lblissueno" name="lblissueno"><s:property value="lblissueno"/></label></td>
  </tr>
  <tr>
