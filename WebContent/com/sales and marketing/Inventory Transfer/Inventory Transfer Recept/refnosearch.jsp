...
.myButtons:active {
	...
	function getdatas(docnoss,refnosss,datess,aa){
		...
		var frmlocid=document.getElementById("locationfrmid").value;
		var tolocid=document.getElementById("locationtoid").value;
	
			 $("#refsearch").load('subrefnosearch.jsp?docnoss='+docnoss+'&datess='+datess+'&refnosss='+refnosss+'&aa='+aa+'&frmlocid='+frmlocid+'&tolocid='+tolocid);
		        	...
		        	if(r==false)
		        	  {
		        		...
		        		$("#prodsearchtype").val("2");
		       		  ...
		       		  $("#InvTransReceptGrid").load("InvTransReceptGrid.jsp?enqdoc="+ document.getElementById("refmasterdocno").value+"&chk="+chk+"&from="+from+"&cond=1");	
