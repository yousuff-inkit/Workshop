     ...
     var branchdata= '<%=DAO.searchBranch(session,branchid) %>';
		$(document).ready(function () { 	
          ...
          $('#branchsearch').on('rowdoubleclick', function (event) {
                ...
                document.getElementById("txtfrmbranch").value=$('#branchsearch').jqxGrid('getcellvalue', rowindex1, "branch");
                document.getElementById("branchfrmid").value=$('#branchsearch').jqxGrid('getcellvalue', rowindex1, "doc_no");
