...
function funReadOnly(){
	...
	$('#frmbrinvReturn input').attr('readonly', true );
	$('#frmbrinvReturn select').attr('disabled', true);
...
document.getElementById("editdata").value="";
	$('#frmbrinvReturn input').attr('readonly', false );
	$('#frmbrinvReturn select').attr('disabled', false);
  ...
  x.send();
	...
	function funwarningopen(){
	   ...
	   function funPrintBtn(){
	        ...
	        var reurl=url.split("saveBranchInvoiceReturn");
	        
	        $("#docno").prop("disabled", false);                
	        
	  
	var win= window.open(reurl[0]+"printbranchinvret?docno="+document.getElementById("masterdoc_no").value+"&formdetailcode=CREDIT","_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
...
<form id="frmbrinvReturn" action="saveBranchInvoiceReturn" method="post" autocomplete="off">
...
<table width="100%">
  <tr>
    ...
    <td width="10%"><input type="text" id="txtrefno" name="txtrefno" style="width:80%;" value='<s:property value="txtrefno"/>'/></td>
    <td align="right">Location</td>
  <td><input type="text" id="txtlocation" name="txtlocation" style="width:60%;" placeholder="Press F3 to Search" value='<s:property value="txtlocation"/>' onkeydown="getLocation(event);"/>
      <input type="hidden" id="locationid" name="locationid" value='<s:property value="locationid"/>'/></td>
    <td width="9%" align="right">Doc No.</td>
    <td width="20%"><input type="text" id="docno" name="docno" style="width:50%;" value='<s:property value="docno"/>' tabindex="-1"/></td>
  </tr>
  <tr>
  <td align="right"></td>
  <td><input type="hidden" id="txtsalesperson" name="txtsalesperson" style="width:71%;" placeholder="Press F3 to Search" onKeyDown="getSalesPerson(event);" value='<s:property value="txtsalesperson"/>'>
      <input type="hidden" id="salespersonid" name="salespersonid" value='<s:property value="salespersonid"/>'/></td>
  <td align="right"></td>
  <td><select id="cmbmodeofpay"  hidden="true" name="cmbmodeofpay" style="width:51%;" value='<s:property value="cmbmodeofpay"/>'>
