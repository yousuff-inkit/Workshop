	  ...
	  function setValues(){
		 ...
		 // funSetlabel();
		  ...
		  if(masterdoc_no>0){
			  ...
			  $("#delNoteDiv").load("deliveryNoteGrid.jsp?qotdoc="+masterdoc_no+"&locationid="+locationid+"&reftype="+cmbreftype+"&enqdoc="+refmasterdocno+"&cond=2"+"&date="+document.getElementById("date").value);
