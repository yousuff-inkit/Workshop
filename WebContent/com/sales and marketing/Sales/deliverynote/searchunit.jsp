...
<script type="text/javascript">
        ...
        $(document).ready(function () { 	
    	   ...
    	   $('#jqxDeliveryNote').jqxGrid('setcellvalue', rowno, "qty" ,'');
    	   
    	   
         	 
 
                   $('#jqxDeliveryNote').jqxGrid('setcellvalue', rowno, "unit" ,$('#qtysearchgrid').jqxGrid('getcellvalue', rowindextemp, "unit"));
	                $('#jqxDeliveryNote').jqxGrid('setcellvalue', rowno, "unitdocno" ,$('#qtysearchgrid').jqxGrid('getcellvalue', rowindextemp, "doc_no"));
