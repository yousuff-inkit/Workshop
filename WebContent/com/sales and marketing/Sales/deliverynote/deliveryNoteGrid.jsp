...
var cond='<%=cond%>';
  ...
  if(cond=="1")
 {
 	...
 	qotgriddata='<%=DAO.prdGridReload(session,enqdoc,locationid,date)%>';  

 } 
 else if(temp>0  && cond=="2")
{
	
	qotgriddata='<%=DAO.prdGridReload(session,qotdoc,enqdoc,locationid,reftype,date)%>';  
          ...
          applyFilter(dataField,$(this).val());  
            ...
            $("#jqxDeliveryNote").jqxGrid(
            {
                ...
                handlekeyboardnavigation: function (event) {
                    ...
                    var cell1 = $('#jqxDeliveryNote').jqxGrid('getselectedcell');
                            ...
                            var rowindextemp=cell1.rowindex;
                       	    document.getElementById("rowindex").value = cell1.rowindex;   
          			      	...
          			      	qtyinfoSearchContent('searchunit.jsp?psrno='+$('#jqxDeliveryNote').jqxGrid('getcellvalue', rowindextemp, "psrno")+
        			      			...
        			      			+"&unitdocno="+$('#jqxDeliveryNote').jqxGrid('getcellvalue', rowindextemp, "unitdocno")+"&locationid="+document.getElementById("locationid").value+"&date="+document.getElementById("date").value);
            	...
            	var columnindex1=event.args.columnindex;
            	 ...
            	 var refmasterdocno=$("#refmasterdocno").val();
            		var df=event.args.datafield;
                	 ...
                	 productSearchContent('productSearch.jsp?prodsearchtype='+prodsearchtype+'&enqmasterdocno='+refmasterdocno+'&location='+document.getElementById("locationid").value+'&reftype='+reftype+"&date="+document.getElementById("date").value);
            	 var rowindextemp = event.args.rowindex;
            	    document.getElementById("rowindex").value = rowindextemp;  
