...
.myButtons:active {
	...
	function getdatas(docnoss,refnosss,datess,aa){
		...
		var clientid=document.getElementById("clientid").value;
			 ...
			 $("#refsearch").load('subrefnosearch.jsp?docnoss='+docnoss+'&datess='+datess+'&refnosss='+refnosss+'&aa='+aa+'&clientid='+clientid+'&locaid='+document.getElementById("locationid").value);
		        	...
		        	if(r==false)
		        	  {
		        		...
		        		$("#prodsearchtype").val("2");
		       		  ...
		       		  $("#delNoteDiv").load("deliveryNoteGrid.jsp?enqdoc="+ document.getElementById("refmasterdocno").value+'&locationid='+document.getElementById("locationid").value+"&chk="+chk+"&from="+from+"&cond=1"+"&date="+document.getElementById("date").value);	
