		        	...
		        	if(r==false)
		        	  {
		        		...
		        		$("#prodsearchtype").val("2");
		       		  ...
		       		  $("#delreturngrid").load("deliveryNoteReturnGrid.jsp?enqdoc="+ document.getElementById("refmasterdocno").value+'&locaid='+document.getElementById("locationid").value+"&chk="+chk+"&from="+from+"&cond=1");	
