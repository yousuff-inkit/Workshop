...
<script type="text/javascript">
        ...
        $(document).ready(function () { 	
        	var Reqmaster='<%=DAO.searchunit(mode,psrno,session,oldqty,unitdocno,locationid,date) %>'; 
    	   ...
    	   $('#jqxInvoiceGrid').jqxGrid('setcellvalue', rowno, "qty" ,'');
    	   
    	   
         	 
 
                   $('#jqxInvoiceGrid').jqxGrid('setcellvalue', rowno, "unit" ,$('#qtysearchgrid').jqxGrid('getcellvalue', rowindextemp, "unit"));
	                $('#jqxInvoiceGrid').jqxGrid('setcellvalue', rowno, "unitdocno" ,$('#qtysearchgrid').jqxGrid('getcellvalue', rowindextemp, "doc_no"));
	                
	                
	         /*         var fr= $('#qtysearchgrid').jqxGrid('getcellvalue', rowindextemp, "fr");
	                var oldqty= $('#jqxInvoiceGrid').jqxGrid('getcellvalue', rowno, "oldqty");
	                var totqty= $('#jqxInvoiceGrid').jqxGrid('getcellvalue', rowno, "totqty");
	                var outqty= $('#jqxInvoiceGrid').jqxGrid('getcellvalue', rowno, "outqty");
	                var balqty= $('#jqxInvoiceGrid').jqxGrid('getcellvalue', rowno, "balqty");
	                 */
	     /*            alert("oldqty="+oldqty);
	                alert("totqty="+totqty);
	                alert("outqty="+outqty);
	           ...
	           /*      if(!(parseFloat(fr)>0))
	                ...
	                if(parseFloat(oldqty)>0)
	                	{
	                	  $('#jqxInvoiceGrid').jqxGrid('setcellvalue', rowno, "oldqty" ,parseFloat(oldqty)/parseFloat(fr));
	                	}
	                if(parseFloat(totqty)>0)
                	{
	                	 $('#jqxInvoiceGrid').jqxGrid('setcellvalue', rowno, "totqty" ,parseFloat(totqty)/parseFloat(fr));
                	}
	                if(parseFloat(outqty)>0)
                	{
	                	 $('#jqxInvoiceGrid').jqxGrid('setcellvalue', rowno, "outqty" ,parseFloat(outqty)/parseFloat(fr));
                	}
	                if(parseFloat(balqty)>0)
                	{
	                	 $('#jqxInvoiceGrid').jqxGrid('setcellvalue', rowno, "balqty" ,parseFloat(balqty)/parseFloat(fr));
                	} */
                	
                	
	                $('#jqxInvoiceGrid').jqxGrid('setcellvalue', rowno, "balqty" ,$('#qtysearchgrid').jqxGrid('getcellvalue', rowindextemp, "balqty"));
	                $('#jqxInvoiceGrid').jqxGrid('setcellvalue', rowno, "outqty" ,$('#qtysearchgrid').jqxGrid('getcellvalue', rowindextemp, "outqty"));
	                $('#jqxInvoiceGrid').jqxGrid('setcellvalue', rowno, "totqty" ,$('#qtysearchgrid').jqxGrid('getcellvalue', rowindextemp, "totqty"));
	                $('#jqxInvoiceGrid').jqxGrid('setcellvalue', rowno, "oldqty" ,$('#qtysearchgrid').jqxGrid('getcellvalue', rowindextemp, "oldqty"));
