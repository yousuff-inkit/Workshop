...
String docnoss=request.getParameter("docnoss")==null?"0":request.getParameter("docnoss");
 ...
 String ref=request.getParameter("ref")==null?"0":request.getParameter("ref");
...
if(temps='yes')
	{
  Reqmaster= '<%=DAO.reqSearchMasters(session,docnoss,refnosss,datess,clientid,reftype,ref) %>'; 
	}
else
	{
	Reqmaster; 
