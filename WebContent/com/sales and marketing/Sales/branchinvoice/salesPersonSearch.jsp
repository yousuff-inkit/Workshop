		...
		$(document).ready(function () { 	
            ...
            $("#spsearch").jqxGrid(
            {
                ...
                columns: [
                              ...
                              { text: 'Sales Person', datafield: 'sal_name', width: '100%' },
                              
                              { text: 'catid', datafield: 'catid', width: '20%',hidden:true },
                              { text: 'usgper', datafield: 'usgper', width: '20%',hidden:true },
          ...
          $('#spsearch').on('celldoubleclick', function (event) {
                ...
                document.getElementById("salesmancatid").value=$('#spsearch').jqxGrid('getcellvalue', rowindex1, "catid");
                document.getElementById("salesmanusgper").value=$('#spsearch').jqxGrid('getcellvalue', rowindex1, "usgper");
