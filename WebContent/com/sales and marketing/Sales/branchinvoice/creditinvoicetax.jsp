...
/* 	   if(document.getElementById("txtlocation").value=="")
 ...
 newTextBox.val(rows[i].prodoc+"::"+rows[i].unitdocno+"::"+rows[i].qty+"::"+rows[i].totwtkg+"::"+rows[i].kgprice+"::"+
		 ...
		 rows[i].outqty+"::"+rows[i].stkid+"::"+rows[i].oldqty+"::"+rows[i].foc+"::"+rows[i].locid+"::"+rows[i].taxper+"::"+rows[i].taxamount+"::");  
  ...
  x.send();
	...
	function funchkforedit()
    {
	   ...
	   function funPrintBtn(){
	        ...
	        var reurl=url.split("saveSalesInvoice");
...
<table width="100%" >   
  ...
  <tr>
    ...
    <td colspan="3"><input type="text" id="currate" name="currate" style="width:13%;" value='<s:property value="currate"/>'/>
     ...
     &nbsp;&nbsp;&nbsp;&nbsp;
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     Bill Type&nbsp;<select id="cmbbilltype" name="cmbbilltype"  style="width:13%;" value='<s:property value="cmbbilltype"/>'>
