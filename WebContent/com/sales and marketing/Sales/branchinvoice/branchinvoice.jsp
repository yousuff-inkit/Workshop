...
function funReadOnly(){
	...
	$('#frmBranchInvoice input').attr('readonly', true );
	$('#frmBranchInvoice select').attr('disabled', true);
...
document.getElementById("editdata").value="";
    $('#rrefno').attr('disabled', true);
	$('#frmBranchInvoice input').attr('readonly', false );
	$('#frmBranchInvoice select').attr('disabled', false);
...
/* 	   if(document.getElementById("txtlocation").value=="")
 ...
 newTextBox.val(rows[i].prodoc+"::"+rows[i].unitdocno+"::"+rows[i].qty+"::"+rows[i].totwtkg+"::"+rows[i].kgprice+"::"+
		 ...
		 rows[i].outqty+"::"+rows[i].stkid+"::"+rows[i].oldqty+"::"+rows[i].foc+"::"+rows[i].locid+"::"+rows[i].taxper+"::"+rows[i].taxamount+"::"+rows[i].allowdiscount+"::"+000+"::"); 
...
// alert(newTextBox.val());
 newTextBox.appendTo('form');
  ...
  document.getElementById("frmBranchInvoice").submit();
} 
  ...
  x.send();
	...
	function funchkforedit()
    {
	   ...
	   function funPrintBtn(){
	        ...
	        var reurl=url.split("saveBranchInvoice");
	        
	        $("#docno").prop("disabled", false);                
	        
	  
	var win= window.open(reurl[0]+"printBRinv?docno="+document.getElementById("masterdoc_no").value+"&formdetailcode=CREDIT","_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
...
<form id="frmBranchInvoice" action="saveBranchInvoice" method="post" autocomplete="off">
...
<%-- <table width="100%" border="1">
 ...
 <table width="100%"  >
  ...
  <td width="16%"><select id="cmbmodeofpay" hidden="true" name="cmbmodeofpay" style="width:61%;" value='<s:property value="cmbmodeofpay"/>'>
...
<table width="100%" >   
  ...
  <tr>
    <td align="right"></td>
    <td><select id="cmbreftype" name="cmbreftype" style="width:71%;" hidden="true" onchange="refChange();" value='<s:property value="cmbreftype"/>'>
     ...
     <td width="14%"><input type="hidden" id="rrefno" name="rrefno" style="width:100%;" placeholder="Press F3 to Search"  onKeyDown="getrefno(event);" value='<s:property value="rrefno"/>'/></td> 
     <%-- <td>Sales Order
