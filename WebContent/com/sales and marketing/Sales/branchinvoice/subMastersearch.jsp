...
String Cl_names = request.getParameter("Cl_names")==null?"0":request.getParameter("Cl_names");
 ...
 String transid = request.getParameter("tranid")==null?"0":request.getParameter("tranid").trim();
 
 String Cl_mobnos = request.getParameter("Cl_mobnos")==null?"0":request.getParameter("Cl_mobnos").trim();
 
 
 
 String Cl_salper = request.getParameter("Cl_salper")==null?"0":request.getParameter("Cl_salper").trim();
...
%> 
 ...
 var qotmasterdata; 
  ...
  qotmasterdata='<%=DAO.searchMaster(session,msdocno,Cl_names,Cl_enqno,qotdate,qottype,transid,Cl_mobnos,Cl_salper)%>';
     ...
     $("#subquotationSearch").jqxGrid(
     {
        ...
        selectionmode: 'singlerow',
         ...
         columns: [
				...
				{ text: 'Client', datafield: 'name', width: '40%' },

				{ text: 'MOB', datafield: 'per_mob', width: '13%' },
				{ text: ' Sales Person', datafield: 'sal_name', width: '22%' }, 
				{ text: 'Ref.type', datafield: 'ref_type', width: '10%' ,hidden:true},
