...
String reftypes=request.getParameter("reftype")==null?"0":request.getParameter("reftype").trim();
...
if(clientcaid>0)
  ...
  prodsearchdata1='<%=DAO.hidesearchProduct(session,prodsearchtype,rrefno,reftypes,clientcaid,dates,cmbbilltype)%>';
	}
else
	{
	prodsearchdata1;
