	       ...
	       $.messager.confirm('Message', 'Do you want to Import?', function(r){
        		 ...
        		 var dates=document.getElementById("date").value; 
        	 		...
        	 		var cmbbilltype=document.getElementById("cmbbilltype").value; 
		       		  $("#quotationDiv").load("quotationGrid.jsp?enqdoc="+ document.getElementById("enqmasterdocno").value+"&chk="+chk+"&from="+from+"&reftype="+reftype+"&cond=1"+"&clientcaid="+clientcaid+"&dates="+dates+"&cmbbilltype="+cmbbilltype);	
