...
<script type="text/javascript">
        ...
        $(document).ready(function () { 	
        	var Reqmaster='<%=DAO.searchunit(mode,psrno) %>'; 
    	   ...
    	   $('#jqxQuotation').jqxGrid('setcellvalue', rowno, "qty" ,'');
    	   
    	   
         	 
 
                 $('#jqxQuotation').jqxGrid('setcellvalue', rowno, "unit" ,$('#qtysearchgrid').jqxGrid('getcellvalue', rowindextemp, "unit"));
	                $('#jqxQuotation').jqxGrid('setcellvalue', rowno, "unitdocno" ,$('#qtysearchgrid').jqxGrid('getcellvalue', rowindextemp, "doc_no"));
