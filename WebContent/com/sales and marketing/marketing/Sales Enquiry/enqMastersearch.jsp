...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	getdata1(Cl_names,msdocno,Cl_mobno,enqdate,enqtype,Cl_clientsale1);
 

	}
	function getdata1(Cl_names,msdocno,Cl_mobno,enqdate,enqtype,Cl_clientsale1){
		

		
		 $("#refreshdivmas").load('subMastersearch.jsp?Cl_names='+Cl_names+'&msdocno='+msdocno+'&Cl_mobno='+Cl_mobno+'&enqdate='+enqdate+'&enqtype='+enqtype+"&Cl_clientsale1="+Cl_clientsale1);
...
<table width="100%" >
  <tr>
   ...
   <td align="right">Docno</td>
    ...
    <td    >Type</td><td colspan="3" ><select  name="enqtype" id="enqtype" style="width:15%;"  value='<s:property value="enqtype"/>' >
