...
<script type="text/javascript">
        ...
        $(document).ready(function () { 	
    	   ...
    	   $('#prodetGrid').jqxGrid('setcellvalue', rowno, "qty" ,'');
    	   
    	   
         	 
 
                 $('#prodetGrid').jqxGrid('setcellvalue', rowno, "unit" ,$('#qtysearchgrid').jqxGrid('getcellvalue', rowindextemp, "unit"));
	                $('#prodetGrid').jqxGrid('setcellvalue', rowno, "unitdocno" ,$('#qtysearchgrid').jqxGrid('getcellvalue', rowindextemp, "doc_no"));
