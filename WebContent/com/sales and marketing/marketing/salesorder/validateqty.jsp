 ...
 //  System.out.println("-----list-------"+list);
   ...
   for(int i=0;i<aa.length;i++){
    ...
    try
    {
    	...
    	String chk311="select method  from gl_prdconfig where field_nme='prosearch_stock' ";
				  ...
				  String[] serarray=mainarray.get(k).split("::");  
				   ...
				   //  System.out.println("====prdids==="+prdids);
				    ...
				    System.out.println("====slsss==="+slsss);
				     ...
				     double stockqty=0;
				     String stksql=" select (sum(op_qty)-sum(out_qty+rsv_qty+del_qty)) stockqty  from my_prddin where psrno="+prdid+" and brhid="+branch+" and specno="+specno+"  group by psrno ";
    	...
    	else
    	{
    		 ...
    		 System.out.println("====status==ddd="+status);  
    	}
