...
try{	ClsConnection ClsConnection=new ClsConnection();
	...
	{
		String strSql2 = "select * from my_qotd where rdocno in("+refmasterdocno+")  and clstatus=1";
	...
	String strSql = "select rrefno from my_invm where  FIND_IN_SET('"+masterdoc_no+"', rrefno) and ref_type='SOR'";
	...
	String strSql1 = "select rrefno from my_delm where    FIND_IN_SET('"+masterdoc_no+"', rrefno) and ref_type='SOR'";
