...
<%	
	...
	try{
		...
		if(mode.equalsIgnoreCase("A") && docno.equalsIgnoreCase("")){
			sql = "select * from my_acbook where status<>7 and dtype='CRM' and per_mob='"+mobileno+"'";
		}else if(mode.equalsIgnoreCase("E") && !(docno.equalsIgnoreCase(""))){
			sql = "select * from my_acbook where status<>7 and dtype='CRM' and per_mob='"+mobileno+"' and doc_no!="+docno+"";
		 }
