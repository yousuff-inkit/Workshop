...
<%	
	...
	try{
		...
		if(mode.equalsIgnoreCase("A") && docno.equalsIgnoreCase("")){
			sql = "select * from gl_drdetails where dtype='CRM' and visano<>'0' and visano='"+visano+"'";
		}else if(mode.equalsIgnoreCase("E") && !(docno.equalsIgnoreCase(""))){
			sql = "select * from gl_drdetails where dtype='CRM' and visano<>'0' and visano='"+visano+"' and doc_no!="+docno+"";
		}
