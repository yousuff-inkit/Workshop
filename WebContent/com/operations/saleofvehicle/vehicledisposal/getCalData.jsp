...
try{
	...
	/* String strasset="select (select sum(dramount) from gc_assettran where fleet_no="+fleet+") sumamount,datediff('"+docdate+"','"+deprdate+"') daysdiff"; */
	 String strasset="select datediff('"+docdate+"','"+deprdate+"') datediff,round((("+purcost+" * depr/100)/365)*(select datediff) ,2) currentdepr from gl_vehmaster where fleet_no="+fleet; 
