...
<script type="text/javascript">
    ...
    function getdata(accountName, srNo, date, total, refNo){
        ...
        $("#refreshdiv").load('rrvMainSearchGrid.jsp?accountName=' + encodeURIComponent(accountName) + 
...
<div id="search" class="modern-ui">
    ...
    <div class="grid-container">
        <div id="refreshdiv">
            <jsp:include page="rrvMainSearchGrid.jsp"></jsp:include>
        </div>
    </div>
