...
<form id="frmReceiptVoucher" action="printCommercialReceipt" method="post" autocomplete="off" target="_blank">

<div style="background-color:white;">

<jsp:include page="../../common/printHeaderWorkshopPalHorizontal.jsp"></jsp:include>  

<table width="99%" >
  <tr>
    <td width="71%"><b>Received with Thanks From</b></td>
    <td width="15%" align="right"><b>DOC No :</b></td>
    <td width="14%"><label id="receiptdocno" name="receiptdocno"><s:property value="receiptdocno"/></label></td>
  </tr>
  <tr>
  ...
  <tr>
    <td  ><font size="2"><label id="clientinfo"
     name="clientinfo"><s:property value="clientinfo"/></label></font></td>
