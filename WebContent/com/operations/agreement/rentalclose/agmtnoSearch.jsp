...
.hidden-scrollbar {
	...
	function getdata(docnosearch,fleetsearch,regnosearch,clientsearch,searchdate,mobilesearch,branch){
		//alert(searchdate);
				$("#loadRaSearch").load("gridRaSearch.jsp?docno="+docnosearch+"&fleet="+fleetsearch+"&regno="+regnosearch+"&client="+clientsearch+"&date="+searchdate+"&mobile="+mobilesearch+"&branch="+branch);
		}
