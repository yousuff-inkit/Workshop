...
ClsRentalAgmtNewDAO viewDAO= new ClsRentalAgmtNewDAO();
 ...
 var datatar= '<%=viewDAO.trariffbtnGrid(session,vehgpid,cldocno,tarifnew)%>';
       // alert(data);
        $(document).ready(function () { 	
            ...
            $('#jqxbtntarif').on('rowdoubleclick', function (event) 
              ...
              //  alert(vehGroup);
                ...
                $("#tariffDivId").load('rateDescription.jsp?ratariffdocno1='+indexVal+'&vehGroup='+vehGroup+'&tarifnew='+tarifnew);
