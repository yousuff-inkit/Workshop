 ...
 <tr>
   ...
   <td width="28%" align="left">Issued From</td>
    ...
    <td align="left">Issued From</td>
      <td><label name="lblpassissued" id="lblpassissued" ><s:property value="lblpassissued"/></label></td>
  ...
  <fieldset><legend><b>Additional Driver Details</b></legend>
   ...
   <!--<tr>
    ...
    <label id="addlicno2" name="addlicno2"><s:property value="addlicno2"/>Issued By</label>
    <label id="adddrname2" name="adddrname2"><s:property value="adddrname2"/></label>
    <label id="expdate2" name="expdate2"><s:property value="expdate2"/></label>
    <label id="adddob2" name="adddob2"><s:property value="adddob2"/></label>
