...
<%@page import="com.operations.agreement.rentalagmtnew.*" %>
	...
	String weekdoc = request.getParameter("weekdoc")==null?"0":request.getParameter("weekdoc").trim();
 	...
 	String tarifnew=request.getParameter("tarifnew")==null?"":request.getParameter("tarifnew").trim();
  ...
  if(temp2>0)
	{
		...
		datatariff='<%=viewDAO.tariffratereload(session,relodedoc,revehGroup,tarifnew)%>';
	...
	{
	 datatariff='<%=viewDAO.tariffRate(session,ratariffdocno1,vehGroup,tarifnew)%>';
	
	} 
  else if(temp6>0)
	{
	 datatariff='<%=viewDAO.weektariffRate(session,weekdoc,weekGroup,outdate,outtime,tarifnew)%>';
...
$("#jqxgridtarif").jqxGrid('addrow', null,  {"rentaltype": "","tarif": "","cdw": "","pai": "","cdw1": "","pai1": "","gps": "","babyseater": "","cooler": "","kmrest": "","exkmrte": "","oinschg": "","exhrchg": "","chaufchg": "","chaufexchg": "","status": ""});    
 ...
 var cellbeginedit = function (row, datafield, columntype, value) {
     if (row == disabledRow) return false;
 }
   ...
   $("#jqxgridtarif").jqxGrid(
   {
      ...
      theme: theme,
       ...
       columns: [  
					...
					{ text: '      '+document.getElementById("mainslabfromday").value,     datafield: 'slabfromday', editable:true,cellsformat: 'd2', cellsalign: 'right', align:'right',cellbeginedit: rowEdit,cellsrenderer: cellsrenderer },
					{ text: '      '+document.getElementById("mainslabtoday").value,        datafield: 'slabtoday',  editable:true ,cellsformat: 'd2' , cellsalign: 'right', align:'right',cellbeginedit: rowEdit, cellsrenderer: cellsrenderer},
					{ text: '      '+document.getElementById("mainslabrateperday").value,        datafield: 'slabrateperday',  editable:true ,cellsformat: 'd2' , cellsalign: 'right', align:'right',cellbeginedit: rowEdit, cellsrenderer: cellsrenderer},
					{ text: '      '+document.getElementById("mainpackageblockday").value,     	 datafield: 'packageblockday',  editable:true,cellsformat: 'd2', cellsalign: 'right', align:'right',cellbeginedit: rowEdit, cellsrenderer: cellsrenderer},
					{ text: '      '+document.getElementById("mainpackageblocktarif").value,    	 datafield: 'packageblocktarif',  editable:true ,cellsformat: 'd2', cellsalign: 'right', align:'right',cellbeginedit: rowEdit,cellsrenderer: cellsrenderer},
					{ text: '      '+document.getElementById("mainpackageextradaytarif").value,    	 datafield: 'packageextradaytarif',  editable:true,cellsformat: 'd2', cellsalign: 'right', align:'right',cellbeginedit: rowEdit,cellsrenderer: cellsrenderer},
           ...
           var rentypevalid=$('#jqxgridtarif').jqxGrid('getcellvalue', rentalrow, "rentaltype");
            ...
            if(columnindex1>0)
			   ...
			   if(columnindex1==0)
				...
				if(tarifnew=="Slab"){
					$('#jqxgridtarif').jqxGrid('setcellvalue', rentalrow, "slabfromday",$('#jqxgridtarif').jqxGrid('getcellvalue', rowindex1, "slabfromday"));
					$('#jqxgridtarif').jqxGrid('setcellvalue', nettotalrow, "slabfromday",$('#jqxgridtarif').jqxGrid('getcellvalue', rowindex1, "slabfromday"));
					$('#jqxgridtarif').jqxGrid('setcellvalue', rentalrow, "slabtoday",$('#jqxgridtarif').jqxGrid('getcellvalue', rowindex1, "slabtoday"));
					$('#jqxgridtarif').jqxGrid('setcellvalue', nettotalrow, "slabtoday",$('#jqxgridtarif').jqxGrid('getcellvalue', rowindex1, "slabtoday"));
					$('#jqxgridtarif').jqxGrid('setcellvalue', rentalrow, "slabrateperday",$('#jqxgridtarif').jqxGrid('getcellvalue', rowindex1, "slabrateperday"));
					$('#jqxgridtarif').jqxGrid('setcellvalue', nettotalrow, "slabrateperday",$('#jqxgridtarif').jqxGrid('getcellvalue', rowindex1, "slabrateperday"));
				}
				else if(tarifnew=="Package"){
					
					$('#jqxgridtarif').jqxGrid('setcellvalue', rentalrow, "packageblockday",$('#jqxgridtarif').jqxGrid('getcellvalue', rowindex1, "packageblockday"));
					$('#jqxgridtarif').jqxGrid('setcellvalue', nettotalrow, "packageblockday",$('#jqxgridtarif').jqxGrid('getcellvalue', rowindex1, "packageblockday"));
					$('#jqxgridtarif').jqxGrid('setcellvalue', rentalrow, "packageblocktarif",$('#jqxgridtarif').jqxGrid('getcellvalue', rowindex1, "packageblocktarif"));
					$('#jqxgridtarif').jqxGrid('setcellvalue', nettotalrow, "packageblocktarif",$('#jqxgridtarif').jqxGrid('getcellvalue', rowindex1, "packageblocktarif"));
					$('#jqxgridtarif').jqxGrid('setcellvalue', rentalrow, "packageextradaytarif",$('#jqxgridtarif').jqxGrid('getcellvalue', rowindex1, "packageextradaytarif"));
					$('#jqxgridtarif').jqxGrid('setcellvalue', nettotalrow, "packageextradaytarif",$('#jqxgridtarif').jqxGrid('getcellvalue', rowindex1, "packageextradaytarif"));
				}
...
function ShowColumns(tarifnew){
	 if(tarifnew=="Slab"){
		  $('#jqxgridtarif').jqxGrid('hidecolumn', 'rate');
		  $('#jqxgridtarif').jqxGrid('hidecolumn', 'packageblockday');
		  $('#jqxgridtarif').jqxGrid('hidecolumn', 'packageblocktarif');
		  $('#jqxgridtarif').jqxGrid('hidecolumn', 'packageextradaytarif');
		  $('#jqxgridtarif').jqxGrid('hidecolumn', 'chaufchg');
		  $('#jqxgridtarif').jqxGrid('showcolumn', 'slabfromday');
		  $('#jqxgridtarif').jqxGrid('showcolumn', 'slabtoday');
		  $('#jqxgridtarif').jqxGrid('showcolumn', 'slabrateperday');
		  
	  }
	  else if(tarifnew=="Package"){
		  $('#jqxgridtarif').jqxGrid('hidecolumn', 'rate');
		  $('#jqxgridtarif').jqxGrid('showcolumn', 'packageblockday');
		  $('#jqxgridtarif').jqxGrid('showcolumn', 'packageblocktarif');
		  $('#jqxgridtarif').jqxGrid('showcolumn', 'packageextradaytarif');
		  $('#jqxgridtarif').jqxGrid('hidecolumn', 'chaufchg');
		  $('#jqxgridtarif').jqxGrid('hidecolumn', 'slabfromday');
		  $('#jqxgridtarif').jqxGrid('hidecolumn', 'slabtoday');
		  $('#jqxgridtarif').jqxGrid('hidecolumn', 'slabrateperday');
		  	  
	  }
	  else{
		  $('#jqxgridtarif').jqxGrid('showcolumn', 'rate');
		  $('#jqxgridtarif').jqxGrid('hidecolumn', 'packageblockday');
		  $('#jqxgridtarif').jqxGrid('hidecolumn', 'packageblocktarif');
		  $('#jqxgridtarif').jqxGrid('hidecolumn', 'packageextradaytarif');
		  $('#jqxgridtarif').jqxGrid('showcolumn', 'chaufchg');
		  $('#jqxgridtarif').jqxGrid('hidecolumn', 'slabfromday');
		  $('#jqxgridtarif').jqxGrid('hidecolumn', 'slabtoday');
		  $('#jqxgridtarif').jqxGrid('hidecolumn', 'slabrateperday');
