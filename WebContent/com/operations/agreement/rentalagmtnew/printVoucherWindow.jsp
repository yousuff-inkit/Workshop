...
function funGetPrint(){
	...
	var url=document.URL;
	 ...
	 var win= window.open(reurl[0]+"printRA?docno="+<%=masterdocno%>+"&formdetailcode=RAG"+"&printdate="+document.getElementById("printdate").value+"&printtime="+document.getElementById("printtime").value,"_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
