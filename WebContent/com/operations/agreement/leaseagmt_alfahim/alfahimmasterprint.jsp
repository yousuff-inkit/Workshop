...
<legend></legend>
<%-- <p align="right">
<b>المرور/ موقف السيارات/ سالك (الرسوم)</b><br>
بالتوقيع على الوثيقة الماثلة، أكون موافقاً على دفع جميع غرامات المرور/الانتظار وغيرها بالإضافة إلى مبلغ وقدره <label   id="trafficcharge"><s:property value="trafficcharge"/></label> درهم إماراتي لكل غرامة و<label id="salikcharge"><s:property value="salikcharge"/></label> درهم لكل معبر سالك كرسوم إضافية، خلال فترة الاتفاق
</p> --%>
