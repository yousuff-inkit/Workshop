...
ClsConnection connDAO= new ClsConnection();
	...
	Statement stmt = conn.createStatement ();
				   ...
				   String upsql1="select * from my_jvtran where rdocno='"+docnos+"' and  rtype='LAG' " ;		   
		 ...
		 else
		 {
		     ...
		     String upsql3=" delete from gl_vmove where repno=0 and rdocno='"+docnos+"' and rdtype='LAG'  and fleet_no='"+valfleet+"' " ;		   
