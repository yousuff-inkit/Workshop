...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	$(document).ready(function () {
 	...
 	function mainloadSearch() {
 		...
 		getdata(sclname,smob,rno,flno,sregno,branch_chk);
 

	}
	 function getdata(sclname,smob,rno,flno,sregno,branch_chk){
		
		// $("#tariffDivId").load('rateDescription.jsp?txtrentaldocno='+indexVal1+'&revehGroup='+revehGroup);
		
		 $("#srefreshdiv").load('submainSearch.jsp?sclname='+sclname+'&smob='+smob+'&rno='+rno+'&flno='+flno+'&sregno='+sregno+'&branch_chk='+branch_chk);
...
<%--    <table  width="100%"  border="1">
   <tr>
    ...
    <td align="left" colspan="3"><input type="text" name="SCl_name" id="SCl_name"  style="width:96.5%;" value='<s:property value="SCl_name"/>'></td>
...
<td align="left"  width="55">Doc NO</td>
    ...
    <td align="left" width="110"><input type="text" id="sregno" name="sregno" value='<s:property value="sregno"/>'></td>
   
    
    <td  width="80" colspan="2">
    <input type="checkbox" id="branch_chk"  name="branch_chk" value="0" onclick="$(this).attr('value', this.checked ? 1 : 0)" >All Branch <input type="button" name="mbtnrasearch" id="mbtnrasearch" class="myButton" value="Search"  onclick="mainloadSearch();"></td>
  </tr> 
  </table>--%>
   ...
   <table  width="100%"  >
   <tr>
    <td align="right" width="68">Name</td>
    <td align="left" colspan="3"><input type="text" name="SCl_name" id="SCl_name"  style="width:96.5%;" value='<s:property value="SCl_name"/>'></td>
    <td align="right"  > MOB</td>
    <td align="left"  ><input type="text" name="Sl_mob" id="Sl_mob"  value='<s:property value="Sl_mob"/>'></td>
...
<td align="right"  width="68">Doc NO</td>
    <td align="left" width="202"><input type="text" name="rno" id="rno" value='<s:property value="rno"/>'>
 
    <td align="right" width="95">Fleet NO</td>
    
    <td align="left" width="389"><input type="text" name="flno" id="flno" style="width:96.5%;" value='<s:property value="flno"/>'></td>
    <td align="right" width="78">Reg NO</td>
