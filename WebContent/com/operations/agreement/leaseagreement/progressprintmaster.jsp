...
<p align="justify">PROGRESS rent a car "PROGRESS", hereafter called “Lessor” rents the vehicle(s) that is/are mentioned in the “Rental/LeaseAgreement,
 Vehicle Check Out Report” to _______________________________, hereafter called the  “Client”  and is subject to the terms and conditions mentioned below:</p>

<p id="para1" align="justify"><b><u>1)Hire Period</u></b></p>
<p id="para1" align="justify">The period of the hire will be as per the Lease or Rental agreement.</p>

<p id="para1" align="justify"><b><u>2)Tariff Card, LPO and Delivery</u></b></p>
<p id="para1" align="justify">The Tariff will be as per the agreed quotation and the client will issue LPO as per the 
terms mentioned in the contract and based on which the Lessor will deliver the vehicle as per the “Rental/Lease Agreement, Vehicle Check Out Report”.</p>

<p id="para1" align="justify"><b><u>3)Lease/Rental Invoicing.</u></b></p>
<p id="para1" align="justify">Lessor will be invoicing as  mentioned in the Lease/Rental Agreement.<br/>
...
<p id="para1" align="justify">Credit period will be __________ from the Invoice date. In case of delay beyond 10 days, Client will be liable to pay a late payment fee of 1.5% p/m on the total outstanding.
Client shall ensure that an official receipt is obtained from Lessor for any payment.
<br/>
<br/>
<b>Invoices for Fine, Fuel recharge, Insurance Excess, Cleaning charges,Salik,damage,others are to be paid immediately on presentation of the invoice.</b></p>
 
<p id="para1" align="justify"><u>Client will transfer monthly dues to Lessor’s bank account with following details:</u></p>
...
<ul class="a">
  <li>Provide vehicles as mentioned in the “Lease/Rental Agreement/Vehicle Check Out Report” in good condition with clean interior and adequate fuel.</li>
  <li>Provide insurance cover for persons using the vehicle with its permission as per the fleet policy and payment of Police report and Insurance excess.
   CDW/PAI provided at extra cost.</li>
  <li>Insurance will not cover Sabotage/Terrorism/Force Majeure.</li>
 <li>Perform maintenance and repair of the vehicle due to normal wear and tear.</li>
  ...
  <li>Replace the vehicle during maintenance, repairs and accident. In case of more than three accidents during any given period of 12 months, 
  the replacement period will be limited to 15 days per year and the extra days will be chargeable as extras. Replacement for accidents will be given only on submission of Police Report.</li>
</ul>
  
<p id="para1" align="justify"><b><u>6)Client’s Undertaking</u></b></p>
<ul class="a">
  ...
  <li>Provide undertaking letter if Original Registration card is required.</li>
  ...
  <li>Client agrees to transfer any black points on traffic fine to the driver who is driving the vehicle.</li>
...
<ul> 
  <li>Client will provide details of all drivers driving the vehicle(s) and provide coloured copies of Passport with entry stamp/visa and valid Driving License. This is a statutory requirement and has to be provided to the Lessor before the vehicle is driven by the driver.</li>
 <li>Drivers 23-25 years with prior approval at PRAC Management discretion: Excess AED 2,000 + 25% of total repair cost</li>
...
<p id="para1" align="justify">Lessor has the right to terminate the contract and take possession of the vehicle(s) at the expense of the Client in case the Client does not pay the rental, fines and 
...
For early termination by the Client due to any reason, Client agrees to compensate the Lessor as listed below:</p>
