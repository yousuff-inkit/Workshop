	...
	/*       function funchknumber()
	       ...
	       function funPrintBtn(){
	    	   if (($("#mode").val() == "view") && $("#masterdoc_no").val()!="") {
	    	    ...
	    	    var url=document.URL;
		           ...
		           var reurl=url.split("saveRentalAgmtSayara");
	    	     if(mth==1)
	    	    	 {
	  ...
	  // var win= window.open(reurl[0]+"printRA?docno="+document.getElementById("masterdoc_no").value+"&formdetailcode=RAG","_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
	   ...
	   win_voucher.focus();
	    	    	 ...
	    	    	 {
	    	    	 $("#docno").prop("disabled", false); 
	    	    	 var win= window.open(reurl[0]+"printRASayara?docno="+document.getElementById("masterdoc_no").value+"&formdetailcode=RAG","_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
...
<form id="frmRentalAgreement" action="saveRentalAgmtSayara" name="rentalform" method="post"  autocomplete="off">
...
<tr>
  <td colspan="2" align="left">Org. Reg. Card issued
    <input type="checkbox" name="chkorgregcard" id="chkorgregcard" onChange="setOrgRegCard();" style="width:15px;height:15px;"></td>
  </tr>
