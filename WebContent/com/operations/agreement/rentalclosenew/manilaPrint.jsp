...
<form id="frmInvoicePrint" action="printrental" autocomplete="off" target="_blank">
 <div style="background-color:white;">
      <table width="100%">
		  <tr>
		    <td width="20%"><img src="<%=contextPath%>/icons/epic.jpg"  width="100%" height="82"  alt=""/></td>
		    <td width="49%" align="center"><b><font size="3" style="padding-left:60px;">Rental Agreement</font></b></td>
		    <td colspan="2" align="center"><img src="<%=contextPath%>/icons/manilaBooking.gif"  width="100%" height="82"  alt=""/></td>
	      </tr>
		  <%-- <label id="mobileno" name="mobileno"><s:property value="mobileno"/></label>
		  <label id="fax" name="fax"><s:property value="fax"/></label> --%>
		  <tr>
		    <td><b>Tel 1:</b>&nbsp;<label id="lbltel1" name="lbltel1"><s:property value="lbltel1"/></label></td>
		    <td colspan="2" rowspan="2" align="center"><b>RANO :</b><b><label id="rentaldoc" name="rentaldoc" ><s:property value="rentaldoc"/></label></b>&nbsp;&nbsp;&nbsp;&nbsp;
		    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>MRA NO# :<label id="mrano" name="mrano"><s:property value="mrano"/></label></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		    &nbsp;&nbsp;&nbsp;&nbsp; <b>RA :</b><b><label  id="rastatus" name="rastatus"><s:property value="rastatus"/></label></b></td>
		    <td width="25%"><b>Website :</b>&nbsp;<label id="lblcompwebsite" name="lblcompwebsite"><s:property value="lblcompwebsite"/></label></td>
		  </tr>
		  <tr>
		    <td><b>Tel 2:</b>&nbsp;<label id="lbltel2" name="lbltel2"><s:property value="lbltel2"/></label></td>
		    <td><b>Email :</b>&nbsp;<label id="lblcompmail" name="lblcompmail"><s:property value="lblcompmail"/></label></td>
		  </tr>
		  <tr>
		    <td>&nbsp;</td>
		    <td colspan="2" align="center">&nbsp;</td>
		    <td><b>Branch :</b>&nbsp;<label id="barnchval" name="barnchval"><s:property value="barnchval"/></label></td>
	      </tr>
      </table>
	<hr>
<table width="100%" >
...
<fieldset><legend><b>Terms And Conditions</b></legend>
<table width="100%">
<tr ><td><div style="text-align:justify">Minimum rental period is 24 hours,with a maximum period of (3) hours from the time it is rented.In case the vehicle is returned beyond grace period, 
company reserves the right to charge additional daily rate. Renter is responsible to inform the company  regarding the return of vehicle on or before the due date.
Failure to do so, the agreement will be renewed automatically with similar terms  and all charges will be debited from the credit card.
Driver age below than 25 years old(b/n 23 and 25) additional  deductible of 10% of the claim amount,in addition to the normal policy deductible (as per law).
Driver age below 23 years old (b/n 21 and 23) additional deductible of 30% (20% + 10% as per law) of the  claim amount  with minimum AED 2000, all these will be charged 
in addition to the normal policy deductible. This scheme is not applicable in case driver age less than 21 years old.
Company promotes a Greener community, thus <b>Smoking</b> in the car is strictly prohibited. If the vehicle was returned with cigeratte smell or unacceptable odor, 
the ccompany reserves the right to charge <b>AED 1500</b> for ozone treatment.<br><br>
<b>Traffic Fines and Salik (Road Tolls)</b><br><br>
The renter is responsible for any salik or Traffic fine incurred during the time of the rental and Manila car and Bus Rental is authorized to debit the cost of penalties 
to the renter's credit card. Salik toll fee will be charge <b>AED 5.00</b> per crossing and <b>AED 50.00</b> service will be charged on the top of each Traffic fine excluding the 
knowledge fee.</div><br>
<!-- <h4>Accidents</h4> -->
<b>Accidents</b><br><br>
<div style="text-align:justify">If the CDW & PAI is declined, the renter undertakes to pay excess charge of <b>AED 2000.00</b> for accident at fault accompanied by a Police Report. Tire damage not included in 
Insurance.Renter is responsible to repair/or change punctured and blow out tires.</div></td></tr>
<tr><td align="right"><input type="text" style="border:1px solid rgb(139,136,120);border-radius:8px;"></td></tr>
</table>
</fieldset><br>
<b><div style="text-align:center;">VEHICLE INSURED FOR UAE TERRITORY ONLY</div></b>
  </td>
  <td width="50%">
  <fieldset>
...
<td><label id="colfuels" name="colfuels"><s:property value="colfuels"/></label></td>
 ...
 <tr>
    ...
    <td>It is important that you have read and understood the terms
     and conditions that  will apply  to this contract before signing.
      ...
      over the page. (Arabic translation overleaf is available on the rental 
       wallet) and if you are paying by Credit card + Bank Charges, your signature is authorization 
  ...
  <table>
	<tr>
		<td width="50%"><img src="Page1.jpg" alt="" width="100%"></td>
		<td width="50%"><img src="Page2.jpg" alt="" width="100%"></td>
	</tr>
</table>
<%--   <fieldset>
    <legend><b>Out Details</b></legend>
