...
String tarifnew=request.getParameter("tarifnew")==null?"0":request.getParameter("tarifnew");
...
String idnew=request.getParameter("idnew")==null?"0":request.getParameter("idnew");
        ...
        $(document).ready(function () { 	
            ...
            if((temp1=="1")&&(document.getElementById("docno").value=="")){
            	...
            	if(document.getElementById("useddays").value!=""){
            		if(tarifnew=="Slab" || tarifnew=="Package"){
            			datatotal='<%=closedao.getTotalDataPackage(useddays,usedhours,totalkm,agmtno,rentaltype,agmtdate,closedate,closecalflag,closeinvdate,temp,tarifnew,idnew)%>';
            		}
            		else{
