...
var tempid='<%=agmtno%>';
      var datareference;
      if(tempid!=''){
    	  datareference='<%=closedao.getReferenceTarif(agmtno,tarifnew)%>';  
      }
        ...
        $(document).ready(function () { 	
            ...
            $('#tarifreferencegrid').on('bindingcomplete', function (event) {
            	
        	 	ShowColumns(tarifnew,"tarifreferencegrid");
...
{ text: '      '+document.getElementById("mainslabfromday").value,     datafield: 'slabfromday',editable:true,renderer: columnsrenderer},
{ text: '      '+document.getElementById("mainslabtoday").value,        datafield: 'slabtoday',editable:true,renderer: columnsrenderer},
{ text: '      '+document.getElementById("mainslabrateperday").value,        datafield: 'slabrateperday',editable:true,renderer: columnsrenderer,cellsformat: 'd2',cellsalign: 'right',align: 'right'},
{ text: '      '+document.getElementById("mainpackageblockday").value,     	 datafield: 'packageblockday',editable:true,renderer: columnsrenderer},
{ text: '      '+document.getElementById("mainpackageblocktarif").value,    	 datafield: 'packageblocktarif',editable:true,renderer: columnsrenderer,cellsformat: 'd2',cellsalign: 'right',align: 'right'},
{ text: '      '+document.getElementById("mainpackageextradaytarif").value,    	 datafield: 'packageextradaytarif',editable:true,renderer: columnsrenderer,cellsformat: 'd2',cellsalign: 'right',align: 'right'},
