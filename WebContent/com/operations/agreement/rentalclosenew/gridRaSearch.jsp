...
ClsRentalCloseNewDAO rentaldao=new ClsRentalCloseNewDAO();
%>
<script type="text/javascript">

      var radata='<%=rentaldao.getAgmtno(docno,fleet,regno,client,date,mobile,branch)%>';	
        ...
        $(document).ready(function () { 	
            ...
            $("#gridRaSearch").jqxGrid(
            {
               ...
               // pageable: true,
                ...
                columns: [
							...
							{ text: 'Delstatus', datafield: 'delstatus', width: '20%',hidden:true},
							{ text: 'Delivery Chg',datafield:'deliverychg',width:'20%',hidden:true},
							{ text:	'Description',datafield:'desc1',width:'20%',hidden:true},
							{ text: 'Ac No', datafield: 'acno', width: '30%',hidden:true },
							{ text: 'Plate Code', datafield: 'platecode', width: '30%',hidden:true },
							{ text: 'Tarif Type', datafield: 'tariftype', width: '30%',hidden:false}
							]
            });
            ...
            $('#gridRaSearch').on('rowdoubleclick', function (event) {
            	...
            	var rowindex1=event.args.rowindex;
             	...
             	document.getElementById("tarifnew").value=$('#gridRaSearch').jqxGrid('getcellvalue', rowindex1, "tariftype");
				...
				$("#agmttarifdiv").load("agreementTarifGrid.jsp?agmt="+id1+"&tarifnew="+document.getElementById("tarifnew").value);
				$("#referencetarifdiv").load("referenceTarifGrid.jsp?id="+id1+"&tarifnew="+document.getElementById("tarifnew").value);
				...
				document.getElementById("delstatus").value=$('#gridRaSearch').jqxGrid('getcellvalue', rowindex1, "delstatus");
