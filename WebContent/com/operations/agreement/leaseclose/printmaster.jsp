...
<form id="frmPrintRentalClose" action="printLeaseClose" autocomplete="off" target="_blank">
...
<%--   <table width="100%" >
  ...
  <tr>
    <td rowspan="2"  align="center"><b><font size="5">Lease Agreement Close</font></b></td>
  ...
  <fieldset><legend><b>Additional Driver Details</b></legend>
   ...
   <tr>
      <td width="20%" align="left"></td>
          <td width="40%" align="left"><b>Additional Driver One</b></td>
    
     <td width="40%" align="left"><b>Additional Driver Two</b></td>
...
Failure to provide one will result in additional charges. Customer who opt out of CDW will be liable to pay the excess deductible. <!-- amount in extra insurance charge. -->
<table width="100%"  >
<tr><td  width="50%"></td><td width="50%" height="25px" > <fieldset style="height:100%;border:1px solid;"></fieldset></td>
</tr>
</table>
</fieldset>
</td>
...
<!--<tr>
<td> <fieldset >
<legend><b>Credit Card Imprint</b></legend>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <tr>
    ...
    <td width="60%" ><label id="ravehname" name="ravehname"><s:property value="ravehname"/></label></td>
    <td width="20%" align="center"><label id="rayom" name="rayom"><s:property value="rayom"/></label></td>
    <td width="20%"><label id="racolor" name="racolor"><s:property value="racolor"/></label></td>
    </tr>
   
    </table>
      <table width="100%" > 
      <tr>
      <td width="15%" align="left">Reg NO</td>
    <td width="50%" ><label id="ravehregno" name="ravehregno"><s:property value="ravehregno"/></label></td>
 
     <td width="12%" align="left">Group</td>
    <td width="22%"><label id="ravehgroup" name="ravehgroup"><s:property value="ravehgroup"/></label></td> 
    </tr>
    </table>
    </fieldset>
    <fieldset>
 ...
 <div id="calcdiv">
  ...
  <fieldset>
     ...
     <table  width="100%" align="center" >
           <tr>
    <td width="25%" align="left">Total Paid &nbsp;</td>
    <td width="75%"><label id="totalpaid" name="totalpaid"><s:property value="totalpaid"/></label></td>
 </tr>
 <tr>
    ...
    <td>It is important that you have read and understood the terms
     and conditions that  will apply  to this contract before singing.
      ...
      over the page. (Arabic translation overleaf is available on the rental 
       ...
       charges pertaining to this  contract after the rental agreement has been closed.<hr noshade size=1></td>
    </tr>
    <tr>
    <td align="left" >Customer Signature</td></tr>
    <tr> <td align="left" ><hr noshade size=1>Date</td></tr>
     <tr> <td align="left" ><hr noshade size=1>Rental Agent</td></tr>
      <tr> <td align="left" ><hr noshade size=1>Date</td></tr>
      <tr>
      <td align="left">
    <fieldset>
