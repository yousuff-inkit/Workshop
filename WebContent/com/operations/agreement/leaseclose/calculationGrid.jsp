      ...
      var datacalc;
        ...
        //	alert("temp:"+temp1=="1"  && document.getElementById("docno").value=='');
			...
			if(temp1=="1"  && document.getElementById("docno").value==''){
        		//alert("inside 1");
	        	datacalc='<%=leasedao.getCalcData(agmtno,tarif,cdwtotal,acctotal,chauffer,excesskmchg,excesshrchg,temp,session,usedhours,clientid,fuel,termamt,deliverychg,collectchg,outdate,indate,cmbinfuel,exkm,termmonth,closeinvdate,calctype)%>';
        	}
