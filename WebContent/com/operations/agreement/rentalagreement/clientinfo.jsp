        ...
        $(document).ready(function () { 
         ...
         /*    $("#jqxclientsearch").jqxGrid('addrow', null, {}); */
				           ...
				           if($('#jqxclientsearch').jqxGrid('getcellvalue', rowindex1, "method")>0)
				              ...
				              var outstanding=parseFloat($('#jqxclientsearch').jqxGrid('getcellvalue',rowindex1,'outstanding'));
				              if(outstanding!=0.0){
				            	  document.getElementById("errormsg").innerText="";
				            	  document.getElementById("errormsg").innerText="Outstanding Balance is "+$('#jqxclientsearch').jqxGrid('getcellvalue',rowindex1,'outstanding');
				              }
				              else{
				            	  document.getElementById("errormsg").innerText="";
				              }
