...
<tr>
  <td colspan="2" align="left">Org. Reg. Card issued
    <input type="checkbox" name="chkorgregcard" id="chkorgregcard" onChange="setOrgRegCard();" style="width:15px;height:15px;"><br><span class="igst">Interstate Tax </span><input class="igst" type="checkbox" name="chkigst" id="chkigst" onChange="setIGST();" style="width:15px;height:15px;margin-left:40px;"></td>
  </tr>
