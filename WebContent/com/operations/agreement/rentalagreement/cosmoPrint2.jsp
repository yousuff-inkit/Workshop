...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td width="25%" class="borderbottom borderright"><label id="radlno" name="radlno"><s:property value="radlno"/></label></td>
...
<table width="100%" border="0">
  <tr>
    ...
    <td width="50%"><table width="100%" border="0">
      ...
      <tr>
        <td class="borderbottom borderright"><!-- VRF-Vehicle Reg Fess --> VMD</td>
        <td class="borderbottom borderright" align="right">VMD جهاز مراقبة المركبات </td>
        <td class="borderbottom borderright" align="right"><label id="lblcosmocooler" name="lblcosmocooler"><s:property value="lblcosmocooler"/></label></td>
      </tr>
      <tr>
