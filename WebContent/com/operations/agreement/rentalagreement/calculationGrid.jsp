...
var datacalc='<%=viewDAO.ralistgridload(rentaldoc)%>'; 
...
{ text: 'Rate Description', datafield: 'description', width: '40%',editable:false},
{ text: 'Unit',  datafield: 'qty',  width: '15%',editable:false,cellsalign:'right',align:'right' },
{ text: 'Rate',  datafield: 'rate',  width: '13%',editable:false,cellsalign:'right',align:'right',cellsformat: 'd2' },
