...
var datacalc;
        $(document).ready(function () { 	
        	...
        	if(temp1=="1" && document.getElementById("docno").value==''){
        		//alert("Inside Temp 1");
	        	datacalc='<%=closedao.getCalcData(agmtno,tarif,cdwtotal,acctotal,chauffer,excesskmchg,excesshrchg,temp,session,usedhours,clientid,fuel,deliverychg,collectchg,outdate,indate,cmbinfuel,request,exkm,closeinvdate,closecalflag,calctype,useddays,rentaltype)%>';
        	}
