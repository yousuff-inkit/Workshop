...
ClsRentalCloseSayaraDAO rentaldao=new ClsRentalCloseSayaraDAO();
%>
            ...
            $("#gridRaSearch").jqxGrid(
            {
               ...
               // pageable: true,
                ...
                columns: [
							...
							{ text: 'Org Reg Card', datafield: 'orgregcard', width: '30%',hidden:true }
							]
            });
...
//				document.getElementById("description").value=$('#gridRaSearch').jqxGrid('getcellvalue', rowindex1, "desc1");
				...
				$('#hidchkorgregcard').val($('#gridRaSearch').jqxGrid('getcellvalue',rowindex1,'orgregcard'));	
