...
function gridload(){
       ...
       $("#calcdiv").load("calculationGrid.jsp?rentaldoc="+indexvals+"&mode=1");
...
<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp; 
 ...
 <tr>
    ...
    <hr noshade size=1>
     <table  width="100%"   >
           <tr>
    <td>I have read and understood the terms & conditions above and overleaf and agree with my signature to the same and acknowledge that 
       a) Disclaimer b) Credit Card Authorization  c) Vehicle Checklist (for original and replacement vehicles) are part of this agreement.<hr noshade size=1></td>
    </tr>
   <!--  <tr>
