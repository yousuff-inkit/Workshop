        ...
        $(document).ready(function () { 
          ...
          /*   $("#jqxmainsearch").jqxGrid('addrow', null, {}); */
				          ...
				          $('#jqxmainsearch').on('rowdoubleclick', function (event) 
				              ...
				              document.getElementById("vocno").value=$('#jqxmainsearch').jqxGrid('getcellvalue', rowindex1, "voc_no");
				              document.getElementById("docno").value=$('#jqxmainsearch').jqxGrid('getcellvalue', rowindex1, "doc_no");
				              document.getElementById("cldocno").value=$('#jqxmainsearch').jqxGrid('getcellvalue', rowindex1, "cldocno");
				              document.getElementById("fleetno").value=$('#jqxmainsearch').jqxGrid('getcellvalue', rowindex1, "fleet_no");
				              $('#window').jqxWindow('close');
				              funSetlabel();
				              document.getElementById("frmRentalAgmtEMC").submit();
