  ...
  /*    var temp=document.getElementById("txtcusid").value;
		...
		$(document).ready(function () { 	
          ...
          $('#jqxbrandSearch').on('rowdoubleclick', function (event) {
                ...
                $('#purchasedetails').jqxGrid('setcellvalue', rowindex1, "brand" ,$('#jqxbrandSearch').jqxGrid('getcellvalue', rowindex2, "brand_name"));
                $('#purchasedetails').jqxGrid('setcellvalue', rowindex1, "brdid" ,$('#jqxbrandSearch').jqxGrid('getcellvalue', rowindex2, "doc_no"));
                ...
                document.getElementById("gridvalidate").value=1;
