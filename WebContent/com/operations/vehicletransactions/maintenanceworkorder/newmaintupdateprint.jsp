...
<table width="100%" > 
  <tr>
    ...
    <td width="25%" align="left">Garage Name</td>
     <td align="left">: <label name="lblgarage" id="lblgarage" ><s:property value="lblgarage"/></label></td>
  </tr>
...
<table width="100%" >
  ...
  <tr>
    ...
    <td >: <label id="docvals" name="docvals"><s:property value="docvals"/></label> - <label id="lblbranch" name="lblbranch"><s:property value="lblbranch"/></label></td>
    </tr>
    <tr>
...
<tr>
    ...
    <td>: <label id="lblreg_no" name="lblreg_no"><s:property value="lblreg_no"/></label> - <label id="lblpltid" name="lblpltid"><s:property value="lblpltid"/></label></td>
  </tr>
   
  <tr>
    <td width="20%" align="left">Engine No</td>
    <td >: <label id="lblengno" name="lblengno"><s:property value="lblengno"/></label></td>
    </tr>
    
    
<tr>

    <td align="left">Chasis No</td>
     <td >: <label name="lblchasno" id="lblchasno" ><s:property value="lblchasno"/></label></td>
  </tr>
