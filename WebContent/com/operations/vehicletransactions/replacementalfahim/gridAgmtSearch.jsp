...
String agmtbranch=request.getParameter("agmtbranch1")==null?"0":request.getParameter("agmtbranch1").toString();
        ...
        $(document).ready(function () { 	
            ...
            var source =
            {
                ...
                datafields: [
     						...
     						{name : 'servicelevelreplace',type:'string'}
                 ],
                localdata: radata,
                //url: url,
            ...
            $("#gridAgmtSearch").jqxGrid(
            {
                ...
                columns: [
							...
							{ text:'Service Level',datafield:'servicelevel',width:'10%',hidden:true},
							{ text: 'Service Level Replace',datafield:'servicelevelreplace',width:'10%',hidden:true}
							/*	
            ...
            $('#gridAgmtSearch').on('rowdoubleclick', function (event) {
                ...
                if(agmttype="LAG"){
                	document.getElementById("servicelevel").value=$('#gridAgmtSearch').jqxGrid('getcellvalue', rowindex1, "servicelevel");
                	document.getElementById("servicelevelreplace").value=$('#gridAgmtSearch').jqxGrid('getcellvalue', rowindex1, "servicelevelreplace");
                }
