...
//	$('#ondeliverykm').prop('disabled',false);
      ...
      function checkfuturedate(){
   		...
   		if(date1-futuredate==0){
			   ...
			   document.getElementById("errormsg").innerText="";
			   document.getElementById("errormsg").innerText="Future Time Cannot be applied";
     ...
     /*  function deliverySearchContent(url) {
    	...
    	function funReadOnly(){
    		 $('#frmReplacementAlFahim input').attr('readonly', true );
    		$('#frmReplacementAlFahim select').attr('disabled', true);
    	...
    	function funRemoveReadOnly(){
    		 $('#frmReplacementAlFahim input').attr('readonly', false );
     		$('#frmReplacementAlFahim select').attr('disabled', false);
    	...
    	function funNotify(){
    		...
    		var docdateval=funDateInPeriod($('#date').jqxDateTimeInput('getDate'));
 			...
 			if(document.getElementById("cmbrentaltype").value=="LAG"){
 				var servicelevel=document.getElementById("servicelevel").value;
 				var servicelevelreplace=document.getElementById("servicelevelreplace").value;
 				var cmbtrreason=document.getElementById("cmbtrreason").value;
 				if(servicelevel=="0"){
 					document.getElementById("errormsg").innerText="";
 				}
 				else if(parseInt(servicelevel)>0){
 					if(servicelevelreplace=="0" && cmbtrreason=="GA"){
 						document.getElementById("errormsg").innerText="";
 						document.getElementById("errormsg").innerText="Garrage Accident is not Allowed Service Level Replace is disabled";
 						return 0;
 					}
 					else{
 						document.getElementById("errormsg").innerText="";
		...
		//In Date checking with Out date starts here
     			...
     			if(incollectdate1-ondeliverydate1==0){
     				...
     				if(ondeliverytime1.getHours()==incollecttime1.getHours()){
     					if(ondeliverytime1.getMinutes()<incollecttime1.getMinutes()){
     						document.getElementById("errormsg").innerText="";
                 			document.getElementById("errormsg").innerText="Out Time cannot be less than Vehicle In Time";
                 			$('#ondeliverytime').jqxDateTimeInput('focus'); 
                 			return 0;
     					}
     					else{
     	...
     	//In Date checking with Out date ends here
    		...
    		document.getElementById("errormsg").innerText="";
    		dateenable();
    		$('#frmReplacementAlFahim input').attr('disabled',false);
    		$('#frmReplacementAlFahim select').attr('disabled',false);
...
/*  			alert("On Delivery Date:"+$('#ondeliverydate').jqxDateTimeInput('getDate'));
     	...
     	/*		if(oncollectdate1<deliveryoutdate1){
     		...
     		*/
	//Collection Date checking with Out Date starts here	
     	...
     	//Collection Date checking with Out Date ends here	
         	...
         	//In Date checking with Out date starts here
         			if(incollectdate1<ondeliverydate1){
         				document.getElementById("errormsg").innerText="";
         				document.getElementById("errormsg").innerText="In Date cannot be less than Vehicle out Date";
         				$('#incollectdate').jqxDateTimeInput('focus'); 
             			return false;
         			}
         			if(incollectdate1-ondeliverydate1==0){
         				if(incollecttime1.getHours()<ondeliverytime1.getHours()){
         					document.getElementById("errormsg").innerText="";
                 			document.getElementById("errormsg").innerText="In Time cannot be less than Vehicle out Time";
                 			$('#incollecttime').jqxDateTimeInput('focus'); 
                 			return false;
         				}
         				if(incollecttime1.getHours()==ondeliverytime1.getHours()){
     	 ...
     	 $(function(){
 	        $('#frmReplacementAlFahim').validate({
 	                 rules: {
...
<form id="frmReplacementAlFahim" action="saveReplacementAlFahim" autocomplete="off">
	<script>
...
<div class='hidden-scrollbar'>
    ...
    <option value=0.625>Level 5/8</option><option value=0.750>Level 6/8</option><option value=0.875>Level 7/8</option><option value=1.000>Level 8/8</option>
        ...
        <tr>
          ...
          <td align="left"><select id="cmbtrreason" name="cmbtrreason" style="width:95%;" value='<s:property value="cmbtrreason"/>' onchange="checkServiceLevel();">
          ...
          <td align="right">&nbsp;</td>
          <td colspan="3" align="center"><i><b><label id="lblcancelstatus"  name="lblcancelstatus"   style="font-size: 13px;font-family: Tahoma; color:#6000FC"></label></b></i></td>
...
<input type="hidden" id="servicelevel" name="servicelevel"  value='<s:property value="servicelevel"/>'/>
<input type="hidden" id="servicelevelreplace" name="servicelevelreplace"  value='<s:property value="servicelevelreplace"/>'/>
