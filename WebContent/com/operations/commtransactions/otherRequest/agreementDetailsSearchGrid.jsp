...
%> 
 ...
 var data2='<%=cord.agreementSearch(sclname,smob,rno,flno,sregno,rentaltype,clientId)%>';
        ...
        $(document).ready(function () { 
            ...
            $('#jqxAgreementSearch').on('rowdoubleclick', function (event) {
                ...
                document.getElementById("txtrano").value = $('#jqxAgreementSearch').jqxGrid('getcellvalue', rowindex1, "doc_no");
                document.getElementById("txtravocher").value = $('#jqxAgreementSearch').jqxGrid('getcellvalue', rowindex1, "voc_no");
