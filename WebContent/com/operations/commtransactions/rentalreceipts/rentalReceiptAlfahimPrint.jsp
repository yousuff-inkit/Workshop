...
<table width="99%">
  <tr>
    <td width="72%"><b>Received with Thanks From</b></td>
    <td width="12%" align="right"><b>Receipt No :</b></td>
    <td width="8%"><label id="receiptno" name="receiptno"><s:property value="receiptno"/></label></td>
    <td width="8%">&nbsp;<label id="receiptinfomore" name="receiptinfomore"><s:property value="receiptinfomore"/></label></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="4"><font size="2"><label id="clientinfo" name="clientinfo"><s:property value="clientinfo"/></label></font></td>
  </tr>
</table><br/>
