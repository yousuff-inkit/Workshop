...
<title>GatewayERP(i)</title>
	...
	function getdata(accountName,srNo,date,total,refNo){
		 $("#refreshdiv").load('rrvMainSearchGrid.jsp?accountName='+accountName.replace(/ /g, "%20")+'&srNo='+srNo+'&date='+date+'&total='+total+'&refNo='+refNo);
		}
...
<table width="100%">
  ...
  <tr>
    <td colspan="7"><div id="refreshdiv"><jsp:include  page="rrvMainSearchGrid.jsp"></jsp:include></div></td>
  </tr>
</table>
</div>
</body>
