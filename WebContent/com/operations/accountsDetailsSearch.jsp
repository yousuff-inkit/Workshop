...
<script type="text/javascript">
	...
	function loadAccountSearch() {
			...
			getAccountDetails(accountsno,accountsname,currs,formcode,dates,check);
	}
		
	function getAccountDetails(accountsno,accountsname,currs,formcode,dates,check){
		 $("#refreshAccountDetailsDiv").load("../../accountDetailsSearchGrid.jsp?accountno="+accountsno+'&accountname='+accountsname.replace(/ /g, "%20")+'&currency='+currs+'&dtype='+formcode+'&dates='+dates+'&check='+check);
	}
