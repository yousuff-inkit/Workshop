        ...
        $(document).ready(function () { 	
            ...
            var source =
            {
                ...
                datafields: [
     						...
     						{name : 'residualkmdocno',type:'string'},
            ...
            $("#jqxEnquiry").jqxGrid(
            {
                     ...
                     if (key == 114) {  
                 	 ...
                 	 if (cell1 != undefined && cell1.datafield == 'model') {  
		                    ...
		                    if (key == 114) {  
								...
								var mode=$('#mode').val();
								if(mode=="E"){
									brandval=$('#jqxEnquiry').jqxGrid('getcellvalue',cell1.rowindex,'brdid');
								}
                ...
                columns: [
							...
							{ text: 'Residual Km Docno',datafield:'residualkmdocno',width:'10%',hidden:true},
							{ text: 'VSB',datafield:'vsb',width:'10%'}
			              ]
            ...
            $('#jqxEnquiry').on('celldoubleclick', function (event) {
                ...
                if(dataField=="kmusage" || dataField=="ldur"){
                	var rowindextemp = event.args.rowindex;
              	    document.getElementById("rowindex").value = rowindextemp;  
              	  	$('#jqxEnquiry').jqxGrid('clearselection');
        	  	    $('#kmsearchwindow').jqxWindow('open');
              		kmSearchContent('kmSearch.jsp');
                }
              	  if(columnindex1 == 1)
              		  { 
         	 ...
         	 var rowindextemp = event.args.rowindex;
				...
				var mode=$('#mode').val();
         		if(mode=="E"){
         			brandval=$('#jqxEnquiry').jqxGrid('getcellvalue',rowindextemp,'brdid');
         		}
         	modelinfoSearchContent('modelSearch.jsp?brandval='+brandval);
