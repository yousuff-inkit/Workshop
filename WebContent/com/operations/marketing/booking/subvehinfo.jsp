<%--  
 ...
 <td  width="4%">
 <td style="background-color: #ff6347;" width="5%"></td> <td align="left"><label class="branch">&nbsp;Not Available</label></td>
  <td  width="4%">
...
var a13='<%=a13%>';
 ...
 var vehdata='<%=viewDAO.vehSearch(session)%>'; 
            ...
            $("#jqxfleetsearch").jqxGrid(
            {
              ...
              showfilterrow: true, 
                ...
                columns: [
					...
					{ text: ''+a1, datafield: '1', width: '2.5%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname, filterable: false},
					{ text: ''+a2, datafield: '2', width: '2.7%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname , filterable: false},
					{ text: ''+a3, datafield: '3', width: '2.7%', cellsalign: 'center', align:'center'  ,cellclassname: cellclassname, filterable: false},
					{ text: ''+a4, datafield: '4', width: '2.7%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname, filterable: false},
					{ text: ''+a5, datafield: '5', width: '2.7%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname , filterable: false},
					{ text: ''+a6, datafield: '6', width: '2.7%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname , filterable: false},
					{ text: ''+a7, datafield: '7', width: '2.7%', cellsalign: 'center', align:'center'  ,cellclassname: cellclassname, filterable: false},
					{ text: ''+a8, datafield: '8', width: '2.7%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname, filterable: false },
					{ text: ''+a9, datafield: '9', width: '2.7%', cellsalign: 'center', align:'center'  ,cellclassname: cellclassname, filterable: false},
					{ text: ''+a10, datafield: '10', width: '2.5%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname , filterable: false},
					{ text: ''+a11, datafield: '11', width: '2.5%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname, filterable: false},
					{ text: ''+a12, datafield: '12', width: '2.5%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname , filterable: false},
					{ text: ''+a13, datafield: '13', width: '2.5%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname, filterable: false},
					{ text: ''+a14, datafield: '14', width: '2.5%', cellsalign: 'center', align:'center'  ,cellclassname: cellclassname, filterable: false},
					{ text: ''+a15, datafield: '15', width: '2.5%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname, filterable: false},
					
					{ text: ''+a16, datafield: '16', width: '2.5%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname, filterable: false},
					{ text: ''+a17, datafield: '17', width: '2.5%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname , filterable: false},
					{ text: ''+a18, datafield: '18', width: '2.5%', cellsalign: 'center', align:'center'  ,cellclassname: cellclassname, filterable: false},
					{ text: ''+a19, datafield: '19', width: '2.7%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname, filterable: false},
					{ text: ''+a20, datafield: '20', width: '2.7%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname, filterable: false },
					{ text: ''+a21, datafield: '21', width: '2.7%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname, filterable: false },
					{ text: ''+a22, datafield: '22', width: '2.7%', cellsalign: 'center', align:'center'  ,cellclassname: cellclassname, filterable: false},
					{ text: ''+a23, datafield: '23', width: '2.7%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname, filterable: false },
					{ text: ''+a24, datafield: '24', width: '2.7%', cellsalign: 'center', align:'center'  ,cellclassname: cellclassname, filterable: false},
					{ text: ''+a25, datafield: '25', width: '2.5%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname, filterable: false },
					{ text: ''+a26, datafield: '26', width: '2.5%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname, filterable: false},
					{ text: ''+a27, datafield: '27', width: '2.5%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname , filterable: false},
					{ text: ''+a28, datafield: '28', width: '2.5%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname, filterable: false},
					{ text: ''+a29, datafield: '29', width: '2.5%', cellsalign: 'center', align:'center'  ,cellclassname: cellclassname, filterable: false},
					{ text: ''+a30, datafield: '30', width: '2.5%', cellsalign: 'center', align:'center' ,cellclassname: cellclassname, filterable: false},
