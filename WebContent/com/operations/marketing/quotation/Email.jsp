...
//System.out.println("------------"+request.getParameter("formcode"));
...
x.open("POST","<%=contextPath%>/com/operations/marketing/quotation/msgEmail.jsp?formcode="+formcode,true);
x.send();
}
