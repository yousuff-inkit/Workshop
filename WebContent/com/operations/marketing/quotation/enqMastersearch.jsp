...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	$(document).ready(function () {
 	...
 	function enqloadSearch1() {
 		...
 		var Cl_names = clname.replace(' ', '%20');
		
	
	getdata1(Cl_names,msdocno,enqdate);
	...
	function getdata1(Cl_names,msdocno,enqdate){
		 ...
		 $("#refreshdivmas").load('enqsubMastersearch.jsp?Cl_names='+Cl_names+'&msdocno='+msdocno+'&enqdate='+enqdate);
