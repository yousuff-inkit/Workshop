       ...
       // alert(data);
        $(document).ready(function () { 	
            ...
            $('#jqxbtntarif').on('rowdoubleclick', function (event) 
                ...
                document.getElementById("tdocnos").value=indexVal;
         ...
         /*          var exinsuss=$('#jqxbtntarif').jqxGrid('getcellvalue', rowindex1, "insurexcess");
                ...
                document.getElementById("supercdwinsu").value=$('#jqxbtntarif').jqxGrid('getcellvalue', rowindex1, "scdwexcess"); */
                 ...
                 var vehGroup=document.getElementById("tarigrpid").value;
              //  alert(vehGroup);
                $("#tarifDivId").load('tarifGrid.jsp?ratariffdocno1='+indexVal+'&vehGroup='+vehGroup);
              //  $("#tariffDivId").load('rateDescription.jsp?ratariffdocno1='+indexVal+'&vehGroup='+vehGroup);
