...
try{
	...
	if(zonedata.contains("P")){
		newzonedata=strnumber+"P"+cmbbaystatus;
	}
	else{  
		newzonedata=strnumber+cmbbaystatus;
	}
	String strupdate="update ws_floormgmtdata set z"+cmbbaystatusupdate+"='"+newzonedata+"' where jobdocno="+jobcarddocno;
