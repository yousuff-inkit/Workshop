...
(function (a) {
    ...
    a.extend(a.jqx._jqxMenu.prototype, {
        ...
        minimize: function () {
            ...
            c.wrap(
                '<div class="jqx-menu-wrapper" style="z-index:' + this.popupZIndex + '; padding: 0px; display: none; margin: 0px; height: auto; width: auto; position: absolute; top: 0; left: 0; display: block; visibility: visible;"></div>'
            );
            ...
            var b = function (j) {
                ...
                h.animate({ left: !i ? -h.outerWidth() : e.host.coord().left + e.host.width() + h.width(), opacity: 0 }, e.animationHideDuration, function () {
            ...
            var f = function (k) {
                if (e.minimizedHidden) {
                    ...
                    h.animate({ left: !j ? e.host.coord().left : e.host.coord().left + e.host.width() - i, opacity: 0.95 }, e.animationShowDuration, function () {});
                } else {
                    b(k);
                }
                e._raiseEvent("2", { type: "mouse", item: e.minimizedItem[0], event: k });
                e._setSize();
            };
            this.addHandler(a(window), "orientationchange.jqxmenu" + this.element.id, function (i) {
                setTimeout(function () {
                    if (!e.minimizedHidden) {
                        ...
                        h.css("top", e.host.coord().top + e.host.height());
                        h.css({ left: !k ? e.host.coord().left : e.host.coord().left + e.host.width() - j });
                    }
                }, 25);
            });
        ...
        _closeItem: function (l, o, g, c) {
            ...
            if (k != null) {
                ...
                var n = function () {
                    o.isOpen = false;
                    if (b) {
                        j.stop().animate({ top: m }, l.animationHideDuration, function () {
                        ...
                        j.stop().animate({ left: e }, l.animationHideDuration, function () {
                            if (l.animationHideDuration == 0) {
                                j.css({ left: e });
                            }
                            if (o.level > 0) {
        ...
        _openItem: function (s, r, q) {
            ...
            var b = j
                ? i.left
                : this.menuElements[r.parentId] != null && this.menuElements[r.parentId].subMenuElement != null
                ? parseInt(a(a(this.menuElements[r.parentId].subMenuElement).closest("div.jqx-menu-popup")).outerWidth()) - f[0]
                : parseInt(t.outerWidth());
            o.css({ visibility: "visible", display: "block", left: b, top: j ? i.top + h.outerHeight() : i.top, zIndex: l });
            t.css("display", "block");
            ...
            o.css({ height: parseInt(t.outerHeight()) + parseInt(f[1]) + "px" });
            var n = 0;
            var g = 0;
            switch (r.openVerticalDirection) {
                case "up":
                    if (j) {
                        ...
                        o.css({ display: "block", top: i.top - o.outerHeight(), zIndex: l });
                    } else {
                        n = f[1];
                        t.css("top", t.outerHeight());
                        o.css({ display: "block", top: i.top - o.outerHeight() + f[1] + h.outerHeight(), zIndex: l });
                    }
                    break;
                case "center":
                    if (j) {
                        t.css("top", 0);
                        o.css({ display: "block", top: i.top - o.outerHeight() / 2 + f[1], zIndex: l });
                    } else {
                        t.css("top", 0);
                        o.css({ display: "block", top: i.top + h.outerHeight() / 2 - o.outerHeight() / 2 + f[1], zIndex: l });
                    }
                    break;
            }
            switch (r.openHorizontalDirection) {
                case this._getDir("left"):
                    if (j) {
                        o.css({ left: i.left - (o.outerWidth() - h.outerWidth() - f[0]) });
                    } else {
                        g = 0;
                        t.css("left", o.outerWidth());
                        o.css({ left: i.left - o.outerWidth() + 2 * r.level });
                    }
                    break;
                case "center":
                    if (j) {
                        o.css({ left: i.left - (o.outerWidth() / 2 - h.outerWidth() / 2 - f[0] / 2) });
                    } else {
                        o.css({ left: i.left - (o.outerWidth() / 2 - h.outerWidth() / 2 - f[0] / 2) });
                        t.css("left", o.outerWidth());
                    }
                    ...
                    if (o != null) {
                        if (j) {
                            ...
                            if (r.openVerticalDirection == "down") {
                                ...
                                o.addClass(s.toThemeProperty("show"));
                            } else {
                            ...
                            if (s.animationShowDuration == 0) {
                                ...
                                t.animate({ top: n }, s.animationShowDuration, s.easing, function () {
                                    r.isOpen = true;
                                    a.jqx.aria(a(r.element), "aria-expanded", true);
                                    s._raiseEvent("0", r);
                                });
                            ...
                            if (s.animationShowDuration == 0) {
                                ...
                                t.animate({ left: g }, s.animationShowDuration, s.easing, function () {
                                    s._raiseEvent("0", r);
                                    r.isOpen = true;
                                    a.jqx.aria(a(r.element), "aria-expanded", true);
                                });
            ...
            switch (g.mode) {
                ...
                case "simple":
                    ...
                    if (g.mode == "popup") {
                        ...
                        g.host.wrap(
                            '<div tabindex=0 class="jqx-menu-wrapper" style="z-index:' +
                                g.popupZIndex +
        ...
        _getOffset: function (c) {
            ...
            if (this.hasTransform || (e != null && e) || d || f) {
                var b = { left: a.jqx.mobile.getLeftPos(c), top: a.jqx.mobile.getTopPos(c) };
                return b;
            } else {
                return { left: g, top: h };
            }
        ...
        close: function () {
            ...
            if (d) {
                var b = this.host;
                c.host.removeClass("jqx-popup-show");
        ...
        _render: function (f, g) {
            ...
            h.handleKeyDown = function (k) {
                if (h.keyboardNavigation) {
                    ...
                    if (k.keyCode == 13) {
                        if (q) {
                            t = true;
                            h._raiseEvent("2", { item: q.element, event: k, type: "keyboard" });
            ...
            a.each(this.items, function () {
                ...
                h.addHandler(n, "click", function (w) {
                    ...
                    h._raiseEvent("2", { type: "mouse", item: r.element, event: w });
                    if (!h.autoOpen) {
                        if (r.level > 0) {
                ...
                if (r.subMenuElement != null) {
                    ...
                    o.wrap(
                        '<div class="jqx-menu-popup ' +
                            h.toThemeProperty("jqx-menu-popup") +
                    ...
                    o.css({ overflow: "hidden", position: "absolute", left: 0, display: "inherit", top: -o.outerHeight() });
                    o.data("timer", {});
                    if (r.level > 0) {
                    ...
                    i++;
                    var q = a(r.subMenuElement)
                        .closest("div.jqx-menu-popup")
                        .css({ width: parseInt(a(r.subMenuElement).outerWidth()) + parseInt(d[0]) + "px", height: parseInt(a(r.subMenuElement).outerHeight()) + parseInt(d[1]) + "px" });
                        ...
                        if (!c) {
                            ...
                            h.addHandler(n, "mouseleave", function (u) {
                                if (h.autoCloseOnMouseLeave) {
                                    ...
                                    var t = { left: parseInt(u.pageX), top: parseInt(u.pageY) };
                                    var w = { left: parseInt(x.coord().left), top: parseInt(x.coord().top), width: parseInt(x.outerWidth()), height: parseInt(x.outerHeight()) };
                                    var v = true;
        ...
        _createMenu: function (c, f) {
            ...
            for (var j = 0; j < u.length; j++) {
                ...
                this.itemMapping[j] = { element: u[j], item: g };
