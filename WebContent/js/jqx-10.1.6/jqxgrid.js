    ...
    b.extend(b.jqx._jqxGrid.prototype, {
        defineInstance: function () {
            var d = {
                ...
                rtl: false,
                menuitemsarray: [],
                charting: { appendTo: null, colorScheme: "scheme02", dialog: { header: "Data Visualization", height: 400, width: 400, position: "center", enabled: true }, ready: null, formatSettings: {} },
                events: [
                    "initialized",
                    "rowClick",
                    "rowSelect",
        ...
        createInstance: function (i) {
            ...
            var g =
                "<div class='jqx-clear jqx-border-reset jqx-overflow-hidden jqx-max-size jqx-position-relative'><div tabindex='1' class='jqx-clear jqx-max-size jqx-position-relative jqx-overflow-hidden jqx-background-reset' id='wrapper" +
                h.element.id +
                "'><div class='jqx-clear jqx-position-absolute' id='toolbar' style='visibility: hidden;'></div><div class='jqx-clear jqx-position-absolute' id='groupsheader' style='visibility: hidden;'></div><div class='jqx-clear jqx-position-absolute' id='filter' style='visibility: hidden;'></div><div class='jqx-clear jqx-overflow-hidden jqx-position-absolute jqx-border-reset jqx-background-reset' id='content" +
                h.element.id +
                "'></div><div class='jqx-clear jqx-position-absolute' id='verticalScrollBar" +
                h.element.id +
                "'></div><div class='jqx-clear jqx-position-absolute' id='horizontalScrollBar" +
                h.element.id +
                "'></div><div class='jqx-clear jqx-position-absolute jqx-border-reset' id='bottomRight'></div><div class='jqx-clear jqx-position-absolute' id='addrow'></div><div class='jqx-clear jqx-position-absolute' id='statusbar'></div><div class='jqx-clear jqx-position-absolute' id='pager' style='z-index: 20;'></div></div></div>";
            h.element.innerHTML = "";
            if (h.source) {
            ...
            h.editors = new Array();
            h.vScrollBar = n.jqxScrollBar({ vertical: true, rtl: h.rtl, touchMode: h.touchmode, step: h.verticalscrollbarstep, largestep: h.verticalscrollbarlargestep, theme: h.theme, _triggervaluechanged: false });
            h.hScrollBar = r.jqxScrollBar({ vertical: false, rtl: h.rtl, touchMode: h.touchmode, step: h.horizontalscrollbarstep, largestep: h.horizontalscrollbarlargestep, theme: h.theme, _triggervaluechanged: false });
                ...
                if (m.editcell && m.editcell.editor) {
                    switch (m.editcell.columntype) {
                        case "dropdownlist":
                            ...
                            if (o) {
                                m.editcell.editor.jqxDropDownList({ openDelay: 0 });
                                m.editcell.editor.jqxDropDownList("open");
                                m.editcell.editor.jqxDropDownList({ openDelay: 250 });
                                return;
                            }
                            break;
                        case "combobox":
                            ...
                            if (o) {
                                m.editcell.editor.jqxComboBox({ openDelay: 0 });
                                m.editcell.editor.jqxComboBox("open");
                                m.editcell.editor.jqxComboBox({ openDelay: 250 });
                                return;
                            }
                            break;
                        case "datetimeinput":
                            if (o) {
                                ...
                                m.editcell.editor.jqxDateTimeInput({ openDelay: 0 });
                                m.editcell.editor.jqxDateTimeInput("open");
                                m.editcell.editor.jqxDateTimeInput({ openDelay: 250 });
                                return;
                            }
                            break;
                    }
        ...
        _updateTouchScrolling: function () {
            ...
            if (e.isTouchDevice()) {
                ...
                if (e.gridcontent) {
                    ...
                    b.jqx.mobile.touchScroll(
                        e.gridcontent[0],
                        e.vScrollInstance.max,
                        function (i, h) {
        ...
        _initmenu: function () {
            ...
            if (this.host.jqxMenu) {
                            ...
                            if (K) {
                                ...
                                if (s._buildfilter && s.filterable && !s.showfilterrow) {
                                    if (b.find("#filter1" + s.element.id).length > 0) {
                                        var T =
                                            b(b.find("#filter1" + s.element.id))
                                                .jqxDropDownList("container")
                                                .css("display") == "block";
                                        var R =
                                            b(b.find("#filter2" + s.element.id))
                                                .jqxDropDownList("container")
                                                .css("display") == "block";
                                        var P =
                                            b(b.find("#filter3" + s.element.id))
                                                .jqxDropDownList("container")
                                                .css("display") == "block";
                                    }
                ...
                this.gridmenu.jqxMenu({ popupZIndex: 1000, width: A, height: l, autoCloseOnClick: q, autoOpenPopup: false, mode: "popup", theme: this.theme, animationShowDuration: 0, animationHideDuration: 0, animationShowDelay: 0 });
        ...
        _arrangemenu: function () {
            ...
            this.gridmenu.jqxMenu({ width: f, height: i });
        },
                ...
                if (k.filtermode === "default") {
                    ...
                    if (k._hasdatefilter) {
                        if (b(".filtertext1" + k.element.id)[0].nodeName.toLowerCase() == "div") {
                            if (
                                b(".filtertext1" + k.element.id)
                                    .jqxDateTimeInput("container")
                                    .css("display") == "block"
                            ) {
                                return;
                            }
                            if (
                                b(".filtertext2" + k.element.id)
                                    .jqxDateTimeInput("container")
                                    .css("display") == "block"
                            ) {
                                return;
        ...
        openColumnChooser: function (f, h) {
            ...
            for (var g = 0; g < f.length; g++) {
                ...
                m.push({ label: f[g].text, value: f[g].datafield, checked: !f[g].hidden });
            }
            ...
            var p = new jqxListBox(d, { width: "100%", height: "calc(100% - 30px)", checkboxes: true, source: m });
            var k = new jqxWindow(l, { width: 400, height: 400, position: "center", isModal: true });
            ...
            setTimeout(function () {
                ...
                o.appendChild(n);
                o.appendChild(e);
                n = new jqxButton(n, { theme: j.theme });
                e = new jqxButton(e, { theme: j.theme });
            ...
            if (this._hasOpenedMenu) {
                ...
                if (i != null && this.autoshowcolumnsmenubutton) {
                    if (this.enableanimations) {
                        b(i.columnsmenu).animate({ "margin-left": 0 }, "fast", function () {
                            b(i.columnsmenu).css("display", "none");
                        });
                        var h = !this.rtl ? -32 : 0;
                        i.column.iconscontainer.animate({ "margin-left": h }, "fast");
                    } else {
                        b(i.columnsmenu).css("display", "none");
                        var h = !this.rtl ? -32 : 0;
            ...
            this.dataview.update = function (q) {
                ...
                if (g.pageable) {
                    if (g.pagerrightbutton) {
                        g.pagerrightbutton.jqxButton({ disabled: false });
                        g.pagerleftbutton.jqxButton({ disabled: false });
                        g.pagershowrowscombo.jqxDropDownList({ disabled: false });
                    }
                    if (g.pagerfirstbutton) {
                        g.pagerfirstbutton.jqxButton({ disabled: false });
                        g.pagerlastbutton.jqxButton({ disabled: false });
                    }
                }
                g._raiseEvent(11);
                if (!g.initializedcall) {
        ...
        _setrowdetailsvisibility: function (e, f, i) {
            if (this.rowdetailstemplate) {
                ...
                if (!this.details[e]) {
                    ...
                    this.details[e] = { rowdetailshidden: g.rowdetailshidden, rowdetailsheight: g.rowdetailsheight, rowdetails: g.rowdetails };
        ...
        _updateaddnewrow: function () {
            ...
            d.jqxButton({ template: "success", theme: o.theme });
            k.jqxButton({ template: "danger", theme: o.theme });
            q.jqxButton({ template: "primary", theme: o.theme });
            p.jqxButton({ template: "warning", theme: o.theme });
                        ...
                        var A = function (F, H, j) {
                            ...
                            E.focus(function () {
                                ...
                                if (F.everpresentrowactionsmode !== "columns") {
                                    C.css({ display: "block", top: E.coord().top + F.everpresentrowheight - 1, left: I > 0 ? E.coord().left : E.coord().left - 1 });
                                }
        ...
        _calculatevirtualheight: function () {
            ...
            if (h + f > 0) {
                while (g <= h + f) {
                    ...
                    if (g - f < h && g >= h) {
                        ...
                        if (q > 0) {
                            l -= d;
                            this._pageviews[j - 1] = { top: l, height: d - q * this.rowsheight };
                        }
                        break;
                    } else {
                        this._pageviews[j++] = { top: l, height: d };
                    }
                    l = n;
                    g += f;
                }
            ...
            if (m > k && !this.autoheight) {
                ...
                if (this.scrollmode == "deferred") {
                    this.vScrollBar.jqxScrollBar({ max: m });
                } else {
                    this.vScrollBar.jqxScrollBar({ max: m - k });
                }
            } else {
            ...
            return { visiblerecords: r, virtualheight: m };
        },
        _updatepageviews: function () {
            ...
            if (!this.pageable) {
                for (var t = 0; t < f; t++) {
                    var d = { index: t, height: this.heights[t], hidden: this.hiddens[t], details: this.details[t] };
                    ...
                    r++;
                    if (r >= o || t == f - 1) {
                        this._pageviews[g++] = { top: p, height: q };
                        q = 0;
                        p = l;
                        r = 0;
                    }
            ...
            this.virtualsizeinfo = { visiblerecords: w, virtualheight: n };
        },
        ...
        _rendercolumnheaders: function () {
            ...
            b.each(this.columns.records, function (X, V) {
                ...
                if (M != null) {
                    var O = b(
                        '<div class="iconscontainer" style="height: ' +
                            l +
                            'px; margin-left: -32px; display: block; position: absolute; left: 100%; top: 0%; width: 32px;"><div class="filtericon ' +
                            x.toTP("jqx-widget-header") +
                            '" style="height: ' +
                            l +
                            'px; float: right; display: none; width: 16px;"><div class="' +
                            x.toTP("jqx-grid-column-filterbutton") +
                            '" style="width: 100%; height:100%;"></div></div><div class="sortasc ' +
                            x.toTP("jqx-widget-header") +
                            '" style="height: ' +
                            l +
                            'px; float: right; display: none; width: 16px;"><div class="' +
                            x.toTP("jqx-grid-column-sortascbutton") +
                            " " +
                            x.toTP("jqx-icon-arrow-up") +
                            '" style="width: 100%; height:100%;"></div></div><div class="sortdesc ' +
                            x.toTP("jqx-widget-header") +
                            '" style="height: ' +
                            l +
                            'px; float: right; display: none; width: 16px;"><div class="' +
                            x.toTP("jqx-grid-column-sortdescbutton") +
                            " " +
                            x.toTP("jqx-icon-arrow-down") +
                            '" style="width: 100%; height:100%;"></div></div><div class="sorticon ' +
                            x.toTP("jqx-widget-header") +
                            '" style="height: ' +
                            l +
                            'px; float: right; visibility: hidden; width: 16px;"><div class="' +
                            x.toTP("jqx-grid-column-sorticon") +
                            " " +
                            x.toTP("jqx-icon-arrow-down") +
                ...
                x.addHandler(H, "click", function (i) {
                    ...
                    ac(aa, i);
                    i.preventDefault();
                    x._raiseEvent(7, { column: aa.getcolumnproperties(), datafield: aa.datafield, originalEvent: i });
                });
                    ...
                    x.addHandler(H, j, function (ae) {
                        ...
                        if (x._handlecolumnsresize) {
                            if (I) {
                                ...
                                ag = 40;
                                if (i >= aj + aa.width - ag) {
                                    x.resizablecolumn = { columnelement: H, column: aa };
                ...
                if (aa.checkboxcolumn) {
                    ...
                    k.jqxCheckBox({ _canFocus: false, disabled: x.disabled, disabledContainer: true, theme: x.theme, enableContainerClick: false, animationShowDelay: 0, animationHideDelay: 0 });
                    ...
                    L.updated = function (ae, i, af) {
                        ...
                        if (x.disabled) {
                            k.jqxCheckBox({ disabled: x.disabled });
                            i = af;
                        }
                        if (i) {
                            x.selectallrows();
        ...
        _rendercolumnheader: function (h, i, e, d) {
            ...
            if (this.enableellipsis) {
                if (i == "left") {
                    return (
                        '<div style="padding-bottom: 2px; overflow: hidden; text-overflow: ellipsis; text-align: ' +
                        i +
                        "; margin-left: 4px; margin-right: 2px; line-height: " +
                        e +
                        'px;"><span style="text-overflow: ellipsis; cursor: default;">' +
                        h +
                        "</span></div>"
                    );
                } else {
        ...
        _rendervisualrows: function () {
            ...
            var am = Z.isScrolling() || p.isScrolling() || this._keydown;
            ...
            if (!this.pageable) {
                var M = this._findvisiblerow(o, this._pageviews);
                if (M == -1) {
                    this._clearvisualrows();
                    this._renderemptyrow();
                    this._updaterowdetailsvisibility();
                }
                if (M != this.dataview.pagenum) {
                    this.dataview.pagenum = M;
                    this.dataview.updateview();
                    this._loadrows();
                } else {
                    if (!this._pagescache[this.dataview.pagenum]) {
            ...
            var ao = this.groupable && this.groups.length > 0 ? this.groups.length : 0;
            if (!this.columns.records) {
                return;
            }
            var r = this.columns.records.length - ao;
            var ae = this._findvisiblerow(o, this._pagescache[this.dataview.pagenum]);
            var N = this._pagescache[this.dataview.pagenum];
            var T = ae;
            if (T < 0) {
                T = 0;
            }
            ...
            var Q = this.groupable ? this.groups.length : 0;
            ...
            var P = this.rowsheight;
            var H = T;
            var an = this._rendercell;
            var u = true;
            var q = this._getvisualcolumnsindexes(l, K, ao, r, E, true);
            var d = q.start;
            var ac = q.end;
            var t = this._getvirtualcolumnsindexes(l, K, ao, r, E);
            var J = t.start;
            var h = t.end;
            var ag = b.jqx.browser.msie && b.jqx.browser.version < 9;
            if ((this.autoheight || this.pageable) && this.autorowheight) {
            ...
            if (T >= 0) {
                this._updaterowdetailsvisibility();
                this._startboundindex = N != null ? N[T].bounddata.boundindex : 0;
                this._startvisibleindex = N != null ? N[T].bounddata.visibleindex : 0;
                ...
                if (this.columns.records.length > 10 && this.enablecolumnsvirtualization) {
                    ...
                    for (var ai = 0; ai < A.length; ai++) {
                        ...
                        for (var W = 0; W < J; W++) {
                            var ak = W;
                            if (this.columns.records[ak].pinned) {
                                continue;
                            }
                            if (this.columns.records[ak].datafield == null) {
                                continue;
                            }
                            var aj = k.cells[ak];
                            if (I(aj)) {
                            ...
                            var S = this.columns.records[ak].element;
                            this.columns.records[ak]._rendered = false;
                            if (I(S)) {
                                this.columnsrow[0].removeChild(S);
                            }
                            if (this.filterrow) {
                                if (I(this.filterrow[0].cells[ak]) && this.columns.records[ak].filterable) {
                                    this.filterrow[0].cells[ak].parentNode.removeChild(this.filterrow[0].cells[ak]);
                                }
                            }
                        }
                        for (var W = h; W < this.columns.records.length; W++) {
                            var ak = W;
                            if (this.columns.records[ak].pinned) {
                                continue;
                            }
                        ...
                        for (var W = J; W < h; W++) {
                            ...
                            var S = this.columns.records[ak].element;
                            this.columns.records[ak]._rendered = true;
                            if (S.selectable) {
                                aj.removeAttribute("selected");
                                if (S.selected) {
                                    aj.setAttribute("selected", "");
                                }
                            }
                            if (!I(S)) {
                                this.columnsrow[0].appendChild(S);
                            }
                            if (this.filterrow && this.showfilterrow && !I(this.filterrow[0].cells[ak]) && this.columns.records[ak].filterable) {
                                this.filterrow[0].firstChild.appendChild(this.filterrow[0].cells[ak]);
                            }
                        }
                    }
                }
                for (var n = 0; n < V && ad < V; n++) {
                    var af = N != undefined ? N[T + n] : null;
                    ...
                    if (af == null) {
                        ...
                        if (this._pagescache[this.dataview.pagenum + 1]) {
                            N = this._pagescache[this.dataview.pagenum + 1];
                            ...
                            do {
                                if (this.dataview.pagenum < this._pageviews.length - 1) {
                                    ...
                                    if (this._pageviews[this.dataview.pagenum].height > 0) {
                                        this.dataview.updateview();
                                        this._loadrows();
                                        N = this._pagescache[this.dataview.pagenum];
                                    }
                                } else {
                                    N = undefined;
                                    break;
                                }
                            } while (N == undefined && this.dataview.pagenum < s);
                        }
                        if (N != undefined) {
                            af = N[T + n];
                        }
                    ...
                    if (af != null) {
                        ...
                        if (n == 0) {
                            var m = Math.abs(o - af.top);
                            this.table[0].style.top = -m + "px";
                            var D = this.table;
                            if (b.jqx.browser.chrome) {
                                setTimeout(function () {
                                    D[0].style.top = -m + 0.01 + "px";
                                }, 50);
                            }
                            e = -m;
                        }
                        var k = this.table[0].rows[ad];
                        if (!k) {
                            continue;
                        }
                        if (parseInt(k.style.height) != af.height) {
                            k.style.height = parseInt(af.height) + "px";
                        }
                        R += af.height;
                        var Y = this.rowdetails && af.rowdetails;
                        var w = !af.rowdetailshidden;
                        if (Y && w) {
                            k.style.height = parseInt(af.height - af.rowdetailsheight) + "px";
                            V++;
                        }
                        var L = this._isrowselected(u, af);
                        for (var W = d; W < ac; W++) {
                            var ak = W;
                            this._rendervisualcell(an, B, L, Y, w, E, Q, k, af, ak, ad, am);
                        }
                        if (af.group != undefined && this._rendergroup) {
                            this._rendergroup(Q, k, af, ao, r, ad, K);
                        }
                        if (this.autorowheight && (this.autoheight || this.pageable)) {
                            var P = this.rowsheight;
                            for (var W = d; W < ac; W++) {
                                if (this.editable && this.editcell && this.editcell.column == this.columns.records[W].datafield && this.editcell.row == this.getboundindex(af)) {
                                    if (this.editcell.editor) {
                                        P = Math.max(P, this.editcell.editor.height());
                                        continue;
                                    }
                                }
                                if (k.cells[W].firstChild) {
                                    P = Math.max(P, 8 + parseInt(k.cells[W].firstChild.offsetHeight));
                                }
                            }
                            k.style.height = parseInt(P) + "px";
                            this.heights[this._startboundindex + n] = P;
                            if (Y && w) {
                                P += af.rowdetailsheight;
                            }
                            af.height = P;
                        }
                        this.visiblerows[this.visiblerows.length] = af;
                        this.hittestinfo[this.hittestinfo.length] = { row: af, visualrow: k, details: false };
                        if (Y && w) {
                            ad++;
                            var k = this.table[0].rows[ad];
                            this._renderrowdetails(B, k, af, ao, r, ad);
                            this.visiblerows[this.visiblerows.length] = af;
                            this.hittestinfo[this.hittestinfo.length] = { row: af, visualrow: k, details: true };
                        }
                        if (!this.autorowheight) {
                            if (R + e >= x) {
                                break;
                        ...
                        var ab = true;
                        this._clearvisualrow(l, E, ad, ao, r);
                        if (R + ah + e <= x) {
                            ah += P;
                        }
                    }
                ...
                if (ah > 0) {
                    if (this.vScrollBar[0].style.visibility == "visible") {
                        var al = parseInt(this.table.css("top"));
                        var G = this._pageviews[this._pageviews.length - 1];
                        var v = Z.max;
                        var F = G.top + G.height - x;
                        if (this.hScrollBar.css("visibility") == "visible") {
                            F += this.scrollbarsize + 22;
                        }
                        if (v != F && !this.autorowheight) {
                            if (F >= 0) {
                                if (this.scrollmode != "deferred") {
                                    Z.max = F;
                                    Z.setPosition(Z.max);
            ...
            if ((this.autoheight || this.pageable) && this.autorowheight) {
                ...
                var X = 0;
                var g = 0;
                for (var ai = 0; ai < this.visiblerows.length; ai++) {
                    var z = this.visiblerows[ai];
                    z.top = X;
                    X += z.height;
                    g += z.height;
                    var Y = this.rowdetails && z.rowdetails;
                    var w = !z.rowdetailshidden;
                    var k = this.table[0].rows[ai];
                    if (Y && w) {
                        ai++;
                    }
                    for (var W = d; W < ac; W++) {
                        var aa = this.columns.records[W];
                        if (!aa.hidden && !aa.adaptivehidden) {
                            if (!aa.cellsrenderer) {
                                var O = k.cells[W];
                                var f = 0;
                                if (O.firstChild) {
                                    var f = (z.height - parseInt(O.firstChild.offsetHeight) - 8) / 2;
                                    if (Y && w) {
                                        var f = (z.height - z.rowdetailsheight - b(O.firstChild).height() - 8) / 2;
                                    }
                                } else {
                                    var f = (z.height - parseInt(b(O).height()) - 8) / 2;
                                }
                                if (f >= 0) {
                                    f = parseInt(f) + 4;
                                    if (O.firstChild) {
                                        if (O.firstChild.className.indexOf("jqx-grid-groups-row") == -1) {
                                            if (aa.columntype != "checkbox" && aa.columntype != "button") {
                                                if (this.editable && this.editcell && this.editcell.column == aa.datafield && this.editcell.row == this.getboundindex(z)) {
                                                    continue;
                                                }
                                                O.firstChild.style.marginTop = f + "px";
                                            }
                                        }
                                    }
                                }
            ...
            if (this.toCompile && this.toCompile.length > 0) {
                var U = this;
                b.each(U.toCompile, function (y, ap) {
                    if (this.compiled) {
                        return true;
                    }
                    var i = this.cell;
        ...
        _rendercell: function (w, f, k, u, d, s) {
            ...
            if (f.columntype == "checkbox") {
                w._rendercheckboxcell(w, d, f, k, u);
                w._cellscache[g] = { element: "", title: u };
                if (w.enabletooltips && f.enabletooltips) {
                    d.title = "" + u;
                }
                return;
            ...
            if (f.cellsrenderer != null) {
                ...
                if (v && (v.indexOf("<jqx-") >= 0 || v.indexOf(" ng-") >= 0)) {
                    if (w.toCompile) {
                        w.toCompile.push({ cell: d, value: v, row: w.getboundindex(k) });
                    }
                    return;
                }
            } else {
            ...
            w._cellscache[g] = { element: d.innerHTML, title: m };
            return true;
        },
        _isIE10: function () {
                    ...
                    i.updated = function (l, s, m) {
                        if (g.disabled) {
                            ...
                            for (var o = 0; o < p; o++) {
                                ...
                                if (n) {
                                    b(n).jqxCheckBox({ disabled: g.disabled });
                                }
                            }
                        }
                            ...
                            if (g.editrow == undefined) {
                                ...
                                if (g.editcell && g.editcell.validated == false) {
                                    ...
                                    if (g.editmode !== "selectedrow" || g.editcell == null) {
                                        ...
                                        g._raiseEvent(17, { rowindex: e.checkboxrow, row: q, datafield: f.datafield, value: m, columntype: f.columntype });
                                        g.pushToHistory = true;
                                        g.setcellvalue(e.checkboxrow, f.datafield, s, true);
                                        g.pushToHistory = false;
                                        g._raiseEvent(18, { rowindex: e.checkboxrow, row: q, datafield: f.datafield, oldvalue: m, value: s, columntype: f.columntype });
                                    } else {
                                        g.pushToHistory = true;
        ...
        setcellvalue: function (o, F, H, Q, j) {
            ...
            if (C != null && C[F] !== H) {
                ...
                if (this.pushToHistory) {
                    ...
                    this._undoRedo.push({ action: "setcellvalue", data: { oldvalue: q, value: H, datafield: F, row: o } });
                }
            ...
            this._raiseEvent(19, { rowindex: o, datafield: F, newvalue: H, value: H, oldvalue: q });
            return true;
        },
        ...
        updaterow: function (d, l, g) {
            if (d != undefined && l != undefined) {
                ...
                if (this.pushToHistory) {
                    ...
                    this._undoRedoIndex = -1;
                    this._undoRedo.push({ action: "updaterow", data: { id: d, rowdata: l, oldrowdata: j } });
                }
        ...
        _hascolumnstyle: function () {
            ...
            for (var d = 0; d < this.columns.records.length; d++) {
                var e = this.columns.records[d];
                if (
                    e.style.headerBackgroundColor ||
                    e.style.headerColor ||
                    e.style.headerBackgroundHoveredColor ||
                    e.style.headerHoveredColor ||
                    e.style.headerBackgroundSelectedColor ||
                    e.style.headerSelectedColor ||
                    e.style.backgroundColor ||
                    e.style.color ||
                    e.style.backgroundHoveredColor ||
                    e.style.hoveredColor ||
        ...
        _handlemousedown: function (Z, n) {
            ...
            n.mousecaptureposition = { left: Z.pageX, top: Z.pageY - C, clickedrow: j };
            ...
            if (r != null && G >= 0) {
                this._raiseEvent(1, { rowindex: this.getboundindex(r), visibleindex: r.visibleindex, row: r, group: r.group, rightclick: o, originalEvent: Z });
                ...
                if (L.columntype === "adaptive") {
                    ...
                    for (var S = 0; S < this.columns.records.length; S++) {
                        ...
                        var H = this.filterable
                            ? '<div datafield="' + L.datafield + '" class="' + n.toTP("jqx-grid-column-filterbutton") + '" style="position: relative; top: 4px; display: inline-block; width: 16px; height:16px;"></div>'
                            : "";
                        if (this.editable) {
                            if (L.editable) {
                    ...
                    this.adaptiveview = K;
                    b(this.adaptiveview)
                        .find(".jqx-grid-column-filterbutton")
                        .on("click", function () {
                ...
                if (this._lastmousedown != null) {
                    if (this._mousedown - this._lastmousedown < 300) {
                        if (this._clickedrowindex == this.getboundindex(r)) {
                            this._raiseEvent(22, { rowindex: this.getboundindex(r), row: r, visibleindex: r.visibleindex, group: r.group, rightclick: o, originalEvent: Z });
    ...
    b.jqx.dataview = function () {
        ...
        this.databind = function (y, p) {
            ...
            if (w) {
                ...
                h = new b.jqx.dataAdapter(y, { autoBind: false });
            }
            var f = function (m) {
                h.recordids = [];
                h.records = new Array();
                ...
                if (!I.virtualmode) {
                    ...
                    if (!y.recordendindex) {
                        if (!I.grid.pageable) {
                            ...
                            m = { startindex: I.pagenum * I.pagesize, endindex: I.pagenum * I.pagesize + I.pagesize };
                        }
                    }
                    m.data = h.records;
        ...
        this.refresh = function (m) {
            ...
            if (this.rowschangecallback != null) {
                var o = this.rows;
                if (C != this.totalrows) {
                    this.rowschangecallback({ type: "PagingChanged", data: this.getpagingdetails() });
                }
                if (g != o.length) {
                    this.rowschangecallback({ type: "RowsCountChanged", data: { previous: g, current: o.length } });
                }
                if (s.length > 0 || g != o.length) {
                    this.rowschangecallback({ type: "RowsChanged", data: { previous: g, current: o.length, diff: s } });
                }
            }
        };
        return this;
