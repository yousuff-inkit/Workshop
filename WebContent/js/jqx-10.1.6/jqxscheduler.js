            ...
            for (var c = 0; c < 4; c++) {
                if (d.parentNode) {
                    if (
                        ...
                        d.className.indexOf("jqx-scheduler-appointment-innter-content") == -1 &&
        ...
        _addHandlers: function () {
                ...
                for (var v = 0; v < 4; v++) {
                    if (u.parentNode) {
                        if (
                            ...
                            u.className.indexOf("jqx-scheduler-appointment-innter-content") == -1 &&
            ...
            var j = function (K) {
                ...
                if (q && q[0].className.indexOf("feedback") == -1) {
                    ...
                    var N = a(q).position();
                    i.selectedAppointmentTableBounds = { top: N.top, left: N.left, width: a(q).width(), height: a(q).height() };
                    if (!i._dragStartCell) {
                    ...
                    if (K.which === 3) {
                        ...
                        if (O !== null) {
                            ...
                            i._raiseEvent("cellClick", { cell: u, date: L });
                        }
                    } else {
                        if (K.which != 3) {
                            i.clearAppointmentsSelection();
                ...
                if (P !== undefined && K.which != 3) {
                    ...
                    if (o) {
                        ...
                        if (i._lastSelectedCell && i._lastSelectedCell.getAttribute("data-selected") == "true" && u.getAttribute("data-selected") === "true" && s - i.clickTime.getTime() < F) {
                            var L = new a.jqx.date(u.getAttribute("data-date"), i.timeZone);
                            i._raiseEvent("cellDoubleClick", { cell: u, date: L });
                            G = true;
                            i._initDialog();
                            i._openDialog();
                            if (K.preventDefault) {
